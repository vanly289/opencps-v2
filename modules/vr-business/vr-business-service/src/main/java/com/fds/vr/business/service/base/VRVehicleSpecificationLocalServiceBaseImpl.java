...
import com.fds.vr.business.service.VRVehicleSpecificationLocalService;
...
/**
 * Provides the base implementation for the vr vehicle specification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRVehicleSpecificationLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRVehicleSpecificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRVehicleSpecificationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRVehicleSpecificationLocalServiceUtil} to access the vr vehicle specification local service.
	 */
	...
	@Override
	public VRVehicleSpecification addVRVehicleSpecification(
		VRVehicleSpecification vrVehicleSpecification) {
		vrVehicleSpecification.setNew(true);

		return vrVehicleSpecificationPersistence.update(vrVehicleSpecification);
	}
	 ...
	 */
	@Override
	public VRVehicleSpecification createVRVehicleSpecification(long id) {
		return vrVehicleSpecificationPersistence.create(id);
	}
	...
	@Override
	public VRVehicleSpecification deleteVRVehicleSpecification(long id)
		throws PortalException {
		return vrVehicleSpecificationPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRVehicleSpecification deleteVRVehicleSpecification(
		VRVehicleSpecification vrVehicleSpecification) {
		return vrVehicleSpecificationPersistence.remove(vrVehicleSpecification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRVehicleSpecification.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrVehicleSpecificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrVehicleSpecificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRVehicleSpecification fetchVRVehicleSpecification(long id) {
		return vrVehicleSpecificationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRVehicleSpecification getVRVehicleSpecification(long id)
		throws PortalException {
		return vrVehicleSpecificationPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrVehicleSpecificationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRVehicleSpecification.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrVehicleSpecificationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRVehicleSpecification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrVehicleSpecificationLocalService.deleteVRVehicleSpecification((VRVehicleSpecification)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrVehicleSpecificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRVehicleSpecification> getVRVehicleSpecifications(int start,
		int end) {
		return vrVehicleSpecificationPersistence.findAll(start, end);
	}
	...
	public int getVRVehicleSpecificationsCount() {
		return vrVehicleSpecificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRVehicleSpecification updateVRVehicleSpecification(
		VRVehicleSpecification vrVehicleSpecification) {
		return vrVehicleSpecificationPersistence.update(vrVehicleSpecification);
	}
	 ...
	 */
	public VRVehicleSpecificationLocalService getVRVehicleSpecificationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRVehicleSpecification",
			vrVehicleSpecificationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRVehicleSpecification");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRVehicleSpecificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrVehicleSpecificationPersistence.getDataSource();
	...
	@BeanReference(type = VRVehicleSpecificationLocalService.class)
	protected VRVehicleSpecificationLocalService vrVehicleSpecificationLocalService;
