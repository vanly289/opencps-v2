...
import com.fds.vr.business.service.VRDossierLocalService;
...
/**
 * Provides the base implementation for the vr dossier local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRDossierLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRDossierLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VRDossierLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRDossierLocalServiceUtil} to access the vr dossier local service.
	 */
	...
	@Override
	public VRDossier addVRDossier(VRDossier vrDossier) {
		vrDossier.setNew(true);

		return vrDossierPersistence.update(vrDossier);
	}
	 ...
	 */
	@Override
	public VRDossier createVRDossier(long dossierId) {
		return vrDossierPersistence.create(dossierId);
	}
	...
	@Override
	public VRDossier deleteVRDossier(long dossierId) throws PortalException {
		return vrDossierPersistence.remove(dossierId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRDossier deleteVRDossier(VRDossier vrDossier) {
		return vrDossierPersistence.remove(vrDossier);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRDossier.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrDossierPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vrDossierPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrDossierPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRDossier fetchVRDossier(long dossierId) {
		return vrDossierPersistence.fetchByPrimaryKey(dossierId);
	}
	 ...
	 */
	@Override
	public VRDossier fetchVRDossierByUuidAndGroupId(String uuid, long groupId) {
		return vrDossierPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public VRDossier getVRDossier(long dossierId) throws PortalException {
		return vrDossierPersistence.findByPrimaryKey(dossierId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrDossierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRDossier.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dossierId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrDossierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRDossier.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("dossierId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<VRDossier>() {
				@Override
				public void performAction(VRDossier vrDossier)
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(VRDossier.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrDossierLocalService.deleteVRDossier((VRDossier)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrDossierPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRDossier> getVRDossiersByUuidAndCompanyId(String uuid,
		long companyId) {
		return vrDossierPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<VRDossier> getVRDossiersByUuidAndCompanyId(String uuid,
		...
		return vrDossierPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	@Override
	public VRDossier getVRDossierByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return vrDossierPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<VRDossier> getVRDossiers(int start, int end) {
		return vrDossierPersistence.findAll(start, end);
	}
	...
	public int getVRDossiersCount() {
		return vrDossierPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRDossier updateVRDossier(VRDossier vrDossier) {
		return vrDossierPersistence.update(vrDossier);
	}
	 ...
	 */
	public VRDossierLocalService getVRDossierLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRDossier",
			vrDossierLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRDossier");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRDossierLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrDossierPersistence.getDataSource();
	...
	@BeanReference(type = VRDossierLocalService.class)
	protected VRDossierLocalService vrDossierLocalService;
