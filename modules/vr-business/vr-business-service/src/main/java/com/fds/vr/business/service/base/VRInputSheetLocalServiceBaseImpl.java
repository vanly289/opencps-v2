...
import com.fds.vr.business.service.VRInputSheetLocalService;
...
/**
 * Provides the base implementation for the vr input sheet local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRInputSheetLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRInputSheetLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRInputSheetLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRInputSheetLocalServiceUtil} to access the vr input sheet local service.
	 */
	...
	@Override
	public VRInputSheet addVRInputSheet(VRInputSheet vrInputSheet) {
		vrInputSheet.setNew(true);

		return vrInputSheetPersistence.update(vrInputSheet);
	}
	 ...
	 */
	@Override
	public VRInputSheet createVRInputSheet(long id) {
		return vrInputSheetPersistence.create(id);
	}
	...
	@Override
	public VRInputSheet deleteVRInputSheet(long id) throws PortalException {
		return vrInputSheetPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRInputSheet deleteVRInputSheet(VRInputSheet vrInputSheet) {
		return vrInputSheetPersistence.remove(vrInputSheet);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRInputSheet.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrInputSheetPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrInputSheetPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRInputSheet fetchVRInputSheet(long id) {
		return vrInputSheetPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRInputSheet getVRInputSheet(long id) throws PortalException {
		return vrInputSheetPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrInputSheetLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRInputSheet.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrInputSheetLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRInputSheet.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrInputSheetLocalService.deleteVRInputSheet((VRInputSheet)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrInputSheetPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRInputSheet> getVRInputSheets(int start, int end) {
		return vrInputSheetPersistence.findAll(start, end);
	}
	...
	public int getVRInputSheetsCount() {
		return vrInputSheetPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRInputSheet updateVRInputSheet(VRInputSheet vrInputSheet) {
		return vrInputSheetPersistence.update(vrInputSheet);
	}
	 ...
	 */
	public VRInputSheetLocalService getVRInputSheetLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRInputSheet",
			vrInputSheetLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRInputSheet");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRInputSheetLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrInputSheetPersistence.getDataSource();
	...
	@BeanReference(type = VRInputSheetLocalService.class)
	protected VRInputSheetLocalService vrInputSheetLocalService;
