...
public class VRProductionPlantFinderImpl extends VRProductionPlantFinderBaseImpl
	implements VRProductionPlantFinder {

	Log _log = LogFactoryUtil.getLog(VRProductionPlantFinderImpl.class);
