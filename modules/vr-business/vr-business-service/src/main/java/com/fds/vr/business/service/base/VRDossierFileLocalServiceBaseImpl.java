...
import com.fds.vr.business.service.VRDossierFileLocalService;
...
/**
 * Provides the base implementation for the vr dossier file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRDossierFileLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRDossierFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRDossierFileLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRDossierFileLocalServiceUtil} to access the vr dossier file local service.
	 */
	...
	public VRDossierFile addVRDossierFile(VRDossierFile vrDossierFile) {
		...
		return vrDossierFilePersistence.update(vrDossierFile);
	}
	...
	public VRDossierFile createVRDossierFile(long dossierFileId) {
		return vrDossierFilePersistence.create(dossierFileId);
	}
	...
	public VRDossierFile deleteVRDossierFile(long dossierFileId)
		...
		return vrDossierFilePersistence.remove(dossierFileId);
	}
	...
	public VRDossierFile deleteVRDossierFile(VRDossierFile vrDossierFile) {
		return vrDossierFilePersistence.remove(vrDossierFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRDossierFile.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrDossierFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrDossierFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRDossierFile fetchVRDossierFile(long dossierFileId) {
		return vrDossierFilePersistence.fetchByPrimaryKey(dossierFileId);
	}
	 ...
	 */
	@Override
	public VRDossierFile fetchVRDossierFileByUuidAndGroupId(String uuid,
		long groupId) {
		return vrDossierFilePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public VRDossierFile getVRDossierFile(long dossierFileId)
		throws PortalException {
		return vrDossierFilePersistence.findByPrimaryKey(dossierFileId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrDossierFileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRDossierFile.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dossierFileId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrDossierFileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRDossierFile.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<VRDossierFile>() {
				@Override
				public void performAction(VRDossierFile vrDossierFile)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(VRDossierFile.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrDossierFileLocalService.deleteVRDossierFile((VRDossierFile)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrDossierFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRDossierFile> getVRDossierFilesByUuidAndCompanyId(
		...
		return vrDossierFilePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<VRDossierFile> getVRDossierFilesByUuidAndCompanyId(
		...
		return vrDossierFilePersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public VRDossierFile getVRDossierFileByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return vrDossierFilePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<VRDossierFile> getVRDossierFiles(int start, int end) {
		return vrDossierFilePersistence.findAll(start, end);
	}
	...
	public int getVRDossierFilesCount() {
		return vrDossierFilePersistence.countAll();
	}
	 ...
	 */
	public VRDossierFileLocalService getVRDossierFileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRDossierFile",
			vrDossierFileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRDossierFile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRDossierFileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrDossierFilePersistence.getDataSource();
	...
	@BeanReference(type = VRDossierFileLocalService.class)
	protected VRDossierFileLocalService vrDossierFileLocalService;
