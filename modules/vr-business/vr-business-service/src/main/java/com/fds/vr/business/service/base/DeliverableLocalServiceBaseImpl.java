...
import com.fds.vr.business.service.DeliverableLocalService;
...
/**
 * Provides the base implementation for the deliverable local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.DeliverableLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.DeliverableLocalServiceImpl
 * @see com.fds.vr.business.service.DeliverableLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class DeliverableLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeliverableLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.DeliverableLocalServiceUtil} to access the deliverable local service.
	 */
	...
	public Deliverable addDeliverable(Deliverable deliverable) {
		...
		return deliverablePersistence.update(deliverable);
	}
	...
	public Deliverable createDeliverable(long deliverableId) {
		return deliverablePersistence.create(deliverableId);
	}
	...
	public Deliverable deleteDeliverable(long deliverableId)
		...
		return deliverablePersistence.remove(deliverableId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Deliverable.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deliverablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return deliverablePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deliverablePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public Deliverable fetchDeliverable(long deliverableId) {
		return deliverablePersistence.fetchByPrimaryKey(deliverableId);
	}
	...
	public Deliverable fetchDeliverableByUuidAndGroupId(String uuid,
		long groupId) {
		return deliverablePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public Deliverable getDeliverable(long deliverableId)
		throws PortalException {
		return deliverablePersistence.findByPrimaryKey(deliverableId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deliverableLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Deliverable.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("deliverableId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(deliverableLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Deliverable.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Deliverable>() {
				@Override
				public void performAction(Deliverable deliverable)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(Deliverable.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return deliverableLocalService.deleteDeliverable((Deliverable)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return deliverablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<Deliverable> getDeliverablesByUuidAndCompanyId(String uuid,
		long companyId) {
		return deliverablePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Deliverable> getDeliverablesByUuidAndCompanyId(String uuid,
		...
		return deliverablePersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public Deliverable getDeliverableByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return deliverablePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<Deliverable> getDeliverables(int start, int end) {
		return deliverablePersistence.findAll(start, end);
	}
	...
	public int getDeliverablesCount() {
		return deliverablePersistence.countAll();
	}
	 ...
	 */
	public DeliverableLocalService getDeliverableLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.Deliverable",
			deliverableLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.Deliverable");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeliverableLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deliverablePersistence.getDataSource();
	...
	@BeanReference(type = DeliverableLocalService.class)
	protected DeliverableLocalService deliverableLocalService;
