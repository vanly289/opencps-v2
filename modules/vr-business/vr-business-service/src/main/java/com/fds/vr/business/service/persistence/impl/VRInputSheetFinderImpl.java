...
public class VRInputSheetFinderImpl extends VRInputSheetFinderBaseImpl implements VRInputSheetFinder {

	Log log = LogFactoryUtil.getLog(VRInputSheetFinderImpl.class);
	...
	public JSONArray findData(String sql, List<String> columnNames, List<String> dataTypes, Class<?> modelClazz,
		...
		try {
			...
			log.info("===>>>VRInputSheetFinder " + sql + "|" + start + "|" + end);
	...
	public long countData(String sql) throws SystemException {
		...
		try {
			...
			log.info("===>>>VRInputSheetFinder " + sql);
