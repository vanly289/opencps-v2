...
public class VRInputSheetFinderImpl extends VRInputSheetFinderBaseImpl
	implements VRInputSheetFinder {

	Log _log = LogFactoryUtil.getLog(VRInputSheetFinderImpl.class);
