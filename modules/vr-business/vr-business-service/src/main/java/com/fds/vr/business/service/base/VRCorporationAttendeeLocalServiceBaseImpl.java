...
import com.fds.vr.business.service.VRCorporationAttendeeLocalService;
...
/**
 * Provides the base implementation for the vr corporation attendee local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRCorporationAttendeeLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRCorporationAttendeeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRCorporationAttendeeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRCorporationAttendeeLocalServiceUtil} to access the vr corporation attendee local service.
	 */
	...
	public VRCorporationAttendee addVRCorporationAttendee(
		...
		return vrCorporationAttendeePersistence.update(vrCorporationAttendee);
	}
	...
	public VRCorporationAttendee createVRCorporationAttendee(long id) {
		return vrCorporationAttendeePersistence.create(id);
	}
	...
	public VRCorporationAttendee deleteVRCorporationAttendee(long id)
		...
		return vrCorporationAttendeePersistence.remove(id);
	}
	...
	public VRCorporationAttendee deleteVRCorporationAttendee(
		VRCorporationAttendee vrCorporationAttendee) {
		return vrCorporationAttendeePersistence.remove(vrCorporationAttendee);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRCorporationAttendee.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrCorporationAttendeePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrCorporationAttendeePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRCorporationAttendee fetchVRCorporationAttendee(long id) {
		return vrCorporationAttendeePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRCorporationAttendee getVRCorporationAttendee(long id)
		throws PortalException {
		return vrCorporationAttendeePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrCorporationAttendeeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRCorporationAttendee.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrCorporationAttendeeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRCorporationAttendee.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrCorporationAttendeeLocalService.deleteVRCorporationAttendee((VRCorporationAttendee)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrCorporationAttendeePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRCorporationAttendee> getVRCorporationAttendees(int start,
		int end) {
		return vrCorporationAttendeePersistence.findAll(start, end);
	}
	...
	public int getVRCorporationAttendeesCount() {
		return vrCorporationAttendeePersistence.countAll();
	}
	 ...
	 */
	public VRCorporationAttendeeLocalService getVRCorporationAttendeeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRCorporationAttendee",
			vrCorporationAttendeeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRCorporationAttendee");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRCorporationAttendeeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrCorporationAttendeePersistence.getDataSource();
	...
	@BeanReference(type = VRCorporationAttendeeLocalService.class)
	protected VRCorporationAttendeeLocalService vrCorporationAttendeeLocalService;
