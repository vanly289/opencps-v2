...
public class VRProductionPlantEquipmentFinderImpl extends VRProductionPlantEquipmentFinderBaseImpl
		implements VRProductionPlantEquipmentFinder {

	Log log = LogFactoryUtil.getLog(VRProductionPlantEquipmentFinderImpl.class);
	...
	public JSONArray findData(String sql, List<String> columnNames, List<String> dataTypes, Class<?> modelClazz,
		...
		try {
			...
			log.info("===>>>VRProductionPlantEquipmentFinder " + sql + "|" + start + "|" + end);
	...
	public long countData(String sql) throws SystemException {
		...
		try {
			...
			log.info("===>>>VRProductionPlantEquipmentFinder " + sql);
