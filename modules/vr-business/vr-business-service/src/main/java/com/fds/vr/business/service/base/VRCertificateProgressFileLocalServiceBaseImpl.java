...
import com.fds.vr.business.service.VRCertificateProgressFileLocalService;
...
/**
 * Provides the base implementation for the vr certificate progress file local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRCertificateProgressFileLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRCertificateProgressFileLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements VRCertificateProgressFileLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRCertificateProgressFileLocalServiceUtil} to access the vr certificate progress file local service.
	 */
	...
	@Override
	public VRCertificateProgressFile addVRCertificateProgressFile(
		VRCertificateProgressFile vrCertificateProgressFile) {
		vrCertificateProgressFile.setNew(true);

		return vrCertificateProgressFilePersistence.update(vrCertificateProgressFile);
	}
	 ...
	 */
	@Override
	public VRCertificateProgressFile createVRCertificateProgressFile(long id) {
		return vrCertificateProgressFilePersistence.create(id);
	}
	...
	@Override
	public VRCertificateProgressFile deleteVRCertificateProgressFile(long id)
		throws PortalException {
		return vrCertificateProgressFilePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRCertificateProgressFile deleteVRCertificateProgressFile(
		VRCertificateProgressFile vrCertificateProgressFile) {
		return vrCertificateProgressFilePersistence.remove(vrCertificateProgressFile);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRCertificateProgressFile.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrCertificateProgressFilePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrCertificateProgressFilePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRCertificateProgressFile fetchVRCertificateProgressFile(long id) {
		return vrCertificateProgressFilePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRCertificateProgressFile getVRCertificateProgressFile(long id)
		throws PortalException {
		return vrCertificateProgressFilePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrCertificateProgressFileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRCertificateProgressFile.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrCertificateProgressFileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRCertificateProgressFile.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrCertificateProgressFileLocalService.deleteVRCertificateProgressFile((VRCertificateProgressFile)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrCertificateProgressFilePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRCertificateProgressFile> getVRCertificateProgressFiles(
		int start, int end) {
		return vrCertificateProgressFilePersistence.findAll(start, end);
	}
	...
	public int getVRCertificateProgressFilesCount() {
		return vrCertificateProgressFilePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRCertificateProgressFile updateVRCertificateProgressFile(
		VRCertificateProgressFile vrCertificateProgressFile) {
		return vrCertificateProgressFilePersistence.update(vrCertificateProgressFile);
	}
	 ...
	 */
	public VRCertificateProgressFileLocalService getVRCertificateProgressFileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRCertificateProgressFile",
			vrCertificateProgressFileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRCertificateProgressFile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRCertificateProgressFileLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrCertificateProgressFilePersistence.getDataSource();
	...
	@BeanReference(type = VRCertificateProgressFileLocalService.class)
	protected VRCertificateProgressFileLocalService vrCertificateProgressFileLocalService;
