...
public class VROutputSheetFinderImpl extends VROutputSheetFinderBaseImpl
	implements VROutputSheetFinder {

	Log _log = LogFactoryUtil.getLog(VROutputSheetFinderImpl.class);
