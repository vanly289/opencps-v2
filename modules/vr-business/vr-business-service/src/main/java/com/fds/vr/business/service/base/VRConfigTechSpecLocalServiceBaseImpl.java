...
import com.fds.vr.business.service.VRConfigTechSpecLocalService;
...
/**
 * Provides the base implementation for the vr config tech spec local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRConfigTechSpecLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRConfigTechSpecLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRConfigTechSpecLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRConfigTechSpecLocalServiceUtil} to access the vr config tech spec local service.
	 */
	...
	@Override
	public VRConfigTechSpec addVRConfigTechSpec(
		VRConfigTechSpec vrConfigTechSpec) {
		vrConfigTechSpec.setNew(true);

		return vrConfigTechSpecPersistence.update(vrConfigTechSpec);
	}
	 ...
	 */
	@Override
	public VRConfigTechSpec createVRConfigTechSpec(long id) {
		return vrConfigTechSpecPersistence.create(id);
	}
	...
	@Override
	public VRConfigTechSpec deleteVRConfigTechSpec(long id)
		throws PortalException {
		return vrConfigTechSpecPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRConfigTechSpec deleteVRConfigTechSpec(
		VRConfigTechSpec vrConfigTechSpec) {
		return vrConfigTechSpecPersistence.remove(vrConfigTechSpec);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRConfigTechSpec.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrConfigTechSpecPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrConfigTechSpecPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRConfigTechSpec fetchVRConfigTechSpec(long id) {
		return vrConfigTechSpecPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRConfigTechSpec getVRConfigTechSpec(long id)
		throws PortalException {
		return vrConfigTechSpecPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrConfigTechSpecLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRConfigTechSpec.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrConfigTechSpecLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRConfigTechSpec.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrConfigTechSpecLocalService.deleteVRConfigTechSpec((VRConfigTechSpec)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrConfigTechSpecPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRConfigTechSpec> getVRConfigTechSpecs(int start, int end) {
		return vrConfigTechSpecPersistence.findAll(start, end);
	}
	...
	public int getVRConfigTechSpecsCount() {
		return vrConfigTechSpecPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRConfigTechSpec updateVRConfigTechSpec(
		VRConfigTechSpec vrConfigTechSpec) {
		return vrConfigTechSpecPersistence.update(vrConfigTechSpec);
	}
	 ...
	 */
	public VRConfigTechSpecLocalService getVRConfigTechSpecLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRConfigTechSpec",
			vrConfigTechSpecLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRConfigTechSpec");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRConfigTechSpecLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrConfigTechSpecPersistence.getDataSource();
	...
	@BeanReference(type = VRConfigTechSpecLocalService.class)
	protected VRConfigTechSpecLocalService vrConfigTechSpecLocalService;
