...
import com.fds.vr.business.service.VRTechnicalSpec_XDDLocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xdd local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XDDLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XDDLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XDDLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XDDLocalServiceUtil} to access the vr technical spec_xdd local service.
	 */
	...
	public VRTechnicalSpec_XDD addVRTechnicalSpec_XDD(
		...
		return vrTechnicalSpec_XDDPersistence.update(vrTechnicalSpec_XDD);
	}
	...
	public VRTechnicalSpec_XDD createVRTechnicalSpec_XDD(long id) {
		return vrTechnicalSpec_XDDPersistence.create(id);
	}
	...
	public VRTechnicalSpec_XDD deleteVRTechnicalSpec_XDD(long id)
		...
		return vrTechnicalSpec_XDDPersistence.remove(id);
	}
	...
	public VRTechnicalSpec_XDD deleteVRTechnicalSpec_XDD(
		VRTechnicalSpec_XDD vrTechnicalSpec_XDD) {
		return vrTechnicalSpec_XDDPersistence.remove(vrTechnicalSpec_XDD);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XDD.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XDDPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XDDPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTechnicalSpec_XDD fetchVRTechnicalSpec_XDD(long id) {
		return vrTechnicalSpec_XDDPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRTechnicalSpec_XDD getVRTechnicalSpec_XDD(long id)
		throws PortalException {
		return vrTechnicalSpec_XDDPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XDDLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XDD.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XDDLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XDD.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XDDLocalService.deleteVRTechnicalSpec_XDD((VRTechnicalSpec_XDD)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XDDPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTechnicalSpec_XDD> getVRTechnicalSpec_XDDs(int start, int end) {
		return vrTechnicalSpec_XDDPersistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XDDsCount() {
		return vrTechnicalSpec_XDDPersistence.countAll();
	}
	 ...
	 */
	public VRTechnicalSpec_XDDLocalService getVRTechnicalSpec_XDDLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XDD",
			vrTechnicalSpec_XDDLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XDD");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XDDLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XDDPersistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XDDLocalService.class)
	protected VRTechnicalSpec_XDDLocalService vrTechnicalSpec_XDDLocalService;
