...
import com.fds.vr.business.service.VRRegistrationLocalService;
...
/**
 * Provides the base implementation for the vr registration local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRRegistrationLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRRegistrationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRRegistrationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRRegistrationLocalServiceUtil} to access the vr registration local service.
	 */
	...
	public VRRegistration addVRRegistration(VRRegistration vrRegistration) {
		...
		return vrRegistrationPersistence.update(vrRegistration);
	}
	...
	public VRRegistration createVRRegistration(long registrationId) {
		return vrRegistrationPersistence.create(registrationId);
	}
	...
	public VRRegistration deleteVRRegistration(long registrationId)
		...
		return vrRegistrationPersistence.remove(registrationId);
	}
	...
	public VRRegistration deleteVRRegistration(VRRegistration vrRegistration) {
		return vrRegistrationPersistence.remove(vrRegistration);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRRegistration.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrRegistrationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrRegistrationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRRegistration fetchVRRegistration(long registrationId) {
		return vrRegistrationPersistence.fetchByPrimaryKey(registrationId);
	}
	 ...
	 */
	@Override
	public VRRegistration fetchVRRegistrationByUuidAndGroupId(String uuid,
		long groupId) {
		return vrRegistrationPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public VRRegistration getVRRegistration(long registrationId)
		throws PortalException {
		return vrRegistrationPersistence.findByPrimaryKey(registrationId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrRegistrationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRRegistration.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrRegistrationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRRegistration.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<VRRegistration>() {
				@Override
				public void performAction(VRRegistration vrRegistration)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(VRRegistration.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrRegistrationLocalService.deleteVRRegistration((VRRegistration)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrRegistrationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRRegistration> getVRRegistrationsByUuidAndCompanyId(
		...
		return vrRegistrationPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<VRRegistration> getVRRegistrationsByUuidAndCompanyId(
		...
		return vrRegistrationPersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public VRRegistration getVRRegistrationByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return vrRegistrationPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<VRRegistration> getVRRegistrations(int start, int end) {
		return vrRegistrationPersistence.findAll(start, end);
	}
	...
	public int getVRRegistrationsCount() {
		return vrRegistrationPersistence.countAll();
	}
	 ...
	 */
	public VRRegistrationLocalService getVRRegistrationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRRegistration",
			vrRegistrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRRegistration");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRRegistrationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrRegistrationPersistence.getDataSource();
	...
	@BeanReference(type = VRRegistrationLocalService.class)
	protected VRRegistrationLocalService vrRegistrationLocalService;
