...
public class VRProductionClassificationPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(VRProductionClassificationModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(VRProductionClassificationModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionClassificationModelImpl.FINDER_CACHE_ENABLED,
			VRProductionClassificationImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(VRProductionClassificationModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionClassificationModelImpl.FINDER_CACHE_ENABLED,
			VRProductionClassificationImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			VRProductionClassificationModelImpl.UUID_COLUMN_BITMASK |
			VRProductionClassificationModelImpl.MODIFYDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(VRProductionClassificationModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionClassificationModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUuid", new String[] { String.class.getName() });

	/**
	 * Returns all the vr production classifications where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @return the matching vr production classifications
	 */
	@Override
	public List<VRProductionClassification> findByUuid(String uuid) {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the vr production classifications where uuid = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<VRProductionClassification> findByUuid(String uuid, int start,
		int end) {
		return findByUuid(uuid, start, end, null);
	}

	/**
	 * Returns an ordered range of all the vr production classifications where uuid = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link VRProductionClassificationModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<VRProductionClassification> findByUuid(String uuid, int start,
		int end, OrderByComparator<VRProductionClassification> orderByComparator) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (VRProductionClassification vrProductionClassification : list) {
					if (!Objects.equals(uuid,
								vrProductionClassification.getUuid())) {
						list = null;
	...
	/**
	 * Returns the first vr production classification in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public VRProductionClassification findByUuid_First(String uuid,
		OrderByComparator<VRProductionClassification> orderByComparator)
		throws NoSuchVRProductionClassificationException {
		VRProductionClassification vrProductionClassification = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public VRProductionClassification fetchByUuid_First(String uuid,
		OrderByComparator<VRProductionClassification> orderByComparator) {
		List<VRProductionClassification> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last vr production classification in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public VRProductionClassification findByUuid_Last(String uuid,
		OrderByComparator<VRProductionClassification> orderByComparator)
		throws NoSuchVRProductionClassificationException {
		VRProductionClassification vrProductionClassification = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public VRProductionClassification fetchByUuid_Last(String uuid,
		OrderByComparator<VRProductionClassification> orderByComparator) {
		...
		List<VRProductionClassification> list = findByUuid(uuid, count - 1,
	...
	/**
	 * Returns the vr production classifications before and after the current vr production classification in the ordered set where uuid = &#63;.
	 *
	 ...
	 */
	@Override
	public VRProductionClassification[] findByUuid_PrevAndNext(long id,
		String uuid,
		OrderByComparator<VRProductionClassification> orderByComparator)
		throws NoSuchVRProductionClassificationException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session,
					vrProductionClassification, uuid, orderByComparator, true);

			array[1] = vrProductionClassification;

			array[2] = getByUuid_PrevAndNext(session,
					vrProductionClassification, uuid, orderByComparator, false);
	...
	protected VRProductionClassification getByUuid_PrevAndNext(
		Session session, VRProductionClassification vrProductionClassification,
		String uuid,
		OrderByComparator<VRProductionClassification> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the vr production classifications where uuid = &#63; from the database.
	 *
	 * @param uuid the uuid
	 */
	@Override
	public void removeByUuid(String uuid) {
		for (VRProductionClassification vrProductionClassification : findByUuid(
	...
	/**
	 * Returns the number of vr production classifications where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "vrProductionClassification.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "vrProductionClassification.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(vrProductionClassification.uuid IS NULL OR vrProductionClassification.uuid = '')";
	...
	public VRProductionClassification create(long id) {
		...
		vrProductionClassification.setUuid(uuid);
	...
	public VRProductionClassification updateImpl(
		...
		if (Validator.isNull(vrProductionClassification.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew ||
			...
			if ((vrProductionClassificationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						vrProductionClassificationModelImpl.getOriginalUuid()
					};
				...
				args = new Object[] {
						vrProductionClassificationModelImpl.getUuid()
					};
	...
	protected VRProductionClassification toUnwrappedModel(
		...
		vrProductionClassificationImpl.setUuid(vrProductionClassification.getUuid());
