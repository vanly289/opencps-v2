...
import com.fds.vr.business.service.VRTechnicalSpec_XCGPart3LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg part3 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart3LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGPart3LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGPart3LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGPart3LocalServiceUtil} to access the vr technical spec_xcg part3 local service.
	 */
	...
	public VRTechnicalSpec_XCGPart3 addVRTechnicalSpec_XCGPart3(
		...
		return vrTechnicalSpec_XCGPart3Persistence.update(vrTechnicalSpec_XCGPart3);
	}
	...
	public VRTechnicalSpec_XCGPart3 createVRTechnicalSpec_XCGPart3(long id) {
		return vrTechnicalSpec_XCGPart3Persistence.create(id);
	}
	...
	public VRTechnicalSpec_XCGPart3 deleteVRTechnicalSpec_XCGPart3(long id)
		...
		return vrTechnicalSpec_XCGPart3Persistence.remove(id);
	}
	...
	public VRTechnicalSpec_XCGPart3 deleteVRTechnicalSpec_XCGPart3(
		VRTechnicalSpec_XCGPart3 vrTechnicalSpec_XCGPart3) {
		return vrTechnicalSpec_XCGPart3Persistence.remove(vrTechnicalSpec_XCGPart3);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCGPart3.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart3Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart3Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTechnicalSpec_XCGPart3 fetchVRTechnicalSpec_XCGPart3(long id) {
		return vrTechnicalSpec_XCGPart3Persistence.fetchByPrimaryKey(id);
	}
	...
	public VRTechnicalSpec_XCGPart3 getVRTechnicalSpec_XCGPart3(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart3Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart3LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart3.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart3LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart3.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGPart3LocalService.deleteVRTechnicalSpec_XCGPart3((VRTechnicalSpec_XCGPart3)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPart3Persistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTechnicalSpec_XCGPart3> getVRTechnicalSpec_XCGPart3s(
		int start, int end) {
		return vrTechnicalSpec_XCGPart3Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGPart3sCount() {
		return vrTechnicalSpec_XCGPart3Persistence.countAll();
	}
	 ...
	 */
	public VRTechnicalSpec_XCGPart3LocalService getVRTechnicalSpec_XCGPart3LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCGPart3",
			vrTechnicalSpec_XCGPart3LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCGPart3");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGPart3LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPart3Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGPart3LocalService.class)
	protected VRTechnicalSpec_XCGPart3LocalService vrTechnicalSpec_XCGPart3LocalService;
