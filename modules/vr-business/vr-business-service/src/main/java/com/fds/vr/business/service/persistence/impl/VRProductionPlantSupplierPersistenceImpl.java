...
public class VRProductionPlantSupplierPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(VRProductionPlantSupplierModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(VRProductionPlantSupplierModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionPlantSupplierModelImpl.FINDER_CACHE_ENABLED,
			VRProductionPlantSupplierImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(VRProductionPlantSupplierModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionPlantSupplierModelImpl.FINDER_CACHE_ENABLED,
			VRProductionPlantSupplierImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			VRProductionPlantSupplierModelImpl.UUID_COLUMN_BITMASK |
			VRProductionPlantSupplierModelImpl.MODIFYDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_UUID = new FinderPath(VRProductionPlantSupplierModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionPlantSupplierModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByUuid", new String[] { String.class.getName() });

	/**
	 * Returns all the vr production plant suppliers where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @return the matching vr production plant suppliers
	 */
	@Override
	public List<VRProductionPlantSupplier> findByUuid(String uuid) {
		return findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the vr production plant suppliers where uuid = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<VRProductionPlantSupplier> findByUuid(String uuid, int start,
		int end) {
		return findByUuid(uuid, start, end, null);
	}

	/**
	 * Returns an ordered range of all the vr production plant suppliers where uuid = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link VRProductionPlantSupplierModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<VRProductionPlantSupplier> findByUuid(String uuid, int start,
		int end, OrderByComparator<VRProductionPlantSupplier> orderByComparator) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (VRProductionPlantSupplier vrProductionPlantSupplier : list) {
					if (!Objects.equals(uuid,
								vrProductionPlantSupplier.getUuid())) {
						list = null;
	...
	/**
	 * Returns the first vr production plant supplier in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 ...
	 */
	@Override
	public VRProductionPlantSupplier findByUuid_First(String uuid,
		OrderByComparator<VRProductionPlantSupplier> orderByComparator)
		throws NoSuchVRProductionPlantSupplierException {
		VRProductionPlantSupplier vrProductionPlantSupplier = fetchByUuid_First(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public VRProductionPlantSupplier fetchByUuid_First(String uuid,
		OrderByComparator<VRProductionPlantSupplier> orderByComparator) {
		List<VRProductionPlantSupplier> list = findByUuid(uuid, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last vr production plant supplier in the ordered set where uuid = &#63;.
	 *
	 * @param uuid the uuid
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public VRProductionPlantSupplier findByUuid_Last(String uuid,
		OrderByComparator<VRProductionPlantSupplier> orderByComparator)
		throws NoSuchVRProductionPlantSupplierException {
		VRProductionPlantSupplier vrProductionPlantSupplier = fetchByUuid_Last(uuid,
				orderByComparator);
	 ...
	 */
	@Override
	public VRProductionPlantSupplier fetchByUuid_Last(String uuid,
		OrderByComparator<VRProductionPlantSupplier> orderByComparator) {
		...
		List<VRProductionPlantSupplier> list = findByUuid(uuid, count - 1,
	...
	/**
	 * Returns the vr production plant suppliers before and after the current vr production plant supplier in the ordered set where uuid = &#63;.
	 *
	 ...
	 */
	@Override
	public VRProductionPlantSupplier[] findByUuid_PrevAndNext(long id,
		String uuid,
		OrderByComparator<VRProductionPlantSupplier> orderByComparator)
		throws NoSuchVRProductionPlantSupplierException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session,
					vrProductionPlantSupplier, uuid, orderByComparator, true);

			array[1] = vrProductionPlantSupplier;

			array[2] = getByUuid_PrevAndNext(session,
					vrProductionPlantSupplier, uuid, orderByComparator, false);
	...
	protected VRProductionPlantSupplier getByUuid_PrevAndNext(Session session,
		VRProductionPlantSupplier vrProductionPlantSupplier, String uuid,
		OrderByComparator<VRProductionPlantSupplier> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the vr production plant suppliers where uuid = &#63; from the database.
	 *
	 * @param uuid the uuid
	 */
	@Override
	public void removeByUuid(String uuid) {
		for (VRProductionPlantSupplier vrProductionPlantSupplier : findByUuid(
	...
	/**
	 * Returns the number of vr production plant suppliers where uuid = &#63;.
	 *
	 * @param uuid the uuid
	...
	private static final String _FINDER_COLUMN_UUID_UUID_1 = "vrProductionPlantSupplier.uuid IS NULL";
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "vrProductionPlantSupplier.uuid = ?";
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(vrProductionPlantSupplier.uuid IS NULL OR vrProductionPlantSupplier.uuid = '')";
	...
	public VRProductionPlantSupplier create(long id) {
		...
		vrProductionPlantSupplier.setUuid(uuid);
	...
	public VRProductionPlantSupplier updateImpl(
		...
		if (Validator.isNull(vrProductionPlantSupplier.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (isNew ||
			...
			if ((vrProductionPlantSupplierModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						vrProductionPlantSupplierModelImpl.getOriginalUuid()
					};
				...
				args = new Object[] { vrProductionPlantSupplierModelImpl.getUuid() };
	...
	protected VRProductionPlantSupplier toUnwrappedModel(
		...
		vrProductionPlantSupplierImpl.setUuid(vrProductionPlantSupplier.getUuid());
		...
		vrProductionPlantSupplierImpl.setProductPlantID(vrProductionPlantSupplier.getProductPlantID());
		vrProductionPlantSupplierImpl.setProductionPlantCode(vrProductionPlantSupplier.getProductionPlantCode());
		vrProductionPlantSupplierImpl.setProductionPlantName(vrProductionPlantSupplier.getProductionPlantName());
		vrProductionPlantSupplierImpl.setProductionPlantAddress(vrProductionPlantSupplier.getProductionPlantAddress());
		vrProductionPlantSupplierImpl.setMarkupImporter(vrProductionPlantSupplier.getMarkupImporter());
		vrProductionPlantSupplierImpl.setMappingMA_CTY(vrProductionPlantSupplier.getMappingMA_CTY());
		vrProductionPlantSupplierImpl.setMappingTEN_CTY(vrProductionPlantSupplier.getMappingTEN_CTY());
		vrProductionPlantSupplierImpl.setMappingDIA_CHI_CTY(vrProductionPlantSupplier.getMappingDIA_CHI_CTY());
		vrProductionPlantSupplierImpl.setMappingMA_XUONG_LR(vrProductionPlantSupplier.getMappingMA_XUONG_LR());
		vrProductionPlantSupplierImpl.setMappingTEN_XUONG_LR(vrProductionPlantSupplier.getMappingTEN_XUONG_LR());
		vrProductionPlantSupplierImpl.setMappingDIA_CHI_XUONG_LR(vrProductionPlantSupplier.getMappingDIA_CHI_XUONG_LR());
	...
	private static final Set<String> _badColumnNames = SetUtil.fromArray(new String[] {
				"uuid", "supplierId", "supplierName", "applicantprofileId",
				"productPlantID"
			});
}