...
public class VRProductionPlantEquipmentPersistenceImpl
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_PRODUCTPLANTID =
		new FinderPath(VRProductionPlantEquipmentModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionPlantEquipmentModelImpl.FINDER_CACHE_ENABLED,
			VRProductionPlantEquipmentImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_PRODUCTPLANTID =
		new FinderPath(VRProductionPlantEquipmentModelImpl.ENTITY_CACHE_ENABLED,
			...
			VRProductionPlantEquipmentModelImpl.MTCORE_COLUMN_BITMASK |
			VRProductionPlantEquipmentModelImpl.PRODUCTPLANTID_COLUMN_BITMASK |
			VRProductionPlantEquipmentModelImpl.MODIFYDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_PRODUCTPLANTID = new FinderPath(VRProductionPlantEquipmentModelImpl.ENTITY_CACHE_ENABLED,
			VRProductionPlantEquipmentModelImpl.FINDER_CACHE_ENABLED,
			Long.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByproductPlantID",
			new String[] { Long.class.getName(), Long.class.getName() });

	/**
	 * Returns all the vr production plant equipments where mtCore = &#63; and productPlantID = &#63;.
	 *
	...
	/**
	 * Returns a range of all the vr production plant equipments where mtCore = &#63; and productPlantID = &#63;.
	 *
	 * <p>
	...
	/**
	 * Returns an ordered range of all the vr production plant equipments where mtCore = &#63; and productPlantID = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link VRProductionPlantEquipmentModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (VRProductionPlantEquipment vrProductionPlantEquipment : list) {
					if ((mtCore != vrProductionPlantEquipment.getMtCore()) ||
							(productPlantID != vrProductionPlantEquipment.getProductPlantID())) {
						list = null;
	...
	/**
	 * Returns the first vr production plant equipment in the ordered set where mtCore = &#63; and productPlantID = &#63;.
	 *
	 * @param mtCore the mt core
	 * @param productPlantID the product plant ID
	 ...
	 */
	@Override
	public VRProductionPlantEquipment findByproductPlantID_First(long mtCore,
		long productPlantID,
		OrderByComparator<VRProductionPlantEquipment> orderByComparator)
		throws NoSuchVRProductionPlantEquipmentException {
		VRProductionPlantEquipment vrProductionPlantEquipment = fetchByproductPlantID_First(mtCore,
	 ...
	 */
	@Override
	public VRProductionPlantEquipment fetchByproductPlantID_First(long mtCore,
		long productPlantID,
		OrderByComparator<VRProductionPlantEquipment> orderByComparator) {
		List<VRProductionPlantEquipment> list = findByproductPlantID(mtCore,
	...
	/**
	 * Returns the last vr production plant equipment in the ordered set where mtCore = &#63; and productPlantID = &#63;.
	 *
	 * @param mtCore the mt core
	 * @param productPlantID the product plant ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public VRProductionPlantEquipment findByproductPlantID_Last(long mtCore,
		long productPlantID,
		OrderByComparator<VRProductionPlantEquipment> orderByComparator)
		throws NoSuchVRProductionPlantEquipmentException {
		VRProductionPlantEquipment vrProductionPlantEquipment = fetchByproductPlantID_Last(mtCore,
				productPlantID, orderByComparator);
	 ...
	 */
	@Override
	public VRProductionPlantEquipment fetchByproductPlantID_Last(long mtCore,
		long productPlantID,
		OrderByComparator<VRProductionPlantEquipment> orderByComparator) {
	...
	/**
	 * Returns the vr production plant equipments before and after the current vr production plant equipment in the ordered set where mtCore = &#63; and productPlantID = &#63;.
	 *
	 ...
	 */
	@Override
	public VRProductionPlantEquipment[] findByproductPlantID_PrevAndNext(
		...
		try {
			...
			array[0] = getByproductPlantID_PrevAndNext(session,
					vrProductionPlantEquipment, mtCore, productPlantID,
					orderByComparator, true);
	...
	protected VRProductionPlantEquipment getByproductPlantID_PrevAndNext(
		Session session, VRProductionPlantEquipment vrProductionPlantEquipment,
	...
	/**
	 * Removes all the vr production plant equipments where mtCore = &#63; and productPlantID = &#63; from the database.
	 *
	 * @param mtCore the mt core
	 * @param productPlantID the product plant ID
	 */
	...
	public void removeByproductPlantID(long mtCore, long productPlantID) {
		for (VRProductionPlantEquipment vrProductionPlantEquipment : findByproductPlantID(
	...
	/**
	 * Returns the number of vr production plant equipments where mtCore = &#63; and productPlantID = &#63;.
	 *
	 * @param mtCore the mt core
	 * @param productPlantID the product plant ID
	...
	private static final String _FINDER_COLUMN_PRODUCTPLANTID_MTCORE_2 = "vrProductionPlantEquipment.mtCore = ? AND ";
	private static final String _FINDER_COLUMN_PRODUCTPLANTID_PRODUCTPLANTID_2 = "vrProductionPlantEquipment.productPlantID = ?";
		...
		if (isNew ||
			...
			if ((vrProductionPlantEquipmentModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						vrProductionPlantEquipmentModelImpl.getOriginalMtCore(),
						vrProductionPlantEquipmentModelImpl.getOriginalProductPlantID()
					};
				...
				args = new Object[] {
						vrProductionPlantEquipmentModelImpl.getMtCore(),
						vrProductionPlantEquipmentModelImpl.getProductPlantID()
					};
	...
	protected VRProductionPlantEquipment toUnwrappedModel(
		...
		vrProductionPlantEquipmentImpl.setProductPlantID(vrProductionPlantEquipment.getProductPlantID());
