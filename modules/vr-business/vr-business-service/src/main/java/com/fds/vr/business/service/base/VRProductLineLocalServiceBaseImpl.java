...
import com.fds.vr.business.service.VRProductLineLocalService;
...
/**
 * Provides the base implementation for the vr product line local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRProductLineLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRProductLineLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRProductLineLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRProductLineLocalServiceUtil} to access the vr product line local service.
	 */
	...
	public VRProductLine addVRProductLine(VRProductLine vrProductLine) {
		...
		return vrProductLinePersistence.update(vrProductLine);
	}
	...
	public VRProductLine createVRProductLine(long id) {
		return vrProductLinePersistence.create(id);
	}
	...
	public VRProductLine deleteVRProductLine(long id) throws PortalException {
		return vrProductLinePersistence.remove(id);
	}
	...
	public VRProductLine deleteVRProductLine(VRProductLine vrProductLine) {
		return vrProductLinePersistence.remove(vrProductLine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRProductLine.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrProductLinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrProductLinePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRProductLine fetchVRProductLine(long id) {
		return vrProductLinePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRProductLine getVRProductLine(long id) throws PortalException {
		return vrProductLinePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrProductLineLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRProductLine.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrProductLineLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRProductLine.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrProductLineLocalService.deleteVRProductLine((VRProductLine)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrProductLinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRProductLine> getVRProductLines(int start, int end) {
		return vrProductLinePersistence.findAll(start, end);
	}
	...
	public int getVRProductLinesCount() {
		return vrProductLinePersistence.countAll();
	}
	 ...
	 */
	public VRProductLineLocalService getVRProductLineLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRProductLine",
			vrProductLineLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRProductLine");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRProductLineLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrProductLinePersistence.getDataSource();
	...
	@BeanReference(type = VRProductLineLocalService.class)
	protected VRProductLineLocalService vrProductLineLocalService;
