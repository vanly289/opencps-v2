	...
	private SQLQueryBuilder getBuilder(LinkedHashMap<String, Object> params) {
		...
		if (params != null) {
			...
			/*if (params.containsKey("applieddate")) {
				appliedDate = (String)params.get("applieddate");
			}
			...
			if (params.containsKey("applicantrepresentative")) {
				applicantRepresentative = (String)params.get("applicantrepresentative");
			}
			if (params.containsKey("applicantrepresentativetitle")) {
				applicantRepresentativeTitle = (String)params.get("applicantrepresentativetitle");
			}
			if (params.containsKey("applicantemail")) {
				applicantEmail = (String)params.get("applicantemail");
			}
			if (params.containsKey("applicantphone")) {
				applicantPhone = (String)params.get("applicantphone");
			}
			if (params.containsKey("applicantfax")) {
				applicantFax = (String)params.get("applicantfax");
			}
			if (params.containsKey("applicantcontactname")) {
				applicantContactName = (String)params.get("applicantcontactname");
			}
			if (params.containsKey("applicantcontactemail")) {
				applicantContactEmail = (String)params.get("applicantcontactemail");
			}
			if (params.containsKey("applicantcontactphone")) {
				applicantContactPhone = (String)params.get("applicantcontactphone");
			}
			...
			if (params.containsKey("productionplantname")) {
				productionPlantName = (String)params.get("productionplantname");
			}
			if (params.containsKey("productionplantaddress")) {
				productionPlantAddress = (String)params.get("productionplantaddress");
			}
			if (params.containsKey("remarks")) {
				remarks = (String)params.get("remarks");
			}
			if (params.containsKey("methodofissue")) {
				methodOfIssue = (String)params.get("methodofissue");
			}
			if (params.containsKey("totalindocument")) {
				totalInDocument = (Long)params.get("totalindocument");
			}
			if (params.containsKey("issuecorporationid")) {
				issueCorporationId = (Long)params.get("issuecorporationid");
			}
			if (params.containsKey("verifycorporationid")) {
				verifyCorporationId = (String)params.get("verifycorporationid");
			}
			if (params.containsKey("digitalissuestatus")) {
				digitalissuestatus = (Integer)params.get("digitalissuestatus");
			}*/
			if (params.containsKey("issuetype")) {
				issueType = (String) params.get("issuetype");
			}
			/*if (params.containsKey("averagestbquantity")) {
				averageSTBQuantity = (Integer)params.get("averagestbquantity");
			}
			if (params.containsKey("maxmonthquantity")) {
				maxMonthQuantity = (Integer)params.get("maxmonthquantity");
			}
			if (params.containsKey("averagestmquantity")) {
				averageSTMQuantity = (Integer)params.get("averagestmquantity");
			}
			if (params.containsKey("accumulatedmonthquantity")) {
				accumulatedMonthQuantity = (Integer)params.get("accumulatedmonthquantity");
			}
			if (params.containsKey("totalinuse")) {
				totalInUse = (Integer)params.get("totalinuse");
			}
			if (params.containsKey("totalcancelled")) {
				totalCancelled = (Integer)params.get("totalcancelled");
			}
			if (params.containsKey("totallost")) {
				totalLost = (Integer)params.get("totallost");
			}
			if (params.containsKey("totalnotused")) {
				totalNotUsed = (Integer)params.get("totalnotused");
			}
			if (params.containsKey("totalreturned")) {
				totalReturned = (Integer)params.get("totalreturned");
			}*/
			if (params.containsKey("flow")) {
				flow = (String) params.get("flow");
			}
			/*if (params.containsKey("examinationrequired")) {
				examinationRequired = (String)params.get("examinationrequired");
			}
			if (params.containsKey("examinationperiod")) {
				examinationPeriod = (String)params.get("examinationperiod");
			}
			if (params.containsKey("examinationlasttime")) {
				examinationLastTime = (String)params.get("examinationlasttime");
			}
			if (params.containsKey("copresult")) {
				copresult = (String)params.get("copresult");
			}
			if (params.containsKey("copreportno")) {
				copreportno = (String)params.get("copreportno");
			}
			if (params.containsKey("copreportdate")) {
				copreportdate = (String)params.get("copreportdate");
			}
			if (params.containsKey("postreview")) {
				postreview = (String)params.get("postreview");
			}
			if (params.containsKey("postreviewrecordno")) {
				postreviewrecordno = (String)params.get("postreviewrecordno");
			}
			if (params.containsKey("postreviewrecorddate")) {
				postreviewrecorddate = (String)params.get("postreviewrecorddate");
			}
			if (params.containsKey("corporationid")) {
				corporationId = (String)params.get("corporationid");
			}
			if (params.containsKey("inspectorcode")) {
				inspectorcode = (String)params.get("inspectorcode");
			}
			if (params.containsKey("inspectorname")) {
				inspectorname = (String)params.get("inspectorname");
			}
			if (params.containsKey("leadername")) {
				leadername = (String)params.get("leadername");
			}
			if (params.containsKey("applicantmaker")) {
				applicantmaker = (String)params.get("applicantmaker");
			}
			if (params.containsKey("applicantchecker")) {
				applicantchecker = (String)params.get("applicantchecker");
			}
			if (params.containsKey("inspectorid")) {
				inspectorId = (Long)params.get("inspectorid");
			}
			if (params.containsKey("issueinspectorid")) {
				issueInspectorId = (Long)params.get("issueinspectorid");
			}
			if (params.containsKey("verifyinspectorid")) {
				verifyInspectorId = (Long)params.get("verifyinspectorid");
			}
		...
		//builder.selectAll(VRIssueModelImpl.class, VROutputSheetModelImpl.class, VROutputSheetDetailsModelImpl.class, VRInputStampbookDetailsModelImpl.class)
