...
public class VRIssueActionImpl implements VRIssueAction {
	...
	public JSONObject findVRIssue(User user, ServiceContext serviceContext, LinkedHashMap<String, Object> params) {
		...
		//String applicantRepresentative = "";
		...
		String examinationLastTime = "";
		String copresult = "";
		String copreportno = "";
		String copreportdate = "";
		String postreview = "";
		String postreviewrecordno = "";
		String postreviewrecorddate = "";
		String corporationId = "";
		String inspectorcode = "";
		String inspectorname = "";
		String leadername = "";
		String applicantmaker = "";
		String applicantchecker = "";
