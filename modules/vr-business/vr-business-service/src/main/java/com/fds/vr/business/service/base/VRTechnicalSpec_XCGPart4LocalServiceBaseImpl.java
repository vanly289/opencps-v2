...
import com.fds.vr.business.service.VRTechnicalSpec_XCGPart4LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg part4 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart4LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGPart4LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGPart4LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGPart4LocalServiceUtil} to access the vr technical spec_xcg part4 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_XCGPart4 addVRTechnicalSpec_XCGPart4(
		VRTechnicalSpec_XCGPart4 vrTechnicalSpec_XCGPart4) {
		vrTechnicalSpec_XCGPart4.setNew(true);

		return vrTechnicalSpec_XCGPart4Persistence.update(vrTechnicalSpec_XCGPart4);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCGPart4 createVRTechnicalSpec_XCGPart4(long id) {
		return vrTechnicalSpec_XCGPart4Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_XCGPart4 deleteVRTechnicalSpec_XCGPart4(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart4Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_XCGPart4 deleteVRTechnicalSpec_XCGPart4(
		VRTechnicalSpec_XCGPart4 vrTechnicalSpec_XCGPart4) {
		return vrTechnicalSpec_XCGPart4Persistence.remove(vrTechnicalSpec_XCGPart4);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCGPart4.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart4Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart4Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_XCGPart4 fetchVRTechnicalSpec_XCGPart4(long id) {
		return vrTechnicalSpec_XCGPart4Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCGPart4 getVRTechnicalSpec_XCGPart4(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart4Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart4LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart4.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart4LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart4.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGPart4LocalService.deleteVRTechnicalSpec_XCGPart4((VRTechnicalSpec_XCGPart4)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPart4Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_XCGPart4> getVRTechnicalSpec_XCGPart4s(
		int start, int end) {
		return vrTechnicalSpec_XCGPart4Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGPart4sCount() {
		return vrTechnicalSpec_XCGPart4Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_XCGPart4 updateVRTechnicalSpec_XCGPart4(
		VRTechnicalSpec_XCGPart4 vrTechnicalSpec_XCGPart4) {
		return vrTechnicalSpec_XCGPart4Persistence.update(vrTechnicalSpec_XCGPart4);
	}
	 ...
	 */
	public VRTechnicalSpec_XCGPart4LocalService getVRTechnicalSpec_XCGPart4LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCGPart4",
			vrTechnicalSpec_XCGPart4LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCGPart4");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGPart4LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPart4Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGPart4LocalService.class)
	protected VRTechnicalSpec_XCGPart4LocalService vrTechnicalSpec_XCGPart4LocalService;
