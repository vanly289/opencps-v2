...
/**
 * Provides the base implementation for the vr issue equipment certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRIssueEquipmentCertificateLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRIssueEquipmentCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements VRIssueEquipmentCertificateLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRIssueEquipmentCertificateLocalServiceUtil} to access the vr issue equipment certificate local service.
	 */
	...
	@Override
	public VRIssueEquipmentCertificate addVRIssueEquipmentCertificate(
	 ...
	 */
	@Override
	public VRIssueEquipmentCertificate createVRIssueEquipmentCertificate(
		long id) {
		return vrIssueEquipmentCertificatePersistence.create(id);
	}
	...
	@Override
	public VRIssueEquipmentCertificate deleteVRIssueEquipmentCertificate(
		long id) throws PortalException {
		return vrIssueEquipmentCertificatePersistence.remove(id);
	}
	...
	public VRIssueEquipmentCertificate deleteVRIssueEquipmentCertificate(
		VRIssueEquipmentCertificate vrIssueEquipmentCertificate) {
		return vrIssueEquipmentCertificatePersistence.remove(vrIssueEquipmentCertificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRIssueEquipmentCertificate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrIssueEquipmentCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrIssueEquipmentCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRIssueEquipmentCertificate fetchVRIssueEquipmentCertificate(long id) {
		return vrIssueEquipmentCertificatePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRIssueEquipmentCertificate getVRIssueEquipmentCertificate(long id)
		throws PortalException {
		return vrIssueEquipmentCertificatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrIssueEquipmentCertificateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRIssueEquipmentCertificate.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrIssueEquipmentCertificateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRIssueEquipmentCertificate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrIssueEquipmentCertificateLocalService.deleteVRIssueEquipmentCertificate((VRIssueEquipmentCertificate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrIssueEquipmentCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRIssueEquipmentCertificate> getVRIssueEquipmentCertificates(
		int start, int end) {
		return vrIssueEquipmentCertificatePersistence.findAll(start, end);
	}
	...
	public int getVRIssueEquipmentCertificatesCount() {
		return vrIssueEquipmentCertificatePersistence.countAll();
	}
	 ...
	 */
	public VRIssueEquipmentCertificateLocalService getVRIssueEquipmentCertificateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRIssueEquipmentCertificate",
			vrIssueEquipmentCertificateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRIssueEquipmentCertificate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRIssueEquipmentCertificateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrIssueEquipmentCertificatePersistence.getDataSource();
	...
	@BeanReference(type = VRIssueEquipmentCertificateLocalService.class)
	protected VRIssueEquipmentCertificateLocalService vrIssueEquipmentCertificateLocalService;
