...
import com.fds.vr.business.service.VRTechnicalSpec_XMYPart2LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xmy part2 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XMYPart2LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRTechnicalSpec_XMYPart2LocalServiceImpl
 * @see com.fds.vr.business.service.VRTechnicalSpec_XMYPart2LocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRTechnicalSpec_XMYPart2LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XMYPart2LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XMYPart2LocalServiceUtil} to access the vr technical spec_xmy part2 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_XMYPart2 addVRTechnicalSpec_XMYPart2(
		VRTechnicalSpec_XMYPart2 vrTechnicalSpec_XMYPart2) {
		vrTechnicalSpec_XMYPart2.setNew(true);

		return vrTechnicalSpec_XMYPart2Persistence.update(vrTechnicalSpec_XMYPart2);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XMYPart2 createVRTechnicalSpec_XMYPart2(long id) {
		return vrTechnicalSpec_XMYPart2Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_XMYPart2 deleteVRTechnicalSpec_XMYPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_XMYPart2Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_XMYPart2 deleteVRTechnicalSpec_XMYPart2(
		VRTechnicalSpec_XMYPart2 vrTechnicalSpec_XMYPart2) {
		return vrTechnicalSpec_XMYPart2Persistence.remove(vrTechnicalSpec_XMYPart2);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XMYPart2.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XMYPart2Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XMYPart2Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_XMYPart2 fetchVRTechnicalSpec_XMYPart2(long id) {
		return vrTechnicalSpec_XMYPart2Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XMYPart2 getVRTechnicalSpec_XMYPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_XMYPart2Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XMYPart2LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XMYPart2.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XMYPart2LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XMYPart2.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XMYPart2LocalService.deleteVRTechnicalSpec_XMYPart2((VRTechnicalSpec_XMYPart2)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XMYPart2Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_XMYPart2> getVRTechnicalSpec_XMYPart2s(
		int start, int end) {
		return vrTechnicalSpec_XMYPart2Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XMYPart2sCount() {
		return vrTechnicalSpec_XMYPart2Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_XMYPart2 updateVRTechnicalSpec_XMYPart2(
		VRTechnicalSpec_XMYPart2 vrTechnicalSpec_XMYPart2) {
		return vrTechnicalSpec_XMYPart2Persistence.update(vrTechnicalSpec_XMYPart2);
	}
	 ...
	 */
	public VRTechnicalSpec_XMYPart2LocalService getVRTechnicalSpec_XMYPart2LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XMYPart2",
			vrTechnicalSpec_XMYPart2LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XMYPart2");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XMYPart2LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XMYPart2Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XMYPart2LocalService.class)
	protected VRTechnicalSpec_XMYPart2LocalService vrTechnicalSpec_XMYPart2LocalService;
