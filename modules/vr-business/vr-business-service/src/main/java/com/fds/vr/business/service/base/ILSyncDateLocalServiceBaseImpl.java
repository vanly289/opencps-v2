...
import com.fds.vr.business.service.ILSyncDateLocalService;
...
/**
 * Provides the base implementation for the il sync date local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.ILSyncDateLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class ILSyncDateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ILSyncDateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.ILSyncDateLocalServiceUtil} to access the il sync date local service.
	 */
	...
	public ILSyncDate addILSyncDate(ILSyncDate ilSyncDate) {
		...
		return ilSyncDatePersistence.update(ilSyncDate);
	}
	...
	public ILSyncDate createILSyncDate(long id) {
		return ilSyncDatePersistence.create(id);
	}
	...
	public ILSyncDate deleteILSyncDate(long id) throws PortalException {
		return ilSyncDatePersistence.remove(id);
	}
	...
	public ILSyncDate deleteILSyncDate(ILSyncDate ilSyncDate) {
		return ilSyncDatePersistence.remove(ilSyncDate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ILSyncDate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ilSyncDatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ilSyncDatePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ilSyncDatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ILSyncDate fetchILSyncDate(long id) {
		return ilSyncDatePersistence.fetchByPrimaryKey(id);
	}
	...
	public ILSyncDate getILSyncDate(long id) throws PortalException {
		return ilSyncDatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ilSyncDateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ILSyncDate.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ilSyncDateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ILSyncDate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ilSyncDateLocalService.deleteILSyncDate((ILSyncDate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ilSyncDatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ILSyncDate> getILSyncDates(int start, int end) {
		return ilSyncDatePersistence.findAll(start, end);
	}
	...
	public int getILSyncDatesCount() {
		return ilSyncDatePersistence.countAll();
	}
	 ...
	 */
	public ILSyncDateLocalService getILSyncDateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.ILSyncDate",
			ilSyncDateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.ILSyncDate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ILSyncDateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ilSyncDatePersistence.getDataSource();
	...
	@BeanReference(type = ILSyncDateLocalService.class)
	protected ILSyncDateLocalService ilSyncDateLocalService;
