...
import com.fds.vr.business.service.VRTechnicalSpec_XMYPart3LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xmy part3 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XMYPart3LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRTechnicalSpec_XMYPart3LocalServiceImpl
 * @see com.fds.vr.business.service.VRTechnicalSpec_XMYPart3LocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRTechnicalSpec_XMYPart3LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XMYPart3LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XMYPart3LocalServiceUtil} to access the vr technical spec_xmy part3 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_XMYPart3 addVRTechnicalSpec_XMYPart3(
		VRTechnicalSpec_XMYPart3 vrTechnicalSpec_XMYPart3) {
		vrTechnicalSpec_XMYPart3.setNew(true);

		return vrTechnicalSpec_XMYPart3Persistence.update(vrTechnicalSpec_XMYPart3);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XMYPart3 createVRTechnicalSpec_XMYPart3(long id) {
		return vrTechnicalSpec_XMYPart3Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_XMYPart3 deleteVRTechnicalSpec_XMYPart3(long id)
		throws PortalException {
		return vrTechnicalSpec_XMYPart3Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_XMYPart3 deleteVRTechnicalSpec_XMYPart3(
		VRTechnicalSpec_XMYPart3 vrTechnicalSpec_XMYPart3) {
		return vrTechnicalSpec_XMYPart3Persistence.remove(vrTechnicalSpec_XMYPart3);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XMYPart3.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XMYPart3Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XMYPart3Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_XMYPart3 fetchVRTechnicalSpec_XMYPart3(long id) {
		return vrTechnicalSpec_XMYPart3Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XMYPart3 getVRTechnicalSpec_XMYPart3(long id)
		throws PortalException {
		return vrTechnicalSpec_XMYPart3Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XMYPart3LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XMYPart3.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XMYPart3LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XMYPart3.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XMYPart3LocalService.deleteVRTechnicalSpec_XMYPart3((VRTechnicalSpec_XMYPart3)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XMYPart3Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_XMYPart3> getVRTechnicalSpec_XMYPart3s(
		int start, int end) {
		return vrTechnicalSpec_XMYPart3Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XMYPart3sCount() {
		return vrTechnicalSpec_XMYPart3Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_XMYPart3 updateVRTechnicalSpec_XMYPart3(
		VRTechnicalSpec_XMYPart3 vrTechnicalSpec_XMYPart3) {
		return vrTechnicalSpec_XMYPart3Persistence.update(vrTechnicalSpec_XMYPart3);
	}
	 ...
	 */
	public VRTechnicalSpec_XMYPart3LocalService getVRTechnicalSpec_XMYPart3LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XMYPart3",
			vrTechnicalSpec_XMYPart3LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XMYPart3");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XMYPart3LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XMYPart3Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XMYPart3LocalService.class)
	protected VRTechnicalSpec_XMYPart3LocalService vrTechnicalSpec_XMYPart3LocalService;
