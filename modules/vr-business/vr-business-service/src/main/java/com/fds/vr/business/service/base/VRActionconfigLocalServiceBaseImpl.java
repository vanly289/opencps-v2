...
import com.fds.vr.business.service.VRActionconfigLocalService;
...
/**
 * Provides the base implementation for the vr actionconfig local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRActionconfigLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRActionconfigLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRActionconfigLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRActionconfigLocalServiceUtil} to access the vr actionconfig local service.
	 */
	...
	@Override
	public VRActionconfig addVRActionconfig(VRActionconfig vrActionconfig) {
		vrActionconfig.setNew(true);

		return vrActionconfigPersistence.update(vrActionconfig);
	}
	 ...
	 */
	@Override
	public VRActionconfig createVRActionconfig(long id) {
		return vrActionconfigPersistence.create(id);
	}
	...
	@Override
	public VRActionconfig deleteVRActionconfig(long id)
		throws PortalException {
		return vrActionconfigPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRActionconfig deleteVRActionconfig(VRActionconfig vrActionconfig) {
		return vrActionconfigPersistence.remove(vrActionconfig);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRActionconfig.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrActionconfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrActionconfigPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRActionconfig fetchVRActionconfig(long id) {
		return vrActionconfigPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRActionconfig getVRActionconfig(long id) throws PortalException {
		return vrActionconfigPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrActionconfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRActionconfig.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrActionconfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRActionconfig.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrActionconfigLocalService.deleteVRActionconfig((VRActionconfig)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrActionconfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRActionconfig> getVRActionconfigs(int start, int end) {
		return vrActionconfigPersistence.findAll(start, end);
	}
	...
	public int getVRActionconfigsCount() {
		return vrActionconfigPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRActionconfig updateVRActionconfig(VRActionconfig vrActionconfig) {
		return vrActionconfigPersistence.update(vrActionconfig);
	}
	 ...
	 */
	public VRActionconfigLocalService getVRActionconfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRActionconfig",
			vrActionconfigLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRActionconfig");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRActionconfigLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrActionconfigPersistence.getDataSource();
	...
	@BeanReference(type = VRActionconfigLocalService.class)
	protected VRActionconfigLocalService vrActionconfigLocalService;
