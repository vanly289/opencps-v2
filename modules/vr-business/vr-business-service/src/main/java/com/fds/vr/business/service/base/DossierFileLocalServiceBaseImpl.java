...
import com.fds.vr.business.service.DossierFileLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.DossierFileLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.DossierFileLocalServiceImpl
...
public abstract class DossierFileLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.DossierFileLocalServiceUtil} to access the dossier file local service.
	 */
	...
	public DossierFile fetchDossierFileByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierFilePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierFileLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierFile.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierFileLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierFile.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DossierFile>() {
				@Override
				public void performAction(DossierFile dossierFile)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DossierFile.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierFileLocalService.deleteDossierFile((DossierFile)persistedModel);
	}
	...
	public List<DossierFile> getDossierFilesByUuidAndCompanyId(String uuid,
		long companyId) {
		return dossierFilePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DossierFile> getDossierFilesByUuidAndCompanyId(String uuid,
		...
		return dossierFilePersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public DossierFile getDossierFileByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return dossierFilePersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	public DossierFileLocalService getDossierFileLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.DossierFile",
			dossierFileLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.DossierFile");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierFileLocalService.class.getName();
	}
	...
	@BeanReference(type = DossierFileLocalService.class)
	protected DossierFileLocalService dossierFileLocalService;
