...
import com.fds.vr.business.service.VRCOPProductLineLocalService;
...
/**
 * Provides the base implementation for the vrcop product line local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRCOPProductLineLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRCOPProductLineLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRCOPProductLineLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRCOPProductLineLocalServiceUtil} to access the vrcop product line local service.
	 */
	...
	@Override
	public VRCOPProductLine addVRCOPProductLine(
		VRCOPProductLine vrcopProductLine) {
		vrcopProductLine.setNew(true);

		return vrcopProductLinePersistence.update(vrcopProductLine);
	}
	 ...
	 */
	@Override
	public VRCOPProductLine createVRCOPProductLine(long id) {
		return vrcopProductLinePersistence.create(id);
	}
	...
	@Override
	public VRCOPProductLine deleteVRCOPProductLine(long id)
		throws PortalException {
		return vrcopProductLinePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRCOPProductLine deleteVRCOPProductLine(
		VRCOPProductLine vrcopProductLine) {
		return vrcopProductLinePersistence.remove(vrcopProductLine);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRCOPProductLine.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrcopProductLinePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrcopProductLinePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRCOPProductLine fetchVRCOPProductLine(long id) {
		return vrcopProductLinePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRCOPProductLine getVRCOPProductLine(long id)
		throws PortalException {
		return vrcopProductLinePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrcopProductLineLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRCOPProductLine.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrcopProductLineLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRCOPProductLine.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrcopProductLineLocalService.deleteVRCOPProductLine((VRCOPProductLine)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrcopProductLinePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRCOPProductLine> getVRCOPProductLines(int start, int end) {
		return vrcopProductLinePersistence.findAll(start, end);
	}
	...
	public int getVRCOPProductLinesCount() {
		return vrcopProductLinePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRCOPProductLine updateVRCOPProductLine(
		VRCOPProductLine vrcopProductLine) {
		return vrcopProductLinePersistence.update(vrcopProductLine);
	}
	 ...
	 */
	public VRCOPProductLineLocalService getVRCOPProductLineLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRCOPProductLine",
			vrcopProductLineLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRCOPProductLine");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRCOPProductLineLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrcopProductLinePersistence.getDataSource();
	...
	@BeanReference(type = VRCOPProductLineLocalService.class)
	protected VRCOPProductLineLocalService vrcopProductLineLocalService;
