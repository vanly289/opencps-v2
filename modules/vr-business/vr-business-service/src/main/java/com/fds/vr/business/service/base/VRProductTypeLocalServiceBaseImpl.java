...
import com.fds.vr.business.service.VRProductTypeLocalService;
...
/**
 * Provides the base implementation for the vr product type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRProductTypeLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRProductTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRProductTypeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRProductTypeLocalServiceUtil} to access the vr product type local service.
	 */
	...
	@Override
	public VRProductType addVRProductType(VRProductType vrProductType) {
	 ...
	 */
	@Override
	public VRProductType createVRProductType(long id) {
		return vrProductTypePersistence.create(id);
	}
	...
	@Override
	public VRProductType deleteVRProductType(long id) throws PortalException {
		return vrProductTypePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRProductType deleteVRProductType(VRProductType vrProductType) {
		return vrProductTypePersistence.remove(vrProductType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRProductType.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrProductTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrProductTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRProductType fetchVRProductType(long id) {
		return vrProductTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRProductType getVRProductType(long id) throws PortalException {
		return vrProductTypePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrProductTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRProductType.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrProductTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRProductType.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrProductTypeLocalService.deleteVRProductType((VRProductType)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrProductTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRProductType> getVRProductTypes(int start, int end) {
		return vrProductTypePersistence.findAll(start, end);
	}
	...
	public int getVRProductTypesCount() {
		return vrProductTypePersistence.countAll();
	}
	 ...
	 */
	public VRProductTypeLocalService getVRProductTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRProductType",
			vrProductTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRProductType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRProductTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrProductTypePersistence.getDataSource();
	...
	@BeanReference(type = VRProductTypeLocalService.class)
	protected VRProductTypeLocalService vrProductTypeLocalService;
