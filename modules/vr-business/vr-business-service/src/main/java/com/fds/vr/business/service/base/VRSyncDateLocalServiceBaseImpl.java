...
import com.fds.vr.business.service.VRSyncDateLocalService;
...
/**
 * Provides the base implementation for the vr sync date local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRSyncDateLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRSyncDateLocalServiceImpl
 * @see com.fds.vr.business.service.VRSyncDateLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRSyncDateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRSyncDateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRSyncDateLocalServiceUtil} to access the vr sync date local service.
	 */
	...
	@Override
	public VRSyncDate addVRSyncDate(VRSyncDate vrSyncDate) {
		vrSyncDate.setNew(true);

		return vrSyncDatePersistence.update(vrSyncDate);
	}
	 ...
	 */
	@Override
	public VRSyncDate createVRSyncDate(long id) {
		return vrSyncDatePersistence.create(id);
	}
	...
	@Override
	public VRSyncDate deleteVRSyncDate(long id) throws PortalException {
		return vrSyncDatePersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRSyncDate deleteVRSyncDate(VRSyncDate vrSyncDate) {
		return vrSyncDatePersistence.remove(vrSyncDate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRSyncDate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrSyncDatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vrSyncDatePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrSyncDatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRSyncDate fetchVRSyncDate(long id) {
		return vrSyncDatePersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRSyncDate getVRSyncDate(long id) throws PortalException {
		return vrSyncDatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrSyncDateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRSyncDate.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrSyncDateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRSyncDate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrSyncDateLocalService.deleteVRSyncDate((VRSyncDate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrSyncDatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRSyncDate> getVRSyncDates(int start, int end) {
		return vrSyncDatePersistence.findAll(start, end);
	}
	...
	public int getVRSyncDatesCount() {
		return vrSyncDatePersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRSyncDate updateVRSyncDate(VRSyncDate vrSyncDate) {
		return vrSyncDatePersistence.update(vrSyncDate);
	}
	 ...
	 */
	public VRSyncDateLocalService getVRSyncDateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRSyncDate",
			vrSyncDateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRSyncDate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRSyncDateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrSyncDatePersistence.getDataSource();
	...
	@BeanReference(type = VRSyncDateLocalService.class)
	protected VRSyncDateLocalService vrSyncDateLocalService;
