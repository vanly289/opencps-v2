...
import com.fds.vr.business.service.VRInspectionStandardLocalService;
...
/**
 * Provides the base implementation for the vr inspection standard local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRInspectionStandardLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRInspectionStandardLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRInspectionStandardLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRInspectionStandardLocalServiceUtil} to access the vr inspection standard local service.
	 */
	...
	public VRInspectionStandard addVRInspectionStandard(
		...
		return vrInspectionStandardPersistence.update(vrInspectionStandard);
	}
	...
	public VRInspectionStandard createVRInspectionStandard(long id) {
		return vrInspectionStandardPersistence.create(id);
	}
	...
	public VRInspectionStandard deleteVRInspectionStandard(long id)
		...
		return vrInspectionStandardPersistence.remove(id);
	}
	...
	public VRInspectionStandard deleteVRInspectionStandard(
		VRInspectionStandard vrInspectionStandard) {
		return vrInspectionStandardPersistence.remove(vrInspectionStandard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRInspectionStandard.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrInspectionStandardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrInspectionStandardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRInspectionStandard fetchVRInspectionStandard(long id) {
		return vrInspectionStandardPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRInspectionStandard getVRInspectionStandard(long id)
		throws PortalException {
		return vrInspectionStandardPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrInspectionStandardLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRInspectionStandard.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrInspectionStandardLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRInspectionStandard.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrInspectionStandardLocalService.deleteVRInspectionStandard((VRInspectionStandard)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrInspectionStandardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRInspectionStandard> getVRInspectionStandards(int start,
		int end) {
		return vrInspectionStandardPersistence.findAll(start, end);
	}
	...
	public int getVRInspectionStandardsCount() {
		return vrInspectionStandardPersistence.countAll();
	}
	 ...
	 */
	public VRInspectionStandardLocalService getVRInspectionStandardLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRInspectionStandard",
			vrInspectionStandardLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRInspectionStandard");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRInspectionStandardLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrInspectionStandardPersistence.getDataSource();
	...
	@BeanReference(type = VRInspectionStandardLocalService.class)
	protected VRInspectionStandardLocalService vrInspectionStandardLocalService;
