...
import com.fds.vr.business.service.VRTechnicalSpec_XCGPart6LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg part6 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart6LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGPart6LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGPart6LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGPart6LocalServiceUtil} to access the vr technical spec_xcg part6 local service.
	 */
	...
	public VRTechnicalSpec_XCGPart6 addVRTechnicalSpec_XCGPart6(
		...
		return vrTechnicalSpec_XCGPart6Persistence.update(vrTechnicalSpec_XCGPart6);
	}
	...
	public VRTechnicalSpec_XCGPart6 createVRTechnicalSpec_XCGPart6(long id) {
		return vrTechnicalSpec_XCGPart6Persistence.create(id);
	}
	...
	public VRTechnicalSpec_XCGPart6 deleteVRTechnicalSpec_XCGPart6(long id)
		...
		return vrTechnicalSpec_XCGPart6Persistence.remove(id);
	}
	...
	public VRTechnicalSpec_XCGPart6 deleteVRTechnicalSpec_XCGPart6(
		VRTechnicalSpec_XCGPart6 vrTechnicalSpec_XCGPart6) {
		return vrTechnicalSpec_XCGPart6Persistence.remove(vrTechnicalSpec_XCGPart6);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCGPart6.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart6Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart6Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTechnicalSpec_XCGPart6 fetchVRTechnicalSpec_XCGPart6(long id) {
		return vrTechnicalSpec_XCGPart6Persistence.fetchByPrimaryKey(id);
	}
	...
	public VRTechnicalSpec_XCGPart6 getVRTechnicalSpec_XCGPart6(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart6Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart6LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart6.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart6LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart6.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGPart6LocalService.deleteVRTechnicalSpec_XCGPart6((VRTechnicalSpec_XCGPart6)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPart6Persistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTechnicalSpec_XCGPart6> getVRTechnicalSpec_XCGPart6s(
		int start, int end) {
		return vrTechnicalSpec_XCGPart6Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGPart6sCount() {
		return vrTechnicalSpec_XCGPart6Persistence.countAll();
	}
	 ...
	 */
	public VRTechnicalSpec_XCGPart6LocalService getVRTechnicalSpec_XCGPart6LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCGPart6",
			vrTechnicalSpec_XCGPart6LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCGPart6");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGPart6LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPart6Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGPart6LocalService.class)
	protected VRTechnicalSpec_XCGPart6LocalService vrTechnicalSpec_XCGPart6LocalService;
