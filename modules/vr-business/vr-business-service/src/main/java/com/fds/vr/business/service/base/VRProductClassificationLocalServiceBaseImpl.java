...
import com.fds.vr.business.service.VRProductClassificationLocalService;
...
/**
 * Provides the base implementation for the vr product classification local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRProductClassificationLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRProductClassificationLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRProductClassificationLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRProductClassificationLocalServiceUtil} to access the vr product classification local service.
	 */
	...
	@Override
	public VRProductClassification addVRProductClassification(
		VRProductClassification vrProductClassification) {
		vrProductClassification.setNew(true);

		return vrProductClassificationPersistence.update(vrProductClassification);
	}
	 ...
	 */
	@Override
	public VRProductClassification createVRProductClassification(long id) {
		return vrProductClassificationPersistence.create(id);
	}
	...
	@Override
	public VRProductClassification deleteVRProductClassification(long id)
		throws PortalException {
		return vrProductClassificationPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRProductClassification deleteVRProductClassification(
		VRProductClassification vrProductClassification) {
		return vrProductClassificationPersistence.remove(vrProductClassification);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRProductClassification.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrProductClassificationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrProductClassificationPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRProductClassification fetchVRProductClassification(long id) {
		return vrProductClassificationPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRProductClassification getVRProductClassification(long id)
		throws PortalException {
		return vrProductClassificationPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrProductClassificationLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRProductClassification.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrProductClassificationLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRProductClassification.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrProductClassificationLocalService.deleteVRProductClassification((VRProductClassification)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrProductClassificationPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRProductClassification> getVRProductClassifications(
		int start, int end) {
		return vrProductClassificationPersistence.findAll(start, end);
	}
	...
	public int getVRProductClassificationsCount() {
		return vrProductClassificationPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRProductClassification updateVRProductClassification(
		VRProductClassification vrProductClassification) {
		return vrProductClassificationPersistence.update(vrProductClassification);
	}
	 ...
	 */
	public VRProductClassificationLocalService getVRProductClassificationLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRProductClassification",
			vrProductClassificationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRProductClassification");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRProductClassificationLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrProductClassificationPersistence.getDataSource();
	...
	@BeanReference(type = VRProductClassificationLocalService.class)
	protected VRProductClassificationLocalService vrProductClassificationLocalService;
