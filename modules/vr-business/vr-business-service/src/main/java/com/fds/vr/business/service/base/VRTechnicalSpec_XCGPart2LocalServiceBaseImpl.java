...
import com.fds.vr.business.service.VRTechnicalSpec_XCGPart2LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg part2 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart2LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart2LocalServiceImpl
 * @see com.fds.vr.business.service.VRTechnicalSpec_XCGPart2LocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGPart2LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGPart2LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGPart2LocalServiceUtil} to access the vr technical spec_xcg part2 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_XCGPart2 addVRTechnicalSpec_XCGPart2(
		VRTechnicalSpec_XCGPart2 vrTechnicalSpec_XCGPart2) {
		vrTechnicalSpec_XCGPart2.setNew(true);

		return vrTechnicalSpec_XCGPart2Persistence.update(vrTechnicalSpec_XCGPart2);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCGPart2 createVRTechnicalSpec_XCGPart2(long id) {
		return vrTechnicalSpec_XCGPart2Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_XCGPart2 deleteVRTechnicalSpec_XCGPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart2Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_XCGPart2 deleteVRTechnicalSpec_XCGPart2(
		VRTechnicalSpec_XCGPart2 vrTechnicalSpec_XCGPart2) {
		return vrTechnicalSpec_XCGPart2Persistence.remove(vrTechnicalSpec_XCGPart2);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCGPart2.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart2Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart2Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_XCGPart2 fetchVRTechnicalSpec_XCGPart2(long id) {
		return vrTechnicalSpec_XCGPart2Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCGPart2 getVRTechnicalSpec_XCGPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart2Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart2LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart2.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart2LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart2.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGPart2LocalService.deleteVRTechnicalSpec_XCGPart2((VRTechnicalSpec_XCGPart2)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPart2Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_XCGPart2> getVRTechnicalSpec_XCGPart2s(
		int start, int end) {
		return vrTechnicalSpec_XCGPart2Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGPart2sCount() {
		return vrTechnicalSpec_XCGPart2Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_XCGPart2 updateVRTechnicalSpec_XCGPart2(
		VRTechnicalSpec_XCGPart2 vrTechnicalSpec_XCGPart2) {
		return vrTechnicalSpec_XCGPart2Persistence.update(vrTechnicalSpec_XCGPart2);
	}
	 ...
	 */
	public VRTechnicalSpec_XCGPart2LocalService getVRTechnicalSpec_XCGPart2LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCGPart2",
			vrTechnicalSpec_XCGPart2LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCGPart2");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGPart2LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPart2Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGPart2LocalService.class)
	protected VRTechnicalSpec_XCGPart2LocalService vrTechnicalSpec_XCGPart2LocalService;
