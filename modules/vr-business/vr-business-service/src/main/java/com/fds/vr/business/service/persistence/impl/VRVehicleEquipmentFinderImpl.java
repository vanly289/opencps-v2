...
public class VRVehicleEquipmentFinderImpl extends VRVehicleEquipmentFinderBaseImpl
	implements VRVehicleEquipmentFinder {

	Log _log = LogFactoryUtil.getLog(VRVehicleEquipmentFinderImpl.class);
