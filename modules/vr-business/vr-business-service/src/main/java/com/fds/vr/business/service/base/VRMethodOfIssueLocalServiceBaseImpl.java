...
import com.fds.vr.business.service.VRMethodOfIssueLocalService;
...
/**
 * Provides the base implementation for the vr method of issue local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRMethodOfIssueLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRMethodOfIssueLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRMethodOfIssueLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRMethodOfIssueLocalServiceUtil} to access the vr method of issue local service.
	 */
	...
	public VRMethodOfIssue addVRMethodOfIssue(VRMethodOfIssue vrMethodOfIssue) {
		...
		return vrMethodOfIssuePersistence.update(vrMethodOfIssue);
	}
	...
	public VRMethodOfIssue createVRMethodOfIssue(long id) {
		return vrMethodOfIssuePersistence.create(id);
	}
	...
	public VRMethodOfIssue deleteVRMethodOfIssue(long id)
		...
		return vrMethodOfIssuePersistence.remove(id);
	}
	...
	public VRMethodOfIssue deleteVRMethodOfIssue(
		...
		return vrMethodOfIssuePersistence.remove(vrMethodOfIssue);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRMethodOfIssue.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrMethodOfIssuePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrMethodOfIssuePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRMethodOfIssue fetchVRMethodOfIssue(long id) {
		return vrMethodOfIssuePersistence.fetchByPrimaryKey(id);
	}
	...
	public VRMethodOfIssue getVRMethodOfIssue(long id)
		throws PortalException {
		return vrMethodOfIssuePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrMethodOfIssueLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRMethodOfIssue.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrMethodOfIssueLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRMethodOfIssue.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrMethodOfIssueLocalService.deleteVRMethodOfIssue((VRMethodOfIssue)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrMethodOfIssuePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRMethodOfIssue> getVRMethodOfIssues(int start, int end) {
		return vrMethodOfIssuePersistence.findAll(start, end);
	}
	...
	public int getVRMethodOfIssuesCount() {
		return vrMethodOfIssuePersistence.countAll();
	}
	 ...
	 */
	public VRMethodOfIssueLocalService getVRMethodOfIssueLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRMethodOfIssue",
			vrMethodOfIssueLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRMethodOfIssue");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRMethodOfIssueLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrMethodOfIssuePersistence.getDataSource();
	...
	@BeanReference(type = VRMethodOfIssueLocalService.class)
	protected VRMethodOfIssueLocalService vrMethodOfIssueLocalService;
