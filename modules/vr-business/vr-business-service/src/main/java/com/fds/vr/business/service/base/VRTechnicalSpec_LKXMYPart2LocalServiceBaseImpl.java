...
import com.fds.vr.business.service.VRTechnicalSpec_LKXMYPart2LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_lkxmy part2 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_LKXMYPart2LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_LKXMYPart2LocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements VRTechnicalSpec_LKXMYPart2LocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_LKXMYPart2LocalServiceUtil} to access the vr technical spec_lkxmy part2 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_LKXMYPart2 addVRTechnicalSpec_LKXMYPart2(
		VRTechnicalSpec_LKXMYPart2 vrTechnicalSpec_LKXMYPart2) {
		vrTechnicalSpec_LKXMYPart2.setNew(true);

		return vrTechnicalSpec_LKXMYPart2Persistence.update(vrTechnicalSpec_LKXMYPart2);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_LKXMYPart2 createVRTechnicalSpec_LKXMYPart2(long id) {
		return vrTechnicalSpec_LKXMYPart2Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_LKXMYPart2 deleteVRTechnicalSpec_LKXMYPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_LKXMYPart2Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_LKXMYPart2 deleteVRTechnicalSpec_LKXMYPart2(
		VRTechnicalSpec_LKXMYPart2 vrTechnicalSpec_LKXMYPart2) {
		return vrTechnicalSpec_LKXMYPart2Persistence.remove(vrTechnicalSpec_LKXMYPart2);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_LKXMYPart2.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_LKXMYPart2Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_LKXMYPart2Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_LKXMYPart2 fetchVRTechnicalSpec_LKXMYPart2(long id) {
		return vrTechnicalSpec_LKXMYPart2Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_LKXMYPart2 getVRTechnicalSpec_LKXMYPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_LKXMYPart2Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_LKXMYPart2LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_LKXMYPart2.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_LKXMYPart2LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_LKXMYPart2.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_LKXMYPart2LocalService.deleteVRTechnicalSpec_LKXMYPart2((VRTechnicalSpec_LKXMYPart2)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_LKXMYPart2Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_LKXMYPart2> getVRTechnicalSpec_LKXMYPart2s(
		int start, int end) {
		return vrTechnicalSpec_LKXMYPart2Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_LKXMYPart2sCount() {
		return vrTechnicalSpec_LKXMYPart2Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_LKXMYPart2 updateVRTechnicalSpec_LKXMYPart2(
		VRTechnicalSpec_LKXMYPart2 vrTechnicalSpec_LKXMYPart2) {
		return vrTechnicalSpec_LKXMYPart2Persistence.update(vrTechnicalSpec_LKXMYPart2);
	}
	 ...
	 */
	public VRTechnicalSpec_LKXMYPart2LocalService getVRTechnicalSpec_LKXMYPart2LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_LKXMYPart2",
			vrTechnicalSpec_LKXMYPart2LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_LKXMYPart2");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_LKXMYPart2LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_LKXMYPart2Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_LKXMYPart2LocalService.class)
	protected VRTechnicalSpec_LKXMYPart2LocalService vrTechnicalSpec_LKXMYPart2LocalService;
