...
import com.fds.vr.business.service.VRInventoryLocalService;
...
/**
 * Provides the base implementation for the vr inventory local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRInventoryLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRInventoryLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRInventoryLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRInventoryLocalServiceUtil} to access the vr inventory local service.
	 */
	...
	public VRInventory createVRInventory(long id) {
		return vrInventoryPersistence.create(id);
	}
	...
	public VRInventory deleteVRInventory(long id) throws PortalException {
		return vrInventoryPersistence.remove(id);
	}
	...
	public VRInventory deleteVRInventory(VRInventory vrInventory) {
		return vrInventoryPersistence.remove(vrInventory);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRInventory.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrInventoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vrInventoryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrInventoryPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRInventory fetchVRInventory(long id) {
		return vrInventoryPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRInventory getVRInventory(long id) throws PortalException {
		return vrInventoryPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrInventoryLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRInventory.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrInventoryLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRInventory.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrInventoryLocalService.deleteVRInventory((VRInventory)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrInventoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRInventory> getVRInventories(int start, int end) {
		return vrInventoryPersistence.findAll(start, end);
	}
	...
	public int getVRInventoriesCount() {
		return vrInventoryPersistence.countAll();
	}
	 ...
	 */
	public VRInventoryLocalService getVRInventoryLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRInventory",
			vrInventoryLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRInventory");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRInventoryLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrInventoryPersistence.getDataSource();
	...
	@BeanReference(type = VRInventoryLocalService.class)
	protected VRInventoryLocalService vrInventoryLocalService;
