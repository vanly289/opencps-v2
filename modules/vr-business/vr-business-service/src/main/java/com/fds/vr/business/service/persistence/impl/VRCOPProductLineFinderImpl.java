...
public class VRCOPProductLineFinderImpl extends VRCOPProductLineFinderBaseImpl
	implements VRCOPProductLineFinder {

	Log _log = LogFactoryUtil.getLog(VRCOPProductLineFinderImpl.class);
