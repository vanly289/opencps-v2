...
import com.fds.vr.business.exception.NoSuchRegistrationException;
import com.fds.vr.business.model.Registration;
import com.fds.vr.business.model.impl.RegistrationImpl;
import com.fds.vr.business.model.impl.RegistrationModelImpl;
 ...
 * @see com.fds.vr.business.service.persistence.RegistrationUtil
 * @generated
 */
@ProviderType
public class RegistrationPersistenceImpl extends BasePersistenceImpl<Registration>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((registration.getUuid() == null) ||
							!registration.getUuid().equals(uuid) ||
							(registration.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, registration);
					}
				}
			}
			catch (Exception e) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Registration registration : list) {
					if ((groupId != registration.getGroupId()) ||
							(submitting != registration.getSubmitting())) {
						list = null;
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((registration.getGroupId() != groupId) ||
							(registration.getRegistrationId() != registrationId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_G_REGID,
							finderArgs, registration);
					}
				}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((registration.getApplicantIdNo() == null) ||
							!registration.getApplicantIdNo()
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_REG_APPNO_MARKASDELETED =
		new FinderPath(RegistrationModelImpl.ENTITY_CACHE_ENABLED,
			...
			RegistrationModelImpl.GROUPID_COLUMN_BITMASK |
			RegistrationModelImpl.APPLICANTIDNO_COLUMN_BITMASK |
			RegistrationModelImpl.MARKASDELETED_COLUMN_BITMASK |
			RegistrationModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_REG_APPNO_MARKASDELETED = new FinderPath(RegistrationModelImpl.ENTITY_CACHE_ENABLED,
			RegistrationModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
	...
	/**
	 * Returns all the registrations where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * @param groupId the group ID
	 * @param applicantIdNo the applicant ID no
	 ...
	 */
	@Override
	public List<Registration> findByREG_APPNO_markasdeleted(long groupId,
	...
	/**
	 * Returns a range of all the registrations where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link RegistrationModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the registrations where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link RegistrationModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
			...
			if ((list != null) && !list.isEmpty()) {
				for (Registration registration : list) {
					if ((groupId != registration.getGroupId()) ||
							!Objects.equals(applicantIdNo,
								registration.getApplicantIdNo()) ||
							(markasdeleted != registration.getMarkasdeleted())) {
						list = null;
	...
	/**
	 * Returns the first registration in the ordered set where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * @param groupId the group ID
	 * @param applicantIdNo the applicant ID no
	 * @param markasdeleted the markasdeleted
	 ...
	 */
	@Override
	public Registration findByREG_APPNO_markasdeleted_First(long groupId,
		String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator)
		throws NoSuchRegistrationException {
		Registration registration = fetchByREG_APPNO_markasdeleted_First(groupId,
	 ...
	 */
	@Override
	public Registration fetchByREG_APPNO_markasdeleted_First(long groupId,
		String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator) {
		List<Registration> list = findByREG_APPNO_markasdeleted(groupId,
	...
	/**
	 * Returns the last registration in the ordered set where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * @param groupId the group ID
	 * @param applicantIdNo the applicant ID no
	 * @param markasdeleted the markasdeleted
	 ...
	 */
	@Override
	public Registration findByREG_APPNO_markasdeleted_Last(long groupId,
		String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator)
		throws NoSuchRegistrationException {
		Registration registration = fetchByREG_APPNO_markasdeleted_Last(groupId,
				applicantIdNo, markasdeleted, orderByComparator);
	 ...
	 */
	@Override
	public Registration fetchByREG_APPNO_markasdeleted_Last(long groupId,
		String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator) {
	...
	/**
	 * Returns the registrations before and after the current registration in the ordered set where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * @param registrationId the primary key of the current registration
	 * @param groupId the group ID
	 * @param applicantIdNo the applicant ID no
	 ...
	 */
	@Override
	public Registration[] findByREG_APPNO_markasdeleted_PrevAndNext(
		long registrationId, long groupId, String applicantIdNo,
		int markasdeleted, OrderByComparator<Registration> orderByComparator)
		throws NoSuchRegistrationException {
		Registration registration = findByPrimaryKey(registrationId);
		...
		try {
			...
			array[0] = getByREG_APPNO_markasdeleted_PrevAndNext(session,
					registration, groupId, applicantIdNo, markasdeleted,
					orderByComparator, true);
	...
	protected Registration getByREG_APPNO_markasdeleted_PrevAndNext(
	...
	/**
	 * Removes all the registrations where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param applicantIdNo the applicant ID no
	 * @param markasdeleted the markasdeleted
	...
	public void removeByREG_APPNO_markasdeleted(long groupId,
		String applicantIdNo, int markasdeleted) {
		for (Registration registration : findByREG_APPNO_markasdeleted(
	...
	/**
	 * Returns the number of registrations where groupId = &#63; and applicantIdNo = &#63; and markasdeleted = &#63;.
	 *
	 * @param groupId the group ID
	 * @param applicantIdNo the applicant ID no
	 * @param markasdeleted the markasdeleted
	...
	public Registration updateImpl(Registration registration) {
		...
		if (isNew || !RegistrationModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((registrationModelImpl.getColumnBitmask() &
				...
				args = new Object[] {
						registrationModelImpl.getGroupId(),
						registrationModelImpl.getSubmitting()
					};
			...
			if ((registrationModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						registrationModelImpl.getOriginalGroupId(),
						registrationModelImpl.getOriginalApplicantIdNo(),
						registrationModelImpl.getOriginalMarkasdeleted()
					};
				...
				args = new Object[] {
						registrationModelImpl.getGroupId(),
						registrationModelImpl.getApplicantIdNo(),
						registrationModelImpl.getMarkasdeleted()
					};
	...
	protected Registration toUnwrappedModel(Registration registration) {
		...
		registrationImpl.setApplicantName(registration.getApplicantName());
		registrationImpl.setApplicantIdType(registration.getApplicantIdType());
		registrationImpl.setApplicantIdNo(registration.getApplicantIdNo());
		registrationImpl.setApplicantIdDate(registration.getApplicantIdDate());
		registrationImpl.setAddress(registration.getAddress());
		registrationImpl.setCityCode(registration.getCityCode());
		registrationImpl.setCityName(registration.getCityName());
		registrationImpl.setDistrictCode(registration.getDistrictCode());
		registrationImpl.setDistrictName(registration.getDistrictName());
		registrationImpl.setWardCode(registration.getWardCode());
		registrationImpl.setWardName(registration.getWardName());
		registrationImpl.setContactName(registration.getContactName());
		registrationImpl.setContactTelNo(registration.getContactTelNo());
		registrationImpl.setContactEmail(registration.getContactEmail());
		registrationImpl.setGovAgencyCode(registration.getGovAgencyCode());
		registrationImpl.setGovAgencyName(registration.getGovAgencyName());
		registrationImpl.setRegistrationState(registration.getRegistrationState());
		registrationImpl.setRegistrationClass(registration.getRegistrationClass());
		registrationImpl.setSubmitting(registration.isSubmitting());
		registrationImpl.setRepresentativeEnterprise(registration.getRepresentativeEnterprise());
		registrationImpl.setRemarks(registration.getRemarks());
		registrationImpl.setMarkasdeleted(registration.getMarkasdeleted());
