...
import com.fds.vr.business.service.VRTechnicalSpec_XCGLocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGLocalServiceUtil} to access the vr technical spec_xcg local service.
	 */
	...
	public VRTechnicalSpec_XCG addVRTechnicalSpec_XCG(
		...
		return vrTechnicalSpec_XCGPersistence.update(vrTechnicalSpec_XCG);
	}
	...
	public VRTechnicalSpec_XCG createVRTechnicalSpec_XCG(long id) {
		return vrTechnicalSpec_XCGPersistence.create(id);
	}
	...
	public VRTechnicalSpec_XCG deleteVRTechnicalSpec_XCG(long id)
		...
		return vrTechnicalSpec_XCGPersistence.remove(id);
	}
	...
	public VRTechnicalSpec_XCG deleteVRTechnicalSpec_XCG(
		VRTechnicalSpec_XCG vrTechnicalSpec_XCG) {
		return vrTechnicalSpec_XCGPersistence.remove(vrTechnicalSpec_XCG);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCG.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTechnicalSpec_XCG fetchVRTechnicalSpec_XCG(long id) {
		return vrTechnicalSpec_XCGPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRTechnicalSpec_XCG getVRTechnicalSpec_XCG(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCG.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCG.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGLocalService.deleteVRTechnicalSpec_XCG((VRTechnicalSpec_XCG)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTechnicalSpec_XCG> getVRTechnicalSpec_XCGs(int start, int end) {
		return vrTechnicalSpec_XCGPersistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGsCount() {
		return vrTechnicalSpec_XCGPersistence.countAll();
	}
	 ...
	 */
	public VRTechnicalSpec_XCGLocalService getVRTechnicalSpec_XCGLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCG",
			vrTechnicalSpec_XCGLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCG");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPersistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGLocalService.class)
	protected VRTechnicalSpec_XCGLocalService vrTechnicalSpec_XCGLocalService;
