...
public class VRCOPReportAttachFinderImpl extends VRCOPReportAttachFinderBaseImpl
	implements VRCOPReportAttachFinder {

	Log log = LogFactoryUtil.getLog(VRCOPReportAttachFinderImpl.class);
	...
	public JSONArray findData(String sql, List<String> columnNames, List<String> dataTypes, Class<?> modelClazz,
		...
		try {
			...
			log.info("===>>>VRCOPReportAttachFinder " + sql + "|" + start + "|" + end);
	...
	public long countData(String sql) throws SystemException {
		...
		try {
			...
			log.info("===>>>VRCOPReportAttachFinder " + sql);
