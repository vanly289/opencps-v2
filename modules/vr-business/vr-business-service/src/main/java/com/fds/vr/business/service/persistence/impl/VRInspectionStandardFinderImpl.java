...
public class VRInspectionStandardFinderImpl extends VRInspectionStandardFinderBaseImpl
		implements VRInspectionStandardFinder {

	Log log = LogFactoryUtil.getLog(VRInspectionStandardFinderImpl.class);
	...
	public JSONArray findData(String sql, List<String> columnNames, List<String> dataTypes, Class<?> modelClazz,
		...
		try {
			...
			log.info("===>>>VRInspectionStandardFinder " + sql + "|" + start + "|" + end);
	...
	public long countData(String sql) throws SystemException {
		...
		try {
			...
			log.info("===>>>VRInspectionStandardFinder " + sql);
