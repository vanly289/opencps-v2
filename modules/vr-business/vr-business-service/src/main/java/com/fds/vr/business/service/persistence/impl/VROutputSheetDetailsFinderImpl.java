...
public class VROutputSheetDetailsFinderImpl extends VROutputSheetDetailsFinderBaseImpl
		implements VROutputSheetDetailsFinder {

	Log log = LogFactoryUtil.getLog(VROutputSheetDetailsFinderImpl.class);
	...
	public JSONArray findData(String sql, List<String> columnNames, List<String> dataTypes, Class<?> modelClazz,
		...
		try {
			...
			log.info("===>>>VROutputSheetDetailsFinder " + sql + "|" + start + "|" + end);
	...
	public long countData(String sql) throws SystemException {
		...
		try {
			...
			log.info("===>>>VROutputSheetDetailsFinder " + sql);
