...
import com.fds.vr.business.service.VRProductionPlantLocalService;
...
/**
 * Provides the base implementation for the vr production plant local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRProductionPlantLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRProductionPlantLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRProductionPlantLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRProductionPlantLocalServiceUtil} to access the vr production plant local service.
	 */
	...
	public VRProductionPlant addVRProductionPlant(
		...
		return vrProductionPlantPersistence.update(vrProductionPlant);
	}
	...
	public VRProductionPlant createVRProductionPlant(long id) {
		return vrProductionPlantPersistence.create(id);
	}
	...
	public VRProductionPlant deleteVRProductionPlant(long id)
		...
		return vrProductionPlantPersistence.remove(id);
	}
	...
	public VRProductionPlant deleteVRProductionPlant(
		VRProductionPlant vrProductionPlant) {
		return vrProductionPlantPersistence.remove(vrProductionPlant);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRProductionPlant.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrProductionPlantPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrProductionPlantPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRProductionPlant fetchVRProductionPlant(long id) {
		return vrProductionPlantPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRProductionPlant getVRProductionPlant(long id)
		throws PortalException {
		return vrProductionPlantPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrProductionPlantLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRProductionPlant.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrProductionPlantLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRProductionPlant.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrProductionPlantLocalService.deleteVRProductionPlant((VRProductionPlant)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrProductionPlantPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRProductionPlant> getVRProductionPlants(int start, int end) {
		return vrProductionPlantPersistence.findAll(start, end);
	}
	...
	public int getVRProductionPlantsCount() {
		return vrProductionPlantPersistence.countAll();
	}
	 ...
	 */
	public VRProductionPlantLocalService getVRProductionPlantLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRProductionPlant",
			vrProductionPlantLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRProductionPlant");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRProductionPlantLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrProductionPlantPersistence.getDataSource();
	...
	@BeanReference(type = VRProductionPlantLocalService.class)
	protected VRProductionPlantLocalService vrProductionPlantLocalService;
