...
import com.fds.vr.business.service.VRCOPProdEquipmentLocalService;
...
/**
 * Provides the base implementation for the vrcop prod equipment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRCOPProdEquipmentLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRCOPProdEquipmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRCOPProdEquipmentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRCOPProdEquipmentLocalServiceUtil} to access the vrcop prod equipment local service.
	 */
	...
	@Override
	public VRCOPProdEquipment addVRCOPProdEquipment(
		VRCOPProdEquipment vrcopProdEquipment) {
		vrcopProdEquipment.setNew(true);

		return vrcopProdEquipmentPersistence.update(vrcopProdEquipment);
	}
	 ...
	 */
	@Override
	public VRCOPProdEquipment createVRCOPProdEquipment(long id) {
		return vrcopProdEquipmentPersistence.create(id);
	}
	...
	@Override
	public VRCOPProdEquipment deleteVRCOPProdEquipment(long id)
		throws PortalException {
		return vrcopProdEquipmentPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRCOPProdEquipment deleteVRCOPProdEquipment(
		VRCOPProdEquipment vrcopProdEquipment) {
		return vrcopProdEquipmentPersistence.remove(vrcopProdEquipment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRCOPProdEquipment.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrcopProdEquipmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrcopProdEquipmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRCOPProdEquipment fetchVRCOPProdEquipment(long id) {
		return vrcopProdEquipmentPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRCOPProdEquipment getVRCOPProdEquipment(long id)
		throws PortalException {
		return vrcopProdEquipmentPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrcopProdEquipmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRCOPProdEquipment.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrcopProdEquipmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRCOPProdEquipment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrcopProdEquipmentLocalService.deleteVRCOPProdEquipment((VRCOPProdEquipment)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrcopProdEquipmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRCOPProdEquipment> getVRCOPProdEquipments(int start, int end) {
		return vrcopProdEquipmentPersistence.findAll(start, end);
	}
	...
	public int getVRCOPProdEquipmentsCount() {
		return vrcopProdEquipmentPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRCOPProdEquipment updateVRCOPProdEquipment(
		VRCOPProdEquipment vrcopProdEquipment) {
		return vrcopProdEquipmentPersistence.update(vrcopProdEquipment);
	}
	 ...
	 */
	public VRCOPProdEquipmentLocalService getVRCOPProdEquipmentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRCOPProdEquipment",
			vrcopProdEquipmentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRCOPProdEquipment");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRCOPProdEquipmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrcopProdEquipmentPersistence.getDataSource();
	...
	@BeanReference(type = VRCOPProdEquipmentLocalService.class)
	protected VRCOPProdEquipmentLocalService vrcopProdEquipmentLocalService;
