...
import com.fds.vr.business.service.VRCorporationViewLocalService;
...
/**
 * Provides the base implementation for the vr corporation view local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRCorporationViewLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRCorporationViewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRCorporationViewLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRCorporationViewLocalServiceUtil} to access the vr corporation view local service.
	 */
	...
	public VRCorporationView addVRCorporationView(
		...
		return vrCorporationViewPersistence.update(vrCorporationView);
	}
	...
	public VRCorporationView createVRCorporationView(long id) {
		return vrCorporationViewPersistence.create(id);
	}
	...
	public VRCorporationView deleteVRCorporationView(long id)
		...
		return vrCorporationViewPersistence.remove(id);
	}
	...
	public VRCorporationView deleteVRCorporationView(
		VRCorporationView vrCorporationView) {
		return vrCorporationViewPersistence.remove(vrCorporationView);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRCorporationView.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrCorporationViewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrCorporationViewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRCorporationView fetchVRCorporationView(long id) {
		return vrCorporationViewPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRCorporationView getVRCorporationView(long id)
		throws PortalException {
		return vrCorporationViewPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrCorporationViewLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRCorporationView.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrCorporationViewLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRCorporationView.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrCorporationViewLocalService.deleteVRCorporationView((VRCorporationView)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrCorporationViewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRCorporationView> getVRCorporationViews(int start, int end) {
		return vrCorporationViewPersistence.findAll(start, end);
	}
	...
	public int getVRCorporationViewsCount() {
		return vrCorporationViewPersistence.countAll();
	}
	 ...
	 */
	public VRCorporationViewLocalService getVRCorporationViewLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRCorporationView",
			vrCorporationViewLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRCorporationView");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRCorporationViewLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrCorporationViewPersistence.getDataSource();
	...
	@BeanReference(type = VRCorporationViewLocalService.class)
	protected VRCorporationViewLocalService vrCorporationViewLocalService;
