...
import com.fds.vr.business.service.VRTechnicalSpec_XCNPart2LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcn part2 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCNPart2LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XCNPart2LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCNPart2LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCNPart2LocalServiceUtil} to access the vr technical spec_xcn part2 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_XCNPart2 addVRTechnicalSpec_XCNPart2(
		VRTechnicalSpec_XCNPart2 vrTechnicalSpec_XCNPart2) {
		vrTechnicalSpec_XCNPart2.setNew(true);

		return vrTechnicalSpec_XCNPart2Persistence.update(vrTechnicalSpec_XCNPart2);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCNPart2 createVRTechnicalSpec_XCNPart2(long id) {
		return vrTechnicalSpec_XCNPart2Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_XCNPart2 deleteVRTechnicalSpec_XCNPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_XCNPart2Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_XCNPart2 deleteVRTechnicalSpec_XCNPart2(
		VRTechnicalSpec_XCNPart2 vrTechnicalSpec_XCNPart2) {
		return vrTechnicalSpec_XCNPart2Persistence.remove(vrTechnicalSpec_XCNPart2);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCNPart2.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCNPart2Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCNPart2Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_XCNPart2 fetchVRTechnicalSpec_XCNPart2(long id) {
		return vrTechnicalSpec_XCNPart2Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCNPart2 getVRTechnicalSpec_XCNPart2(long id)
		throws PortalException {
		return vrTechnicalSpec_XCNPart2Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCNPart2LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCNPart2.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCNPart2LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCNPart2.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCNPart2LocalService.deleteVRTechnicalSpec_XCNPart2((VRTechnicalSpec_XCNPart2)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCNPart2Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_XCNPart2> getVRTechnicalSpec_XCNPart2s(
		int start, int end) {
		return vrTechnicalSpec_XCNPart2Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCNPart2sCount() {
		return vrTechnicalSpec_XCNPart2Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_XCNPart2 updateVRTechnicalSpec_XCNPart2(
		VRTechnicalSpec_XCNPart2 vrTechnicalSpec_XCNPart2) {
		return vrTechnicalSpec_XCNPart2Persistence.update(vrTechnicalSpec_XCNPart2);
	}
	 ...
	 */
	public VRTechnicalSpec_XCNPart2LocalService getVRTechnicalSpec_XCNPart2LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCNPart2",
			vrTechnicalSpec_XCNPart2LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCNPart2");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCNPart2LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCNPart2Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCNPart2LocalService.class)
	protected VRTechnicalSpec_XCNPart2LocalService vrTechnicalSpec_XCNPart2LocalService;
