...
import com.fds.vr.business.service.VRTechnicalSpec_XCGPart1LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg part1 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart1LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGPart1LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGPart1LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGPart1LocalServiceUtil} to access the vr technical spec_xcg part1 local service.
	 */
	...
	public VRTechnicalSpec_XCGPart1 addVRTechnicalSpec_XCGPart1(
		...
		return vrTechnicalSpec_XCGPart1Persistence.update(vrTechnicalSpec_XCGPart1);
	}
	...
	public VRTechnicalSpec_XCGPart1 createVRTechnicalSpec_XCGPart1(long id) {
		return vrTechnicalSpec_XCGPart1Persistence.create(id);
	}
	...
	public VRTechnicalSpec_XCGPart1 deleteVRTechnicalSpec_XCGPart1(long id)
		...
		return vrTechnicalSpec_XCGPart1Persistence.remove(id);
	}
	...
	public VRTechnicalSpec_XCGPart1 deleteVRTechnicalSpec_XCGPart1(
		VRTechnicalSpec_XCGPart1 vrTechnicalSpec_XCGPart1) {
		return vrTechnicalSpec_XCGPart1Persistence.remove(vrTechnicalSpec_XCGPart1);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCGPart1.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart1Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart1Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTechnicalSpec_XCGPart1 fetchVRTechnicalSpec_XCGPart1(long id) {
		return vrTechnicalSpec_XCGPart1Persistence.fetchByPrimaryKey(id);
	}
	...
	public VRTechnicalSpec_XCGPart1 getVRTechnicalSpec_XCGPart1(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart1Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart1LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart1.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart1LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart1.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGPart1LocalService.deleteVRTechnicalSpec_XCGPart1((VRTechnicalSpec_XCGPart1)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPart1Persistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTechnicalSpec_XCGPart1> getVRTechnicalSpec_XCGPart1s(
		int start, int end) {
		return vrTechnicalSpec_XCGPart1Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGPart1sCount() {
		return vrTechnicalSpec_XCGPart1Persistence.countAll();
	}
	 ...
	 */
	public VRTechnicalSpec_XCGPart1LocalService getVRTechnicalSpec_XCGPart1LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCGPart1",
			vrTechnicalSpec_XCGPart1LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCGPart1");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGPart1LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPart1Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGPart1LocalService.class)
	protected VRTechnicalSpec_XCGPart1LocalService vrTechnicalSpec_XCGPart1LocalService;
