...
import com.fds.vr.business.service.VRReportLocalService;
...
/**
 * Provides the base implementation for the vr report local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRReportLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRReportLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements VRReportLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRReportLocalServiceUtil} to access the vr report local service.
	 */
	...
	@Override
	public VRReport addVRReport(VRReport vrReport) {
		vrReport.setNew(true);

		return vrReportPersistence.update(vrReport);
	}
	 ...
	 */
	@Override
	public VRReport createVRReport(long id) {
		return vrReportPersistence.create(id);
	}
	...
	@Override
	public VRReport deleteVRReport(long id) throws PortalException {
		return vrReportPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRReport deleteVRReport(VRReport vrReport) {
		return vrReportPersistence.remove(vrReport);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRReport.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrReportPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return vrReportPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		...
		return vrReportPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrReportPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRReport fetchVRReport(long id) {
		return vrReportPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRReport getVRReport(long id) throws PortalException {
		return vrReportPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrReportLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRReport.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrReportLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRReport.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrReportLocalService.deleteVRReport((VRReport)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrReportPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRReport> getVRReports(int start, int end) {
		return vrReportPersistence.findAll(start, end);
	}
	...
	public int getVRReportsCount() {
		return vrReportPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRReport updateVRReport(VRReport vrReport) {
		return vrReportPersistence.update(vrReport);
	}
	 ...
	 */
	public VRReportLocalService getVRReportLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRReport",
			vrReportLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRReport");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRReportLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrReportPersistence.getDataSource();
	...
	@BeanReference(type = VRReportLocalService.class)
	protected VRReportLocalService vrReportLocalService;
