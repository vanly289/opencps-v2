...
import com.fds.vr.business.service.ILVehicleLocalService;
...
/**
 * Provides the base implementation for the il vehicle local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.ILVehicleLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class ILVehicleLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements ILVehicleLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.ILVehicleLocalServiceUtil} to access the il vehicle local service.
	 */
	...
	public ILVehicle addILVehicle(ILVehicle ilVehicle) {
		...
		return ilVehiclePersistence.update(ilVehicle);
	}
	...
	public ILVehicle createILVehicle(long id) {
		return ilVehiclePersistence.create(id);
	}
	...
	public ILVehicle deleteILVehicle(long id) throws PortalException {
		return ilVehiclePersistence.remove(id);
	}
	...
	public ILVehicle deleteILVehicle(ILVehicle ilVehicle) {
		return ilVehiclePersistence.remove(ilVehicle);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ILVehicle.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ilVehiclePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return ilVehiclePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ilVehiclePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ILVehicle fetchILVehicle(long id) {
		return ilVehiclePersistence.fetchByPrimaryKey(id);
	}
	...
	public ILVehicle getILVehicle(long id) throws PortalException {
		return ilVehiclePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ilVehicleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ILVehicle.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ilVehicleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ILVehicle.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ilVehicleLocalService.deleteILVehicle((ILVehicle)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ilVehiclePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ILVehicle> getILVehicles(int start, int end) {
		return ilVehiclePersistence.findAll(start, end);
	}
	...
	public int getILVehiclesCount() {
		return ilVehiclePersistence.countAll();
	}
	 ...
	 */
	public ILVehicleLocalService getILVehicleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.ILVehicle",
			ilVehicleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.ILVehicle");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ILVehicleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ilVehiclePersistence.getDataSource();
	...
	@BeanReference(type = ILVehicleLocalService.class)
	protected ILVehicleLocalService ilVehicleLocalService;
