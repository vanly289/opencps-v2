...
public class VRVehicleRecordFinderImpl extends VRVehicleRecordFinderBaseImpl
	implements VRVehicleRecordFinder {

	Log _log = LogFactoryUtil.getLog(VRVehicleRecordFinderImpl.class);
