...
public class VRVehicleRecordFinderImpl extends VRVehicleRecordFinderBaseImpl implements VRVehicleRecordFinder {

	Log log = LogFactoryUtil.getLog(VRVehicleRecordFinderImpl.class);
	...
	public JSONArray findData(String sql, List<String> columnNames, List<String> dataTypes, Class<?> modelClazz,
		...
		try {
			...
			log.info("===>>>VRVehicleRecordFinder " + sql + "|" + start + "|" + end);
	...
	public long countData(String sql) throws SystemException {
		...
		try {
			...
			log.info("===>>>VRVehicleRecordFinder " + sql);
