...
import com.fds.vr.business.service.DossierLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.DossierLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.DossierLocalServiceImpl
 * @see com.fds.vr.business.service.DossierLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class DossierLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DossierLocalService, IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.DossierLocalServiceUtil} to access the dossier local service.
	 */
	...
	public Dossier fetchDossierByUuidAndGroupId(String uuid, long groupId) {
		return dossierPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(Dossier.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(Dossier.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<Dossier>() {
				@Override
				public void performAction(Dossier dossier)
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(Dossier.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierLocalService.deleteDossier((Dossier)persistedModel);
	}
	...
	public List<Dossier> getDossiersByUuidAndCompanyId(String uuid,
		long companyId) {
		return dossierPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<Dossier> getDossiersByUuidAndCompanyId(String uuid,
		...
		return dossierPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public Dossier getDossierByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return dossierPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	public DossierLocalService getDossierLocalService() {
	 ...
	 */
	public void setDossierLocalService(DossierLocalService dossierLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.Dossier",
			dossierLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.Dossier");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierLocalService.class.getName();
	}
	...
	@BeanReference(type = DossierLocalService.class)
	protected DossierLocalService dossierLocalService;
