...
import com.fds.vr.business.service.VRTemplateNoLocalService;
...
/**
 * Provides the base implementation for the vr template no local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTemplateNoLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRTemplateNoLocalServiceImpl
 * @see com.fds.vr.business.service.VRTemplateNoLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRTemplateNoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTemplateNoLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTemplateNoLocalServiceUtil} to access the vr template no local service.
	 */
	...
	public VRTemplateNo addVRTemplateNo(VRTemplateNo vrTemplateNo) {
		...
		return vrTemplateNoPersistence.update(vrTemplateNo);
	}
	...
	public VRTemplateNo createVRTemplateNo(long id) {
		return vrTemplateNoPersistence.create(id);
	}
	...
	public VRTemplateNo deleteVRTemplateNo(long id) throws PortalException {
		return vrTemplateNoPersistence.remove(id);
	}
	...
	public VRTemplateNo deleteVRTemplateNo(VRTemplateNo vrTemplateNo) {
		return vrTemplateNoPersistence.remove(vrTemplateNo);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTemplateNo.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTemplateNoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTemplateNoPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRTemplateNo fetchVRTemplateNo(long id) {
		return vrTemplateNoPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRTemplateNo getVRTemplateNo(long id) throws PortalException {
		return vrTemplateNoPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTemplateNoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTemplateNo.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTemplateNoLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTemplateNo.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTemplateNoLocalService.deleteVRTemplateNo((VRTemplateNo)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTemplateNoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRTemplateNo> getVRTemplateNos(int start, int end) {
		return vrTemplateNoPersistence.findAll(start, end);
	}
	...
	public int getVRTemplateNosCount() {
		return vrTemplateNoPersistence.countAll();
	}
	 ...
	 */
	public VRTemplateNoLocalService getVRTemplateNoLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTemplateNo",
			vrTemplateNoLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTemplateNo");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTemplateNoLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTemplateNoPersistence.getDataSource();
	...
	@BeanReference(type = VRTemplateNoLocalService.class)
	protected VRTemplateNoLocalService vrTemplateNoLocalService;
