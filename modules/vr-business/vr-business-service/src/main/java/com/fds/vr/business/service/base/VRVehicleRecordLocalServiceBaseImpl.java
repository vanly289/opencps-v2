...
import com.fds.vr.business.service.VRVehicleRecordLocalService;
...
/**
 * Provides the base implementation for the vr vehicle record local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRVehicleRecordLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRVehicleRecordLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRVehicleRecordLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRVehicleRecordLocalServiceUtil} to access the vr vehicle record local service.
	 */
	...
	public VRVehicleRecord createVRVehicleRecord(long id) {
		return vrVehicleRecordPersistence.create(id);
	}
	...
	public VRVehicleRecord deleteVRVehicleRecord(long id)
		...
		return vrVehicleRecordPersistence.remove(id);
	}
	...
	public VRVehicleRecord deleteVRVehicleRecord(
		...
		return vrVehicleRecordPersistence.remove(vrVehicleRecord);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRVehicleRecord.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrVehicleRecordPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrVehicleRecordPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRVehicleRecord fetchVRVehicleRecord(long id) {
		return vrVehicleRecordPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRVehicleRecord getVRVehicleRecord(long id)
		throws PortalException {
		return vrVehicleRecordPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrVehicleRecordLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRVehicleRecord.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrVehicleRecordLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRVehicleRecord.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrVehicleRecordLocalService.deleteVRVehicleRecord((VRVehicleRecord)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrVehicleRecordPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRVehicleRecord> getVRVehicleRecords(int start, int end) {
		return vrVehicleRecordPersistence.findAll(start, end);
	}
	...
	public int getVRVehicleRecordsCount() {
		return vrVehicleRecordPersistence.countAll();
	}
	 ...
	 */
	public VRVehicleRecordLocalService getVRVehicleRecordLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRVehicleRecord",
			vrVehicleRecordLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRVehicleRecord");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRVehicleRecordLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrVehicleRecordPersistence.getDataSource();
	...
	@BeanReference(type = VRVehicleRecordLocalService.class)
	protected VRVehicleRecordLocalService vrVehicleRecordLocalService;
