...
import com.fds.vr.business.service.VRInputStampbookLocalService;
...
/**
 * Provides the base implementation for the vr input stampbook local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRInputStampbookLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRInputStampbookLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRInputStampbookLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRInputStampbookLocalServiceUtil} to access the vr input stampbook local service.
	 */
	...
	public VRInputStampbook addVRInputStampbook(
		...
		return vrInputStampbookPersistence.update(vrInputStampbook);
	}
	...
	public VRInputStampbook createVRInputStampbook(long id) {
		return vrInputStampbookPersistence.create(id);
	}
	...
	public VRInputStampbook deleteVRInputStampbook(long id)
		...
		return vrInputStampbookPersistence.remove(id);
	}
	...
	public VRInputStampbook deleteVRInputStampbook(
		VRInputStampbook vrInputStampbook) {
		return vrInputStampbookPersistence.remove(vrInputStampbook);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRInputStampbook.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrInputStampbookPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrInputStampbookPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRInputStampbook fetchVRInputStampbook(long id) {
		return vrInputStampbookPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRInputStampbook getVRInputStampbook(long id)
		throws PortalException {
		return vrInputStampbookPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrInputStampbookLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRInputStampbook.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrInputStampbookLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRInputStampbook.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrInputStampbookLocalService.deleteVRInputStampbook((VRInputStampbook)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrInputStampbookPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRInputStampbook> getVRInputStampbooks(int start, int end) {
		return vrInputStampbookPersistence.findAll(start, end);
	}
	...
	public int getVRInputStampbooksCount() {
		return vrInputStampbookPersistence.countAll();
	}
	 ...
	 */
	public VRInputStampbookLocalService getVRInputStampbookLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRInputStampbook",
			vrInputStampbookLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRInputStampbook");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRInputStampbookLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrInputStampbookPersistence.getDataSource();
	...
	@BeanReference(type = VRInputStampbookLocalService.class)
	protected VRInputStampbookLocalService vrInputStampbookLocalService;
