...
import com.fds.vr.business.service.VRTechnicalSpec_XCGPart5LocalService;
...
/**
 * Provides the base implementation for the vr technical spec_xcg part5 local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart5LocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart5LocalServiceImpl
 * @see com.fds.vr.business.service.VRTechnicalSpec_XCGPart5LocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRTechnicalSpec_XCGPart5LocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRTechnicalSpec_XCGPart5LocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRTechnicalSpec_XCGPart5LocalServiceUtil} to access the vr technical spec_xcg part5 local service.
	 */
	...
	@Override
	public VRTechnicalSpec_XCGPart5 addVRTechnicalSpec_XCGPart5(
		VRTechnicalSpec_XCGPart5 vrTechnicalSpec_XCGPart5) {
		vrTechnicalSpec_XCGPart5.setNew(true);

		return vrTechnicalSpec_XCGPart5Persistence.update(vrTechnicalSpec_XCGPart5);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCGPart5 createVRTechnicalSpec_XCGPart5(long id) {
		return vrTechnicalSpec_XCGPart5Persistence.create(id);
	}
	...
	@Override
	public VRTechnicalSpec_XCGPart5 deleteVRTechnicalSpec_XCGPart5(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart5Persistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRTechnicalSpec_XCGPart5 deleteVRTechnicalSpec_XCGPart5(
		VRTechnicalSpec_XCGPart5 vrTechnicalSpec_XCGPart5) {
		return vrTechnicalSpec_XCGPart5Persistence.remove(vrTechnicalSpec_XCGPart5);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRTechnicalSpec_XCGPart5.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart5Persistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrTechnicalSpec_XCGPart5Persistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRTechnicalSpec_XCGPart5 fetchVRTechnicalSpec_XCGPart5(long id) {
		return vrTechnicalSpec_XCGPart5Persistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VRTechnicalSpec_XCGPart5 getVRTechnicalSpec_XCGPart5(long id)
		throws PortalException {
		return vrTechnicalSpec_XCGPart5Persistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart5LocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart5.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrTechnicalSpec_XCGPart5LocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRTechnicalSpec_XCGPart5.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrTechnicalSpec_XCGPart5LocalService.deleteVRTechnicalSpec_XCGPart5((VRTechnicalSpec_XCGPart5)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrTechnicalSpec_XCGPart5Persistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRTechnicalSpec_XCGPart5> getVRTechnicalSpec_XCGPart5s(
		int start, int end) {
		return vrTechnicalSpec_XCGPart5Persistence.findAll(start, end);
	}
	...
	public int getVRTechnicalSpec_XCGPart5sCount() {
		return vrTechnicalSpec_XCGPart5Persistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRTechnicalSpec_XCGPart5 updateVRTechnicalSpec_XCGPart5(
		VRTechnicalSpec_XCGPart5 vrTechnicalSpec_XCGPart5) {
		return vrTechnicalSpec_XCGPart5Persistence.update(vrTechnicalSpec_XCGPart5);
	}
	 ...
	 */
	public VRTechnicalSpec_XCGPart5LocalService getVRTechnicalSpec_XCGPart5LocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRTechnicalSpec_XCGPart5",
			vrTechnicalSpec_XCGPart5LocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRTechnicalSpec_XCGPart5");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRTechnicalSpec_XCGPart5LocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrTechnicalSpec_XCGPart5Persistence.getDataSource();
	...
	@BeanReference(type = VRTechnicalSpec_XCGPart5LocalService.class)
	protected VRTechnicalSpec_XCGPart5LocalService vrTechnicalSpec_XCGPart5LocalService;
