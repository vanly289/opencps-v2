...
import com.fds.vr.business.service.ILCertificateLocalService;
...
/**
 * Provides the base implementation for the il certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.ILCertificateLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class ILCertificateLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ILCertificateLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.ILCertificateLocalServiceUtil} to access the il certificate local service.
	 */
	...
	public ILCertificate addILCertificate(ILCertificate ilCertificate) {
		...
		return ilCertificatePersistence.update(ilCertificate);
	}
	...
	public ILCertificate createILCertificate(long id) {
		return ilCertificatePersistence.create(id);
	}
	...
	public ILCertificate deleteILCertificate(long id) throws PortalException {
		return ilCertificatePersistence.remove(id);
	}
	...
	public ILCertificate deleteILCertificate(ILCertificate ilCertificate) {
		return ilCertificatePersistence.remove(ilCertificate);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ILCertificate.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return ilCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return ilCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ILCertificate fetchILCertificate(long id) {
		return ilCertificatePersistence.fetchByPrimaryKey(id);
	}
	...
	public ILCertificate getILCertificate(long id) throws PortalException {
		return ilCertificatePersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(ilCertificateLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ILCertificate.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(ilCertificateLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ILCertificate.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return ilCertificateLocalService.deleteILCertificate((ILCertificate)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return ilCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ILCertificate> getILCertificates(int start, int end) {
		return ilCertificatePersistence.findAll(start, end);
	}
	...
	public int getILCertificatesCount() {
		return ilCertificatePersistence.countAll();
	}
	 ...
	 */
	public ILCertificateLocalService getILCertificateLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.ILCertificate",
			ilCertificateLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.ILCertificate");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ILCertificateLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = ilCertificatePersistence.getDataSource();
	...
	@BeanReference(type = ILCertificateLocalService.class)
	protected ILCertificateLocalService ilCertificateLocalService;
