...
import com.fds.vr.business.service.VRVehicleEquipmentLocalService;
...
/**
 * Provides the base implementation for the vr vehicle equipment local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRVehicleEquipmentLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 ...
 */
@ProviderType
public abstract class VRVehicleEquipmentLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRVehicleEquipmentLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRVehicleEquipmentLocalServiceUtil} to access the vr vehicle equipment local service.
	 */
	...
	public VRVehicleEquipment addVRVehicleEquipment(
		...
		return vrVehicleEquipmentPersistence.update(vrVehicleEquipment);
	}
	...
	public VRVehicleEquipment createVRVehicleEquipment(long id) {
		return vrVehicleEquipmentPersistence.create(id);
	}
	...
	public VRVehicleEquipment deleteVRVehicleEquipment(long id)
		...
		return vrVehicleEquipmentPersistence.remove(id);
	}
	...
	public VRVehicleEquipment deleteVRVehicleEquipment(
		VRVehicleEquipment vrVehicleEquipment) {
		return vrVehicleEquipmentPersistence.remove(vrVehicleEquipment);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRVehicleEquipment.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrVehicleEquipmentPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrVehicleEquipmentPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public VRVehicleEquipment fetchVRVehicleEquipment(long id) {
		return vrVehicleEquipmentPersistence.fetchByPrimaryKey(id);
	}
	...
	public VRVehicleEquipment getVRVehicleEquipment(long id)
		throws PortalException {
		return vrVehicleEquipmentPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrVehicleEquipmentLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRVehicleEquipment.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrVehicleEquipmentLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRVehicleEquipment.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrVehicleEquipmentLocalService.deleteVRVehicleEquipment((VRVehicleEquipment)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrVehicleEquipmentPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<VRVehicleEquipment> getVRVehicleEquipments(int start, int end) {
		return vrVehicleEquipmentPersistence.findAll(start, end);
	}
	...
	public int getVRVehicleEquipmentsCount() {
		return vrVehicleEquipmentPersistence.countAll();
	}
	 ...
	 */
	public VRVehicleEquipmentLocalService getVRVehicleEquipmentLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRVehicleEquipment",
			vrVehicleEquipmentLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRVehicleEquipment");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRVehicleEquipmentLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrVehicleEquipmentPersistence.getDataSource();
	...
	@BeanReference(type = VRVehicleEquipmentLocalService.class)
	protected VRVehicleEquipmentLocalService vrVehicleEquipmentLocalService;
