...
import com.fds.vr.business.service.VRCFGStandardLocalService;
...
/**
 * Provides the base implementation for the vrcfg standard local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.fds.vr.business.service.impl.VRCFGStandardLocalServiceImpl}.
 * </p>
 *
 * @author LamTV
 * @see com.fds.vr.business.service.impl.VRCFGStandardLocalServiceImpl
 * @see com.fds.vr.business.service.VRCFGStandardLocalServiceUtil
 * @generated
 */
@ProviderType
public abstract class VRCFGStandardLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VRCFGStandardLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.fds.vr.business.service.VRCFGStandardLocalServiceUtil} to access the vrcfg standard local service.
	 */

	/**
	 * Adds the vrcfg standard to the database. Also notifies the appropriate model listeners.
	 *
	 * @param vrcfgStandard the vrcfg standard
	 * @return the vrcfg standard that was added
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRCFGStandard addVRCFGStandard(VRCFGStandard vrcfgStandard) {
		vrcfgStandard.setNew(true);

		return vrcfgStandardPersistence.update(vrcfgStandard);
	}
	 ...
	 */
	@Override
	public VRCFGStandard createVRCFGStandard(long id) {
		return vrcfgStandardPersistence.create(id);
	}

	/**
	 * Deletes the vrcfg standard with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param id the primary key of the vrcfg standard
	 * @return the vrcfg standard that was removed
	 * @throws PortalException if a vrcfg standard with the primary key could not be found
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRCFGStandard deleteVRCFGStandard(long id) throws PortalException {
		return vrcfgStandardPersistence.remove(id);
	}

	/**
	 * Deletes the vrcfg standard from the database. Also notifies the appropriate model listeners.
	 *
	 * @param vrcfgStandard the vrcfg standard
	 * @return the vrcfg standard that was removed
	 */
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VRCFGStandard deleteVRCFGStandard(VRCFGStandard vrcfgStandard) {
		return vrcfgStandardPersistence.remove(vrcfgStandard);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VRCFGStandard.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return vrcfgStandardPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return vrcfgStandardPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VRCFGStandard fetchVRCFGStandard(long id) {
		return vrcfgStandardPersistence.fetchByPrimaryKey(id);
	}

	/**
	 * Returns the vrcfg standard with the primary key.
	 *
	 * @param id the primary key of the vrcfg standard
	 ...
	 */
	@Override
	public VRCFGStandard getVRCFGStandard(long id) throws PortalException {
		return vrcfgStandardPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(vrcfgStandardLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(VRCFGStandard.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(vrcfgStandardLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(VRCFGStandard.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return vrcfgStandardLocalService.deleteVRCFGStandard((VRCFGStandard)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return vrcfgStandardPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VRCFGStandard> getVRCFGStandards(int start, int end) {
		return vrcfgStandardPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVRCFGStandardsCount() {
		return vrcfgStandardPersistence.countAll();
	}

	/**
	 * Updates the vrcfg standard in the database or adds it if it does not yet exist. Also notifies the appropriate model listeners.
	 *
	 * @param vrcfgStandard the vrcfg standard
	 * @return the vrcfg standard that was updated
	 */
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VRCFGStandard updateVRCFGStandard(VRCFGStandard vrcfgStandard) {
		return vrcfgStandardPersistence.update(vrcfgStandard);
	}
	 ...
	 */
	public VRCFGStandardLocalService getVRCFGStandardLocalService() {
	...
	public void setVRCFGStandardLocalService(
		VRCFGStandardLocalService vrcfgStandardLocalService) {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("com.fds.vr.business.model.VRCFGStandard",
			vrcfgStandardLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"com.fds.vr.business.model.VRCFGStandard");
	}
	...
	public String getOSGiServiceIdentifier() {
		return VRCFGStandardLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = vrcfgStandardPersistence.getDataSource();
	...
	@BeanReference(type = VRCFGStandardLocalService.class)
	protected VRCFGStandardLocalService vrcfgStandardLocalService;
