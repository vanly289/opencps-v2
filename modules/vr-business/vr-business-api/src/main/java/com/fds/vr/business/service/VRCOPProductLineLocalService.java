...
/**
 * Provides the local service interface for VRCOPProductLine. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRCOPProductLineLocalServiceUtil
...
public interface VRCOPProductLineLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRCOPProductLineLocalServiceUtil} to access the vrcop product line local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRCOPProductLineLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public VRCOPProductLine updateCOPProductLine(
