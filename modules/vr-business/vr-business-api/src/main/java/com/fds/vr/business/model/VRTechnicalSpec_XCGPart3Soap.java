 ...
 */
@ProviderType
public class VRTechnicalSpec_XCGPart3Soap implements Serializable {
	public static VRTechnicalSpec_XCGPart3Soap toSoapModel(
		VRTechnicalSpec_XCGPart3 model) {
		VRTechnicalSpec_XCGPart3Soap soapModel = new VRTechnicalSpec_XCGPart3Soap();
	...
	public static VRTechnicalSpec_XCGPart3Soap[] toSoapModels(
		VRTechnicalSpec_XCGPart3[] models) {
		VRTechnicalSpec_XCGPart3Soap[] soapModels = new VRTechnicalSpec_XCGPart3Soap[models.length];
	...
	public static VRTechnicalSpec_XCGPart3Soap[][] toSoapModels(
		VRTechnicalSpec_XCGPart3[][] models) {
		VRTechnicalSpec_XCGPart3Soap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new VRTechnicalSpec_XCGPart3Soap[models.length][models[0].length];
		}
		else {
			soapModels = new VRTechnicalSpec_XCGPart3Soap[0][0];
		}
	...
	public static VRTechnicalSpec_XCGPart3Soap[] toSoapModels(
		List<VRTechnicalSpec_XCGPart3> models) {
		List<VRTechnicalSpec_XCGPart3Soap> soapModels = new ArrayList<VRTechnicalSpec_XCGPart3Soap>(models.size());

		for (VRTechnicalSpec_XCGPart3 model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new VRTechnicalSpec_XCGPart3Soap[soapModels.size()]);
	}

	public VRTechnicalSpec_XCGPart3Soap() {
	}
