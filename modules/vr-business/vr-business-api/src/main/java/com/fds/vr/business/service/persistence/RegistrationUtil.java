 ...
 * @see com.fds.vr.business.service.persistence.impl.RegistrationPersistenceImpl
 * @generated
 */
@ProviderType
public class RegistrationUtil {
	...
	*/
	public static Registration findByUuid_First(java.lang.String uuid,
		OrderByComparator<Registration> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchRegistrationException {
	...
	* @throws NoSuchRegistrationException if a matching registration could not be found
	*/
	public static Registration findByREG_APPNO(java.lang.String applicantIdNo)
		throws com.fds.vr.business.exception.NoSuchRegistrationException {
	...
	* @return the matching registration, or <code>null</code> if a matching registration could not be found
	*/
	public static Registration fetchByREG_APPNO(java.lang.String applicantIdNo) {
	...
	* @return the matching registration, or <code>null</code> if a matching registration could not be found
	*/
	public static Registration fetchByREG_APPNO(
	...
	* @return the registration that was removed
	*/
	public static Registration removeByREG_APPNO(java.lang.String applicantIdNo)
		throws com.fds.vr.business.exception.NoSuchRegistrationException {
	...
	* @return the matching registrations
	*/
	public static List<Registration> findByREG_APPNO_markasdeleted(
	...
	* @throws NoSuchRegistrationException if a matching registration could not be found
	*/
	public static Registration findByREG_APPNO_markasdeleted_First(
		long groupId, java.lang.String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchRegistrationException {
		return getPersistence()
	...
	* @return the first matching registration, or <code>null</code> if a matching registration could not be found
	*/
	public static Registration fetchByREG_APPNO_markasdeleted_First(
		long groupId, java.lang.String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchRegistrationException if a matching registration could not be found
	*/
	public static Registration findByREG_APPNO_markasdeleted_Last(
		long groupId, java.lang.String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchRegistrationException {
		return getPersistence()
	...
	* @return the last matching registration, or <code>null</code> if a matching registration could not be found
	*/
	public static Registration fetchByREG_APPNO_markasdeleted_Last(
		long groupId, java.lang.String applicantIdNo, int markasdeleted,
		OrderByComparator<Registration> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchRegistrationException if a registration with the primary key could not be found
	*/
	public static Registration[] findByREG_APPNO_markasdeleted_PrevAndNext(
		long registrationId, long groupId, java.lang.String applicantIdNo,
