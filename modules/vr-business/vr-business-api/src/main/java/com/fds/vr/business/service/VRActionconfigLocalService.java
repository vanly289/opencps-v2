...
/**
 * Provides the local service interface for VRActionconfig. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRActionconfigLocalServiceUtil
...
public interface VRActionconfigLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRActionconfigLocalServiceUtil} to access the vr actionconfig local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRActionconfigLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
