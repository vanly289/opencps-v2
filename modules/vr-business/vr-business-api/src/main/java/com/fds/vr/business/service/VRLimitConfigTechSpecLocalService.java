...
/**
 * Provides the local service interface for VRLimitConfigTechSpec. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRLimitConfigTechSpecLocalServiceUtil
...
public interface VRLimitConfigTechSpecLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRLimitConfigTechSpecLocalServiceUtil} to access the vr limit config tech spec local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRLimitConfigTechSpecLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VRLimitConfigTechSpec> getLimitConfigs(
		java.lang.String vehicleType, java.lang.String markupSMRM,
		long searchingDriveConfig) throws PortalException, SystemException;
