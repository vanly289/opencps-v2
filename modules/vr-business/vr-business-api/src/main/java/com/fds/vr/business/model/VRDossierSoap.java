 ...
 */
@ProviderType
public class VRDossierSoap implements Serializable {
	public static VRDossierSoap toSoapModel(VRDossier model) {
		VRDossierSoap soapModel = new VRDossierSoap();
	...
	public static VRDossierSoap[] toSoapModels(VRDossier[] models) {
		VRDossierSoap[] soapModels = new VRDossierSoap[models.length];
	...
	public static VRDossierSoap[][] toSoapModels(VRDossier[][] models) {
		VRDossierSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new VRDossierSoap[models.length][models[0].length];
		}
		else {
			soapModels = new VRDossierSoap[0][0];
		}
	...
	public static VRDossierSoap[] toSoapModels(List<VRDossier> models) {
		List<VRDossierSoap> soapModels = new ArrayList<VRDossierSoap>(models.size());

		for (VRDossier model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new VRDossierSoap[soapModels.size()]);
	}

	public VRDossierSoap() {
	}
