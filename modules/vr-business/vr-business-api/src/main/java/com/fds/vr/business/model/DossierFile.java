 ...
 * @see com.fds.vr.business.model.impl.DossierFileImpl
 * @see com.fds.vr.business.model.impl.DossierFileModelImpl
 * @generated
 */
@ImplementationClassName("com.fds.vr.business.model.impl.DossierFileImpl")
@ProviderType
public interface DossierFile extends DossierFileModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.fds.vr.business.model.impl.DossierFileImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
