...
public class ILVehicleLocalServiceWrapper implements ILVehicleLocalService,
	...
	*/
	...
	@Override
	public com.fds.vr.business.model.ILVehicle capNhatVehicle(
		com.liferay.portal.kernel.json.JSONObject jsonData,
		java.lang.String issuingDispatchNo) {
		return _ilVehicleLocalService.capNhatVehicle(jsonData, issuingDispatchNo);
	}
	...
	*/
	...
	@Override
	public com.fds.vr.business.model.ILVehicle getByRegistrationNumber(
		java.lang.String registrationNumber) {
		return _ilVehicleLocalService.getByRegistrationNumber(registrationNumber);
	}
