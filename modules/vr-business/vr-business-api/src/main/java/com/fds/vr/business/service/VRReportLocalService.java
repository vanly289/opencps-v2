...
/**
 * Provides the local service interface for VRReport. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRReportLocalServiceUtil
...
public interface VRReportLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRReportLocalServiceUtil} to access the vr report local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRReportLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VRReport getReport(java.lang.String reportCode)
