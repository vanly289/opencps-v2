...
/**
 * Provides the local service utility for VRCOPProductClassification. This utility wraps
 * {@link com.fds.vr.business.service.impl.VRCOPProductClassificationLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class VRCOPProductClassificationLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.fds.vr.business.service.impl.VRCOPProductClassificationLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.fds.vr.business.model.VRCOPProductClassification addVRCOPProductClassification(
		com.fds.vr.business.model.VRCOPProductClassification vrcopProductClassification) {
		return getService()
				   .addVRCOPProductClassification(vrcopProductClassification);
	}
	...
	*/
	public static com.fds.vr.business.model.VRCOPProductClassification createVRCOPProductClassification(
		long id) {
		return getService().createVRCOPProductClassification(id);
	}
	...
	*/
	public static com.fds.vr.business.model.VRCOPProductClassification deleteVRCOPProductClassification(
		com.fds.vr.business.model.VRCOPProductClassification vrcopProductClassification) {
		return getService()
				   .deleteVRCOPProductClassification(vrcopProductClassification);
	}
	...
	*/
	public static com.fds.vr.business.model.VRCOPProductClassification deleteVRCOPProductClassification(
		...
		return getService().deleteVRCOPProductClassification(id);
	}

	public static com.fds.vr.business.model.VRCOPProductClassification fetchVRCOPProductClassification(
		long id) {
		return getService().fetchVRCOPProductClassification(id);
	}
	...
	* @throws PortalException if a vrcop product classification with the primary key could not be found
	*/
	public static com.fds.vr.business.model.VRCOPProductClassification getVRCOPProductClassification(
		long id) throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.fds.vr.business.model.VRCOPProductClassification updateVRCOPProductClassification(
		com.fds.vr.business.model.VRCOPProductClassification vrcopProductClassification) {
		return getService()
				   .updateVRCOPProductClassification(vrcopProductClassification);
	}
	...
	*/
	public static int getVRCOPProductClassificationsCount() {
		return getService().getVRCOPProductClassificationsCount();
	}
	...
	*/
	...
	public static java.util.List<com.fds.vr.business.model.VRCOPProductClassification> findBycopReportNo(
	...
	public static java.util.List<com.fds.vr.business.model.VRCOPProductClassification> findBycopReportRepositoryID(
	...
	*/
	public static java.util.List<com.fds.vr.business.model.VRCOPProductClassification> getVRCOPProductClassifications(
		int start, int end) {
		return getService().getVRCOPProductClassifications(start, end);
	}
	...
	*/
	...
	public static VRCOPProductClassificationLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<VRCOPProductClassificationLocalService, VRCOPProductClassificationLocalService> _serviceTracker =
		ServiceTrackerFactory.open(VRCOPProductClassificationLocalService.class);
}