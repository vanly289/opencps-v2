...
/**
 * Provides the local service interface for VRProductionPlantEquipmentMarkup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRProductionPlantEquipmentMarkupLocalServiceUtil
...
public interface VRProductionPlantEquipmentMarkupLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRProductionPlantEquipmentMarkupLocalServiceUtil} to access the vr production plant equipment markup local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRProductionPlantEquipmentMarkupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
