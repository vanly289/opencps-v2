...
/**
 * This class is used by SOAP remote services, specifically {@link com.fds.vr.business.service.http.ILCertificateServiceSoap}.
 *
 * @author LamTV
 * @see com.fds.vr.business.service.http.ILCertificateServiceSoap
 * @generated
 */
@ProviderType
public class ILCertificateSoap implements Serializable {
	public static ILCertificateSoap toSoapModel(ILCertificate model) {
		...
		soapModel.setToTQAuthority(model.getToTQAuthority());
		soapModel.setFirstRegistrationDate(model.getFirstRegistrationDate());
		soapModel.setIssuedDate(model.getIssuedDate());
		soapModel.setIsFixedRoadTransport(model.getIsFixedRoadTransport());
		soapModel.setIsPassengerTaxi(model.getIsPassengerTaxi());
		soapModel.setIsCargoTransport(model.getIsCargoTransport());
		soapModel.setIsPassengerTransport(model.getIsPassengerTransport());
		soapModel.setIsContractRoadTransport(model.getIsContractRoadTransport());
		soapModel.setFromParkingLotCode(model.getFromParkingLotCode());
		soapModel.setToParkingLotCode(model.getToParkingLotCode());
		soapModel.setRouteCode(model.getRouteCode());
		soapModel.setRouteName(model.getRouteName());
		soapModel.setFromBorderGate(model.getFromBorderGate());
		soapModel.setToBorderGate(model.getToBorderGate());
		...
		soapModel.setOtherRemarks(model.getOtherRemarks());
		soapModel.setDossierNo(model.getDossierNo());
		soapModel.setPhuongtienid(model.getPhuongtienid());
	...
	public String getToTQAuthority() {
		return _toTQAuthority;
	}

	public void setToTQAuthority(String toTQAuthority) {
		_toTQAuthority = toTQAuthority;
	}
	...
	public String getIsFixedRoadTransport() {
		return _IsFixedRoadTransport;
	}

	public void setIsFixedRoadTransport(String IsFixedRoadTransport) {
		_IsFixedRoadTransport = IsFixedRoadTransport;
	}

	public String getIsPassengerTaxi() {
		return _IsPassengerTaxi;
	}

	public void setIsPassengerTaxi(String IsPassengerTaxi) {
		_IsPassengerTaxi = IsPassengerTaxi;
	}

	public String getIsCargoTransport() {
		return _IsCargoTransport;
	}

	public void setIsCargoTransport(String IsCargoTransport) {
		_IsCargoTransport = IsCargoTransport;
	}

	public String getIsPassengerTransport() {
		return _IsPassengerTransport;
	}

	public void setIsPassengerTransport(String IsPassengerTransport) {
		_IsPassengerTransport = IsPassengerTransport;
	}

	public String getIsContractRoadTransport() {
		return _IsContractRoadTransport;
	}

	public void setIsContractRoadTransport(String IsContractRoadTransport) {
		_IsContractRoadTransport = IsContractRoadTransport;
	}

	public String getFromParkingLotCode() {
		return _FromParkingLotCode;
	}

	public void setFromParkingLotCode(String FromParkingLotCode) {
		_FromParkingLotCode = FromParkingLotCode;
	}

	public String getToParkingLotCode() {
		return _ToParkingLotCode;
	}

	public void setToParkingLotCode(String ToParkingLotCode) {
		_ToParkingLotCode = ToParkingLotCode;
	}
	...
	public String getFromBorderGate() {
		return _FromBorderGate;
	}

	public void setFromBorderGate(String FromBorderGate) {
		_FromBorderGate = FromBorderGate;
	}

	public String getToBorderGate() {
		return _ToBorderGate;
	}

	public void setToBorderGate(String ToBorderGate) {
		_ToBorderGate = ToBorderGate;
	}
	...
	public long getPhuongtienid() {
		return _phuongtienid;
	}

	public void setPhuongtienid(long phuongtienid) {
		_phuongtienid = phuongtienid;
	}
	...
	private String _toTQAuthority;
	private Date _FirstRegistrationDate;
	private Date _IssuedDate;
	private String _IsFixedRoadTransport;
	private String _IsPassengerTaxi;
	private String _IsCargoTransport;
	private String _IsPassengerTransport;
	private String _IsContractRoadTransport;
	private String _FromParkingLotCode;
	private String _ToParkingLotCode;
	private String _RouteCode;
	private String _RouteName;
	private String _FromBorderGate;
	private String _ToBorderGate;
