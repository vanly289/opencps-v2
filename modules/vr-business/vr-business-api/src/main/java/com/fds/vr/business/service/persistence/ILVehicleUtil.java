...
public class ILVehicleUtil {
	...
	*/
	...
	/**
	* Returns the il vehicle where registrationNumber = &#63; or throws a {@link NoSuchILVehicleException} if it could not be found.
	*
	* @param registrationNumber the registration number
	* @return the matching il vehicle
	* @throws NoSuchILVehicleException if a matching il vehicle could not be found
	*/
	public static ILVehicle findByF_RN(java.lang.String registrationNumber)
		throws com.fds.vr.business.exception.NoSuchILVehicleException {
		return getPersistence().findByF_RN(registrationNumber);
	}

	/**
	* Returns the il vehicle where registrationNumber = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param registrationNumber the registration number
	* @return the matching il vehicle, or <code>null</code> if a matching il vehicle could not be found
	*/
	public static ILVehicle fetchByF_RN(java.lang.String registrationNumber) {
		return getPersistence().fetchByF_RN(registrationNumber);
	}

	/**
	* Returns the il vehicle where registrationNumber = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param registrationNumber the registration number
	* @param retrieveFromCache whether to retrieve from the finder cache
	* @return the matching il vehicle, or <code>null</code> if a matching il vehicle could not be found
	*/
	public static ILVehicle fetchByF_RN(java.lang.String registrationNumber,
		boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByF_RN(registrationNumber, retrieveFromCache);
	}

	/**
	* Removes the il vehicle where registrationNumber = &#63; from the database.
	*
	* @param registrationNumber the registration number
	* @return the il vehicle that was removed
	*/
	public static ILVehicle removeByF_RN(java.lang.String registrationNumber)
		throws com.fds.vr.business.exception.NoSuchILVehicleException {
		return getPersistence().removeByF_RN(registrationNumber);
	}

	/**
	* Returns the number of il vehicles where registrationNumber = &#63;.
	*
	* @param registrationNumber the registration number
	* @return the number of matching il vehicles
	*/
	public static int countByF_RN(java.lang.String registrationNumber) {
		return getPersistence().countByF_RN(registrationNumber);
	}
