 ...
 */
@ProviderType
public class VRRegistrationSoap implements Serializable {
	public static VRRegistrationSoap toSoapModel(VRRegistration model) {
		VRRegistrationSoap soapModel = new VRRegistrationSoap();
	...
	public static VRRegistrationSoap[] toSoapModels(VRRegistration[] models) {
		VRRegistrationSoap[] soapModels = new VRRegistrationSoap[models.length];
	...
	public static VRRegistrationSoap[][] toSoapModels(VRRegistration[][] models) {
		VRRegistrationSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new VRRegistrationSoap[models.length][models[0].length];
		}
		else {
			soapModels = new VRRegistrationSoap[0][0];
		}
	...
	public static VRRegistrationSoap[] toSoapModels(List<VRRegistration> models) {
		List<VRRegistrationSoap> soapModels = new ArrayList<VRRegistrationSoap>(models.size());

		for (VRRegistration model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new VRRegistrationSoap[soapModels.size()]);
	}

	public VRRegistrationSoap() {
	}
