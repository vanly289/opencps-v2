...
/**
 * Provides the local service interface for VRTechnicalSpec_XCGPart4. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRTechnicalSpec_XCGPart4LocalServiceUtil
...
public interface VRTechnicalSpec_XCGPart4LocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRTechnicalSpec_XCGPart4LocalServiceUtil} to access the vr technical spec_xcg part4 local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCGPart4LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<VRTechnicalSpec_XCGPart4> findByDossierNo(
	...
	public List<VRTechnicalSpec_XCGPart4> findByVehicleCertificateId(
