...
/**
 * Provides the local service interface for VRCOPProdEquipment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRCOPProdEquipmentLocalServiceUtil
...
public interface VRCOPProdEquipmentLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRCOPProdEquipmentLocalServiceUtil} to access the vrcop prod equipment local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRCOPProdEquipmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public VRCOPProdEquipment updateCOPProdEquipment(
