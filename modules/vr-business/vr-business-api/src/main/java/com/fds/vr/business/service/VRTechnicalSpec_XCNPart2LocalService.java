...
/**
 * Provides the local service interface for VRTechnicalSpec_XCNPart2. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRTechnicalSpec_XCNPart2LocalServiceUtil
...
public interface VRTechnicalSpec_XCNPart2LocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRTechnicalSpec_XCNPart2LocalServiceUtil} to access the vr technical spec_xcn part2 local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCNPart2LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<VRTechnicalSpec_XCNPart2> findByDossierNo(
	...
	public List<VRTechnicalSpec_XCNPart2> findByVehicleCertificateId(
