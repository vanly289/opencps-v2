...
/**
 * Provides the local service interface for VRTechnicalSpec_XCN. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRTechnicalSpec_XCNLocalServiceUtil
...
public interface VRTechnicalSpec_XCNLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRTechnicalSpec_XCNLocalServiceUtil} to access the vr technical spec_xcn local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XCNLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<VRTechnicalSpec_XCN> adminProcessData(JSONArray arrayData,
	...
	*/
	...
	public List<VRTechnicalSpec_XCN> findByDossierIdCTN(
		java.lang.String dossierIdCTN) throws SystemException;

	public List<VRTechnicalSpec_XCN> findByDossierNo(
