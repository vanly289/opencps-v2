...
public class ILVehicleCustomsBorderGuardLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<com.fds.vr.business.model.ILVehicleCustomsBorderGuard> getBorderGuardList(
		...
		return getService().getBorderGuardList(registrationNumber, start, end);
	}
	...
	*/
	...
	public static long countBorderGuardList(java.lang.String registrationNumber) {
		return getService().countBorderGuardList(registrationNumber);
	}
