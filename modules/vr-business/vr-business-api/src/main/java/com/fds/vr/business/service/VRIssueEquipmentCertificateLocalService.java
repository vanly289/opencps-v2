...
/**
 * Provides the local service interface for VRIssueEquipmentCertificate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRIssueEquipmentCertificateLocalServiceUtil
...
public interface VRIssueEquipmentCertificateLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRIssueEquipmentCertificateLocalServiceUtil} to access the vr issue equipment certificate local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRIssueEquipmentCertificateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
