...
/**
 * Provides the local service interface for VRCertificateProgressFile. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRCertificateProgressFileLocalServiceUtil
...
public interface VRCertificateProgressFileLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRCertificateProgressFileLocalServiceUtil} to access the vr certificate progress file local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRCertificateProgressFileLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
