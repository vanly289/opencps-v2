...
/**
 * Provides the local service interface for VRTechnicalSpec_XMYPart3. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRTechnicalSpec_XMYPart3LocalServiceUtil
...
public interface VRTechnicalSpec_XMYPart3LocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRTechnicalSpec_XMYPart3LocalServiceUtil} to access the vr technical spec_xmy part3 local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRTechnicalSpec_XMYPart3LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<VRTechnicalSpec_XMYPart3> findByDossierNo(
	...
	public List<VRTechnicalSpec_XMYPart3> findByVehicleCertificateId(
