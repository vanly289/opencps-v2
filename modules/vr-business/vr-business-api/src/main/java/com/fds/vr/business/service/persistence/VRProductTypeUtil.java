...
public class VRProductTypeUtil {
	...
	*/
	public static List<VRProductType> findByproductPlantID(long mtCore,
		long productPlantID) {
	...
	*/
	public static VRProductType findByproductPlantID_First(long mtCore,
	...
	*/
	public static VRProductType fetchByproductPlantID_First(long mtCore,
		long productPlantID, OrderByComparator<VRProductType> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchVRProductTypeException if a matching vr product type could not be found
	*/
	public static VRProductType findByproductPlantID_Last(long mtCore,
		long productPlantID, OrderByComparator<VRProductType> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchVRProductTypeException {
		return getPersistence()
	...
	*/
	public static VRProductType fetchByproductPlantID_Last(long mtCore,
		long productPlantID, OrderByComparator<VRProductType> orderByComparator) {
		return getPersistence()
	...
	*/
	public static VRProductType[] findByproductPlantID_PrevAndNext(long id,
