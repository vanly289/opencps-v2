...
/**
 * This class is used by SOAP remote services, specifically {@link com.fds.vr.business.service.http.VRInputStampbookDetailsServiceSoap}.
 *
 * @author LamTV
 * @see com.fds.vr.business.service.http.VRInputStampbookDetailsServiceSoap
 * @generated
 */
@ProviderType
public class VRInputStampbookDetailsSoap implements Serializable {
	public static VRInputStampbookDetailsSoap toSoapModel(
		...
		soapModel.set___No(model.get___No());
	...
	public String get___No() {
		return ____No;
	}

	public void set___No(String ___No) {
		____No = ___No;
	}
