...
/**
 * Provides the local service interface for VRDossier. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRDossierLocalServiceUtil
...
public interface VRDossierLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRDossierLocalServiceUtil} to access the vr dossier local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRDossierLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VRDossier getVRDossierByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VRDossier> getVRDossiersByUuidAndCompanyId(
