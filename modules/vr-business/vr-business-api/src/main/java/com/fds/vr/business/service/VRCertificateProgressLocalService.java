...
/**
 * Provides the local service interface for VRCertificateProgress. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRCertificateProgressLocalServiceUtil
...
public interface VRCertificateProgressLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRCertificateProgressLocalServiceUtil} to access the vr certificate progress local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRCertificateProgressLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
