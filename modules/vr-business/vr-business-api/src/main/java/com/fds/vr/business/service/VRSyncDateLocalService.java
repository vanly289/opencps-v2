...
/**
 * Provides the local service interface for VRSyncDate. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author LamTV
 * @see VRSyncDateLocalServiceUtil
...
public interface VRSyncDateLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRSyncDateLocalServiceUtil} to access the vr sync date local service. Add custom service methods to {@link com.fds.vr.business.service.impl.VRSyncDateLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
