...
/**
 * The persistence interface for the vres service.
 *
 * <p>
 ...
 */
@ProviderType
public interface VRESPersistence extends BasePersistence<VRES> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRESUtil} to access the vres persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	*/
	public void cacheResult(java.util.List<VRES> vreses);
	...
	*/
	...
	@Override
	public java.util.Map<java.io.Serializable, VRES> fetchByPrimaryKeys(
	...
	* @return the vreses
	*/
	public java.util.List<VRES> findAll();
	...
	*/
	public java.util.List<VRES> findAll(int start, int end);
	...
	*/
	public java.util.List<VRES> findAll(int start, int end,
		com.liferay.portal.kernel.util.OrderByComparator<VRES> orderByComparator);
