...
public class ILCertificateUtil {
	...
	*/
	...
	/**
	* Returns the il certificate where licenceNo = &#63; or throws a {@link NoSuchILCertificateException} if it could not be found.
	*
	* @param licenceNo the licence no
	* @return the matching il certificate
	* @throws NoSuchILCertificateException if a matching il certificate could not be found
	*/
	public static ILCertificate findByF_LICENCENO(java.lang.String licenceNo)
		throws com.fds.vr.business.exception.NoSuchILCertificateException {
		return getPersistence().findByF_LICENCENO(licenceNo);
	}

	/**
	* Returns the il certificate where licenceNo = &#63; or returns <code>null</code> if it could not be found. Uses the finder cache.
	*
	* @param licenceNo the licence no
	* @return the matching il certificate, or <code>null</code> if a matching il certificate could not be found
	*/
	public static ILCertificate fetchByF_LICENCENO(java.lang.String licenceNo) {
		return getPersistence().fetchByF_LICENCENO(licenceNo);
	}

	/**
	* Returns the il certificate where licenceNo = &#63; or returns <code>null</code> if it could not be found, optionally using the finder cache.
	*
	* @param licenceNo the licence no
	* @param retrieveFromCache whether to retrieve from the finder cache
	* @return the matching il certificate, or <code>null</code> if a matching il certificate could not be found
	*/
	public static ILCertificate fetchByF_LICENCENO(java.lang.String licenceNo,
		boolean retrieveFromCache) {
		return getPersistence().fetchByF_LICENCENO(licenceNo, retrieveFromCache);
	}

	/**
	* Removes the il certificate where licenceNo = &#63; from the database.
	*
	* @param licenceNo the licence no
	* @return the il certificate that was removed
	*/
	public static ILCertificate removeByF_LICENCENO(java.lang.String licenceNo)
		throws com.fds.vr.business.exception.NoSuchILCertificateException {
		return getPersistence().removeByF_LICENCENO(licenceNo);
	}

	/**
	* Returns the number of il certificates where licenceNo = &#63;.
	*
	* @param licenceNo the licence no
	* @return the number of matching il certificates
	*/
	public static int countByF_LICENCENO(java.lang.String licenceNo) {
		return getPersistence().countByF_LICENCENO(licenceNo);
	}

	/**
	* Returns all the il certificates where registrationNumber = &#63;.
	*
	* @param registrationNumber the registration number
	* @return the matching il certificates
	*/
	public static List<ILCertificate> findByREG_NUM(
		java.lang.String registrationNumber) {
		return getPersistence().findByREG_NUM(registrationNumber);
	}

	/**
	* Returns a range of all the il certificates where registrationNumber = &#63;.
	*
	* <p>
	* Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ILCertificateModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	* </p>
	...
	*/
	public static List<ILCertificate> findByREG_NUM(
		java.lang.String registrationNumber, int start, int end) {
		return getPersistence().findByREG_NUM(registrationNumber, start, end);
	}

	/**
	* Returns an ordered range of all the il certificates where registrationNumber = &#63;.
	*
	* <p>
	* Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ILCertificateModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	* </p>
	...
	*/
	public static List<ILCertificate> findByREG_NUM(
		...
		OrderByComparator<ILCertificate> orderByComparator) {
		return getPersistence()
				   .findByREG_NUM(registrationNumber, start, end,
			orderByComparator);
	}
	...
	*/
	...
	/**
	* Returns the first il certificate in the ordered set where registrationNumber = &#63;.
	*
	* @param registrationNumber the registration number
	* @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	* @return the first matching il certificate
	* @throws NoSuchILCertificateException if a matching il certificate could not be found
	*/
	public static ILCertificate findByREG_NUM_First(
		java.lang.String registrationNumber,
		OrderByComparator<ILCertificate> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchILCertificateException {
		return getPersistence()
				   .findByREG_NUM_First(registrationNumber, orderByComparator);
	}
	...
	* @return the first matching il certificate, or <code>null</code> if a matching il certificate could not be found
	*/
	public static ILCertificate fetchByREG_NUM_First(
		java.lang.String registrationNumber,
		OrderByComparator<ILCertificate> orderByComparator) {
		return getPersistence()
				   .fetchByREG_NUM_First(registrationNumber, orderByComparator);
	}

	/**
	* Returns the last il certificate in the ordered set where registrationNumber = &#63;.
	*
	* @param registrationNumber the registration number
	* @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	* @return the last matching il certificate
	* @throws NoSuchILCertificateException if a matching il certificate could not be found
	*/
	public static ILCertificate findByREG_NUM_Last(
		java.lang.String registrationNumber,
		OrderByComparator<ILCertificate> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchILCertificateException {
		return getPersistence()
				   .findByREG_NUM_Last(registrationNumber, orderByComparator);
	}
	...
	* @return the last matching il certificate, or <code>null</code> if a matching il certificate could not be found
	*/
	public static ILCertificate fetchByREG_NUM_Last(
		java.lang.String registrationNumber,
		OrderByComparator<ILCertificate> orderByComparator) {
		return getPersistence()
				   .fetchByREG_NUM_Last(registrationNumber, orderByComparator);
	}

	/**
	* Returns the il certificates before and after the current il certificate in the ordered set where registrationNumber = &#63;.
	*
	* @param id the primary key of the current il certificate
	* @param registrationNumber the registration number
	* @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	...
	* @throws NoSuchILCertificateException if a il certificate with the primary key could not be found
	*/
	public static ILCertificate[] findByREG_NUM_PrevAndNext(long id,
		java.lang.String registrationNumber,
		OrderByComparator<ILCertificate> orderByComparator)
		throws com.fds.vr.business.exception.NoSuchILCertificateException {
		return getPersistence()
				   .findByREG_NUM_PrevAndNext(id, registrationNumber,
			orderByComparator);
	}

	/**
	* Removes all the il certificates where registrationNumber = &#63; from the database.
	*
	* @param registrationNumber the registration number
	*/
	public static void removeByREG_NUM(java.lang.String registrationNumber) {
		getPersistence().removeByREG_NUM(registrationNumber);
	}

	/**
	* Returns the number of il certificates where registrationNumber = &#63;.
	*
	* @param registrationNumber the registration number
	* @return the number of matching il certificates
	*/
	public static int countByREG_NUM(java.lang.String registrationNumber) {
		return getPersistence().countByREG_NUM(registrationNumber);
	}
