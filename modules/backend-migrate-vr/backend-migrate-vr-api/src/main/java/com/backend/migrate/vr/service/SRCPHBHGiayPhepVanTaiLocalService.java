...
/**
 * Provides the local service interface for SRCPHBHGiayPhepVanTai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SRCPHBHGiayPhepVanTaiLocalServiceUtil
...
public interface SRCPHBHGiayPhepVanTaiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SRCPHBHGiayPhepVanTaiLocalServiceUtil} to access the srcphbh giay phep van tai local service. Add custom service methods to {@link com.backend.migrate.vr.service.impl.SRCPHBHGiayPhepVanTaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SRCPHBHGiayPhepVanTai addSRCPHBHGiayPhepVanTai(
	...
	*/
	public SRCPHBHGiayPhepVanTai createSRCPHBHGiayPhepVanTai(long id);
	...
	*/
	...
	public SRCPHBHGiayPhepVanTai deleteSRCPHBHGiayPhepVanTai(
		SRCPHBHGiayPhepVanTai srcphbhGiayPhepVanTai);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SRCPHBHGiayPhepVanTai deleteSRCPHBHGiayPhepVanTai(long id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCPHBHGiayPhepVanTai fetchSRCPHBHGiayPhepVanTai(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCPHBHGiayPhepVanTai getSRCPHBHGiayPhepVanTai(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SRCPHBHGiayPhepVanTai updateSRCPHBHGiayPhepVanTai(
		SRCPHBHGiayPhepVanTai srcphbhGiayPhepVanTai);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SRCPHBHGiayPhepVanTai> getSRCPHBHGiayPhepVanTais(int start,
		int end);
