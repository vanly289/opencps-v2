...
/**
 * The persistence utility for the src giay phep lien van service. This utility wraps {@link com.backend.migrate.vr.service.persistence.impl.SRCGiayPhepLienVanPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class SRCGiayPhepLienVanUtil {
	 ...
	 */
	public static void clearCache(SRCGiayPhepLienVan srcGiayPhepLienVan) {
		getPersistence().clearCache(srcGiayPhepLienVan);
	}
	 ...
	 */
	public static List<SRCGiayPhepLienVan> findWithDynamicQuery(
	...
	public static List<SRCGiayPhepLienVan> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<SRCGiayPhepLienVan> orderByComparator) {
	 ...
	 */
	public static SRCGiayPhepLienVan update(
		SRCGiayPhepLienVan srcGiayPhepLienVan) {
		return getPersistence().update(srcGiayPhepLienVan);
	}
	 ...
	 */
	public static SRCGiayPhepLienVan update(
		SRCGiayPhepLienVan srcGiayPhepLienVan, ServiceContext serviceContext) {
		return getPersistence().update(srcGiayPhepLienVan, serviceContext);
	}
	...
	*/
	public static List<SRCGiayPhepLienVan> findByGT_ID(long id) {
	...
	*/
	public static List<SRCGiayPhepLienVan> findByGT_ID(long id, int start,
		int end) {
	...
	*/
	public static List<SRCGiayPhepLienVan> findByGT_ID(long id, int start,
		int end, OrderByComparator<SRCGiayPhepLienVan> orderByComparator) {
	...
	*/
	public static SRCGiayPhepLienVan findByGT_ID_First(long id,
		OrderByComparator<SRCGiayPhepLienVan> orderByComparator)
		throws com.backend.migrate.vr.exception.NoSuchSRCGiayPhepLienVanException {
	...
	*/
	public static SRCGiayPhepLienVan fetchByGT_ID_First(long id,
		OrderByComparator<SRCGiayPhepLienVan> orderByComparator) {
	...
	* @throws NoSuchSRCGiayPhepLienVanException if a matching src giay phep lien van could not be found
	*/
	public static SRCGiayPhepLienVan findByGT_ID_Last(long id,
		OrderByComparator<SRCGiayPhepLienVan> orderByComparator)
		throws com.backend.migrate.vr.exception.NoSuchSRCGiayPhepLienVanException {
	...
	*/
	public static SRCGiayPhepLienVan fetchByGT_ID_Last(long id,
		OrderByComparator<SRCGiayPhepLienVan> orderByComparator) {
	...
	*/
	public static void cacheResult(SRCGiayPhepLienVan srcGiayPhepLienVan) {
		getPersistence().cacheResult(srcGiayPhepLienVan);
	}
	...
	*/
	public static void cacheResult(List<SRCGiayPhepLienVan> srcGiayPhepLienVans) {
		getPersistence().cacheResult(srcGiayPhepLienVans);
	}
	...
	*/
	public static SRCGiayPhepLienVan create(long id) {
	...
	*/
	public static SRCGiayPhepLienVan remove(long id)
		throws com.backend.migrate.vr.exception.NoSuchSRCGiayPhepLienVanException {
		return getPersistence().remove(id);
	}

	public static SRCGiayPhepLienVan updateImpl(
		SRCGiayPhepLienVan srcGiayPhepLienVan) {
		return getPersistence().updateImpl(srcGiayPhepLienVan);
	}
	...
	* @throws NoSuchSRCGiayPhepLienVanException if a src giay phep lien van with the primary key could not be found
	*/
	public static SRCGiayPhepLienVan findByPrimaryKey(long id)
		throws com.backend.migrate.vr.exception.NoSuchSRCGiayPhepLienVanException {
	...
	*/
	public static SRCGiayPhepLienVan fetchByPrimaryKey(long id) {
		return getPersistence().fetchByPrimaryKey(id);
	}

	public static java.util.Map<java.io.Serializable, SRCGiayPhepLienVan> fetchByPrimaryKeys(
	...
	*/
	public static List<SRCGiayPhepLienVan> findAll() {
	...
	*/
	public static List<SRCGiayPhepLienVan> findAll(int start, int end) {
	...
	*/
	...
	public static SRCGiayPhepLienVanPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<SRCGiayPhepLienVanPersistence, SRCGiayPhepLienVanPersistence> _serviceTracker =
		ServiceTrackerFactory.open(SRCGiayPhepLienVanPersistence.class);
}