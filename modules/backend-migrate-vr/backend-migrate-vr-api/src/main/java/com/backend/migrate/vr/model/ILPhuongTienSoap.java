...
/**
 * This class is used by SOAP remote services, specifically {@link com.backend.migrate.vr.service.http.ILPhuongTienServiceSoap}.
 *
 * @author Brian Wing Shun Chan
 * @see com.backend.migrate.vr.service.http.ILPhuongTienServiceSoap
 * @generated
 */
@ProviderType
public class ILPhuongTienSoap implements Serializable {
	public static ILPhuongTienSoap toSoapModel(ILPhuongTien model) {
		ILPhuongTienSoap soapModel = new ILPhuongTienSoap();
	...
	public static ILPhuongTienSoap[] toSoapModels(ILPhuongTien[] models) {
		ILPhuongTienSoap[] soapModels = new ILPhuongTienSoap[models.length];
	...
	public static ILPhuongTienSoap[][] toSoapModels(ILPhuongTien[][] models) {
		ILPhuongTienSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new ILPhuongTienSoap[models.length][models[0].length];
		}
		else {
			soapModels = new ILPhuongTienSoap[0][0];
		}
	...
	public static ILPhuongTienSoap[] toSoapModels(List<ILPhuongTien> models) {
		List<ILPhuongTienSoap> soapModels = new ArrayList<ILPhuongTienSoap>(models.size());

		for (ILPhuongTien model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new ILPhuongTienSoap[soapModels.size()]);
	}

	public ILPhuongTienSoap() {
	}
