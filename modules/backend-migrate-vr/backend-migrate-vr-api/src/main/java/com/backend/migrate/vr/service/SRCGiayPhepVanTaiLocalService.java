...
/**
 * Provides the local service interface for SRCGiayPhepVanTai. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SRCGiayPhepVanTaiLocalServiceUtil
...
public interface SRCGiayPhepVanTaiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SRCGiayPhepVanTaiLocalServiceUtil} to access the src giay phep van tai local service. Add custom service methods to {@link com.backend.migrate.vr.service.impl.SRCGiayPhepVanTaiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SRCGiayPhepVanTai addSRCGiayPhepVanTai(
	...
	*/
	public SRCGiayPhepVanTai createSRCGiayPhepVanTai(long id);
	...
	*/
	...
	public SRCGiayPhepVanTai deleteSRCGiayPhepVanTai(
		SRCGiayPhepVanTai srcGiayPhepVanTai);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SRCGiayPhepVanTai deleteSRCGiayPhepVanTai(long id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCGiayPhepVanTai fetchSRCGiayPhepVanTai(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCGiayPhepVanTai getSRCGiayPhepVanTai(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SRCGiayPhepVanTai updateSRCGiayPhepVanTai(
		SRCGiayPhepVanTai srcGiayPhepVanTai);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SRCGiayPhepVanTai> getSRCGiayPhepVanTais(int start, int end);
