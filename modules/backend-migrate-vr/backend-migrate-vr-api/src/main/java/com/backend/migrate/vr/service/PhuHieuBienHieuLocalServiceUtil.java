...
/**
 * Provides the local service utility for PhuHieuBienHieu. This utility wraps
 * {@link com.backend.migrate.vr.service.impl.PhuHieuBienHieuLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class PhuHieuBienHieuLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.backend.migrate.vr.service.impl.PhuHieuBienHieuLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.backend.migrate.vr.model.PhuHieuBienHieu addPhuHieuBienHieu(
		com.backend.migrate.vr.model.PhuHieuBienHieu phuHieuBienHieu) {
		return getService().addPhuHieuBienHieu(phuHieuBienHieu);
	}
	...
	*/
	public static com.backend.migrate.vr.model.PhuHieuBienHieu createPhuHieuBienHieu(
		long id) {
		return getService().createPhuHieuBienHieu(id);
	}
	...
	*/
	public static com.backend.migrate.vr.model.PhuHieuBienHieu deletePhuHieuBienHieu(
		com.backend.migrate.vr.model.PhuHieuBienHieu phuHieuBienHieu) {
		return getService().deletePhuHieuBienHieu(phuHieuBienHieu);
	}
	...
	*/
	public static com.backend.migrate.vr.model.PhuHieuBienHieu deletePhuHieuBienHieu(
		...
		return getService().deletePhuHieuBienHieu(id);
	}

	public static com.backend.migrate.vr.model.PhuHieuBienHieu fetchPhuHieuBienHieu(
		long id) {
		return getService().fetchPhuHieuBienHieu(id);
	}
	...
	* @throws PortalException if a phu hieu bien hieu with the primary key could not be found
	*/
	public static com.backend.migrate.vr.model.PhuHieuBienHieu getPhuHieuBienHieu(
		long id) throws com.liferay.portal.kernel.exception.PortalException {
		return getService().getPhuHieuBienHieu(id);
	}
	...
	*/
	public static com.backend.migrate.vr.model.PhuHieuBienHieu updatePhuHieuBienHieu(
		com.backend.migrate.vr.model.PhuHieuBienHieu phuHieuBienHieu) {
		return getService().updatePhuHieuBienHieu(phuHieuBienHieu);
	}
	...
	*/
	public static int getPhuHieuBienHieusCount() {
		return getService().getPhuHieuBienHieusCount();
	}
	...
	*/
	public static java.util.List<com.backend.migrate.vr.model.PhuHieuBienHieu> getPhuHieuBienHieus(
		int start, int end) {
		return getService().getPhuHieuBienHieus(start, end);
	}
	...
	*/
	...
	public static PhuHieuBienHieuLocalService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<PhuHieuBienHieuLocalService, PhuHieuBienHieuLocalService> _serviceTracker =
		ServiceTrackerFactory.open(PhuHieuBienHieuLocalService.class);
}