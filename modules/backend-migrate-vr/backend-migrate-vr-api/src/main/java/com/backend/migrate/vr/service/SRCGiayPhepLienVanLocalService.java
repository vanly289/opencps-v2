...
/**
 * Provides the local service interface for SRCGiayPhepLienVan. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SRCGiayPhepLienVanLocalServiceUtil
...
public interface SRCGiayPhepLienVanLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SRCGiayPhepLienVanLocalServiceUtil} to access the src giay phep lien van local service. Add custom service methods to {@link com.backend.migrate.vr.service.impl.SRCGiayPhepLienVanLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SRCGiayPhepLienVan addSRCGiayPhepLienVan(
	...
	*/
	public SRCGiayPhepLienVan createSRCGiayPhepLienVan(long id);
	...
	*/
	...
	public SRCGiayPhepLienVan deleteSRCGiayPhepLienVan(
		SRCGiayPhepLienVan srcGiayPhepLienVan);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SRCGiayPhepLienVan deleteSRCGiayPhepLienVan(long id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCGiayPhepLienVan fetchSRCGiayPhepLienVan(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCGiayPhepLienVan getSRCGiayPhepLienVan(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SRCGiayPhepLienVan updateSRCGiayPhepLienVan(
		SRCGiayPhepLienVan srcGiayPhepLienVan);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SRCGiayPhepLienVan> getSRCGiayPhepLienVans(int start, int end);
