...
/**
 * Provides the local service interface for SRCILHopDongThue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SRCILHopDongThueLocalServiceUtil
...
public interface SRCILHopDongThueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SRCILHopDongThueLocalServiceUtil} to access the srcil hop dong thue local service. Add custom service methods to {@link com.backend.migrate.vr.service.impl.SRCILHopDongThueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SRCILHopDongThue addSRCILHopDongThue(
		SRCILHopDongThue srcilHopDongThue);
	...
	*/
	public SRCILHopDongThue createSRCILHopDongThue(long id);
	...
	*/
	...
	public SRCILHopDongThue deleteSRCILHopDongThue(
		SRCILHopDongThue srcilHopDongThue);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SRCILHopDongThue deleteSRCILHopDongThue(long id)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCILHopDongThue fetchSRCILHopDongThue(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SRCILHopDongThue getSRCILHopDongThue(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SRCILHopDongThue updateSRCILHopDongThue(
		SRCILHopDongThue srcilHopDongThue);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SRCILHopDongThue> getSRCILHopDongThues(int start, int end);
