...
public class ViPhamUtil {
	...
	*/
	public static List<ViPham> findByGT_ID(long id) {
	...
	*/
	public static List<ViPham> findByGT_ID(long id, int start, int end) {
	...
	*/
	public static ViPham findByGT_ID_First(long id,
		OrderByComparator<ViPham> orderByComparator)
	...
	*/
	public static ViPham fetchByGT_ID_First(long id,
		OrderByComparator<ViPham> orderByComparator) {
	...
	* @throws NoSuchViPhamException if a matching vi pham could not be found
	*/
	public static ViPham findByGT_ID_Last(long id,
		OrderByComparator<ViPham> orderByComparator)
		throws com.backend.migrate.vr.exception.NoSuchViPhamException {
	...
	*/
	public static ViPham fetchByGT_ID_Last(long id,
		OrderByComparator<ViPham> orderByComparator) {
	...
	* @return the matching vi phams
	*/
	public static List<ViPham> findByPTID(long phuongtien_id) {
	...
	* @return the range of matching vi phams
	*/
	public static List<ViPham> findByPTID(long phuongtien_id, int start, int end) {
	...
	* @return the ordered range of matching vi phams
	*/
	public static List<ViPham> findByPTID(long phuongtien_id, int start,
	...
	* @throws NoSuchViPhamException if a matching vi pham could not be found
	*/
	public static ViPham findByPTID_First(long phuongtien_id,
		OrderByComparator<ViPham> orderByComparator)
		throws com.backend.migrate.vr.exception.NoSuchViPhamException {
		return getPersistence()
	...
	* @return the first matching vi pham, or <code>null</code> if a matching vi pham could not be found
	*/
	public static ViPham fetchByPTID_First(long phuongtien_id,
		OrderByComparator<ViPham> orderByComparator) {
		return getPersistence()
	...
	* @throws NoSuchViPhamException if a matching vi pham could not be found
	*/
	public static ViPham findByPTID_Last(long phuongtien_id,
		OrderByComparator<ViPham> orderByComparator)
		throws com.backend.migrate.vr.exception.NoSuchViPhamException {
	...
	* @return the last matching vi pham, or <code>null</code> if a matching vi pham could not be found
	*/
	public static ViPham fetchByPTID_Last(long phuongtien_id,
		OrderByComparator<ViPham> orderByComparator) {
		return getPersistence()
	...
	*/
	public static ViPham[] findByPTID_PrevAndNext(long id, long phuongtien_id,
		OrderByComparator<ViPham> orderByComparator)
		throws com.backend.migrate.vr.exception.NoSuchViPhamException {
		return getPersistence()
