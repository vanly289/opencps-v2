...
/**
 * The base model interface for the PhuongTien service. Represents a row in the &quot;phbh_phuongtien&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link com.backend.migrate.vr.model.impl.PhuongTienModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link com.backend.migrate.vr.model.impl.PhuongTienImpl}.
 * </p>
 *
 ...
 */
@ProviderType
public interface PhuongTienModel extends BaseModel<PhuongTien> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a phuong tien model instance should use the {@link PhuongTien} interface instead.
	 */
	...
	@Override
	public CacheModel<PhuongTien> toCacheModel();
