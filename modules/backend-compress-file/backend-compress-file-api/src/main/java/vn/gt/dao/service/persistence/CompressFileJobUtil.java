...
/**
 * The persistence utility for the compress file job service. This utility wraps {@link vn.gt.dao.service.persistence.impl.CompressFileJobPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class CompressFileJobUtil {
	 ...
	 */
	public static void clearCache(CompressFileJob compressFileJob) {
		getPersistence().clearCache(compressFileJob);
	}
	 ...
	 */
	public static List<CompressFileJob> findWithDynamicQuery(
	...
	public static List<CompressFileJob> findWithDynamicQuery(
		DynamicQuery dynamicQuery, int start, int end,
		OrderByComparator<CompressFileJob> orderByComparator) {
	 ...
	 */
	public static CompressFileJob update(CompressFileJob compressFileJob) {
		return getPersistence().update(compressFileJob);
	}
	...
	public static CompressFileJob update(CompressFileJob compressFileJob,
		...
		return getPersistence().update(compressFileJob, serviceContext);
	}
	...
	*/
	public static void cacheResult(CompressFileJob compressFileJob) {
		getPersistence().cacheResult(compressFileJob);
	}
	...
	*/
	public static void cacheResult(List<CompressFileJob> compressFileJobs) {
		getPersistence().cacheResult(compressFileJobs);
	}
	...
	*/
	public static CompressFileJob create(long id) {
	...
	*/
	public static CompressFileJob remove(long id)
		throws vn.gt.dao.exception.NoSuchCompressFileJobException {
		return getPersistence().remove(id);
	}

	public static CompressFileJob updateImpl(CompressFileJob compressFileJob) {
		return getPersistence().updateImpl(compressFileJob);
	}
	...
	* @throws NoSuchCompressFileJobException if a compress file job with the primary key could not be found
	*/
	public static CompressFileJob findByPrimaryKey(long id)
		throws vn.gt.dao.exception.NoSuchCompressFileJobException {
	...
	*/
	public static CompressFileJob fetchByPrimaryKey(long id) {
		return getPersistence().fetchByPrimaryKey(id);
	}

	public static java.util.Map<java.io.Serializable, CompressFileJob> fetchByPrimaryKeys(
	...
	*/
	public static List<CompressFileJob> findAll() {
	...
	*/
	public static List<CompressFileJob> findAll(int start, int end) {
	...
	*/
	...
	public static CompressFileJobPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<CompressFileJobPersistence, CompressFileJobPersistence> _serviceTracker =
		ServiceTrackerFactory.open(CompressFileJobPersistence.class);
}