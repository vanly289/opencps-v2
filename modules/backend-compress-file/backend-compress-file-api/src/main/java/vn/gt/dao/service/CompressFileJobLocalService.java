...
/**
 * Provides the local service interface for CompressFileJob. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see CompressFileJobLocalServiceUtil
...
public interface CompressFileJobLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompressFileJobLocalServiceUtil} to access the compress file job local service. Add custom service methods to {@link vn.gt.dao.service.impl.CompressFileJobLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CompressFileJob> getCompressFileJobs(int start, int end);
	...
	*/
	...
	public CompressFileJob addCompressFileJob(CompressFileJob compressFileJob);

	public CompressFileJob addJob(List<Dossier> listHoSo)
	...
	*/
	public CompressFileJob createCompressFileJob(long id);
	...
	*/
	...
	public CompressFileJob deleteCompressFileJob(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CompressFileJob deleteCompressFileJob(
		CompressFileJob compressFileJob);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompressFileJob fetchCompressFileJob(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompressFileJob getCompressFileJob(long id)
		throws PortalException;

	public CompressFileJob updateCompressFileJob(long id)
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CompressFileJob updateCompressFileJob(
		CompressFileJob compressFileJob);
}