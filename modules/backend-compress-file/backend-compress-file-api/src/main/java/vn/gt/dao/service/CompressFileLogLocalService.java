...
/**
 * Provides the local service interface for CompressFileLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see CompressFileLogLocalServiceUtil
...
public interface CompressFileLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CompressFileLogLocalServiceUtil} to access the compress file log local service. Add custom service methods to {@link vn.gt.dao.service.impl.CompressFileLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<CompressFileLog> getCompressFileLogs(int start, int end);
	...
	*/
	...
	public CompressFileLog addCompressFileLog(long hoSoId, long fileEntryId,
		long oldSize, long newSize) throws SystemException;

	public CompressFileLog addCompressFileLog(long hoSoId, long fileEntryId,
		long oldSize, long newSize, boolean status, java.lang.String errorMsg)
	...
	*/
	...
	public CompressFileLog addCompressFileLog(CompressFileLog compressFileLog);
	...
	*/
	public CompressFileLog createCompressFileLog(long id);
	...
	*/
	...
	public CompressFileLog deleteCompressFileLog(long id)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public CompressFileLog deleteCompressFileLog(
		CompressFileLog compressFileLog);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompressFileLog fetchCompressFileLog(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public CompressFileLog getCompressFileLog(long id)
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public CompressFileLog updateCompressFileLog(
		CompressFileLog compressFileLog);
}