...
/**
 * Provides the local service interface for VRCOPProductionPlantProdEquipment. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author HoangLeTrongNhan
 * @see VRCOPProductionPlantProdEquipmentLocalServiceUtil
...
public interface VRCOPProductionPlantProdEquipmentLocalService
	extends BaseLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRCOPProductionPlantProdEquipmentLocalServiceUtil} to access the vrcop production plant prod equipment local service. Add custom service methods to {@link com.fds.vr.cop.service.impl.VRCOPProductionPlantProdEquipmentLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VRCOPProductionPlantProdEquipmentModel> getListBy(
