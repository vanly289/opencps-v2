...
public interface VRCOPProductTypeLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRCOPProductTypeLocalServiceUtil} to access the vrcop product type local service. Add custom service methods to {@link com.fds.vr.cop.service.impl.VRCOPProductTypeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VRCOPProductTypeModel> getListBy(java.lang.String COPReportNo);
