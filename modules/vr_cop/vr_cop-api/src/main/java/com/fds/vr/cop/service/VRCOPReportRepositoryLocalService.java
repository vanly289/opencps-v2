...
public interface VRCOPReportRepositoryLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONArray getCOPReports(int start, int end)
		throws SystemException, JSONException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JSONObject getCOPReport(java.lang.String COPReportNo)
		throws SystemException, JSONException;
