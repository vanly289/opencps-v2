...
import com.fds.vr.cop.exception.NoSuchVRCOPReportAttachException;
import com.fds.vr.cop.model.VRCOPReportAttach;
import com.fds.vr.cop.model.impl.VRCOPReportAttachImpl;
import com.fds.vr.cop.model.impl.VRCOPReportAttachModelImpl;
 ...
 * @see com.fds.vr.cop.service.persistence.VRCOPReportAttachUtil
 * @generated
 */
@ProviderType
public class VRCOPReportAttachPersistenceImpl extends BasePersistenceImpl<VRCOPReportAttach>
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_COP_REPORT_NO = new FinderPath(VRCOPReportAttachModelImpl.ENTITY_CACHE_ENABLED,
			VRCOPReportAttachModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByCOP_REPORT_NO",
			new String[] { String.class.getName() });

	/**
	 * Returns all the vrcop report attachs where COPReportNo = &#63;.
	 *
	 * @param COPReportNo the cop report no
	 * @return the matching vrcop report attachs
	 */
	@Override
	public List<VRCOPReportAttach> findByCOP_REPORT_NO(String COPReportNo) {
		return findByCOP_REPORT_NO(COPReportNo, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the vrcop report attachs where COPReportNo = &#63;.
	 *
	 * <p>
	...
	/**
	 * Returns an ordered range of all the vrcop report attachs where COPReportNo = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link VRCOPReportAttachModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	/**
	 * Returns the first vrcop report attach in the ordered set where COPReportNo = &#63;.
	 *
	 * @param COPReportNo the cop report no
	 ...
	 */
	@Override
	public VRCOPReportAttach findByCOP_REPORT_NO_First(String COPReportNo,
		OrderByComparator<VRCOPReportAttach> orderByComparator)
		throws NoSuchVRCOPReportAttachException {
		VRCOPReportAttach vrcopReportAttach = fetchByCOP_REPORT_NO_First(COPReportNo,
				orderByComparator);
	 ...
	 */
	@Override
	public VRCOPReportAttach fetchByCOP_REPORT_NO_First(String COPReportNo,
		OrderByComparator<VRCOPReportAttach> orderByComparator) {
		List<VRCOPReportAttach> list = findByCOP_REPORT_NO(COPReportNo, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last vrcop report attach in the ordered set where COPReportNo = &#63;.
	 *
	 * @param COPReportNo the cop report no
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public VRCOPReportAttach findByCOP_REPORT_NO_Last(String COPReportNo,
		OrderByComparator<VRCOPReportAttach> orderByComparator)
		throws NoSuchVRCOPReportAttachException {
		VRCOPReportAttach vrcopReportAttach = fetchByCOP_REPORT_NO_Last(COPReportNo,
				orderByComparator);
	 ...
	 */
	@Override
	public VRCOPReportAttach fetchByCOP_REPORT_NO_Last(String COPReportNo,
		OrderByComparator<VRCOPReportAttach> orderByComparator) {
		...
		List<VRCOPReportAttach> list = findByCOP_REPORT_NO(COPReportNo,
	...
	/**
	 * Returns the vrcop report attachs before and after the current vrcop report attach in the ordered set where COPReportNo = &#63;.
	 *
	 ...
	 */
	@Override
	public VRCOPReportAttach[] findByCOP_REPORT_NO_PrevAndNext(long id,
		String COPReportNo,
		OrderByComparator<VRCOPReportAttach> orderByComparator)
		throws NoSuchVRCOPReportAttachException {
		...
		try {
			...
			array[0] = getByCOP_REPORT_NO_PrevAndNext(session,
					vrcopReportAttach, COPReportNo, orderByComparator, true);

			array[1] = vrcopReportAttach;

			array[2] = getByCOP_REPORT_NO_PrevAndNext(session,
					vrcopReportAttach, COPReportNo, orderByComparator, false);
	...
	protected VRCOPReportAttach getByCOP_REPORT_NO_PrevAndNext(
		Session session, VRCOPReportAttach vrcopReportAttach,
		String COPReportNo,
	...
	/**
	 * Removes all the vrcop report attachs where COPReportNo = &#63; from the database.
	 *
	 * @param COPReportNo the cop report no
	 */
	@Override
	public void removeByCOP_REPORT_NO(String COPReportNo) {
		for (VRCOPReportAttach vrcopReportAttach : findByCOP_REPORT_NO(
	...
	/**
	 * Returns the number of vrcop report attachs where COPReportNo = &#63;.
	 *
	 * @param COPReportNo the cop report no
	...
	private static final String _FINDER_COLUMN_COP_REPORT_NO_COPREPORTNO_1 = "vrcopReportAttach.COPReportNo IS NULL";
	private static final String _FINDER_COLUMN_COP_REPORT_NO_COPREPORTNO_2 = "vrcopReportAttach.COPReportNo = ?";
	private static final String _FINDER_COLUMN_COP_REPORT_NO_COPREPORTNO_3 = "(vrcopReportAttach.COPReportNo IS NULL OR vrcopReportAttach.COPReportNo = '')";
	...
	public VRCOPReportAttach updateImpl(VRCOPReportAttach vrcopReportAttach) {
		...
		if (isNew || !VRCOPReportAttachModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((vrcopReportAttachModelImpl.getColumnBitmask() &
				...
				args = new Object[] { vrcopReportAttachModelImpl.getCOPReportNo() };
