...
import com.fds.vr.cop.model.VRCOPProductionPlantProdEquipmentModel;
...
/**
 * The base model implementation for the VRCOPProductionPlantProdEquipment service. Represents a row in the &quot;vr_copproductionplantprodequipment&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link VRCOPProductionPlantProdEquipmentModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link VRCOPProductionPlantProdEquipmentImpl}.
 * </p>
 *
 * @author HoangLeTrongNhan
 * @see VRCOPProductionPlantProdEquipmentImpl
 * @see VRCOPProductionPlantProdEquipment
 * @see VRCOPProductionPlantProdEquipmentModel
 * @generated
 */
@ProviderType
public class VRCOPProductionPlantProdEquipmentModelImpl extends BaseModelImpl<VRCOPProductionPlantProdEquipment>
	implements VRCOPProductionPlantProdEquipmentModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a vrcop production plant prod equipment model instance should use the {@link VRCOPProductionPlantProdEquipment} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.fds.vr.cop.vr.cop.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.fds.vr.cop.model.VRCOPProductionPlantProdEquipment"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.fds.vr.cop.vr.cop.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.fds.vr.cop.model.VRCOPProductionPlantProdEquipment"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.fds.vr.cop.vr.cop.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.fds.vr.cop.model.VRCOPProductionPlantProdEquipment"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.fds.vr.cop.vr.cop.service.util.ServiceProps.get(
				"lock.expiration.time.com.fds.vr.cop.model.VRCOPProductionPlantProdEquipment"));

	public VRCOPProductionPlantProdEquipmentModelImpl() {
	}
	...
	public ExpandoBridge getExpandoBridge() {
		return ExpandoBridgeFactoryUtil.getExpandoBridge(0,
			VRCOPProductionPlantProdEquipment.class.getName(), getPrimaryKey());
	}
	...
	public VRCOPProductionPlantProdEquipment toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (VRCOPProductionPlantProdEquipment)ProxyUtil.newProxyInstance(_classLoader,
	...
	public Object clone() {
		...
		vrcopProductionPlantProdEquipmentImpl.setId(getId());
		vrcopProductionPlantProdEquipmentImpl.setMtCore(getMtCore());
		vrcopProductionPlantProdEquipmentImpl.setCOPReportRepositoryID(getCOPReportRepositoryID());
		vrcopProductionPlantProdEquipmentImpl.setCOPReportNo(getCOPReportNo());
		vrcopProductionPlantProdEquipmentImpl.setSequenceNo(getSequenceNo());
		vrcopProductionPlantProdEquipmentImpl.setEquipmentCode(getEquipmentCode());
		vrcopProductionPlantProdEquipmentImpl.setEquipmentName(getEquipmentName());
		vrcopProductionPlantProdEquipmentImpl.setEquipmentType(getEquipmentType());
		vrcopProductionPlantProdEquipmentImpl.setTradeMark(getTradeMark());
		vrcopProductionPlantProdEquipmentImpl.setTradeMarkName(getTradeMarkName());
		vrcopProductionPlantProdEquipmentImpl.setCommercialName(getCommercialName());
		vrcopProductionPlantProdEquipmentImpl.setModelCode(getModelCode());
		vrcopProductionPlantProdEquipmentImpl.setDesignSymbolNo(getDesignSymbolNo());
		vrcopProductionPlantProdEquipmentImpl.setProductionCountryCode(getProductionCountryCode());
		vrcopProductionPlantProdEquipmentImpl.setEquipmentStatus(getEquipmentStatus());
		vrcopProductionPlantProdEquipmentImpl.setNotes(getNotes());
		vrcopProductionPlantProdEquipmentImpl.setModifyDate(getModifyDate());
		vrcopProductionPlantProdEquipmentImpl.setSyncDate(getSyncDate());
	...
	public int compareTo(
		...
		if (getId() < vrcopProductionPlantProdEquipment.getId()) {
			value = -1;
		}
		else if (getId() > vrcopProductionPlantProdEquipment.getId()) {
			value = 1;
		}
		else {
			value = 0;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof VRCOPProductionPlantProdEquipment)) {
			return false;
		}

		VRCOPProductionPlantProdEquipment vrcopProductionPlantProdEquipment = (VRCOPProductionPlantProdEquipment)obj;

		long primaryKey = vrcopProductionPlantProdEquipment.getPrimaryKey();
	...
	public void resetOriginalValues() {
		...
		vrcopProductionPlantProdEquipmentModelImpl._originalCOPReportNo = vrcopProductionPlantProdEquipmentModelImpl._COPReportNo;

		vrcopProductionPlantProdEquipmentModelImpl._columnBitmask = 0;
	}
	...
	public CacheModel<VRCOPProductionPlantProdEquipment> toCacheModel() {
		VRCOPProductionPlantProdEquipmentCacheModel vrcopProductionPlantProdEquipmentCacheModel =
			new VRCOPProductionPlantProdEquipmentCacheModel();

		vrcopProductionPlantProdEquipmentCacheModel.id = getId();

		vrcopProductionPlantProdEquipmentCacheModel.mtCore = getMtCore();

		vrcopProductionPlantProdEquipmentCacheModel.COPReportRepositoryID = getCOPReportRepositoryID();

		vrcopProductionPlantProdEquipmentCacheModel.COPReportNo = getCOPReportNo();

		String COPReportNo = vrcopProductionPlantProdEquipmentCacheModel.COPReportNo;

		if ((COPReportNo != null) && (COPReportNo.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.COPReportNo = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.sequenceNo = getSequenceNo();

		vrcopProductionPlantProdEquipmentCacheModel.equipmentCode = getEquipmentCode();

		String equipmentCode = vrcopProductionPlantProdEquipmentCacheModel.equipmentCode;

		if ((equipmentCode != null) && (equipmentCode.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.equipmentCode = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.equipmentName = getEquipmentName();

		String equipmentName = vrcopProductionPlantProdEquipmentCacheModel.equipmentName;

		if ((equipmentName != null) && (equipmentName.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.equipmentName = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.equipmentType = getEquipmentType();

		String equipmentType = vrcopProductionPlantProdEquipmentCacheModel.equipmentType;

		if ((equipmentType != null) && (equipmentType.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.equipmentType = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.tradeMark = getTradeMark();

		String tradeMark = vrcopProductionPlantProdEquipmentCacheModel.tradeMark;

		if ((tradeMark != null) && (tradeMark.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.tradeMark = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.tradeMarkName = getTradeMarkName();

		String tradeMarkName = vrcopProductionPlantProdEquipmentCacheModel.tradeMarkName;

		if ((tradeMarkName != null) && (tradeMarkName.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.tradeMarkName = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.commercialName = getCommercialName();

		String commercialName = vrcopProductionPlantProdEquipmentCacheModel.commercialName;

		if ((commercialName != null) && (commercialName.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.commercialName = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.modelCode = getModelCode();

		String modelCode = vrcopProductionPlantProdEquipmentCacheModel.modelCode;

		if ((modelCode != null) && (modelCode.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.modelCode = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.designSymbolNo = getDesignSymbolNo();

		String designSymbolNo = vrcopProductionPlantProdEquipmentCacheModel.designSymbolNo;

		if ((designSymbolNo != null) && (designSymbolNo.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.designSymbolNo = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.productionCountryCode = getProductionCountryCode();

		vrcopProductionPlantProdEquipmentCacheModel.equipmentStatus = getEquipmentStatus();

		String equipmentStatus = vrcopProductionPlantProdEquipmentCacheModel.equipmentStatus;

		if ((equipmentStatus != null) && (equipmentStatus.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.equipmentStatus = null;
		}

		vrcopProductionPlantProdEquipmentCacheModel.notes = getNotes();

		String notes = vrcopProductionPlantProdEquipmentCacheModel.notes;

		if ((notes != null) && (notes.length() == 0)) {
			vrcopProductionPlantProdEquipmentCacheModel.notes = null;
		}

		Date modifyDate = getModifyDate();

		if (modifyDate != null) {
			vrcopProductionPlantProdEquipmentCacheModel.modifyDate = modifyDate.getTime();
		}
		else {
			vrcopProductionPlantProdEquipmentCacheModel.modifyDate = Long.MIN_VALUE;
		}

		Date syncDate = getSyncDate();

		if (syncDate != null) {
			vrcopProductionPlantProdEquipmentCacheModel.syncDate = syncDate.getTime();
		}
		else {
			vrcopProductionPlantProdEquipmentCacheModel.syncDate = Long.MIN_VALUE;
		}

		return vrcopProductionPlantProdEquipmentCacheModel;
	}
	...
	public String toXmlString() {
		...
		sb.append("com.fds.vr.cop.model.VRCOPProductionPlantProdEquipment");
	...
	private static final ClassLoader _classLoader = VRCOPProductionPlantProdEquipment.class.getClassLoader();
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
			VRCOPProductionPlantProdEquipment.class
		};
	private long _id;
	private int _mtCore;
	...
	private VRCOPProductionPlantProdEquipment _escapedModel;
}