...
public class DictItemPersistenceImpl extends BasePersistenceImpl<DictItem>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID_GREATER_THAN =
		new FinderPath(DictItemModelImpl.ENTITY_CACHE_ENABLED,
			DictItemModelImpl.FINDER_CACHE_ENABLED, DictItemImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByGROUPID_GREATER_THAN",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_GROUPID_GREATER_THAN =
		new FinderPath(DictItemModelImpl.ENTITY_CACHE_ENABLED,
			DictItemModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"countByGROUPID_GREATER_THAN", new String[] { Long.class.getName() });

	/**
	 * Returns all the dict items where groupId &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching dict items
	 */
	@Override
	public List<DictItem> findByGROUPID_GREATER_THAN(long groupId) {
		return findByGROUPID_GREATER_THAN(groupId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the dict items where groupId &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link DictItemModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<DictItem> findByGROUPID_GREATER_THAN(long groupId, int start,
		int end) {
		return findByGROUPID_GREATER_THAN(groupId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the dict items where groupId &ge; &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link DictItemModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<DictItem> findByGROUPID_GREATER_THAN(long groupId, int start,
		int end, OrderByComparator<DictItem> orderByComparator) {
		return findByGROUPID_GREATER_THAN(groupId, start, end,
			orderByComparator, true);
	}
	...
	public List<DictItem> findByGROUPID_GREATER_THAN(long groupId, int start,
		...
		finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_GROUPID_GREATER_THAN;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_GROUPID_GREATER_THAN_GROUPID_2);
	...
	/**
	 * Returns the first dict item in the ordered set where groupId &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching dict item
	 ...
	 */
	@Override
	public DictItem findByGROUPID_GREATER_THAN_First(long groupId,
		OrderByComparator<DictItem> orderByComparator)
		throws NoSuchDictItemException {
		DictItem dictItem = fetchByGROUPID_GREATER_THAN_First(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DictItem fetchByGROUPID_GREATER_THAN_First(long groupId,
		OrderByComparator<DictItem> orderByComparator) {
		List<DictItem> list = findByGROUPID_GREATER_THAN(groupId, 0, 1,
				orderByComparator);
	...
	/**
	 * Returns the last dict item in the ordered set where groupId &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching dict item
	 ...
	 */
	@Override
	public DictItem findByGROUPID_GREATER_THAN_Last(long groupId,
		OrderByComparator<DictItem> orderByComparator)
		throws NoSuchDictItemException {
		DictItem dictItem = fetchByGROUPID_GREATER_THAN_Last(groupId,
				orderByComparator);
	 ...
	 */
	@Override
	public DictItem fetchByGROUPID_GREATER_THAN_Last(long groupId,
		OrderByComparator<DictItem> orderByComparator) {
		int count = countByGROUPID_GREATER_THAN(groupId);

		if (count == 0) {
			return null;
		}

		List<DictItem> list = findByGROUPID_GREATER_THAN(groupId, count - 1,
				count, orderByComparator);
	...
	/**
	 * Returns the dict items before and after the current dict item in the ordered set where groupId &ge; &#63;.
	 *
	 * @param dictItemId the primary key of the current dict item
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public DictItem[] findByGROUPID_GREATER_THAN_PrevAndNext(long dictItemId,
		long groupId, OrderByComparator<DictItem> orderByComparator)
		throws NoSuchDictItemException {
		DictItem dictItem = findByPrimaryKey(dictItemId);
		...
		try {
			...
			array[0] = getByGROUPID_GREATER_THAN_PrevAndNext(session, dictItem,
					groupId, orderByComparator, true);

			array[1] = dictItem;

			array[2] = getByGROUPID_GREATER_THAN_PrevAndNext(session, dictItem,
	...
	protected DictItem getByGROUPID_GREATER_THAN_PrevAndNext(Session session,
		DictItem dictItem, long groupId,
		OrderByComparator<DictItem> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the dict items where groupId &ge; &#63; from the database.
	 *
	 * @param groupId the group ID
	 */
	@Override
	public void removeByGROUPID_GREATER_THAN(long groupId) {
		for (DictItem dictItem : findByGROUPID_GREATER_THAN(groupId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dictItem);
		}
	}
	...
	/**
	 * Returns the number of dict items where groupId &ge; &#63;.
	 *
	 * @param groupId the group ID
	 * @return the number of matching dict items
	 */
	@Override
	public int countByGROUPID_GREATER_THAN(long groupId) {
		FinderPath finderPath = FINDER_PATH_WITH_PAGINATION_COUNT_BY_GROUPID_GREATER_THAN;
	...
	private static final String _FINDER_COLUMN_GROUPID_GREATER_THAN_GROUPID_2 = "dictItem.groupId >= ?";
