...
public class DictItemCacheModel implements CacheModel<DictItem>, Externalizable {
	...
	public DictItem toEntityModel() {
		...
		if (uuid == null) {
			dictItemImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dictItemImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (itemNameEN == null) {
			dictItemImpl.setItemNameEN(StringPool.BLANK);
		}
		else {
		...
		if (sibling == null) {
			dictItemImpl.setSibling(StringPool.BLANK);
		}
		else {
		...
		if (metaData == null) {
			dictItemImpl.setMetaData(StringPool.BLANK);
		}
		else {
