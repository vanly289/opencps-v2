...
public class FileAttachCacheModel implements CacheModel<FileAttach>,
	...
	public FileAttach toEntityModel() {
		...
		if (userName == null) {
			fileAttachImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (className == null) {
			fileAttachImpl.setClassName(StringPool.BLANK);
		}
		else {
		...
		if (classPK == null) {
			fileAttachImpl.setClassPK(StringPool.BLANK);
		}
		else {
		...
		if (fullName == null) {
			fileAttachImpl.setFullName(StringPool.BLANK);
		}
		else {
		...
		if (email == null) {
			fileAttachImpl.setEmail(StringPool.BLANK);
		}
		else {
		...
		if (source == null) {
			fileAttachImpl.setSource(StringPool.BLANK);
		}
		else {
		...
		if (sourceUrl == null) {
			fileAttachImpl.setSourceUrl(StringPool.BLANK);
		}
		else {
		...
		if (fileName == null) {
			fileAttachImpl.setFileName(StringPool.BLANK);
		}
		else {
