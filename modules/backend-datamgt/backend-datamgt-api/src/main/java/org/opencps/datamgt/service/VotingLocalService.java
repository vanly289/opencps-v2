...
public interface VotingLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VotingLocalServiceUtil} to access the voting local service. Add custom service methods to {@link org.opencps.datamgt.service.impl.VotingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Voting> getVotingsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Voting fetchVotingByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Voting getVotingByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
