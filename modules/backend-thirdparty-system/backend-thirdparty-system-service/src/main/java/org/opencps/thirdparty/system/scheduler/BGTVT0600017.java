...
import org.opencps.thirdparty.system.nsw.model.ApprovalOfVLAdjustFrequency;
...
public class BGTVT0600017 {
	public static MessageQueueInputModel convertResult(Dossier dossier, ThirdPartyDossierSync dossierSync, Envelope envelope, String type, String function) throws PortalException {
		...
		ApprovalOfVLAdjustFrequency approvalOfVLAdjustFrequency = new ApprovalOfVLAdjustFrequency();
		...
		approvalOfVLAdjustFrequency.getAttachedFile().addAll(lstFiles);
		envelope.getBody().getContent().setApprovalOfVLAdjustFrequency(approvalOfVLAdjustFrequency);
