...
public interface ServiceProcessLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ServiceProcess> getByServerNo(java.lang.String serverNo);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceProcess fetchServiceProcessByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceProcess getServiceProcessByUuidAndGroupId(
	...
	public ServiceProcess updateServiceProcess(long groupId,
		...
		java.lang.String serverNo, ServiceContext context)
		throws PortalException;
