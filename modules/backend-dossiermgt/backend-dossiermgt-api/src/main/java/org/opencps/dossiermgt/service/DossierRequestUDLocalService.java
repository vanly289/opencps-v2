...
public interface DossierRequestUDLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierRequestUD fetchDossierRequestUDByUuidAndGroupId(
		java.lang.String uuid, long groupId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierRequestUD getByDossierAndType(long dossierId,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierRequestUD getDossierRequestUDByUuidAndGroupId(
	...
	public DossierRequestUD updateDossierRequest(long dossierRequestId,
		...
		int status, ServiceContext context)
		throws PortalException, SystemException;
