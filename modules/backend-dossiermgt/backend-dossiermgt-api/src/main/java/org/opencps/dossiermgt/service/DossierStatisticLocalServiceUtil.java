...
public class DossierStatisticLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.dossiermgt.model.DossierStatistic insert(
		...
		int ontimeCount, int overtimeCount, java.lang.String govAgencyCode,
		java.lang.String govAgencyName, java.lang.String domainCode,
		java.lang.String domainName, int administrationLevel,
		boolean reporting,
	...
	*/
	...
	private static ServiceTracker<DossierStatisticLocalService, DossierStatisticLocalService> _serviceTracker =
		ServiceTrackerFactory.open(DossierStatisticLocalService.class);
}