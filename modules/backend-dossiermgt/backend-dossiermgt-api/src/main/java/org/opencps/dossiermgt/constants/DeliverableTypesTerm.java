...
public class DeliverableTypesTerm {
	public static final String DOSSIER_LOG_ID = "deliverableTypeId";
	public static final String CREATE_DATE = "createDate";
	public static final String MODIFIED_DATE  = "modifiedDate";
	public static final String DELIVERABLE_TYPE = "deliverableType_";
