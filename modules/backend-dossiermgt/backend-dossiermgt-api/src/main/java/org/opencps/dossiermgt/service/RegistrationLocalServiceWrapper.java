...
public class RegistrationLocalServiceWrapper implements RegistrationLocalService,
	...
	*/
	...
	@Override
	public java.util.List<org.opencps.dossiermgt.model.Registration> findByREG_APPNO_markasdeleted(
		long groupId, java.lang.String applicantIdNo, int markasdeleted) {
		return _registrationLocalService.findByREG_APPNO_markasdeleted(groupId,
			applicantIdNo, markasdeleted);
	}
	...
	*/
	...
	public org.opencps.dossiermgt.model.Registration insert(long groupId,
		long companyId, java.lang.String applicantName,
	...
	public org.opencps.dossiermgt.model.Registration updateRegistration(
		...
		return _registrationLocalService.updateRegistration(groupId,
			...
			registrationClass, representativeEnterprise, markasdeleted,
			remarks, serviceContext);
	}
