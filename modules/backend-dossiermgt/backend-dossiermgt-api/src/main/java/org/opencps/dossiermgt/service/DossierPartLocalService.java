...
public interface DossierPartLocalService extends BaseLocalService,
	...
	*/
	...
	public java.lang.String updateContent(long dossierPartId, int contentType,
		java.lang.String input, ServiceContext context)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DossierPart> getByTemplateNo(long groupId,
		java.lang.String templateNo) throws PortalException;
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierPart fetchByTemplatePartNo(long groupId,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierPart getByFileTemplateNo(long groupId,
		java.lang.String fileTemplateNo);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierPart getByPartTypeEsign(java.lang.String templateNo,
	...
	*/
	...
	public DossierPart updateDossierPart(long groupId, long dossierPartId,
		...
		boolean multiple, java.lang.String formScript,
		java.lang.String formReport, java.lang.String sampleData,
		boolean required, java.lang.String fileTemplateNo, boolean eSign,
