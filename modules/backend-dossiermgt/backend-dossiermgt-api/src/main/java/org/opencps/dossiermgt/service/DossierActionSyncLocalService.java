...
/**
 * Provides the local service interface for DossierActionSync. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see DossierActionSyncLocalServiceUtil
...
public interface DossierActionSyncLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DossierActionSyncLocalServiceUtil} to access the dossier action sync local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.DossierActionSyncLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierActionSync getDossierActionSyncByUuidAndGroupId(
