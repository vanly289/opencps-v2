...
public interface DeliverableTypeLocalService extends BaseLocalService,
	...
	*/
	...
	public DeliverableType addDeliverableType(long groupId,
		java.lang.String deliverableName, java.lang.String deliverableType_,
		java.lang.String codePattern, java.lang.String counter,
		java.lang.String formScript, java.lang.String formReport,
		java.lang.String mappingData, ServiceContext serviceContext)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeliverableType fetchDeliverableTypeByUuidAndGroupId(
		java.lang.String uuid, long groupId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeliverableType getByCode(long groupId, java.lang.String typeCode);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeliverableType getDeliverableTypeByUuidAndGroupId(
		java.lang.String uuid, long groupId) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeliverableType getDeliverableTypebyId(long groupId,
		java.lang.String deliverableTypeId) throws PortalException;

	public DeliverableType removeDeliverableType(long groupId,
		java.lang.String deliverableTypeId) throws PortalException;

	public DeliverableType updateDeliverableType(long groupId,
		long deliverableTypeId, java.lang.String deliverableName,
		java.lang.String deliverableType_, java.lang.String codePattern,
		java.lang.String counter, java.lang.String formScript,
		java.lang.String formReport, java.lang.String mappingData,
	...
	*/
	...
	public DeliverableType updateFormReport(long groupId,
		long deliverableTypeId, java.lang.String formReport,
		ServiceContext serviceContext) throws PortalException, SystemException;

	public DeliverableType updateFormScript(long groupId,
		long deliverableTypeId, java.lang.String formScript,
		ServiceContext serviceContext) throws PortalException, SystemException;

	public DeliverableType updateMappingData(long groupId,
		long deliverableTypeId, java.lang.String mappingData,
		ServiceContext serviceContext) throws PortalException, SystemException;
}