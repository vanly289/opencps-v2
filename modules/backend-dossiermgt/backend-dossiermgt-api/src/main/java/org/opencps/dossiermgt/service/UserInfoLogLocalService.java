...
/**
 * Provides the local service interface for UserInfoLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see UserInfoLogLocalServiceUtil
...
public interface UserInfoLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserInfoLogLocalServiceUtil} to access the user info log local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.UserInfoLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public UserInfoLog addUserInfoLog(long userId, JSONObject jsonData,
