...
public class ProcessStepRoleUtil {
	...
	*/
	public static List<ProcessStepRole> findByUuid(java.lang.String uuid) {
	...
	*/
	public static ProcessStepRole findByUuid_First(java.lang.String uuid,
		OrderByComparator<ProcessStepRole> orderByComparator)
	...
	*/
	public static ProcessStepRole fetchByUuid_First(java.lang.String uuid,
		OrderByComparator<ProcessStepRole> orderByComparator) {
	...
	* @throws NoSuchProcessStepRoleException if a matching process step role could not be found
	*/
	public static ProcessStepRole findByUuid_Last(java.lang.String uuid,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepRoleException {
	...
	*/
	public static ProcessStepRole fetchByUuid_Last(java.lang.String uuid,
		OrderByComparator<ProcessStepRole> orderByComparator) {
	...
	*/
	public static ProcessStepRole[] findByUuid_PrevAndNext(
		ProcessStepRolePK processStepRolePK, java.lang.String uuid,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepRoleException {
		return getPersistence()
	...
	* @return the matching process step roles
	*/
	public static List<ProcessStepRole> findByP_RID(long roleId) {
		return getPersistence().findByP_RID(roleId);
	}
	...
	* @return the range of matching process step roles
	*/
	public static List<ProcessStepRole> findByP_RID(long roleId, int start,
		int end) {
		return getPersistence().findByP_RID(roleId, start, end);
	}
	...
	*/
	public static List<ProcessStepRole> findByP_RID(long roleId, int start,
		...
		return getPersistence()
				   .findByP_RID(roleId, start, end, orderByComparator);
	}
	...
	* @throws NoSuchProcessStepRoleException if a matching process step role could not be found
	*/
	public static ProcessStepRole findByP_RID_First(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepRoleException {
		return getPersistence().findByP_RID_First(roleId, orderByComparator);
	}
	...
	* @return the first matching process step role, or <code>null</code> if a matching process step role could not be found
	*/
	public static ProcessStepRole fetchByP_RID_First(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator) {
		return getPersistence().fetchByP_RID_First(roleId, orderByComparator);
	}
	...
	* @throws NoSuchProcessStepRoleException if a matching process step role could not be found
	*/
	public static ProcessStepRole findByP_RID_Last(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepRoleException {
		return getPersistence().findByP_RID_Last(roleId, orderByComparator);
	}
	...
	* @return the last matching process step role, or <code>null</code> if a matching process step role could not be found
	*/
	public static ProcessStepRole fetchByP_RID_Last(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator) {
		return getPersistence().fetchByP_RID_Last(roleId, orderByComparator);
	}
	...
	* @throws NoSuchProcessStepRoleException if a process step role with the primary key could not be found
	*/
	public static ProcessStepRole[] findByP_RID_PrevAndNext(
		ProcessStepRolePK processStepRolePK, long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchProcessStepRoleException {
		return getPersistence()
				   .findByP_RID_PrevAndNext(processStepRolePK, roleId,
			orderByComparator);
	}
	...
	* @param roleId the role ID
	*/
	public static void removeByP_RID(long roleId) {
		getPersistence().removeByP_RID(roleId);
	}
	...
	* @return the number of matching process step roles
	*/
	public static int countByP_RID(long roleId) {
		return getPersistence().countByP_RID(roleId);
	}
	...
	*/
	...
	private static ServiceTracker<ProcessStepRolePersistence, ProcessStepRolePersistence> _serviceTracker =
		ServiceTrackerFactory.open(ProcessStepRolePersistence.class);
}