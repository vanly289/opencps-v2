...
public interface ProcessOptionLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessOption fetchProcessOptionByUuidAndGroupId(
		java.lang.String uuid, long groupId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessOption getByDTPLNoAndServiceCF(long groupId,
		java.lang.String dossierTemplateNo, long serviceConfigId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessOption getProcessOptionByUuidAndGroupId(
	...
	@Indexable(type = IndexableType.REINDEX)
	public ProcessOption updateProcessOption(long groupId,
		java.lang.String optionName, long processOptionId,
		long serviceConfigId, int seqOrder, java.lang.String autoSelect,
		java.lang.String instructionNote, java.lang.String submissionNote,
