...
/**
 * Provides the local service interface for DeliverableLog. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author huymq
 * @see DeliverableLogLocalServiceUtil
...
public interface DeliverableLogLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DeliverableLogLocalServiceUtil} to access the deliverable log local service. Add custom service methods to {@link org.opencps.dossiermgt.service.impl.DeliverableLogLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeliverableLog fetchDeliverableLogByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DeliverableLog getDeliverableLogByUuidAndGroupId(
