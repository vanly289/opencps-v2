...
public class DossierRequestUDLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.dossiermgt.model.DossierRequestUD getByDossierAndType(
		long dossierId, java.lang.String type) {
		return getService().getByDossierAndType(dossierId, type);
	}
	...
	*/
	...
	public static org.opencps.dossiermgt.model.DossierRequestUD updateDossierRequest(
		long dossierRequestId, long dossierId, java.lang.String referenceUid,
		java.lang.String requestType, java.lang.String comment, int isNew,
		int status, com.liferay.portal.kernel.service.ServiceContext context)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService()
	...
	*/
	...
	private static ServiceTracker<DossierRequestUDLocalService, DossierRequestUDLocalService> _serviceTracker =
		ServiceTrackerFactory.open(DossierRequestUDLocalService.class);
}