...
public class ProcessPluginLocalServiceWrapper
	...
	*/
	...
	@Override
	public java.util.List<org.opencps.dossiermgt.model.ProcessPlugin> getBySC_SPID_ARUN(
		long serviceProcessId, java.lang.String stepCode, boolean autoRun) {
		return _processPluginLocalService.getBySC_SPID_ARUN(serviceProcessId,
			stepCode, autoRun);
	}
