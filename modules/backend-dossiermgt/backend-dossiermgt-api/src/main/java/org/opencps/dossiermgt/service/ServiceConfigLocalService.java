...
public interface ServiceConfigLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceConfig fetchServiceConfigByUuidAndGroupId(
		java.lang.String uuid, long groupId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceConfig getBySICodeAndGAC(long groupId,
		java.lang.String serviceInfoCode, java.lang.String govAgencyCode)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ServiceConfig getServiceConfigByUuidAndGroupId(
	...
	public ServiceConfig updateServiceConfig(long serviceConfigId, long userId,
		...
		java.lang.String serviceInstruction, int serviceLevel,
		java.lang.String serviceUrl, boolean forCitizen, boolean forBusiness,
		boolean postalService, boolean registration, ServiceContext context)
		throws PortalException;
