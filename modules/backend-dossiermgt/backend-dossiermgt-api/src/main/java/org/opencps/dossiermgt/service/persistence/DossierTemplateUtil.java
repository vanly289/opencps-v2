 ...
 * @see org.opencps.dossiermgt.service.persistence.impl.DossierTemplatePersistenceImpl
 * @generated
 */
@ProviderType
public class DossierTemplateUtil {
	...
	*/
	public static DossierTemplate findByUuid_First(java.lang.String uuid,
		OrderByComparator<DossierTemplate> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
	...
	* @throws NoSuchDossierTemplateException if a matching dossier template could not be found
	*/
	public static DossierTemplate findByG_DT_NAME(long groupId,
		java.lang.String templateName)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
		return getPersistence().findByG_DT_NAME(groupId, templateName);
	}
	...
	* @return the matching dossier template, or <code>null</code> if a matching dossier template could not be found
	*/
	public static DossierTemplate fetchByG_DT_NAME(long groupId,
		java.lang.String templateName) {
		return getPersistence().fetchByG_DT_NAME(groupId, templateName);
	}
	...
	*/
	public static DossierTemplate fetchByG_DT_NAME(long groupId,
		java.lang.String templateName, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByG_DT_NAME(groupId, templateName, retrieveFromCache);
	}
	...
	* @return the dossier template that was removed
	*/
	public static DossierTemplate removeByG_DT_NAME(long groupId,
		java.lang.String templateName)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
		return getPersistence().removeByG_DT_NAME(groupId, templateName);
	}
	...
	* @return the number of matching dossier templates
	*/
	public static int countByG_DT_NAME(long groupId,
		java.lang.String templateName) {
		return getPersistence().countByG_DT_NAME(groupId, templateName);
	}
	...
	* @throws NoSuchDossierTemplateException if a matching dossier template could not be found
	*/
	public static DossierTemplate findByG_DT_TPLNO(long groupId,
		java.lang.String templateNo)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
		return getPersistence().findByG_DT_TPLNO(groupId, templateNo);
	}
	...
	* @return the matching dossier template, or <code>null</code> if a matching dossier template could not be found
	*/
	public static DossierTemplate fetchByG_DT_TPLNO(long groupId,
		java.lang.String templateNo) {
		return getPersistence().fetchByG_DT_TPLNO(groupId, templateNo);
	}
	...
	*/
	public static DossierTemplate fetchByG_DT_TPLNO(long groupId,
		...
		return getPersistence()
				   .fetchByG_DT_TPLNO(groupId, templateNo, retrieveFromCache);
	}
	...
	* @return the dossier template that was removed
	*/
	public static DossierTemplate removeByG_DT_TPLNO(long groupId,
		java.lang.String templateNo)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
		return getPersistence().removeByG_DT_TPLNO(groupId, templateNo);
	}
	...
	* @return the number of matching dossier templates
	*/
	public static int countByG_DT_TPLNO(long groupId,
		java.lang.String templateNo) {
		return getPersistence().countByG_DT_TPLNO(groupId, templateNo);
	}
	...
	* @throws NoSuchDossierTemplateException if a matching dossier template could not be found
	*/
	public static DossierTemplate findByGID_DTPLNO(long groupId,
		java.lang.String templateNo)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
		return getPersistence().findByGID_DTPLNO(groupId, templateNo);
	}
	...
	* @return the matching dossier template, or <code>null</code> if a matching dossier template could not be found
	*/
	public static DossierTemplate fetchByGID_DTPLNO(long groupId,
		java.lang.String templateNo) {
		return getPersistence().fetchByGID_DTPLNO(groupId, templateNo);
	}
	...
	*/
	public static DossierTemplate fetchByGID_DTPLNO(long groupId,
		java.lang.String templateNo, boolean retrieveFromCache) {
		return getPersistence()
				   .fetchByGID_DTPLNO(groupId, templateNo, retrieveFromCache);
	}
	...
	* @return the dossier template that was removed
	*/
	public static DossierTemplate removeByGID_DTPLNO(long groupId,
		java.lang.String templateNo)
		throws org.opencps.dossiermgt.exception.NoSuchDossierTemplateException {
		return getPersistence().removeByGID_DTPLNO(groupId, templateNo);
	}
	...
	* @return the number of matching dossier templates
	*/
	public static int countByGID_DTPLNO(long groupId,
		java.lang.String templateNo) {
		return getPersistence().countByGID_DTPLNO(groupId, templateNo);
	}
