...
public interface DossierMarkLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DossierMark> getDossierMarksByUuidAndCompanyId(
	...
	*/
	...
	public DossierMark addDossierMark(long groupId, long dossierId,
		java.lang.String dossierPartNo, java.lang.Boolean fileCheck,
		int fileType, ServiceContext serviceContext)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierMark fetchDossierMarkByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DossierMark getDossierMarkByUuidAndGroupId(java.lang.String uuid,
