...
public class DossierActionUserLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.dossiermgt.model.DossierActionUser getByDID_UID_MOD(
		long dossierActionId, long userId, int moderator) {
		return getService().getByDID_UID_MOD(dossierActionId, userId, moderator);
	}
