...
public class DossierActionUserUtil {
	...
	* @throws NoSuchDossierActionUserException if a matching dossier action user could not be found
	*/
	public static DossierActionUser findByDID_UID_MOD(long dossierActionId,
		long userId, int moderator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .findByDID_UID_MOD(dossierActionId, userId, moderator);
	}
	...
	* @return the matching dossier action user, or <code>null</code> if a matching dossier action user could not be found
	*/
	public static DossierActionUser fetchByDID_UID_MOD(long dossierActionId,
		long userId, int moderator) {
		return getPersistence()
				   .fetchByDID_UID_MOD(dossierActionId, userId, moderator);
	}
	...
	* @return the dossier action user that was removed
	*/
	public static DossierActionUser removeByDID_UID_MOD(long dossierActionId,
		long userId, int moderator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierActionUserException {
		return getPersistence()
				   .removeByDID_UID_MOD(dossierActionId, userId, moderator);
	}
	...
	* @return the number of matching dossier action users
	*/
	public static int countByDID_UID_MOD(long dossierActionId, long userId,
		int moderator) {
		return getPersistence()
				   .countByDID_UID_MOD(dossierActionId, userId, moderator);
	}
