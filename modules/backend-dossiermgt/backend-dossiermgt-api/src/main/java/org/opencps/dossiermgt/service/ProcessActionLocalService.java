...
public interface ProcessActionLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProcessAction> getByActionCode(long groupId,
		java.lang.String actionCode) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessAction fetchProcessActionByUuidAndGroupId(
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessAction getByS_A_PS(long serviceProcessId,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProcessAction getProcessActionByUuidAndGroupId(
	...
	public ProcessAction updateProcessAction(long groupId,
		...
		java.lang.String actionCode, java.lang.String actionName,
		boolean allowAssignUser, long assignUserId, boolean requestPayment,
