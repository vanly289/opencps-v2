...
public interface ServiceInfoPersistence extends BasePersistence<ServiceInfo> {
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public ServiceInfo findBySC_GI(java.lang.String serviceCode, long groupId)
		throws NoSuchServiceInfoException;
	...
	* @return the matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public ServiceInfo fetchBySC_GI(java.lang.String serviceCode, long groupId);
	...
	* @return the service info that was removed
	*/
	public ServiceInfo removeBySC_GI(java.lang.String serviceCode, long groupId)
		throws NoSuchServiceInfoException;
	...
	* @return the number of matching service infos
	*/
	public int countBySC_GI(java.lang.String serviceCode, long groupId);
	...
	* @return the matching service infos
	*/
	public java.util.List<ServiceInfo> findByGI_DC(
		java.lang.String domainCode, long groupId);
	...
	*/
	public java.util.List<ServiceInfo> findByGI_DC(
		java.lang.String domainCode, long groupId, int start, int end);
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public ServiceInfo findByGI_DC_First(java.lang.String domainCode,
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator<ServiceInfo> orderByComparator)
		throws NoSuchServiceInfoException;
	...
	* @return the first matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public ServiceInfo fetchByGI_DC_First(java.lang.String domainCode,
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator<ServiceInfo> orderByComparator);
	...
	* @throws NoSuchServiceInfoException if a matching service info could not be found
	*/
	public ServiceInfo findByGI_DC_Last(java.lang.String domainCode,
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator<ServiceInfo> orderByComparator)
		throws NoSuchServiceInfoException;
	...
	* @return the last matching service info, or <code>null</code> if a matching service info could not be found
	*/
	public ServiceInfo fetchByGI_DC_Last(java.lang.String domainCode,
		long groupId,
		com.liferay.portal.kernel.util.OrderByComparator<ServiceInfo> orderByComparator);
	...
	* @param groupId the group ID
	*/
	public void removeByGI_DC(java.lang.String domainCode, long groupId);
	...
	* @return the number of matching service infos
	*/
	public int countByGI_DC(java.lang.String domainCode, long groupId);
