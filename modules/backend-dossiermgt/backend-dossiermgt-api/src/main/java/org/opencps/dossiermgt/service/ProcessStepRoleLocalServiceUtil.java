...
public class ProcessStepRoleLocalServiceUtil {
	...
	*/
	...
	public static java.util.List<org.opencps.dossiermgt.model.ProcessStepRole> findByP_RID(
		long roleId) {
		return getService().findByP_RID(roleId);
	}
	...
	*/
	...
	public static org.opencps.dossiermgt.model.ProcessStepRole updateProcessStepRole(
		long processStepId, long roleId, boolean moderator,
	...
	*/
	...
	private static ServiceTracker<ProcessStepRoleLocalService, ProcessStepRoleLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ProcessStepRoleLocalService.class);
}