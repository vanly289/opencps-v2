...
public interface PaymentConfigLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public PaymentConfig getPaymentConfigByUuidAndGroupId(
	...
	@Indexable(type = IndexableType.REINDEX)
	public PaymentConfig updateEConfig(long paymentConfigId,
		java.lang.String eConfig, ServiceContext context)
		throws PortalException;

	@Indexable(type = IndexableType.REINDEX)
	public PaymentConfig updateInvoidForm(long paymentConfigId,
		java.lang.String invoiceForm, ServiceContext context)
		throws PortalException;

	@Indexable(type = IndexableType.REINDEX)
	public PaymentConfig updatePaymentConfig(long groupId,
		long paymentConfigId, java.lang.String govAgencyCode,
		...
		java.lang.String invoiceLastNo, java.lang.String invoiceForm,
		java.lang.String bankInfo, java.lang.String epaymentConfig,
