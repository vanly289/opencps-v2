...
public class RegistrationTerm {
	...
	public static final String APPLICATION_ID_TYPE = "applicantIdType";
	public static final String APPLICATION_ID_NO = "applicantIdNo";
	public static final String APPLICATION_ID_DATE = "applicantIdDate";
