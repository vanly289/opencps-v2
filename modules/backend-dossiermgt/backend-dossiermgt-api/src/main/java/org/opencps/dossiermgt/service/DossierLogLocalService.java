...
public interface DossierLogLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DossierLog> getByDossierAndType(long dossierId,
		java.lang.String type, int start, int end) throws PortalException;
	...
	*/
	...
	public DossierLog updateDossierLog(long groupId, long dossierId,
		long dossierLogId, java.lang.String author, java.lang.String content,
		java.lang.String notificationType, java.lang.String payload,
		ServiceContext serviceContext) throws PortalException, SystemException;
	...
	*/
	...
	public void deleteByDossierAndType(long dossierId, java.lang.String type)
		throws PortalException;
}