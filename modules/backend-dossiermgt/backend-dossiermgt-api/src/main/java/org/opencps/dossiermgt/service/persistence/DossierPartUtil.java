...
public class DossierPartUtil {
	...
	* @throws NoSuchDossierPartException if a matching dossier part could not be found
	*/
	public static DossierPart findByTP_NO_Last(long groupId,
		java.lang.String templateNo,
		OrderByComparator<DossierPart> orderByComparator)
		throws org.opencps.dossiermgt.exception.NoSuchDossierPartException {
		return getPersistence()
	...
	* @param templateNo the template no
	*/
	public static void removeByTP_NO(long groupId, java.lang.String templateNo) {
	...
	* @return the number of matching dossier parts
	*/
	public static int countByTP_NO(long groupId, java.lang.String templateNo) {
	...
	* @throws NoSuchDossierPartException if a matching dossier part could not be found
	*/
	public static DossierPart findByTP_NO_PART(long groupId,
	...
	* @return the number of matching dossier parts
	*/
	public static int countByTP_NO_PART(long groupId,
		java.lang.String templateNo, java.lang.String partNo) {
	...
	* @throws NoSuchDossierPartException if a matching dossier part could not be found
	*/
	public static DossierPart findByGID_FTN(long groupId,
	...
	* @return the number of matching dossier parts
	*/
	public static int countByGID_FTN(long groupId,
		java.lang.String fileTemplateNo) {
	...
	* @throws NoSuchDossierPartException if a matching dossier part could not be found
	*/
	public static DossierPart findByTP_NO_PART_ESIGN(
	...
	* @return the matching dossier part, or <code>null</code> if a matching dossier part could not be found
	*/
	public static DossierPart fetchByTP_NO_PART_ESIGN(
		java.lang.String templateNo, java.lang.String partNo, int partType,
		boolean eSign) {
		return getPersistence()
	...
	*/
	public static DossierPart fetchByTP_NO_PART_ESIGN(
		java.lang.String templateNo, java.lang.String partNo, int partType,
		boolean eSign, boolean retrieveFromCache) {
		return getPersistence()
	...
	* @return the dossier part that was removed
	*/
	public static DossierPart removeByTP_NO_PART_ESIGN(
		java.lang.String templateNo, java.lang.String partNo, int partType,
		boolean eSign)
		throws org.opencps.dossiermgt.exception.NoSuchDossierPartException {
		return getPersistence()
	...
	* @return the number of matching dossier parts
	*/
	public static int countByTP_NO_PART_ESIGN(java.lang.String templateNo,
