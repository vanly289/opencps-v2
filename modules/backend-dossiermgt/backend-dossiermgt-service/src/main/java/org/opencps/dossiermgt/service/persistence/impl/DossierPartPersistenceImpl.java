 ...
 * @see org.opencps.dossiermgt.service.persistence.DossierPartUtil
 * @generated
 */
@ProviderType
public class DossierPartPersistenceImpl extends BasePersistenceImpl<DossierPart>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_TP_NO = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, DossierPartImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByTP_NO",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_TP_NO = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, DossierPartImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByTP_NO",
			new String[] { Long.class.getName(), String.class.getName() },
			DossierPartModelImpl.GROUPID_COLUMN_BITMASK |
			DossierPartModelImpl.TEMPLATENO_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_TP_NO = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByTP_NO",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public List<DossierPart> findByTP_NO(long groupId, String templateNo) {
		return findByTP_NO(groupId, templateNo, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DossierPart> findByTP_NO(long groupId, String templateNo,
		int start, int end) {
		return findByTP_NO(groupId, templateNo, start, end, null);
	}
	...
	public List<DossierPart> findByTP_NO(long groupId, String templateNo,
		int start, int end, OrderByComparator<DossierPart> orderByComparator) {
		return findByTP_NO(groupId, templateNo, start, end, orderByComparator,
			true);
	}
	...
	public List<DossierPart> findByTP_NO(long groupId, String templateNo,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_TP_NO;
			finderArgs = new Object[] { groupId, templateNo };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_TP_NO;
			finderArgs = new Object[] {
					groupId, templateNo,
			...
			if ((list != null) && !list.isEmpty()) {
				for (DossierPart dossierPart : list) {
					if ((groupId != dossierPart.getGroupId()) ||
							!Objects.equals(templateNo,
								dossierPart.getTemplateNo())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_TP_NO_GROUPID_2);

			boolean bindTemplateNo = false;

			if (templateNo == null) {
				query.append(_FINDER_COLUMN_TP_NO_TEMPLATENO_1);
			}
			else if (templateNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_TP_NO_TEMPLATENO_3);
			}
			else {
				bindTemplateNo = true;

				query.append(_FINDER_COLUMN_TP_NO_TEMPLATENO_2);
			}
	 ...
	 */
	@Override
	public DossierPart findByTP_NO_First(long groupId, String templateNo,
		OrderByComparator<DossierPart> orderByComparator)
		throws NoSuchDossierPartException {
		DossierPart dossierPart = fetchByTP_NO_First(groupId, templateNo,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierPart fetchByTP_NO_First(long groupId, String templateNo,
		OrderByComparator<DossierPart> orderByComparator) {
		List<DossierPart> list = findByTP_NO(groupId, templateNo, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierPart findByTP_NO_Last(long groupId, String templateNo,
		OrderByComparator<DossierPart> orderByComparator)
		throws NoSuchDossierPartException {
		DossierPart dossierPart = fetchByTP_NO_Last(groupId, templateNo,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierPart fetchByTP_NO_Last(long groupId, String templateNo,
		OrderByComparator<DossierPart> orderByComparator) {
		int count = countByTP_NO(groupId, templateNo);

		if (count == 0) {
			return null;
		}

		List<DossierPart> list = findByTP_NO(groupId, templateNo, count - 1,
				count, orderByComparator);
	...
	public DossierPart[] findByTP_NO_PrevAndNext(long dossierPartId,
		...
		try {
			...
			array[0] = getByTP_NO_PrevAndNext(session, dossierPart, groupId,
					templateNo, orderByComparator, true);

			array[1] = dossierPart;

			array[2] = getByTP_NO_PrevAndNext(session, dossierPart, groupId,
					templateNo, orderByComparator, false);
	...
	protected DossierPart getByTP_NO_PrevAndNext(Session session,
		DossierPart dossierPart, long groupId, String templateNo,
		OrderByComparator<DossierPart> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByTP_NO(long groupId, String templateNo) {
		for (DossierPart dossierPart : findByTP_NO(groupId, templateNo,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dossierPart);
		}
	}
	 ...
	 */
	@Override
	public int countByTP_NO(long groupId, String templateNo) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_TP_NO;
	...
	private static final String _FINDER_COLUMN_TP_NO_GROUPID_2 = "dossierPart.groupId = ? AND ";
	private static final String _FINDER_COLUMN_TP_NO_TEMPLATENO_1 = "dossierPart.templateNo IS NULL";
	private static final String _FINDER_COLUMN_TP_NO_TEMPLATENO_2 = "dossierPart.templateNo = ?";
	private static final String _FINDER_COLUMN_TP_NO_TEMPLATENO_3 = "(dossierPart.templateNo IS NULL OR dossierPart.templateNo = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_TP_NO_PART = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, DossierPartImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByTP_NO_PART",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			},
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_TP_NO_PART = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByTP_NO_PART",
			new String[] {
				Long.class.getName(), String.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public DossierPart findByTP_NO_PART(long groupId, String templateNo,
		String partNo) throws NoSuchDossierPartException {
		DossierPart dossierPart = fetchByTP_NO_PART(groupId, templateNo, partNo);
	 ...
	 */
	@Override
	public DossierPart fetchByTP_NO_PART(long groupId, String templateNo,
		String partNo) {
		return fetchByTP_NO_PART(groupId, templateNo, partNo, true);
	}
	...
	@Override
	public DossierPart fetchByTP_NO_PART(long groupId, String templateNo,
		String partNo, boolean retrieveFromCache) {
		Object[] finderArgs = new Object[] { groupId, templateNo, partNo };

		Object result = null;

		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_TP_NO_PART,
					finderArgs, this);
		}
		...
		if (result instanceof DossierPart) {
			...
			if ((groupId != dossierPart.getGroupId()) ||
					...
					!Objects.equals(partNo, dossierPart.getPartNo())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_TP_NO_PART_GROUPID_2);

			boolean bindTemplateNo = false;

			if (templateNo == null) {
				query.append(_FINDER_COLUMN_TP_NO_PART_TEMPLATENO_1);
			}
			else if (templateNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_TP_NO_PART_TEMPLATENO_3);
			}
			else {
				bindTemplateNo = true;

				query.append(_FINDER_COLUMN_TP_NO_PART_TEMPLATENO_2);
			}

			boolean bindPartNo = false;

			if (partNo == null) {
				query.append(_FINDER_COLUMN_TP_NO_PART_PARTNO_1);
			}
			else if (partNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_TP_NO_PART_PARTNO_3);
			}
			else {
				bindPartNo = true;

				query.append(_FINDER_COLUMN_TP_NO_PART_PARTNO_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_TP_NO_PART,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"DossierPartPersistenceImpl.fetchByTP_NO_PART(long, String, String, boolean) with parameters (" +
					...
					if ((dossierPart.getGroupId() != groupId) ||
							(dossierPart.getTemplateNo() == null) ||
							!dossierPart.getTemplateNo().equals(templateNo) ||
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_TP_NO_PART,
					finderArgs);
	 ...
	 */
	@Override
	public DossierPart removeByTP_NO_PART(long groupId, String templateNo,
		String partNo) throws NoSuchDossierPartException {
		DossierPart dossierPart = findByTP_NO_PART(groupId, templateNo, partNo);
	 ...
	 */
	@Override
	public int countByTP_NO_PART(long groupId, String templateNo, String partNo) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_TP_NO_PART;
	...
	private static final String _FINDER_COLUMN_TP_NO_PART_GROUPID_2 = "dossierPart.groupId = ? AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_TEMPLATENO_1 = "dossierPart.templateNo IS NULL AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_TEMPLATENO_2 = "dossierPart.templateNo = ? AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_TEMPLATENO_3 = "(dossierPart.templateNo IS NULL OR dossierPart.templateNo = '') AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_PARTNO_1 = "dossierPart.partNo IS NULL";
	private static final String _FINDER_COLUMN_TP_NO_PART_PARTNO_2 = "dossierPart.partNo = ?";
	private static final String _FINDER_COLUMN_TP_NO_PART_PARTNO_3 = "(dossierPart.partNo IS NULL OR dossierPart.partNo = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_GID_FTN = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, DossierPartImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByGID_FTN",
			new String[] { Long.class.getName(), String.class.getName() },
			DossierPartModelImpl.GROUPID_COLUMN_BITMASK |
			DossierPartModelImpl.FILETEMPLATENO_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_GID_FTN = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByGID_FTN",
			new String[] { Long.class.getName(), String.class.getName() });
	 ...
	 */
	@Override
	public DossierPart findByGID_FTN(long groupId, String fileTemplateNo)
		throws NoSuchDossierPartException {
		DossierPart dossierPart = fetchByGID_FTN(groupId, fileTemplateNo);
	 ...
	 */
	@Override
	public DossierPart fetchByGID_FTN(long groupId, String fileTemplateNo) {
		return fetchByGID_FTN(groupId, fileTemplateNo, true);
	}
	...
	public DossierPart fetchByGID_FTN(long groupId, String fileTemplateNo,
		...
		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_GID_FTN,
					finderArgs, this);
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_GID_FTN_GROUPID_2);

			boolean bindFileTemplateNo = false;

			if (fileTemplateNo == null) {
				query.append(_FINDER_COLUMN_GID_FTN_FILETEMPLATENO_1);
			}
			else if (fileTemplateNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_GID_FTN_FILETEMPLATENO_3);
			}
			else {
				bindFileTemplateNo = true;

				query.append(_FINDER_COLUMN_GID_FTN_FILETEMPLATENO_2);
			}
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_GID_FTN,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"DossierPartPersistenceImpl.fetchByGID_FTN(long, String, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
					...
					if ((dossierPart.getGroupId() != groupId) ||
							(dossierPart.getFileTemplateNo() == null) ||
							!dossierPart.getFileTemplateNo()
											.equals(fileTemplateNo)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_GID_FTN,
							finderArgs, dossierPart);
					}
				}
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_GID_FTN,
					finderArgs);
	 ...
	 */
	@Override
	public DossierPart removeByGID_FTN(long groupId, String fileTemplateNo)
		throws NoSuchDossierPartException {
		DossierPart dossierPart = findByGID_FTN(groupId, fileTemplateNo);
	 ...
	 */
	@Override
	public int countByGID_FTN(long groupId, String fileTemplateNo) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_GID_FTN;
	...
	private static final String _FINDER_COLUMN_GID_FTN_GROUPID_2 = "dossierPart.groupId = ? AND ";
	private static final String _FINDER_COLUMN_GID_FTN_FILETEMPLATENO_1 = "dossierPart.fileTemplateNo IS NULL";
	private static final String _FINDER_COLUMN_GID_FTN_FILETEMPLATENO_2 = "dossierPart.fileTemplateNo = ?";
	private static final String _FINDER_COLUMN_GID_FTN_FILETEMPLATENO_3 = "(dossierPart.fileTemplateNo IS NULL OR dossierPart.fileTemplateNo = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, DossierPartImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByTP_NO_PART_ESIGN",
			new String[] {
			...
			DossierPartModelImpl.ESIGN_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_TP_NO_PART_ESIGN = new FinderPath(DossierPartModelImpl.ENTITY_CACHE_ENABLED,
			DossierPartModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"countByTP_NO_PART_ESIGN",
			new String[] {
				String.class.getName(), String.class.getName(),
				Integer.class.getName(), Boolean.class.getName()
			});
	 ...
	 */
	@Override
	public DossierPart findByTP_NO_PART_ESIGN(String templateNo, String partNo,
		int partType, boolean eSign) throws NoSuchDossierPartException {
		DossierPart dossierPart = fetchByTP_NO_PART_ESIGN(templateNo, partNo,
				partType, eSign);
	 ...
	 */
	@Override
	public DossierPart fetchByTP_NO_PART_ESIGN(String templateNo,
		String partNo, int partType, boolean eSign) {
		return fetchByTP_NO_PART_ESIGN(templateNo, partNo, partType, eSign, true);
	}
	...
	public DossierPart fetchByTP_NO_PART_ESIGN(String templateNo,
		...
		Object[] finderArgs = new Object[] { templateNo, partNo, partType, eSign };

		Object result = null;

		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN,
					finderArgs, this);
		}
		...
		if (result instanceof DossierPart) {
			...
			if (!Objects.equals(templateNo, dossierPart.getTemplateNo()) ||
					!Objects.equals(partNo, dossierPart.getPartNo()) ||
		...
		if (result == null) {
			...
			if (templateNo == null) {
				query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_TEMPLATENO_1);
			}
			else if (templateNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_TEMPLATENO_3);
			}
			else {
				bindTemplateNo = true;

				query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_TEMPLATENO_2);
			}

			boolean bindPartNo = false;

			if (partNo == null) {
				query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_PARTNO_1);
			}
			else if (partNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_PARTNO_3);
			}
			else {
				bindPartNo = true;

				query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_PARTNO_2);
			}

			query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_PARTTYPE_2);

			query.append(_FINDER_COLUMN_TP_NO_PART_ESIGN_ESIGN_2);
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"DossierPartPersistenceImpl.fetchByTP_NO_PART_ESIGN(String, String, int, boolean, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
					...
					if ((dossierPart.getTemplateNo() == null) ||
							!dossierPart.getTemplateNo().equals(templateNo) ||
							(dossierPart.getPartNo() == null) ||
							!dossierPart.getPartNo().equals(partNo) ||
							(dossierPart.getPartType() != partType) ||
							(dossierPart.getESign() != eSign)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN,
							finderArgs, dossierPart);
					}
				}
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN,
					finderArgs);
	 ...
	 */
	@Override
	public DossierPart removeByTP_NO_PART_ESIGN(String templateNo,
		String partNo, int partType, boolean eSign)
		throws NoSuchDossierPartException {
		DossierPart dossierPart = findByTP_NO_PART_ESIGN(templateNo, partNo,
				partType, eSign);
	 ...
	 */
	@Override
	public int countByTP_NO_PART_ESIGN(String templateNo, String partNo,
		int partType, boolean eSign) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_TP_NO_PART_ESIGN;
	...
	private static final String _FINDER_COLUMN_TP_NO_PART_ESIGN_TEMPLATENO_1 = "dossierPart.templateNo IS NULL AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_ESIGN_TEMPLATENO_2 = "dossierPart.templateNo = ? AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_ESIGN_TEMPLATENO_3 = "(dossierPart.templateNo IS NULL OR dossierPart.templateNo = '') AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_ESIGN_PARTNO_1 = "dossierPart.partNo IS NULL AND ";
	private static final String _FINDER_COLUMN_TP_NO_PART_ESIGN_PARTNO_2 = "dossierPart.partNo = ? AND ";
	...
	public void cacheResult(DossierPart dossierPart) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_GID_FTN,
			new Object[] {
				dossierPart.getGroupId(), dossierPart.getFileTemplateNo()
			}, dossierPart);

		finderCache.putResult(FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN,
			new Object[] {
				dossierPart.getTemplateNo(), dossierPart.getPartNo(),
				dossierPart.getPartType(), dossierPart.getESign()
			}, dossierPart);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
				...
				dossierPartModelImpl.getPartNo()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_TP_NO_PART, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_TP_NO_PART, args,
			dossierPartModelImpl, false);
		...
		finderCache.putResult(FINDER_PATH_COUNT_BY_GID_FTN, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_GID_FTN, args,
			dossierPartModelImpl, false);
		...
		args = new Object[] {
				...
				dossierPartModelImpl.getESign()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_TP_NO_PART_ESIGN, args,
			Long.valueOf(1), false);
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_TP_NO_PART, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_TP_NO_PART, args);
		}

		if ((dossierPartModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_TP_NO_PART.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					dossierPartModelImpl.getOriginalGroupId(),
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_GID_FTN, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_GID_FTN, args);
		}

		if ((dossierPartModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_GID_FTN.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					dossierPartModelImpl.getOriginalGroupId(),
		...
		if ((dossierPartModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_TP_NO_PART_ESIGN.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					dossierPartModelImpl.getOriginalTemplateNo(),
					dossierPartModelImpl.getOriginalPartNo(),
					dossierPartModelImpl.getOriginalPartType(),
					dossierPartModelImpl.getOriginalESign()
				};
	...
	public DossierPart updateImpl(DossierPart dossierPart) {
		...
		if (isNew || !DossierPartModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dossierPartModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_TP_NO.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dossierPartModelImpl.getOriginalGroupId(),
						dossierPartModelImpl.getOriginalTemplateNo()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_TP_NO, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_TP_NO,
					args);
	...
	protected DossierPart toUnwrappedModel(DossierPart dossierPart) {
		...
		dossierPartImpl.setDeliverableType(dossierPart.getDeliverableType());
		dossierPartImpl.setDeliverableAction(dossierPart.getDeliverableAction());
