...
public class DossierActionSyncCacheModel implements CacheModel<DossierActionSync>,
	...
	public DossierActionSync toEntityModel() {
		...
		if (uuid == null) {
			dossierActionSyncImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dossierActionSyncImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (referenceUid == null) {
			dossierActionSyncImpl.setReferenceUid(StringPool.BLANK);
		}
		else {
		...
		if (actionCode == null) {
			dossierActionSyncImpl.setActionCode(StringPool.BLANK);
		}
		else {
		...
		if (actionUser == null) {
			dossierActionSyncImpl.setActionUser(StringPool.BLANK);
		}
		else {
		...
		if (actionNote == null) {
			dossierActionSyncImpl.setActionNote(StringPool.BLANK);
		}
		else {
