...
import org.opencps.dossiermgt.service.DossierMarkLocalService;
...
/**
 * Provides the base implementation for the dossier mark local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierMarkLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierMarkLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierMarkLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierMarkLocalServiceUtil} to access the dossier mark local service.
	 */
	...
	public DossierMark addDossierMark(DossierMark dossierMark) {
		...
		return dossierMarkPersistence.update(dossierMark);
	}
	...
	public DossierMark createDossierMark(long dossierMarkId) {
		return dossierMarkPersistence.create(dossierMarkId);
	}
	...
	public DossierMark deleteDossierMark(long dossierMarkId)
		...
		return dossierMarkPersistence.remove(dossierMarkId);
	}
	...
	public DossierMark deleteDossierMark(DossierMark dossierMark) {
		return dossierMarkPersistence.remove(dossierMark);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierMark.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierMarkPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return dossierMarkPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierMarkPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DossierMark fetchDossierMark(long dossierMarkId) {
		return dossierMarkPersistence.fetchByPrimaryKey(dossierMarkId);
	}
	...
	public DossierMark fetchDossierMarkByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierMarkPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DossierMark getDossierMark(long dossierMarkId)
		throws PortalException {
		return dossierMarkPersistence.findByPrimaryKey(dossierMarkId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierMarkLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierMark.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dossierMarkId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierMarkLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierMark.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DossierMark>() {
				@Override
				public void performAction(DossierMark dossierMark)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DossierMark.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierMarkLocalService.deleteDossierMark((DossierMark)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierMarkPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DossierMark> getDossierMarksByUuidAndCompanyId(String uuid,
		long companyId) {
		return dossierMarkPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DossierMark> getDossierMarksByUuidAndCompanyId(String uuid,
		...
		return dossierMarkPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public DossierMark getDossierMarkByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return dossierMarkPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DossierMark> getDossierMarks(int start, int end) {
		return dossierMarkPersistence.findAll(start, end);
	}
	...
	public int getDossierMarksCount() {
		return dossierMarkPersistence.countAll();
	}
	 ...
	 */
	public DossierMarkLocalService getDossierMarkLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierMark",
			dossierMarkLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierMark");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierMarkLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierMarkPersistence.getDataSource();
	...
	@BeanReference(type = DossierMarkLocalService.class)
	protected DossierMarkLocalService dossierMarkLocalService;
