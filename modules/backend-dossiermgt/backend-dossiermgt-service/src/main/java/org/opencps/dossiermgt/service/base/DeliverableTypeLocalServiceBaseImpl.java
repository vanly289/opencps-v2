...
/**
 * Provides the base implementation for the deliverable type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DeliverableTypeLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DeliverableTypeLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeliverableTypeLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DeliverableTypeLocalServiceUtil} to access the deliverable type local service.
	 */
	...
	public DeliverableType createDeliverableType(long deliverableTypeId) {
		return deliverableTypePersistence.create(deliverableTypeId);
	}
	...
	public DeliverableType deleteDeliverableType(long deliverableTypeId)
		...
		return deliverableTypePersistence.remove(deliverableTypeId);
	}
	...
	public DeliverableType deleteDeliverableType(
		...
		return deliverableTypePersistence.remove(deliverableType);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DeliverableType.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deliverableTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deliverableTypePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DeliverableType fetchDeliverableType(long deliverableTypeId) {
		return deliverableTypePersistence.fetchByPrimaryKey(deliverableTypeId);
	}
	...
	public DeliverableType fetchDeliverableTypeByUuidAndGroupId(String uuid,
		long groupId) {
		return deliverableTypePersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DeliverableType getDeliverableType(long deliverableTypeId)
		throws PortalException {
		return deliverableTypePersistence.findByPrimaryKey(deliverableTypeId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deliverableTypeLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DeliverableType.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("deliverableTypeId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(deliverableTypeLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DeliverableType.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DeliverableType>() {
				@Override
				public void performAction(DeliverableType deliverableType)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DeliverableType.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return deliverableTypeLocalService.deleteDeliverableType((DeliverableType)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return deliverableTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DeliverableType> getDeliverableTypesByUuidAndCompanyId(
		...
		return deliverableTypePersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DeliverableType> getDeliverableTypesByUuidAndCompanyId(
		...
		return deliverableTypePersistence.findByUuid_C(uuid, companyId, start,
	...
	public DeliverableType getDeliverableTypeByUuidAndGroupId(String uuid,
		...
		return deliverableTypePersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DeliverableType> getDeliverableTypes(int start, int end) {
		return deliverableTypePersistence.findAll(start, end);
	}
	...
	public int getDeliverableTypesCount() {
		return deliverableTypePersistence.countAll();
	}
	 ...
	 */
	public DeliverableTypeLocalService getDeliverableTypeLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DeliverableType",
			deliverableTypeLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DeliverableType");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeliverableTypeLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deliverableTypePersistence.getDataSource();
	...
	@BeanReference(type = DeliverableTypeLocalService.class)
	protected DeliverableTypeLocalService deliverableTypeLocalService;
