...
import org.opencps.dossiermgt.service.DossierRequestUDLocalService;
...
/**
 * Provides the base implementation for the dossier request ud local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierRequestUDLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierRequestUDLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierRequestUDLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierRequestUDLocalServiceUtil} to access the dossier request ud local service.
	 */
	...
	public DossierRequestUD addDossierRequestUD(
		...
		return dossierRequestUDPersistence.update(dossierRequestUD);
	}
	...
	public DossierRequestUD createDossierRequestUD(long dossierRequestId) {
		return dossierRequestUDPersistence.create(dossierRequestId);
	}
	...
	public DossierRequestUD deleteDossierRequestUD(long dossierRequestId)
		...
		return dossierRequestUDPersistence.remove(dossierRequestId);
	}
	...
	public DossierRequestUD deleteDossierRequestUD(
		DossierRequestUD dossierRequestUD) {
		return dossierRequestUDPersistence.remove(dossierRequestUD);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierRequestUD.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierRequestUDPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierRequestUDPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DossierRequestUD fetchDossierRequestUD(long dossierRequestId) {
		return dossierRequestUDPersistence.fetchByPrimaryKey(dossierRequestId);
	}
	...
	public DossierRequestUD fetchDossierRequestUDByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierRequestUDPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DossierRequestUD getDossierRequestUD(long dossierRequestId)
		throws PortalException {
		return dossierRequestUDPersistence.findByPrimaryKey(dossierRequestId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierRequestUDLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierRequestUD.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dossierRequestId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierRequestUDLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierRequestUD.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DossierRequestUD>() {
				@Override
				public void performAction(DossierRequestUD dossierRequestUD)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DossierRequestUD.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierRequestUDLocalService.deleteDossierRequestUD((DossierRequestUD)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierRequestUDPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DossierRequestUD> getDossierRequestUDsByUuidAndCompanyId(
		...
		return dossierRequestUDPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DossierRequestUD> getDossierRequestUDsByUuidAndCompanyId(
		...
		return dossierRequestUDPersistence.findByUuid_C(uuid, companyId, start,
	...
	public DossierRequestUD getDossierRequestUDByUuidAndGroupId(String uuid,
		...
		return dossierRequestUDPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DossierRequestUD> getDossierRequestUDs(int start, int end) {
		return dossierRequestUDPersistence.findAll(start, end);
	}
	...
	public int getDossierRequestUDsCount() {
		return dossierRequestUDPersistence.countAll();
	}
	 ...
	 */
	public DossierRequestUDLocalService getDossierRequestUDLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierRequestUD",
			dossierRequestUDLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierRequestUD");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierRequestUDLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierRequestUDPersistence.getDataSource();
	...
	@BeanReference(type = DossierRequestUDLocalService.class)
	protected DossierRequestUDLocalService dossierRequestUDLocalService;
