...
public class DossierStatisticPersistenceImpl extends BasePersistenceImpl<DossierStatistic>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dossierStatistic.getUuid() == null) ||
							!dossierStatistic.getUuid().equals(uuid) ||
							(dossierStatistic.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, dossierStatistic);
					}
				}
			}
			catch (Exception e) {
	...
	protected DossierStatistic removeImpl(DossierStatistic dossierStatistic) {
		dossierStatistic = toUnwrappedModel(dossierStatistic);
	...
	public DossierStatistic updateImpl(DossierStatistic dossierStatistic) {
		...
		if (isNew || !DossierStatisticModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
	...
	protected DossierStatistic toUnwrappedModel(
		DossierStatistic dossierStatistic) {
		if (dossierStatistic instanceof DossierStatisticImpl) {
			return dossierStatistic;
		}

		DossierStatisticImpl dossierStatisticImpl = new DossierStatisticImpl();

		dossierStatisticImpl.setNew(dossierStatistic.isNew());
		dossierStatisticImpl.setPrimaryKey(dossierStatistic.getPrimaryKey());

		dossierStatisticImpl.setUuid(dossierStatistic.getUuid());
		dossierStatisticImpl.setDossierStatisticId(dossierStatistic.getDossierStatisticId());
		dossierStatisticImpl.setCompanyId(dossierStatistic.getCompanyId());
		dossierStatisticImpl.setGroupId(dossierStatistic.getGroupId());
		dossierStatisticImpl.setUserId(dossierStatistic.getUserId());
		dossierStatisticImpl.setUserName(dossierStatistic.getUserName());
		dossierStatisticImpl.setCreateDate(dossierStatistic.getCreateDate());
		dossierStatisticImpl.setModifiedDate(dossierStatistic.getModifiedDate());
		dossierStatisticImpl.setMonth(dossierStatistic.getMonth());
		dossierStatisticImpl.setYear(dossierStatistic.getYear());
		dossierStatisticImpl.setRemainingCount(dossierStatistic.getRemainingCount());
		dossierStatisticImpl.setReceivedCount(dossierStatistic.getReceivedCount());
		dossierStatisticImpl.setOnlineCount(dossierStatistic.getOnlineCount());
		dossierStatisticImpl.setUndueCount(dossierStatistic.getUndueCount());
		dossierStatisticImpl.setOverdueCount(dossierStatistic.getOverdueCount());
		dossierStatisticImpl.setOntimeCount(dossierStatistic.getOntimeCount());
		dossierStatisticImpl.setOvertimeCount(dossierStatistic.getOvertimeCount());
		dossierStatisticImpl.setGovAgencyCode(dossierStatistic.getGovAgencyCode());
		dossierStatisticImpl.setGovAgencyName(dossierStatistic.getGovAgencyName());
		dossierStatisticImpl.setDomainCode(dossierStatistic.getDomainCode());
		dossierStatisticImpl.setDomainName(dossierStatistic.getDomainName());
		dossierStatisticImpl.setAdministrationLevel(dossierStatistic.getAdministrationLevel());
		dossierStatisticImpl.setReporting(dossierStatistic.isReporting());
