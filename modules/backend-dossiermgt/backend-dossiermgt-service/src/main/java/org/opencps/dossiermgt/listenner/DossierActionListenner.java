...
public class DossierActionListenner extends BaseModelListener<DossierAction> {
	...
	public String updateVRCorporationAttendee(DossierAction dossierActionModel) throws PortalException {
		try {
			...
			Employee objManager = new EmployeeImpl();
			objManager = EmployeeLocalServiceUtil.fetchByF_mappingUserId(groupId, dossierActionModel.getUserId());
			EmployeeJobPos objEmployeeJobPos = new EmployeeJobPosImpl();
			objEmployeeJobPos = EmployeeJobPosLocalServiceUtil.fetchByF_EmployeeId_jobPostId(groupId, objManager.getEmployeeId(), objManager.getMainJobPostId());
			WorkingUnit objWorkingUnit = new WorkingUnitImpl();
			objWorkingUnit = WorkingUnitLocalServiceUtil.fetchWorkingUnit(objEmployeeJobPos.getWorkingUnitId());
			...
			String invitation = StringPool.BLANK;
			objVRCorporationAttendee.setInvitation(invitation);
