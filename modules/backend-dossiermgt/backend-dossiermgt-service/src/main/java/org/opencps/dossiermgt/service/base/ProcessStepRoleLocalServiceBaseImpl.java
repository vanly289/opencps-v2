...
/**
 * Provides the base implementation for the process step role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ProcessStepRoleLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ProcessStepRoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProcessStepRoleLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ProcessStepRoleLocalServiceUtil} to access the process step role local service.
	 */
	...
	public ProcessStepRole createProcessStepRole(
		...
		return processStepRolePersistence.create(processStepRolePK);
	}
	...
	public ProcessStepRole deleteProcessStepRole(
		...
		return processStepRolePersistence.remove(processStepRolePK);
	}
	...
	public ProcessStepRole deleteProcessStepRole(
		...
		return processStepRolePersistence.remove(processStepRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProcessStepRole.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return processStepRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return processStepRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProcessStepRole fetchProcessStepRole(
		ProcessStepRolePK processStepRolePK) {
		return processStepRolePersistence.fetchByPrimaryKey(processStepRolePK);
	}
	...
	public ProcessStepRole getProcessStepRole(
		ProcessStepRolePK processStepRolePK) throws PortalException {
		return processStepRolePersistence.findByPrimaryKey(processStepRolePK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(processStepRoleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProcessStepRole.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.processStepId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(processStepRoleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProcessStepRole.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return processStepRoleLocalService.deleteProcessStepRole((ProcessStepRole)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return processStepRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProcessStepRole> getProcessStepRoles(int start, int end) {
		return processStepRolePersistence.findAll(start, end);
	}
	...
	public int getProcessStepRolesCount() {
		return processStepRolePersistence.countAll();
	}
	 ...
	 */
	public ProcessStepRoleLocalService getProcessStepRoleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ProcessStepRole",
			processStepRoleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ProcessStepRole");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcessStepRoleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = processStepRolePersistence.getDataSource();
	...
	@BeanReference(type = ProcessStepRoleLocalService.class)
