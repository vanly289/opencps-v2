...
public class ServiceConfigPersistenceImpl extends BasePersistenceImpl<ServiceConfig>
	...
	protected ServiceConfig toUnwrappedModel(ServiceConfig serviceConfig) {
		...
		serviceConfigImpl.setForCitizen(serviceConfig.isForCitizen());
		serviceConfigImpl.setForBusiness(serviceConfig.isForBusiness());
		serviceConfigImpl.setPostService(serviceConfig.isPostService());
		serviceConfigImpl.setRegistration(serviceConfig.isRegistration());
