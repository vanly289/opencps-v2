...
import org.opencps.dossiermgt.service.RegistrationTemplatesLocalService;
...
/**
 * Provides the base implementation for the registration templates local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.RegistrationTemplatesLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class RegistrationTemplatesLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RegistrationTemplatesLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.RegistrationTemplatesLocalServiceUtil} to access the registration templates local service.
	 */
	...
	public RegistrationTemplates createRegistrationTemplates(
		...
		return registrationTemplatesPersistence.create(registrationTemplateId);
	}
	...
	public RegistrationTemplates deleteRegistrationTemplates(
		...
		return registrationTemplatesPersistence.remove(registrationTemplateId);
	}
	...
	public RegistrationTemplates deleteRegistrationTemplates(
		RegistrationTemplates registrationTemplates) {
		return registrationTemplatesPersistence.remove(registrationTemplates);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RegistrationTemplates.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return registrationTemplatesPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return registrationTemplatesPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public RegistrationTemplates fetchRegistrationTemplates(
		long registrationTemplateId) {
		return registrationTemplatesPersistence.fetchByPrimaryKey(registrationTemplateId);
	}
	...
	public RegistrationTemplates fetchRegistrationTemplatesByUuidAndGroupId(
		...
		return registrationTemplatesPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public RegistrationTemplates getRegistrationTemplates(
		long registrationTemplateId) throws PortalException {
		return registrationTemplatesPersistence.findByPrimaryKey(registrationTemplateId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(registrationTemplatesLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(RegistrationTemplates.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(registrationTemplatesLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(RegistrationTemplates.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return registrationTemplatesLocalService.deleteRegistrationTemplates((RegistrationTemplates)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return registrationTemplatesPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public RegistrationTemplates getRegistrationTemplatesByUuidAndGroupId(
		...
		return registrationTemplatesPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<RegistrationTemplates> getRegistrationTemplateses(int start,
		int end) {
		return registrationTemplatesPersistence.findAll(start, end);
	}
	...
	public int getRegistrationTemplatesesCount() {
		return registrationTemplatesPersistence.countAll();
	}
	 ...
	 */
	public RegistrationTemplatesLocalService getRegistrationTemplatesLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.RegistrationTemplates",
			registrationTemplatesLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.RegistrationTemplates");
	}
	...
	public String getOSGiServiceIdentifier() {
		return RegistrationTemplatesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = registrationTemplatesPersistence.getDataSource();
	...
	@BeanReference(type = RegistrationTemplatesLocalService.class)
	protected RegistrationTemplatesLocalService registrationTemplatesLocalService;
