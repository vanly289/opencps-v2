...
import org.opencps.dossiermgt.service.DossierStatisticLocalService;
...
/**
 * Provides the base implementation for the dossier statistic local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierStatisticLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierStatisticLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierStatisticLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierStatisticLocalServiceUtil} to access the dossier statistic local service.
	 */
	...
	public DossierStatistic addDossierStatistic(
		...
		return dossierStatisticPersistence.update(dossierStatistic);
	}
	...
	public DossierStatistic createDossierStatistic(long dossierStatisticId) {
		return dossierStatisticPersistence.create(dossierStatisticId);
	}
	...
	public DossierStatistic deleteDossierStatistic(long dossierStatisticId)
		...
		return dossierStatisticPersistence.remove(dossierStatisticId);
	}
	...
	public DossierStatistic deleteDossierStatistic(
		DossierStatistic dossierStatistic) {
		return dossierStatisticPersistence.remove(dossierStatistic);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierStatistic.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierStatisticPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierStatisticPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DossierStatistic fetchDossierStatistic(long dossierStatisticId) {
		return dossierStatisticPersistence.fetchByPrimaryKey(dossierStatisticId);
	}
	...
	public DossierStatistic fetchDossierStatisticByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierStatisticPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DossierStatistic getDossierStatistic(long dossierStatisticId)
		throws PortalException {
		return dossierStatisticPersistence.findByPrimaryKey(dossierStatisticId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierStatisticLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierStatistic.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierStatisticLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierStatistic.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DossierStatistic>() {
				@Override
				public void performAction(DossierStatistic dossierStatistic)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DossierStatistic.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierStatisticLocalService.deleteDossierStatistic((DossierStatistic)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierStatisticPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DossierStatistic> getDossierStatisticsByUuidAndCompanyId(
		...
		return dossierStatisticPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DossierStatistic> getDossierStatisticsByUuidAndCompanyId(
		...
		return dossierStatisticPersistence.findByUuid_C(uuid, companyId, start,
	...
	public DossierStatistic getDossierStatisticByUuidAndGroupId(String uuid,
		...
		return dossierStatisticPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DossierStatistic> getDossierStatistics(int start, int end) {
		return dossierStatisticPersistence.findAll(start, end);
	}
	...
	public int getDossierStatisticsCount() {
		return dossierStatisticPersistence.countAll();
	}
	 ...
	 */
	public DossierStatisticLocalService getDossierStatisticLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierStatistic",
			dossierStatisticLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierStatistic");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierStatisticLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierStatisticPersistence.getDataSource();
	...
	@BeanReference(type = DossierStatisticLocalService.class)
	protected DossierStatisticLocalService dossierStatisticLocalService;
