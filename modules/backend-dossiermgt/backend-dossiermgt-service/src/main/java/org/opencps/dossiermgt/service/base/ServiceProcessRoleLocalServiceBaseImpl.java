...
/**
 * Provides the base implementation for the service process role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ServiceProcessRoleLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ServiceProcessRoleLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ServiceProcessRoleLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ServiceProcessRoleLocalServiceUtil} to access the service process role local service.
	 */
	...
	public ServiceProcessRole addServiceProcessRole(
		...
		return serviceProcessRolePersistence.update(serviceProcessRole);
	}
	...
	public ServiceProcessRole createServiceProcessRole(
		...
		return serviceProcessRolePersistence.create(serviceProcessRolePK);
	}
	...
	public ServiceProcessRole deleteServiceProcessRole(
		...
		return serviceProcessRolePersistence.remove(serviceProcessRolePK);
	}
	...
	public ServiceProcessRole deleteServiceProcessRole(
		ServiceProcessRole serviceProcessRole) {
		return serviceProcessRolePersistence.remove(serviceProcessRole);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ServiceProcessRole.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return serviceProcessRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return serviceProcessRolePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ServiceProcessRole fetchServiceProcessRole(
		ServiceProcessRolePK serviceProcessRolePK) {
		return serviceProcessRolePersistence.fetchByPrimaryKey(serviceProcessRolePK);
	}
	...
	public ServiceProcessRole getServiceProcessRole(
		ServiceProcessRolePK serviceProcessRolePK) throws PortalException {
		return serviceProcessRolePersistence.findByPrimaryKey(serviceProcessRolePK);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(serviceProcessRoleLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ServiceProcessRole.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName(
			"primaryKey.serviceProcessId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(serviceProcessRoleLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ServiceProcessRole.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return serviceProcessRoleLocalService.deleteServiceProcessRole((ServiceProcessRole)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return serviceProcessRolePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ServiceProcessRole> getServiceProcessRoles(int start, int end) {
		return serviceProcessRolePersistence.findAll(start, end);
	}
	...
	public int getServiceProcessRolesCount() {
		return serviceProcessRolePersistence.countAll();
	}
	 ...
	 */
	public ServiceProcessRoleLocalService getServiceProcessRoleLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ServiceProcessRole",
			serviceProcessRoleLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ServiceProcessRole");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceProcessRoleLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = serviceProcessRolePersistence.getDataSource();
	...
	@BeanReference(type = ServiceProcessRoleLocalService.class)
	protected ServiceProcessRoleLocalService serviceProcessRoleLocalService;
