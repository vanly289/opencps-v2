 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.RegistrationLogLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class RegistrationLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RegistrationLogLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.RegistrationLogLocalServiceUtil} to access the registration log local service.
	 */
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(RegistrationLog.class,
	...
	public RegistrationLog fetchRegistrationLogByUuidAndGroupId(String uuid,
		long groupId) {
		return registrationLogPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(registrationLogLocalService);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<RegistrationLog>() {
				@Override
				public void performAction(RegistrationLog registrationLog)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(RegistrationLog.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return registrationLogLocalService.deleteRegistrationLog((RegistrationLog)persistedModel);
	}
	...
	public List<RegistrationLog> getRegistrationLogsByUuidAndCompanyId(
		...
		return registrationLogPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<RegistrationLog> getRegistrationLogsByUuidAndCompanyId(
		...
		return registrationLogPersistence.findByUuid_C(uuid, companyId, start,
	...
	public RegistrationLog getRegistrationLogByUuidAndGroupId(String uuid,
		...
		return registrationLogPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	public RegistrationLogLocalService getRegistrationLogLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.RegistrationLog",
			registrationLogLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.RegistrationLog");
	}
	...
	@BeanReference(type = RegistrationLogLocalService.class)
