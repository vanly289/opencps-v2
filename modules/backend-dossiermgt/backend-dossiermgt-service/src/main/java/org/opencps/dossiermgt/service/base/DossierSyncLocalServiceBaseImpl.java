...
/**
 * Provides the base implementation for the dossier sync local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierSyncLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierSyncLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierSyncLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierSyncLocalServiceUtil} to access the dossier sync local service.
	 */
	...
	public DossierSync addDossierSync(DossierSync dossierSync) {
		...
		return dossierSyncPersistence.update(dossierSync);
	}
	...
	public DossierSync createDossierSync(long dossierSyncId) {
		return dossierSyncPersistence.create(dossierSyncId);
	}
	...
	public DossierSync deleteDossierSync(long dossierSyncId)
		...
		return dossierSyncPersistence.remove(dossierSyncId);
	}
	...
	public DossierSync deleteDossierSync(DossierSync dossierSync) {
		return dossierSyncPersistence.remove(dossierSync);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierSync.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierSyncPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return dossierSyncPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierSyncPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DossierSync fetchDossierSync(long dossierSyncId) {
		return dossierSyncPersistence.fetchByPrimaryKey(dossierSyncId);
	}
	 ...
	 */
	@Override
	public DossierSync fetchDossierSyncByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierSyncPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DossierSync getDossierSync(long dossierSyncId)
		throws PortalException {
		return dossierSyncPersistence.findByPrimaryKey(dossierSyncId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierSyncLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierSync.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dossierSyncId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierSyncLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierSync.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DossierSync>() {
				@Override
				public void performAction(DossierSync dossierSync)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DossierSync.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierSyncLocalService.deleteDossierSync((DossierSync)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierSyncPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DossierSync> getDossierSyncsByUuidAndCompanyId(String uuid,
		long companyId) {
		return dossierSyncPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DossierSync> getDossierSyncsByUuidAndCompanyId(String uuid,
		...
		return dossierSyncPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	...
	public DossierSync getDossierSyncByUuidAndGroupId(String uuid, long groupId)
		throws PortalException {
		return dossierSyncPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public int getDossierSyncsCount() {
		return dossierSyncPersistence.countAll();
	}
	 ...
	 */
	public DossierSyncLocalService getDossierSyncLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierSync",
			dossierSyncLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierSync");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierSyncLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierSyncPersistence.getDataSource();
	...
	@BeanReference(type = DossierSyncLocalService.class)
	protected DossierSyncLocalService dossierSyncLocalService;
