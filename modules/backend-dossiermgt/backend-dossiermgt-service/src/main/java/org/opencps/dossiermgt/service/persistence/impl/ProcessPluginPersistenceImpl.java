...
public class ProcessPluginPersistenceImpl extends BasePersistenceImpl<ProcessPlugin>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((processPlugin.getUuid() == null) ||
							!processPlugin.getUuid().equals(uuid) ||
							(processPlugin.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, processPlugin);
					}
				}
			}
			catch (Exception e) {
	...
	public List<ProcessPlugin> findBySC_SPID(String stepCode,
		...
		if (list == null) {
			...
			else if (stepCode.equals(StringPool.BLANK)) {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_SC_SPID_ARUN =
		new FinderPath(ProcessPluginModelImpl.ENTITY_CACHE_ENABLED,
			ProcessPluginModelImpl.FINDER_CACHE_ENABLED,
			ProcessPluginImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findBySC_SPID_ARUN",
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SC_SPID_ARUN =
		new FinderPath(ProcessPluginModelImpl.ENTITY_CACHE_ENABLED,
			ProcessPluginModelImpl.FINDER_CACHE_ENABLED,
			ProcessPluginImpl.class, FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION,
			"findBySC_SPID_ARUN",
			...
			ProcessPluginModelImpl.STEPCODE_COLUMN_BITMASK |
			ProcessPluginModelImpl.SERVICEPROCESSID_COLUMN_BITMASK |
			ProcessPluginModelImpl.AUTORUN_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_SC_SPID_ARUN = new FinderPath(ProcessPluginModelImpl.ENTITY_CACHE_ENABLED,
			ProcessPluginModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBySC_SPID_ARUN",
			new String[] {
				String.class.getName(), Long.class.getName(),
				Boolean.class.getName()
			});
	...
	/**
	 * Returns all the process plugins where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * @param stepCode the step code
	 * @param serviceProcessId the service process ID
	 * @param autoRun the auto run
	 * @return the matching process plugins
	 */
	@Override
	public List<ProcessPlugin> findBySC_SPID_ARUN(String stepCode,
		long serviceProcessId, boolean autoRun) {
		return findBySC_SPID_ARUN(stepCode, serviceProcessId, autoRun,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the process plugins where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProcessPluginModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	@Override
	public List<ProcessPlugin> findBySC_SPID_ARUN(String stepCode,
		long serviceProcessId, boolean autoRun, int start, int end) {
		return findBySC_SPID_ARUN(stepCode, serviceProcessId, autoRun, start,
			end, null);
	}

	/**
	 * Returns an ordered range of all the process plugins where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProcessPluginModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ProcessPlugin> findBySC_SPID_ARUN(String stepCode,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SC_SPID_ARUN;
			finderArgs = new Object[] { stepCode, serviceProcessId, autoRun };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_SC_SPID_ARUN;
			finderArgs = new Object[] {
					stepCode, serviceProcessId, autoRun,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ProcessPlugin processPlugin : list) {
					if (!Objects.equals(stepCode, processPlugin.getStepCode()) ||
							(serviceProcessId != processPlugin.getServiceProcessId()) ||
							(autoRun != processPlugin.getAutoRun())) {
						list = null;
		...
		if (list == null) {
			...
			if (stepCode == null) {
				query.append(_FINDER_COLUMN_SC_SPID_ARUN_STEPCODE_1);
			}
			else if (stepCode.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_SC_SPID_ARUN_STEPCODE_3);
			}
			else {
				bindStepCode = true;

				query.append(_FINDER_COLUMN_SC_SPID_ARUN_STEPCODE_2);
			}

			query.append(_FINDER_COLUMN_SC_SPID_ARUN_SERVICEPROCESSID_2);

			query.append(_FINDER_COLUMN_SC_SPID_ARUN_AUTORUN_2);
	...
	/**
	 * Returns the first process plugin in the ordered set where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * @param stepCode the step code
	 * @param serviceProcessId the service process ID
	 * @param autoRun the auto run
	 ...
	 */
	@Override
	public ProcessPlugin findBySC_SPID_ARUN_First(String stepCode,
		long serviceProcessId, boolean autoRun,
		OrderByComparator<ProcessPlugin> orderByComparator)
		throws NoSuchProcessPluginException {
		ProcessPlugin processPlugin = fetchBySC_SPID_ARUN_First(stepCode,
				serviceProcessId, autoRun, orderByComparator);
	 ...
	 */
	@Override
	public ProcessPlugin fetchBySC_SPID_ARUN_First(String stepCode,
		long serviceProcessId, boolean autoRun,
		OrderByComparator<ProcessPlugin> orderByComparator) {
		List<ProcessPlugin> list = findBySC_SPID_ARUN(stepCode,
				serviceProcessId, autoRun, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last process plugin in the ordered set where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * @param stepCode the step code
	 * @param serviceProcessId the service process ID
	 * @param autoRun the auto run
	 ...
	 */
	@Override
	public ProcessPlugin findBySC_SPID_ARUN_Last(String stepCode,
		long serviceProcessId, boolean autoRun,
		OrderByComparator<ProcessPlugin> orderByComparator)
		throws NoSuchProcessPluginException {
		ProcessPlugin processPlugin = fetchBySC_SPID_ARUN_Last(stepCode,
				serviceProcessId, autoRun, orderByComparator);
	 ...
	 */
	@Override
	public ProcessPlugin fetchBySC_SPID_ARUN_Last(String stepCode,
		long serviceProcessId, boolean autoRun,
		OrderByComparator<ProcessPlugin> orderByComparator) {
		int count = countBySC_SPID_ARUN(stepCode, serviceProcessId, autoRun);
		...
		List<ProcessPlugin> list = findBySC_SPID_ARUN(stepCode,
				serviceProcessId, autoRun, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the process plugins before and after the current process plugin in the ordered set where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * @param processPluginId the primary key of the current process plugin
	 * @param stepCode the step code
	 * @param serviceProcessId the service process ID
	 ...
	 */
	@Override
	public ProcessPlugin[] findBySC_SPID_ARUN_PrevAndNext(
		long processPluginId, String stepCode, long serviceProcessId,
		boolean autoRun, OrderByComparator<ProcessPlugin> orderByComparator)
		throws NoSuchProcessPluginException {
		ProcessPlugin processPlugin = findByPrimaryKey(processPluginId);
		...
		try {
			...
			array[0] = getBySC_SPID_ARUN_PrevAndNext(session, processPlugin,
					stepCode, serviceProcessId, autoRun, orderByComparator, true);

			array[1] = processPlugin;

			array[2] = getBySC_SPID_ARUN_PrevAndNext(session, processPlugin,
					stepCode, serviceProcessId, autoRun, orderByComparator,
					false);
	...
	protected ProcessPlugin getBySC_SPID_ARUN_PrevAndNext(Session session,
		ProcessPlugin processPlugin, String stepCode, long serviceProcessId,
		boolean autoRun, OrderByComparator<ProcessPlugin> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the process plugins where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63; from the database.
	 *
	 * @param stepCode the step code
	 * @param serviceProcessId the service process ID
	 * @param autoRun the auto run
	 */
	@Override
	public void removeBySC_SPID_ARUN(String stepCode, long serviceProcessId,
		boolean autoRun) {
		for (ProcessPlugin processPlugin : findBySC_SPID_ARUN(stepCode,
				serviceProcessId, autoRun, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(processPlugin);
		}
	}
	...
	/**
	 * Returns the number of process plugins where stepCode = &#63; and serviceProcessId = &#63; and autoRun = &#63;.
	 *
	 * @param stepCode the step code
	 * @param serviceProcessId the service process ID
	 * @param autoRun the auto run
	 ...
	 */
	@Override
	public int countBySC_SPID_ARUN(String stepCode, long serviceProcessId,
		boolean autoRun) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_SC_SPID_ARUN;

		Object[] finderArgs = new Object[] { stepCode, serviceProcessId, autoRun };
	...
	private static final String _FINDER_COLUMN_SC_SPID_ARUN_STEPCODE_1 = "processPlugin.stepCode IS NULL AND ";
	private static final String _FINDER_COLUMN_SC_SPID_ARUN_STEPCODE_2 = "processPlugin.stepCode = ? AND ";
	private static final String _FINDER_COLUMN_SC_SPID_ARUN_STEPCODE_3 = "(processPlugin.stepCode IS NULL OR processPlugin.stepCode = '') AND ";
	private static final String _FINDER_COLUMN_SC_SPID_ARUN_SERVICEPROCESSID_2 = "processPlugin.serviceProcessId = ? AND ";
	private static final String _FINDER_COLUMN_SC_SPID_ARUN_AUTORUN_2 = "processPlugin.autoRun = ?";
	...
	protected ProcessPlugin removeImpl(ProcessPlugin processPlugin) {
		processPlugin = toUnwrappedModel(processPlugin);
	...
	public ProcessPlugin updateImpl(ProcessPlugin processPlugin) {
		...
		if (isNew || !ProcessPluginModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((processPluginModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SC_SPID_ARUN.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						processPluginModelImpl.getOriginalStepCode(),
						processPluginModelImpl.getOriginalServiceProcessId(),
						processPluginModelImpl.getOriginalAutoRun()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_SC_SPID_ARUN, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_SC_SPID_ARUN,
					args);

				args = new Object[] {
						processPluginModelImpl.getStepCode(),
						processPluginModelImpl.getServiceProcessId(),
						processPluginModelImpl.getAutoRun()
					};
	...
	protected ProcessPlugin toUnwrappedModel(ProcessPlugin processPlugin) {
		if (processPlugin instanceof ProcessPluginImpl) {
			return processPlugin;
		}

		ProcessPluginImpl processPluginImpl = new ProcessPluginImpl();

		processPluginImpl.setNew(processPlugin.isNew());
		processPluginImpl.setPrimaryKey(processPlugin.getPrimaryKey());

		processPluginImpl.setUuid(processPlugin.getUuid());
		processPluginImpl.setProcessPluginId(processPlugin.getProcessPluginId());
		processPluginImpl.setCompanyId(processPlugin.getCompanyId());
		processPluginImpl.setGroupId(processPlugin.getGroupId());
		processPluginImpl.setUserId(processPlugin.getUserId());
		processPluginImpl.setUserName(processPlugin.getUserName());
		processPluginImpl.setCreateDate(processPlugin.getCreateDate());
		processPluginImpl.setModifiedDate(processPlugin.getModifiedDate());
		processPluginImpl.setStepCode(processPlugin.getStepCode());
		processPluginImpl.setServiceProcessId(processPlugin.getServiceProcessId());
		processPluginImpl.setPluginName(processPlugin.getPluginName());
		processPluginImpl.setSequenceNo(processPlugin.getSequenceNo());
		processPluginImpl.setPluginForm(processPlugin.getPluginForm());
		processPluginImpl.setSampleData(processPlugin.getSampleData());
		processPluginImpl.setAutoRun(processPlugin.isAutoRun());
