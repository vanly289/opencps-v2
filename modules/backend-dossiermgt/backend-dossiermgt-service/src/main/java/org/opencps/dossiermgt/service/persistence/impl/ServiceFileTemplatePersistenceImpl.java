...
public class ServiceFileTemplatePersistenceImpl extends BasePersistenceImpl<ServiceFileTemplate>
	...
	protected ServiceFileTemplate toUnwrappedModel(
		...
		serviceFileTemplateImpl.setUuid(serviceFileTemplate.getUuid());
		serviceFileTemplateImpl.setServiceInfoId(serviceFileTemplate.getServiceInfoId());
		serviceFileTemplateImpl.setFileTemplateNo(serviceFileTemplate.getFileTemplateNo());
		serviceFileTemplateImpl.setTemplateName(serviceFileTemplate.getTemplateName());
		serviceFileTemplateImpl.setFileEntryId(serviceFileTemplate.getFileEntryId());
