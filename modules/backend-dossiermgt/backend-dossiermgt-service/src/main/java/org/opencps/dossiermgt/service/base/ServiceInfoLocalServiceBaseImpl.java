 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ServiceInfoLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class ServiceInfoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ServiceInfoLocalServiceUtil} to access the service info local service.
	 */
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(serviceInfoLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ServiceInfo.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("serviceInfoId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(serviceInfoLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ServiceInfo.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ServiceInfo>() {
				@Override
				public void performAction(ServiceInfo serviceInfo)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ServiceInfo.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return serviceInfoLocalService.deleteServiceInfo((ServiceInfo)persistedModel);
	}
	...
	public List<ServiceInfo> getServiceInfosByUuidAndCompanyId(String uuid,
		long companyId) {
		return serviceInfoPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ServiceInfo> getServiceInfosByUuidAndCompanyId(String uuid,
		...
		return serviceInfoPersistence.findByUuid_C(uuid, companyId, start, end,
			orderByComparator);
	}
	 ...
	 */
	public ServiceInfoLocalService getServiceInfoLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ServiceInfo",
			serviceInfoLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ServiceInfo");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ServiceInfoLocalService.class.getName();
	}
	...
	@BeanReference(type = ServiceInfoLocalService.class)
	protected ServiceInfoLocalService serviceInfoLocalService;
