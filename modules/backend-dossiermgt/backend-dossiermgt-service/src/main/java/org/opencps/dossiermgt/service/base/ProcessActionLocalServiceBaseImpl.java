...
/**
 * Provides the base implementation for the process action local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ProcessActionLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ProcessActionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProcessActionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ProcessActionLocalServiceUtil} to access the process action local service.
	 */
	...
	public ProcessAction addProcessAction(ProcessAction processAction) {
		...
		return processActionPersistence.update(processAction);
	}
	...
	public ProcessAction createProcessAction(long processActionId) {
		return processActionPersistence.create(processActionId);
	}
	...
	public ProcessAction deleteProcessAction(long processActionId)
		...
		return processActionPersistence.remove(processActionId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProcessAction.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return processActionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return processActionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProcessAction fetchProcessAction(long processActionId) {
		return processActionPersistence.fetchByPrimaryKey(processActionId);
	}
	...
	public ProcessAction fetchProcessActionByUuidAndGroupId(String uuid,
		long groupId) {
		return processActionPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProcessAction getProcessAction(long processActionId)
		throws PortalException {
		return processActionPersistence.findByPrimaryKey(processActionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(processActionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProcessAction.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("processActionId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(processActionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProcessAction.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ProcessAction>() {
				@Override
				public void performAction(ProcessAction processAction)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ProcessAction.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return processActionLocalService.deleteProcessAction((ProcessAction)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return processActionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProcessAction> getProcessActionsByUuidAndCompanyId(
		...
		return processActionPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProcessAction> getProcessActionsByUuidAndCompanyId(
		...
		return processActionPersistence.findByUuid_C(uuid, companyId, start,
	...
	public ProcessAction getProcessActionByUuidAndGroupId(String uuid,
		...
		return processActionPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProcessAction> getProcessActions(int start, int end) {
		return processActionPersistence.findAll(start, end);
	}
	...
	public int getProcessActionsCount() {
		return processActionPersistence.countAll();
	}
	 ...
	 */
	public ProcessActionLocalService getProcessActionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ProcessAction",
			processActionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ProcessAction");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcessActionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = processActionPersistence.getDataSource();
	...
	@BeanReference(type = ProcessActionLocalService.class)
	protected ProcessActionLocalService processActionLocalService;
