...
public class ProcessOptionCacheModel implements CacheModel<ProcessOption>,
	...
	public ProcessOption toEntityModel() {
		...
		if (uuid == null) {
			processOptionImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			processOptionImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (optionName == null) {
			processOptionImpl.setOptionName(StringPool.BLANK);
		}
		else {
		...
		if (autoSelect == null) {
			processOptionImpl.setAutoSelect(StringPool.BLANK);
		}
		else {
		...
		if (instructionNote == null) {
			processOptionImpl.setInstructionNote(StringPool.BLANK);
		}
		else {
		...
		if (submissionNote == null) {
			processOptionImpl.setSubmissionNote(StringPool.BLANK);
		}
		else {
