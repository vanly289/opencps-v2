...
public class DeliverableCacheModel implements CacheModel<Deliverable>,
	...
	public Deliverable toEntityModel() {
		...
		if (uuid == null) {
			deliverableImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			deliverableImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (deliverableCode == null) {
			deliverableImpl.setDeliverableCode(StringPool.BLANK);
		}
		else {
		...
		if (deliverableName == null) {
			deliverableImpl.setDeliverableName(StringPool.BLANK);
		}
		else {
		...
		if (deliverableType == null) {
			deliverableImpl.setDeliverableType(StringPool.BLANK);
		}
		else {
		...
		if (govAgencyCode == null) {
			deliverableImpl.setGovAgencyCode(StringPool.BLANK);
		}
		else {
		...
		if (govAgencyName == null) {
			deliverableImpl.setGovAgencyName(StringPool.BLANK);
		}
		else {
		...
		if (applicantIdNo == null) {
			deliverableImpl.setApplicantIdNo(StringPool.BLANK);
		}
		else {
		...
		if (applicantName == null) {
			deliverableImpl.setApplicantName(StringPool.BLANK);
		}
		else {
		...
		if (subject == null) {
			deliverableImpl.setSubject(StringPool.BLANK);
		}
		else {
		...
		if (formData == null) {
			deliverableImpl.setFormData(StringPool.BLANK);
		}
		else {
		...
		if (formScript == null) {
			deliverableImpl.setFormScript(StringPool.BLANK);
		}
		else {
		...
		if (formReport == null) {
			deliverableImpl.setFormReport(StringPool.BLANK);
		}
		else {
		...
		if (deliverableState == null) {
			deliverableImpl.setDeliverableState(StringPool.BLANK);
		}
		else {
