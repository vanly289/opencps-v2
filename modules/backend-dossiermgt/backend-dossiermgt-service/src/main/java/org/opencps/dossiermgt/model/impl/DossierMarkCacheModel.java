...
public class DossierMarkCacheModel implements CacheModel<DossierMark>,
	...
	public DossierMark toEntityModel() {
		...
		if (uuid == null) {
			dossierMarkImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (dossierPartNo == null) {
			dossierMarkImpl.setDossierPartNo(StringPool.BLANK);
		}
		else {
		...
		dossierMarkImpl.setFileType(fileType);
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		fileCheck = objectInput.readBoolean();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		objectOutput.writeBoolean(fileCheck);
