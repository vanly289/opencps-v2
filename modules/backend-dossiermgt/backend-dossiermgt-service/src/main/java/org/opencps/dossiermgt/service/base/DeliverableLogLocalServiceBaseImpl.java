...
import org.opencps.dossiermgt.service.DeliverableLogLocalService;
...
/**
 * Provides the base implementation for the deliverable log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DeliverableLogLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DeliverableLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DeliverableLogLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DeliverableLogLocalServiceUtil} to access the deliverable log local service.
	 */
	...
	@Override
	public DeliverableLog addDeliverableLog(DeliverableLog deliverableLog) {
		deliverableLog.setNew(true);

		return deliverableLogPersistence.update(deliverableLog);
	}
	 ...
	 */
	@Override
	public DeliverableLog createDeliverableLog(long deliverableLogId) {
		return deliverableLogPersistence.create(deliverableLogId);
	}
	...
	@Override
	public DeliverableLog deleteDeliverableLog(long deliverableLogId)
		throws PortalException {
		return deliverableLogPersistence.remove(deliverableLogId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DeliverableLog deleteDeliverableLog(DeliverableLog deliverableLog) {
		return deliverableLogPersistence.remove(deliverableLog);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DeliverableLog.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return deliverableLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return deliverableLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DeliverableLog fetchDeliverableLog(long deliverableLogId) {
		return deliverableLogPersistence.fetchByPrimaryKey(deliverableLogId);
	}
	...
	public DeliverableLog fetchDeliverableLogByUuidAndGroupId(String uuid,
		long groupId) {
		return deliverableLogPersistence.fetchByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public DeliverableLog getDeliverableLog(long deliverableLogId)
		throws PortalException {
		return deliverableLogPersistence.findByPrimaryKey(deliverableLogId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(deliverableLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DeliverableLog.class);
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(deliverableLogLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DeliverableLog.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DeliverableLog>() {
				@Override
				public void performAction(DeliverableLog deliverableLog)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DeliverableLog.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return deliverableLogLocalService.deleteDeliverableLog((DeliverableLog)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return deliverableLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DeliverableLog> getDeliverableLogsByUuidAndCompanyId(
		String uuid, long companyId) {
		return deliverableLogPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DeliverableLog> getDeliverableLogsByUuidAndCompanyId(
		...
		return deliverableLogPersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public DeliverableLog getDeliverableLogByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return deliverableLogPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	@Override
	public List<DeliverableLog> getDeliverableLogs(int start, int end) {
		return deliverableLogPersistence.findAll(start, end);
	}
	...
	public int getDeliverableLogsCount() {
		return deliverableLogPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DeliverableLog updateDeliverableLog(DeliverableLog deliverableLog) {
		return deliverableLogPersistence.update(deliverableLog);
	}
	 ...
	 */
	public DeliverableLogLocalService getDeliverableLogLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DeliverableLog",
			deliverableLogLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DeliverableLog");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DeliverableLogLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = deliverableLogPersistence.getDataSource();
	...
	@BeanReference(type = DeliverableLogLocalService.class)
	protected DeliverableLogLocalService deliverableLogLocalService;
