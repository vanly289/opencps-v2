...
public class RegistrationFormCacheModel implements CacheModel<RegistrationForm>,
	...
	public RegistrationForm toEntityModel() {
		...
		if (uuid == null) {
			registrationFormImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (referenceUid == null) {
			registrationFormImpl.setReferenceUid(StringPool.BLANK);
		}
		else {
		...
		if (formNo == null) {
			registrationFormImpl.setFormNo(StringPool.BLANK);
		}
		else {
		...
		if (formName == null) {
			registrationFormImpl.setFormName(StringPool.BLANK);
		}
		else {
		...
		if (formData == null) {
			registrationFormImpl.setFormData(StringPool.BLANK);
		}
		else {
		...
		if (formScript == null) {
			registrationFormImpl.setFormScript(StringPool.BLANK);
		}
		else {
		...
		if (formReport == null) {
			registrationFormImpl.setFormReport(StringPool.BLANK);
		}
		else {
