...
public class ProcessPluginCacheModel implements CacheModel<ProcessPlugin>,
	...
	public ProcessPlugin toEntityModel() {
		...
		if (uuid == null) {
			processPluginImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			processPluginImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (stepCode == null) {
			processPluginImpl.setStepCode(StringPool.BLANK);
		}
		else {
		...
		if (pluginName == null) {
			processPluginImpl.setPluginName(StringPool.BLANK);
		}
		else {
		...
		if (sequenceNo == null) {
			processPluginImpl.setSequenceNo(StringPool.BLANK);
		}
		else {
		...
		if (pluginForm == null) {
			processPluginImpl.setPluginForm(StringPool.BLANK);
		}
		else {
		...
		if (sampleData == null) {
			processPluginImpl.setSampleData(StringPool.BLANK);
		}
		else {
