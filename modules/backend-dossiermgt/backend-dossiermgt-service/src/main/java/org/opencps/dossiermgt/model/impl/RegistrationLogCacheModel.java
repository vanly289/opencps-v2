...
public class RegistrationLogCacheModel implements CacheModel<RegistrationLog>,
	...
	public RegistrationLog toEntityModel() {
		...
		if (uuid == null) {
			registrationLogImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (author == null) {
			registrationLogImpl.setAuthor(StringPool.BLANK);
		}
		else {
		...
		if (content == null) {
			registrationLogImpl.setContent(StringPool.BLANK);
		}
		else {
		...
		if (payload == null) {
			registrationLogImpl.setPayload(StringPool.BLANK);
		}
		else {
