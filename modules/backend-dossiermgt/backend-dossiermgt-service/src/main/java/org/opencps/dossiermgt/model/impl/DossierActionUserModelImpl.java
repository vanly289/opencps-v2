...
public class DossierActionUserModelImpl extends BaseModelImpl<DossierActionUser>
	...
	public static final String TABLE_SQL_CREATE = "create table opencps_dossieractionuser (uuid_ VARCHAR(75) null,dossierActionId LONG not null,userId LONG not null,moderator INTEGER,assigned BOOLEAN,visited BOOLEAN,primary key (dossierActionId, userId))";
	...
	public static final long MODERATOR_COLUMN_BITMASK = 2L;
	...
	public void setModerator(int moderator) {
		_columnBitmask |= MODERATOR_COLUMN_BITMASK;

		if (!_setOriginalModerator) {
			_setOriginalModerator = true;

			_originalModerator = _moderator;
		}

		_moderator = moderator;
	}

	public int getOriginalModerator() {
		return _originalModerator;
	}
	...
	public Object clone() {
		...
		dossierActionUserImpl.setVisited(getVisited());
	...
	public void resetOriginalValues() {
		...
		dossierActionUserModelImpl._originalModerator = dossierActionUserModelImpl._moderator;

		dossierActionUserModelImpl._setOriginalModerator = false;
	...
	public CacheModel<DossierActionUser> toCacheModel() {
		...
		dossierActionUserCacheModel.visited = getVisited();
	...
	private int _originalModerator;
	private boolean _setOriginalModerator;
