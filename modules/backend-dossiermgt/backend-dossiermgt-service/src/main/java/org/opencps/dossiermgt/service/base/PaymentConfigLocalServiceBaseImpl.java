...
import org.opencps.dossiermgt.service.PaymentConfigLocalService;
...
/**
 * Provides the base implementation for the payment config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.PaymentConfigLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class PaymentConfigLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.PaymentConfigLocalServiceUtil} to access the payment config local service.
	 */
	...
	public PaymentConfig fetchPaymentConfigByUuidAndGroupId(String uuid,
		long groupId) {
		return paymentConfigPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(paymentConfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(PaymentConfig.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("paymentConfigId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(paymentConfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(PaymentConfig.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<PaymentConfig>() {
				@Override
				public void performAction(PaymentConfig paymentConfig)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(PaymentConfig.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return paymentConfigLocalService.deletePaymentConfig((PaymentConfig)persistedModel);
	}
	...
	public List<PaymentConfig> getPaymentConfigsByUuidAndCompanyId(
		...
		return paymentConfigPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<PaymentConfig> getPaymentConfigsByUuidAndCompanyId(
		...
		return paymentConfigPersistence.findByUuid_C(uuid, companyId, start,
	...
	public PaymentConfig getPaymentConfigByUuidAndGroupId(String uuid,
		...
		return paymentConfigPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	public PaymentConfigLocalService getPaymentConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.PaymentConfig",
	...
	public String getOSGiServiceIdentifier() {
		return PaymentConfigLocalService.class.getName();
	}
	...
	@BeanReference(type = PaymentConfigLocalService.class)
	protected PaymentConfigLocalService paymentConfigLocalService;
