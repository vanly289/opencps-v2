...
public class DossierRequestUDCacheModel implements CacheModel<DossierRequestUD>,
	...
	public DossierRequestUD toEntityModel() {
		...
		if (uuid == null) {
			dossierRequestUDImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dossierRequestUDImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (referenceUid == null) {
			dossierRequestUDImpl.setReferenceUid(StringPool.BLANK);
		}
		else {
		...
		if (requestType == null) {
			dossierRequestUDImpl.setRequestType(StringPool.BLANK);
		}
		else {
		...
		if (comment == null) {
			dossierRequestUDImpl.setComment(StringPool.BLANK);
		}
		else {
