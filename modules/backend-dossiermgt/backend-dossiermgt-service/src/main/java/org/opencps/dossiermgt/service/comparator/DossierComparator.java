 ...
 * @author trungnt
 */
public class DossierComparator extends OrderByComparator<Dossier> {

	private static final long serialVersionUID = 1L;

	private static final String _TABLE_NAME = "opencps_dossierfile";
	...
	public DossierComparator() {

		this(false, _defaultColumnName, String.class);
	}

	public DossierComparator(boolean ascending, String columnName, Class<?> columnType) {
	...
	@Override
	public int compare(Dossier dossier0, Dossier dossier1) {

		int value = -1;

		Object value0 = getValue(dossier0.getClass(), dossier0);
		Object value1 = getValue(dossier1.getClass(), dossier1);
	...
	private Log _log = LogFactoryUtil.getLog(DossierFileComparator.class.getName());
