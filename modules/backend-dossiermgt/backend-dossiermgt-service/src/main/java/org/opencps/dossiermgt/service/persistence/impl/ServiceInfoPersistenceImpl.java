...
public class ServiceInfoPersistenceImpl extends BasePersistenceImpl<ServiceInfo>
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((serviceInfo.getServiceCode() == null) ||
							!serviceInfo.getServiceCode().equals(serviceCode) ||
							(serviceInfo.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_SC_GI,
							finderArgs, serviceInfo);
					}
	...
	protected ServiceInfo toUnwrappedModel(ServiceInfo serviceInfo) {
		...
		serviceInfoImpl.setUserName(serviceInfo.getUserName());
		serviceInfoImpl.setCreateDate(serviceInfo.getCreateDate());
		serviceInfoImpl.setModifiedDate(serviceInfo.getModifiedDate());
		serviceInfoImpl.setServiceCode(serviceInfo.getServiceCode());
		serviceInfoImpl.setServiceName(serviceInfo.getServiceName());
		serviceInfoImpl.setProcessText(serviceInfo.getProcessText());
		serviceInfoImpl.setMethodText(serviceInfo.getMethodText());
		serviceInfoImpl.setDossierText(serviceInfo.getDossierText());
		serviceInfoImpl.setConditionText(serviceInfo.getConditionText());
		serviceInfoImpl.setDurationText(serviceInfo.getDurationText());
		serviceInfoImpl.setApplicantText(serviceInfo.getApplicantText());
		serviceInfoImpl.setResultText(serviceInfo.getResultText());
		serviceInfoImpl.setRegularText(serviceInfo.getRegularText());
		serviceInfoImpl.setFeeText(serviceInfo.getFeeText());
		serviceInfoImpl.setAdministrationCode(serviceInfo.getAdministrationCode());
		serviceInfoImpl.setAdministrationName(serviceInfo.getAdministrationName());
		...
		serviceInfoImpl.setDomainName(serviceInfo.getDomainName());
		serviceInfoImpl.setDomainIndex(serviceInfo.getDomainIndex());
		serviceInfoImpl.setMaxLevel(serviceInfo.getMaxLevel());
		serviceInfoImpl.setPublic_(serviceInfo.isPublic_());
