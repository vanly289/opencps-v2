...
import org.opencps.dossiermgt.service.UserInfoLogLocalService;
...
/**
 * Provides the base implementation for the user info log local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.UserInfoLogLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class UserInfoLogLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements UserInfoLogLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.UserInfoLogLocalServiceUtil} to access the user info log local service.
	 */
	 ...
	 */
	@Override
	public UserInfoLog createUserInfoLog(long userLogId) {
		return userInfoLogPersistence.create(userLogId);
	}
	...
	@Override
	public UserInfoLog deleteUserInfoLog(long userLogId)
		throws PortalException {
		return userInfoLogPersistence.remove(userLogId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserInfoLog deleteUserInfoLog(UserInfoLog userInfoLog) {
		return userInfoLogPersistence.remove(userInfoLog);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserInfoLog.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return userInfoLogPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery, int start,
		int end) {
		return userInfoLogPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return userInfoLogPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserInfoLog fetchUserInfoLog(long userLogId) {
		return userInfoLogPersistence.fetchByPrimaryKey(userLogId);
	}
	 ...
	 */
	@Override
	public UserInfoLog getUserInfoLog(long userLogId) throws PortalException {
		return userInfoLogPersistence.findByPrimaryKey(userLogId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(userInfoLogLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(UserInfoLog.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("userLogId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(userInfoLogLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(UserInfoLog.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("userLogId");
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return userInfoLogLocalService.deleteUserInfoLog((UserInfoLog)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return userInfoLogPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserInfoLog> getUserInfoLogs(int start, int end) {
		return userInfoLogPersistence.findAll(start, end);
	}
	...
	public int getUserInfoLogsCount() {
		return userInfoLogPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserInfoLog updateUserInfoLog(UserInfoLog userInfoLog) {
		return userInfoLogPersistence.update(userInfoLog);
	}
	 ...
	 */
	public UserInfoLogLocalService getUserInfoLogLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.UserInfoLog",
			userInfoLogLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.UserInfoLog");
	}
	...
	public String getOSGiServiceIdentifier() {
		return UserInfoLogLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = userInfoLogPersistence.getDataSource();
	...
	@BeanReference(type = UserInfoLogLocalService.class)
	protected UserInfoLogLocalService userInfoLogLocalService;
