...
public class ProcessStepRolePersistenceImpl extends BasePersistenceImpl<ProcessStepRole>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_P_RID = new FinderPath(ProcessStepRoleModelImpl.ENTITY_CACHE_ENABLED,
			ProcessStepRoleModelImpl.FINDER_CACHE_ENABLED,
			ProcessStepRoleImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByP_RID",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_P_RID = new FinderPath(ProcessStepRoleModelImpl.ENTITY_CACHE_ENABLED,
			ProcessStepRoleModelImpl.FINDER_CACHE_ENABLED,
			ProcessStepRoleImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByP_RID",
			new String[] { Long.class.getName() },
			ProcessStepRoleModelImpl.ROLEID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_P_RID = new FinderPath(ProcessStepRoleModelImpl.ENTITY_CACHE_ENABLED,
			ProcessStepRoleModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByP_RID",
			new String[] { Long.class.getName() });

	/**
	 * Returns all the process step roles where roleId = &#63;.
	 *
	...
	public List<ProcessStepRole> findByP_RID(long roleId) {
		return findByP_RID(roleId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the process step roles where roleId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProcessStepRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<ProcessStepRole> findByP_RID(long roleId, int start, int end) {
		return findByP_RID(roleId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the process step roles where roleId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link ProcessStepRoleModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<ProcessStepRole> findByP_RID(long roleId, int start, int end,
		OrderByComparator<ProcessStepRole> orderByComparator) {
		return findByP_RID(roleId, start, end, orderByComparator, true);
	}
	...
	public List<ProcessStepRole> findByP_RID(long roleId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_P_RID;
			finderArgs = new Object[] { roleId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_P_RID;
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (ProcessStepRole processStepRole : list) {
					if ((roleId != processStepRole.getRoleId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_P_RID_ROLEID_2);
	...
	/**
	 * Returns the first process step role in the ordered set where roleId = &#63;.
	 *
	 * @param roleId the role ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching process step role
	 ...
	 */
	@Override
	public ProcessStepRole findByP_RID_First(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws NoSuchProcessStepRoleException {
		ProcessStepRole processStepRole = fetchByP_RID_First(roleId,
				orderByComparator);
	 ...
	 */
	@Override
	public ProcessStepRole fetchByP_RID_First(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator) {
		List<ProcessStepRole> list = findByP_RID(roleId, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last process step role in the ordered set where roleId = &#63;.
	 *
	 * @param roleId the role ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching process step role
	 ...
	 */
	@Override
	public ProcessStepRole findByP_RID_Last(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws NoSuchProcessStepRoleException {
		ProcessStepRole processStepRole = fetchByP_RID_Last(roleId,
				orderByComparator);
	 ...
	 */
	@Override
	public ProcessStepRole fetchByP_RID_Last(long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator) {
		int count = countByP_RID(roleId);

		if (count == 0) {
			return null;
		}

		List<ProcessStepRole> list = findByP_RID(roleId, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the process step roles before and after the current process step role in the ordered set where roleId = &#63;.
	 *
	 * @param processStepRolePK the primary key of the current process step role
	 * @param roleId the role ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public ProcessStepRole[] findByP_RID_PrevAndNext(
		ProcessStepRolePK processStepRolePK, long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator)
		throws NoSuchProcessStepRoleException {
		ProcessStepRole processStepRole = findByPrimaryKey(processStepRolePK);
		...
		try {
			...
			array[0] = getByP_RID_PrevAndNext(session, processStepRole, roleId,
					orderByComparator, true);

			array[1] = processStepRole;

			array[2] = getByP_RID_PrevAndNext(session, processStepRole, roleId,
					orderByComparator, false);
	...
	protected ProcessStepRole getByP_RID_PrevAndNext(Session session,
		ProcessStepRole processStepRole, long roleId,
		OrderByComparator<ProcessStepRole> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the process step roles where roleId = &#63; from the database.
	 *
	 * @param roleId the role ID
	 */
	@Override
	public void removeByP_RID(long roleId) {
		for (ProcessStepRole processStepRole : findByP_RID(roleId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(processStepRole);
		}
	}
	...
	/**
	 * Returns the number of process step roles where roleId = &#63;.
	 *
	 * @param roleId the role ID
	 * @return the number of matching process step roles
	 */
	@Override
	public int countByP_RID(long roleId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_P_RID;
	...
	private static final String _FINDER_COLUMN_P_RID_ROLEID_2 = "processStepRole.id.roleId = ?";
	...
	protected ProcessStepRole removeImpl(ProcessStepRole processStepRole) {
		processStepRole = toUnwrappedModel(processStepRole);
	...
	public ProcessStepRole updateImpl(ProcessStepRole processStepRole) {
		...
		if (isNew || !ProcessStepRoleModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((processStepRoleModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_P_RID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						processStepRoleModelImpl.getOriginalRoleId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_P_RID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_P_RID,
					args);

				args = new Object[] { processStepRoleModelImpl.getRoleId() };
	...
	protected ProcessStepRole toUnwrappedModel(ProcessStepRole processStepRole) {
		if (processStepRole instanceof ProcessStepRoleImpl) {
			return processStepRole;
		}

		ProcessStepRoleImpl processStepRoleImpl = new ProcessStepRoleImpl();

		processStepRoleImpl.setNew(processStepRole.isNew());
		processStepRoleImpl.setPrimaryKey(processStepRole.getPrimaryKey());

		processStepRoleImpl.setUuid(processStepRole.getUuid());
		processStepRoleImpl.setProcessStepId(processStepRole.getProcessStepId());
		processStepRoleImpl.setRoleId(processStepRole.getRoleId());
		processStepRoleImpl.setModerator(processStepRole.isModerator());
		processStepRoleImpl.setCondition(processStepRole.getCondition());
