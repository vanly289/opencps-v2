...
public class ServiceFileTemplateCacheModel implements CacheModel<ServiceFileTemplate>,
	...
	public ServiceFileTemplate toEntityModel() {
		...
		if (uuid == null) {
			serviceFileTemplateImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (fileTemplateNo == null) {
			serviceFileTemplateImpl.setFileTemplateNo(StringPool.BLANK);
		}
		else {
		...
		if (templateName == null) {
			serviceFileTemplateImpl.setTemplateName(StringPool.BLANK);
		}
		else {
