...
import org.opencps.dossiermgt.service.RegistrationLocalService;
 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.RegistrationLocalServiceImpl}.
 * </p>
 *
 * @author huymq
...
public abstract class RegistrationLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.RegistrationLocalServiceUtil} to access the registration local service.
	 */
	...
	public List<Registration> getRegistrationsByUuidAndCompanyId(String uuid,
		...
		return registrationPersistence.findByUuid_C(uuid, companyId, start,
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.Registration",
			registrationLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.Registration");
	}
