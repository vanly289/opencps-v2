...
public class DeliverableLogCacheModel implements CacheModel<DeliverableLog>,
	...
	public DeliverableLog toEntityModel() {
		...
		if (uuid == null) {
			deliverableLogImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			deliverableLogImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (deliverableId == null) {
			deliverableLogImpl.setDeliverableId(StringPool.BLANK);
		}
		else {
		...
		if (dossierUid == null) {
			deliverableLogImpl.setDossierUid(StringPool.BLANK);
		}
		else {
		...
		if (author == null) {
			deliverableLogImpl.setAuthor(StringPool.BLANK);
		}
		else {
		...
		if (content == null) {
			deliverableLogImpl.setContent(StringPool.BLANK);
		}
		else {
		...
		if (payload == null) {
			deliverableLogImpl.setPayload(StringPool.BLANK);
		}
		else {
