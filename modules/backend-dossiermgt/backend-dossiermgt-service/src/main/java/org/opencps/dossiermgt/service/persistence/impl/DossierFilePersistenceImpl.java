...
public class DossierFilePersistenceImpl extends BasePersistenceImpl<DossierFile>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dossierFile.getUuid() == null) ||
							!dossierFile.getUuid().equals(uuid) ||
							(dossierFile.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dossierFile.getDossierId() != dossierId) ||
							(dossierFile.getReferenceUid() == null) ||
							!dossierFile.getReferenceUid().equals(referenceUid) ||
							(dossierFile.getRemoved() != removed)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_D_RUID,
							finderArgs, dossierFile);
					}
				}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dossierFile.getDeliverableCode() == null) ||
							!dossierFile.getDeliverableCode()
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dossierFile.getGroupId() != groupId) ||
							(dossierFile.getReferenceUid() == null) ||
							!dossierFile.getReferenceUid().equals(referenceUid)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_GID_REF,
							finderArgs, dossierFile);
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((dossierFile.getFileEntryId() != fileEntryId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_FILE_ID,
							finderArgs, dossierFile);
					}
				}
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_ISN_TEMP =
		new FinderPath(DossierFileModelImpl.ENTITY_CACHE_ENABLED,
			DossierFileModelImpl.FINDER_CACHE_ENABLED, DossierFileImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByDID_ISN_TEMP",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_ISN_TEMP =
		new FinderPath(DossierFileModelImpl.ENTITY_CACHE_ENABLED,
			DossierFileModelImpl.FINDER_CACHE_ENABLED, DossierFileImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByDID_ISN_TEMP",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			},
			...
			DossierFileModelImpl.MODIFIEDDATE_COLUMN_BITMASK |
			DossierFileModelImpl.DOSSIERPARTNO_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_DID_ISN_TEMP = new FinderPath(DossierFileModelImpl.ENTITY_CACHE_ENABLED,
			DossierFileModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByDID_ISN_TEMP",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			});
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_COUNT_BY_DID_ISN_TEMP =
		new FinderPath(DossierFileModelImpl.ENTITY_CACHE_ENABLED,
			DossierFileModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "countByDID_ISN_TEMP",
			new String[] {
				Long.class.getName(), Boolean.class.getName(),
				String.class.getName()
			});
	 ...
	 */
	@Override
	public List<DossierFile> findByDID_ISN_TEMP(long dossierId, boolean isNew,
		String fileTemplateNo) {
		return findByDID_ISN_TEMP(dossierId, isNew, fileTemplateNo,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<DossierFile> findByDID_ISN_TEMP(long dossierId, boolean isNew,
		String fileTemplateNo, int start, int end) {
		return findByDID_ISN_TEMP(dossierId, isNew, fileTemplateNo, start, end,
			null);
	}
	...
	public List<DossierFile> findByDID_ISN_TEMP(long dossierId, boolean isNew,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_ISN_TEMP;
			finderArgs = new Object[] { dossierId, isNew, fileTemplateNo };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_ISN_TEMP;
			finderArgs = new Object[] {
					dossierId, isNew, fileTemplateNo,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_DID_ISN_TEMP_DOSSIERID_2);

			query.append(_FINDER_COLUMN_DID_ISN_TEMP_ISNEW_2);

			boolean bindFileTemplateNo = false;

			if (fileTemplateNo == null) {
				query.append(_FINDER_COLUMN_DID_ISN_TEMP_FILETEMPLATENO_1);
			}
			else if (fileTemplateNo.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_DID_ISN_TEMP_FILETEMPLATENO_3);
			}
			else {
				bindFileTemplateNo = true;

				query.append(_FINDER_COLUMN_DID_ISN_TEMP_FILETEMPLATENO_2);
			}
	...
	public DossierFile findByDID_ISN_TEMP_First(long dossierId, boolean isNew,
		String fileTemplateNo, OrderByComparator<DossierFile> orderByComparator)
		throws NoSuchDossierFileException {
		DossierFile dossierFile = fetchByDID_ISN_TEMP_First(dossierId, isNew,
				fileTemplateNo, orderByComparator);
	...
	public DossierFile fetchByDID_ISN_TEMP_First(long dossierId, boolean isNew,
		String fileTemplateNo, OrderByComparator<DossierFile> orderByComparator) {
		List<DossierFile> list = findByDID_ISN_TEMP(dossierId, isNew,
				fileTemplateNo, 0, 1, orderByComparator);
	...
	public DossierFile findByDID_ISN_TEMP_Last(long dossierId, boolean isNew,
		String fileTemplateNo, OrderByComparator<DossierFile> orderByComparator)
		throws NoSuchDossierFileException {
		DossierFile dossierFile = fetchByDID_ISN_TEMP_Last(dossierId, isNew,
				fileTemplateNo, orderByComparator);
	...
	public DossierFile fetchByDID_ISN_TEMP_Last(long dossierId, boolean isNew,
		String fileTemplateNo, OrderByComparator<DossierFile> orderByComparator) {
		int count = countByDID_ISN_TEMP(dossierId, isNew, fileTemplateNo);
		...
		List<DossierFile> list = findByDID_ISN_TEMP(dossierId, isNew,
				fileTemplateNo, count - 1, count, orderByComparator);
	...
	public DossierFile[] findByDID_ISN_TEMP_PrevAndNext(long dossierFileId,
		long dossierId, boolean isNew, String fileTemplateNo,
		OrderByComparator<DossierFile> orderByComparator)
		throws NoSuchDossierFileException {
		DossierFile dossierFile = findByPrimaryKey(dossierFileId);
		...
		try {
			...
			array[0] = getByDID_ISN_TEMP_PrevAndNext(session, dossierFile,
					dossierId, isNew, fileTemplateNo, orderByComparator, true);

			array[1] = dossierFile;

			array[2] = getByDID_ISN_TEMP_PrevAndNext(session, dossierFile,
					dossierId, isNew, fileTemplateNo, orderByComparator, false);
	...
	protected DossierFile getByDID_ISN_TEMP_PrevAndNext(Session session,
		DossierFile dossierFile, long dossierId, boolean isNew,
		String fileTemplateNo,
		OrderByComparator<DossierFile> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public List<DossierFile> findByDID_ISN_TEMP(long dossierId, boolean isNew,
		...
		return findByDID_ISN_TEMP(dossierId, isNew, fileTemplateNos,
			QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	...
	public List<DossierFile> findByDID_ISN_TEMP(long dossierId, boolean isNew,
		...
		return findByDID_ISN_TEMP(dossierId, isNew, fileTemplateNos, start,
			end, null);
	}
	...
	public List<DossierFile> findByDID_ISN_TEMP(long dossierId, boolean isNew,
		...
		if (fileTemplateNos.length == 1) {
			return findByDID_ISN_TEMP(dossierId, isNew, fileTemplateNos[0],
				start, end, orderByComparator);
		}
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderArgs = new Object[] {
					dossierId, isNew, StringUtil.merge(fileTemplateNos)
				};
		}
		else {
			finderArgs = new Object[] {
		...
		if (retrieveFromCache) {
			list = (List<DossierFile>)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_ISN_TEMP,
					finderArgs, this);
		...
		if (list == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_ISN_TEMP,
					finderArgs, list);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_ISN_TEMP,
					finderArgs);
	...
	public void removeByDID_ISN_TEMP(long dossierId, boolean isNew,
		String fileTemplateNo) {
		for (DossierFile dossierFile : findByDID_ISN_TEMP(dossierId, isNew,
	...
	public int countByDID_ISN_TEMP(long dossierId, boolean isNew,
		String fileTemplateNo) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_DID_ISN_TEMP;

		Object[] finderArgs = new Object[] { dossierId, isNew, fileTemplateNo };
	...
	public int countByDID_ISN_TEMP(long dossierId, boolean isNew,
		...
		Long count = (Long)finderCache.getResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_DID_ISN_TEMP,
				finderArgs, this);
		...
		if (count == null) {
			...
			try {
				...
				finderCache.putResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_DID_ISN_TEMP,
					finderArgs, count);
			}
			catch (Exception e) {
				finderCache.removeResult(FINDER_PATH_WITH_PAGINATION_COUNT_BY_DID_ISN_TEMP,
					finderArgs);
	...
	private static final String _FINDER_COLUMN_DID_ISN_TEMP_DOSSIERID_2 = "dossierFile.dossierId = ? AND ";
	private static final String _FINDER_COLUMN_DID_ISN_TEMP_ISNEW_2 = "dossierFile.isNew = ? AND ";
	private static final String _FINDER_COLUMN_DID_ISN_TEMP_FILETEMPLATENO_1 = "dossierFile.fileTemplateNo IS NULL";
	private static final String _FINDER_COLUMN_DID_ISN_TEMP_FILETEMPLATENO_2 = "dossierFile.fileTemplateNo = ?";
	private static final String _FINDER_COLUMN_DID_ISN_TEMP_FILETEMPLATENO_3 = "(dossierFile.fileTemplateNo IS NULL OR dossierFile.fileTemplateNo = '')";
	public static final FinderPath FINDER_PATH_FETCH_BY_F_DID_REF_DAID = new FinderPath(DossierFileModelImpl.ENTITY_CACHE_ENABLED,
			DossierFileModelImpl.FINDER_CACHE_ENABLED, DossierFileImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByF_DID_REF_DAID",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			},
			DossierFileModelImpl.DOSSIERID_COLUMN_BITMASK |
			DossierFileModelImpl.REFERENCEUID_COLUMN_BITMASK |
			DossierFileModelImpl.DOSSIERACTIONID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_F_DID_REF_DAID = new FinderPath(DossierFileModelImpl.ENTITY_CACHE_ENABLED,
			DossierFileModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByF_DID_REF_DAID",
			new String[] {
				Long.class.getName(), String.class.getName(),
				Long.class.getName()
			});
	...
	public DossierFile findByF_DID_REF_DAID(long dossierId,
		String referenceUid, long dossierActionId)
		throws NoSuchDossierFileException {
		DossierFile dossierFile = fetchByF_DID_REF_DAID(dossierId,
	...
	public DossierFile fetchByF_DID_REF_DAID(long dossierId,
		String referenceUid, long dossierActionId) {
		return fetchByF_DID_REF_DAID(dossierId, referenceUid, dossierActionId,
			true);
	}
	...
	@Override
	public DossierFile fetchByF_DID_REF_DAID(long dossierId,
		String referenceUid, long dossierActionId, boolean retrieveFromCache) {
		Object[] finderArgs = new Object[] {
				dossierId, referenceUid, dossierActionId
			};

		Object result = null;

		if (retrieveFromCache) {
			result = finderCache.getResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID,
					finderArgs, this);
		}
		...
		if (result instanceof DossierFile) {
			...
			if ((dossierId != dossierFile.getDossierId()) ||
					!Objects.equals(referenceUid, dossierFile.getReferenceUid()) ||
					(dossierActionId != dossierFile.getDossierActionId())) {
				result = null;
			}
		}
		...
		if (result == null) {
			...
			query.append(_FINDER_COLUMN_F_DID_REF_DAID_DOSSIERID_2);

			boolean bindReferenceUid = false;

			if (referenceUid == null) {
				query.append(_FINDER_COLUMN_F_DID_REF_DAID_REFERENCEUID_1);
			}
			else if (referenceUid.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_F_DID_REF_DAID_REFERENCEUID_3);
			}
			else {
				bindReferenceUid = true;

				query.append(_FINDER_COLUMN_F_DID_REF_DAID_REFERENCEUID_2);
			}

			query.append(_FINDER_COLUMN_F_DID_REF_DAID_DOSSIERACTIONID_2);
			...
			try {
				...
				if (list.isEmpty()) {
					finderCache.putResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID,
						finderArgs, list);
				}
				else {
					if (list.size() > 1) {
						...
						if (_log.isWarnEnabled()) {
							_log.warn(
								"DossierFilePersistenceImpl.fetchByF_DID_REF_DAID(long, String, long, boolean) with parameters (" +
								StringUtil.merge(finderArgs) +
								") yields a result set with more than 1 result. This violates the logical unique restriction. There is no order guarantee on which result is returned by this finder.");
						}
					}
					...
					if ((dossierFile.getDossierId() != dossierId) ||
							(dossierFile.getReferenceUid() == null) ||
							!dossierFile.getReferenceUid().equals(referenceUid) ||
							(dossierFile.getDossierActionId() != dossierActionId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID,
							finderArgs, dossierFile);
					}
				}
				...
				finderCache.removeResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID,
					finderArgs);
	...
	public DossierFile removeByF_DID_REF_DAID(long dossierId,
		String referenceUid, long dossierActionId)
		throws NoSuchDossierFileException {
		DossierFile dossierFile = findByF_DID_REF_DAID(dossierId, referenceUid,
				dossierActionId);
	 ...
	 */
	@Override
	public int countByF_DID_REF_DAID(long dossierId, String referenceUid,
		long dossierActionId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_F_DID_REF_DAID;
	...
	private static final String _FINDER_COLUMN_F_DID_REF_DAID_DOSSIERID_2 = "dossierFile.dossierId = ? AND ";
	private static final String _FINDER_COLUMN_F_DID_REF_DAID_REFERENCEUID_1 = "dossierFile.referenceUid IS NULL AND ";
	private static final String _FINDER_COLUMN_F_DID_REF_DAID_REFERENCEUID_2 = "dossierFile.referenceUid = ? AND ";
	private static final String _FINDER_COLUMN_F_DID_REF_DAID_REFERENCEUID_3 = "(dossierFile.referenceUid IS NULL OR dossierFile.referenceUid = '') AND ";
	private static final String _FINDER_COLUMN_F_DID_REF_DAID_DOSSIERACTIONID_2 = "dossierFile.dossierActionId = ?";
	...
	public void cacheResult(DossierFile dossierFile) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID,
			new Object[] {
				dossierFile.getDossierId(), dossierFile.getReferenceUid(),
				dossierFile.getDossierActionId()
			}, dossierFile);
	...
	protected void cacheUniqueFindersCache(
		...
		args = new Object[] {
				dossierFileModelImpl.getDossierId(),
				dossierFileModelImpl.getReferenceUid(),
				dossierFileModelImpl.getDossierActionId()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_F_DID_REF_DAID, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID, args,
			dossierFileModelImpl, false);
	}
	...
	protected void clearUniqueFindersCache(
		...
		if (clearCurrent) {
			...
			finderCache.removeResult(FINDER_PATH_COUNT_BY_F_DID_REF_DAID, args);
			finderCache.removeResult(FINDER_PATH_FETCH_BY_F_DID_REF_DAID, args);
		}

		if ((dossierFileModelImpl.getColumnBitmask() &
				FINDER_PATH_FETCH_BY_F_DID_REF_DAID.getColumnBitmask()) != 0) {
			Object[] args = new Object[] {
					dossierFileModelImpl.getOriginalDossierId(),
					dossierFileModelImpl.getOriginalReferenceUid(),
					dossierFileModelImpl.getOriginalDossierActionId()
				};
	...
	public DossierFile updateImpl(DossierFile dossierFile) {
		...
		if (isNew || !DossierFileModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dossierFileModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_ISN_TEMP.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dossierFileModelImpl.getOriginalDossierId(),
						dossierFileModelImpl.getOriginalIsNew(),
						dossierFileModelImpl.getOriginalFileTemplateNo()
				...
				finderCache.removeResult(FINDER_PATH_COUNT_BY_DID_ISN_TEMP, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_ISN_TEMP,
					args);
	...
	protected DossierFile toUnwrappedModel(DossierFile dossierFile) {
		...
		dossierFileImpl.setUserName(dossierFile.getUserName());
		...
		dossierFileImpl.setReferenceUid(dossierFile.getReferenceUid());
		dossierFileImpl.setDossierTemplateNo(dossierFile.getDossierTemplateNo());
		dossierFileImpl.setDossierPartNo(dossierFile.getDossierPartNo());
		dossierFileImpl.setDossierPartType(dossierFile.getDossierPartType());
		...
		dossierFileImpl.setIsNew(dossierFile.isIsNew());
		dossierFileImpl.setRemoved(dossierFile.isRemoved());
		dossierFileImpl.setSignCheck(dossierFile.getSignCheck());
		dossierFileImpl.setSignInfo(dossierFile.getSignInfo());
		dossierFileImpl.setFormScript(dossierFile.getFormScript());
		dossierFileImpl.setFormReport(dossierFile.getFormReport());
		dossierFileImpl.setFormSchema(dossierFile.getFormSchema());
		dossierFileImpl.setDeliverableCode(dossierFile.getDeliverableCode());
		dossierFileImpl.setDossierActionId(dossierFile.getDossierActionId());
