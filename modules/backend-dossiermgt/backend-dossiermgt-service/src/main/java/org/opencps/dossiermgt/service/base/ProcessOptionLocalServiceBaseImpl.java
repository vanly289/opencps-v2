...
/**
 * Provides the base implementation for the process option local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ProcessOptionLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ProcessOptionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProcessOptionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ProcessOptionLocalServiceUtil} to access the process option local service.
	 */
	...
	public ProcessOption createProcessOption(long processOptionId) {
		return processOptionPersistence.create(processOptionId);
	}
	...
	public ProcessOption deleteProcessOption(long processOptionId)
		...
		return processOptionPersistence.remove(processOptionId);
	}
	...
	public ProcessOption deleteProcessOption(ProcessOption processOption) {
		return processOptionPersistence.remove(processOption);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProcessOption.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return processOptionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return processOptionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProcessOption fetchProcessOption(long processOptionId) {
		return processOptionPersistence.fetchByPrimaryKey(processOptionId);
	}
	...
	public ProcessOption fetchProcessOptionByUuidAndGroupId(String uuid,
		long groupId) {
		return processOptionPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProcessOption getProcessOption(long processOptionId)
		throws PortalException {
		return processOptionPersistence.findByPrimaryKey(processOptionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(processOptionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProcessOption.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("processOptionId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(processOptionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProcessOption.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ProcessOption>() {
				@Override
				public void performAction(ProcessOption processOption)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ProcessOption.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return processOptionLocalService.deleteProcessOption((ProcessOption)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return processOptionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProcessOption> getProcessOptionsByUuidAndCompanyId(
		...
		return processOptionPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProcessOption> getProcessOptionsByUuidAndCompanyId(
		...
		return processOptionPersistence.findByUuid_C(uuid, companyId, start,
	...
	public ProcessOption getProcessOptionByUuidAndGroupId(String uuid,
		...
		return processOptionPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public int getProcessOptionsCount() {
		return processOptionPersistence.countAll();
	}
	 ...
	 */
	public ProcessOptionLocalService getProcessOptionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ProcessOption",
			processOptionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcessOptionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = processOptionPersistence.getDataSource();
	...
	@BeanReference(type = ProcessOptionLocalService.class)
	protected ProcessOptionLocalService processOptionLocalService;
