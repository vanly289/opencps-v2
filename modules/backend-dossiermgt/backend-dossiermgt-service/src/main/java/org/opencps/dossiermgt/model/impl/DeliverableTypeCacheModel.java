...
public class DeliverableTypeCacheModel implements CacheModel<DeliverableType>,
	...
	public DeliverableType toEntityModel() {
		...
		if (uuid == null) {
			deliverableTypeImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			deliverableTypeImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (typeCode == null) {
			deliverableTypeImpl.setTypeCode(StringPool.BLANK);
		}
		else {
		...
		if (typeName == null) {
			deliverableTypeImpl.setTypeName(StringPool.BLANK);
		}
		else {
		...
		if (formScript == null) {
			deliverableTypeImpl.setFormScript(StringPool.BLANK);
		}
		else {
		...
		if (formReport == null) {
			deliverableTypeImpl.setFormReport(StringPool.BLANK);
		}
		else {
		...
		if (codePattern == null) {
			deliverableTypeImpl.setCodePattern(StringPool.BLANK);
		}
		else {
		...
		if (counter == null) {
			deliverableTypeImpl.setCounter(StringPool.BLANK);
		}
		else {
		...
		if (mappingData == null) {
			deliverableTypeImpl.setMappingData(StringPool.BLANK);
		}
		else {
