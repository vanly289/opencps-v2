...
import org.opencps.dossiermgt.exception.NoSuchDossierLogException;
 ...
 * @see org.opencps.dossiermgt.service.persistence.DossierLogUtil
 * @generated
 */
@ProviderType
public class DossierLogPersistenceImpl extends BasePersistenceImpl<DossierLog>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_NOTITYPE = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, DossierLogImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByNotiType",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NOTITYPE =
		new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, DossierLogImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByNotiType",
			new String[] { String.class.getName() },
			DossierLogModelImpl.NOTIFICATIONTYPE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_NOTITYPE = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByNotiType",
			new String[] { String.class.getName() });
	 ...
	 */
	@Override
	public List<DossierLog> findByNotiType(String notificationType) {
		return findByNotiType(notificationType, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<DossierLog> findByNotiType(String notificationType, int start,
		int end) {
		return findByNotiType(notificationType, start, end, null);
	}
	...
	@Override
	public List<DossierLog> findByNotiType(String notificationType, int start,
		int end, OrderByComparator<DossierLog> orderByComparator) {
		return findByNotiType(notificationType, start, end, orderByComparator,
			true);
	}
	...
	public List<DossierLog> findByNotiType(String notificationType, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NOTITYPE;
			finderArgs = new Object[] { notificationType };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_NOTITYPE;
			finderArgs = new Object[] {
					notificationType,
			...
			if ((list != null) && !list.isEmpty()) {
				for (DossierLog dossierLog : list) {
					if (!Objects.equals(notificationType,
								dossierLog.getNotificationType())) {
						list = null;
		...
		if (list == null) {
			...
			if (notificationType == null) {
				query.append(_FINDER_COLUMN_NOTITYPE_NOTIFICATIONTYPE_1);
			}
			else if (notificationType.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_NOTITYPE_NOTIFICATIONTYPE_3);
			}
			else {
				bindNotificationType = true;

				query.append(_FINDER_COLUMN_NOTITYPE_NOTIFICATIONTYPE_2);
			}
	 ...
	 */
	@Override
	public DossierLog findByNotiType_First(String notificationType,
		OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = fetchByNotiType_First(notificationType,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierLog fetchByNotiType_First(String notificationType,
		OrderByComparator<DossierLog> orderByComparator) {
		List<DossierLog> list = findByNotiType(notificationType, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierLog findByNotiType_Last(String notificationType,
		OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = fetchByNotiType_Last(notificationType,
				orderByComparator);
	 ...
	 */
	@Override
	public DossierLog fetchByNotiType_Last(String notificationType,
		OrderByComparator<DossierLog> orderByComparator) {
		int count = countByNotiType(notificationType);

		if (count == 0) {
			return null;
		}

		List<DossierLog> list = findByNotiType(notificationType, count - 1,
	 ...
	 */
	@Override
	public DossierLog[] findByNotiType_PrevAndNext(long dossierLogId,
		...
		try {
			...
			array[0] = getByNotiType_PrevAndNext(session, dossierLog,
					notificationType, orderByComparator, true);

			array[1] = dossierLog;

			array[2] = getByNotiType_PrevAndNext(session, dossierLog,
	...
	protected DossierLog getByNotiType_PrevAndNext(Session session,
		DossierLog dossierLog, String notificationType,
		OrderByComparator<DossierLog> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByNotiType(String notificationType) {
		for (DossierLog dossierLog : findByNotiType(notificationType,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(dossierLog);
		}
	}
	 ...
	 */
	@Override
	public int countByNotiType(String notificationType) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_NOTITYPE;

		Object[] finderArgs = new Object[] { notificationType };
	...
	private static final String _FINDER_COLUMN_NOTITYPE_NOTIFICATIONTYPE_1 = "dossierLog.notificationType IS NULL";
	private static final String _FINDER_COLUMN_NOTITYPE_NOTIFICATIONTYPE_2 = "dossierLog.notificationType = ?";
	private static final String _FINDER_COLUMN_NOTITYPE_NOTIFICATIONTYPE_3 = "(dossierLog.notificationType IS NULL OR dossierLog.notificationType = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_NTYP = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, DossierLogImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByDID_NTYP",
			new String[] {
				String.class.getName(), Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_NTYP =
		new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, DossierLogImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByDID_NTYP",
			new String[] { String.class.getName(), Long.class.getName() },
			DossierLogModelImpl.NOTIFICATIONTYPE_COLUMN_BITMASK |
			DossierLogModelImpl.DOSSIERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_DID_NTYP = new FinderPath(DossierLogModelImpl.ENTITY_CACHE_ENABLED,
			DossierLogModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByDID_NTYP",
			new String[] { String.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<DossierLog> findByDID_NTYP(String notificationType,
		long dossierId) {
		return findByDID_NTYP(notificationType, dossierId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<DossierLog> findByDID_NTYP(String notificationType,
		...
		return findByDID_NTYP(notificationType, dossierId, start, end, null);
	}
	...
	public List<DossierLog> findByDID_NTYP(String notificationType,
		long dossierId, int start, int end,
		OrderByComparator<DossierLog> orderByComparator) {
		return findByDID_NTYP(notificationType, dossierId, start, end,
			orderByComparator, true);
	}
	...
	public List<DossierLog> findByDID_NTYP(String notificationType,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_NTYP;
			finderArgs = new Object[] { notificationType, dossierId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_DID_NTYP;
			finderArgs = new Object[] {
					notificationType, dossierId,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (DossierLog dossierLog : list) {
					if (!Objects.equals(notificationType,
								dossierLog.getNotificationType()) ||
							(dossierId != dossierLog.getDossierId())) {
						list = null;
		...
		if (list == null) {
			...
			if (notificationType == null) {
				query.append(_FINDER_COLUMN_DID_NTYP_NOTIFICATIONTYPE_1);
			}
			else if (notificationType.equals(StringPool.BLANK)) {
				query.append(_FINDER_COLUMN_DID_NTYP_NOTIFICATIONTYPE_3);
			}
			else {
				bindNotificationType = true;

				query.append(_FINDER_COLUMN_DID_NTYP_NOTIFICATIONTYPE_2);
			}

			query.append(_FINDER_COLUMN_DID_NTYP_DOSSIERID_2);
	 ...
	 */
	@Override
	public DossierLog findByDID_NTYP_First(String notificationType,
		long dossierId, OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = fetchByDID_NTYP_First(notificationType,
	 ...
	 */
	@Override
	public DossierLog fetchByDID_NTYP_First(String notificationType,
		long dossierId, OrderByComparator<DossierLog> orderByComparator) {
		List<DossierLog> list = findByDID_NTYP(notificationType, dossierId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public DossierLog findByDID_NTYP_Last(String notificationType,
		long dossierId, OrderByComparator<DossierLog> orderByComparator)
		throws NoSuchDossierLogException {
		DossierLog dossierLog = fetchByDID_NTYP_Last(notificationType,
				dossierId, orderByComparator);
	 ...
	 */
	@Override
	public DossierLog fetchByDID_NTYP_Last(String notificationType,
		long dossierId, OrderByComparator<DossierLog> orderByComparator) {
		int count = countByDID_NTYP(notificationType, dossierId);

		if (count == 0) {
			return null;
		}

		List<DossierLog> list = findByDID_NTYP(notificationType, dossierId,
	 ...
	 */
	@Override
	public DossierLog[] findByDID_NTYP_PrevAndNext(long dossierLogId,
		...
		try {
			...
			array[0] = getByDID_NTYP_PrevAndNext(session, dossierLog,
					notificationType, dossierId, orderByComparator, true);

			array[1] = dossierLog;

			array[2] = getByDID_NTYP_PrevAndNext(session, dossierLog,
					notificationType, dossierId, orderByComparator, false);
	...
	protected DossierLog getByDID_NTYP_PrevAndNext(Session session,
		DossierLog dossierLog, String notificationType, long dossierId,
		OrderByComparator<DossierLog> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByDID_NTYP(String notificationType, long dossierId) {
		for (DossierLog dossierLog : findByDID_NTYP(notificationType,
	 ...
	 */
	@Override
	public int countByDID_NTYP(String notificationType, long dossierId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_DID_NTYP;

		Object[] finderArgs = new Object[] { notificationType, dossierId };
	...
	private static final String _FINDER_COLUMN_DID_NTYP_NOTIFICATIONTYPE_1 = "dossierLog.notificationType IS NULL AND ";
	private static final String _FINDER_COLUMN_DID_NTYP_NOTIFICATIONTYPE_2 = "dossierLog.notificationType = ? AND ";
	private static final String _FINDER_COLUMN_DID_NTYP_NOTIFICATIONTYPE_3 = "(dossierLog.notificationType IS NULL OR dossierLog.notificationType = '') AND ";
	private static final String _FINDER_COLUMN_DID_NTYP_DOSSIERID_2 = "dossierLog.dossierId = ?";
	...
	public DossierLog updateImpl(DossierLog dossierLog) {
		...
		if (isNew || !DossierLogModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((dossierLogModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NOTITYPE.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dossierLogModelImpl.getOriginalNotificationType()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_NOTITYPE, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_NOTITYPE,
					args);

				args = new Object[] { dossierLogModelImpl.getNotificationType() };
			...
			if ((dossierLogModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_NTYP.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						dossierLogModelImpl.getOriginalNotificationType(),
						dossierLogModelImpl.getOriginalDossierId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_DID_NTYP, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_DID_NTYP,
					args);

				args = new Object[] {
						dossierLogModelImpl.getNotificationType(),
	...
	protected DossierLog toUnwrappedModel(DossierLog dossierLog) {
		...
		dossierLogImpl.setPayload(dossierLog.getPayload());
