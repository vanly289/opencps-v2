...
public abstract class ServiceConfigLocalServiceBaseImpl
	...
	public ServiceConfig fetchServiceConfigByUuidAndGroupId(String uuid,
		long groupId) {
		return serviceConfigPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(serviceConfigLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ServiceConfig.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("serviceConfigId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(serviceConfigLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ServiceConfig.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ServiceConfig>() {
				@Override
				public void performAction(ServiceConfig serviceConfig)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ServiceConfig.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return serviceConfigLocalService.deleteServiceConfig((ServiceConfig)persistedModel);
	}
	...
	public List<ServiceConfig> getServiceConfigsByUuidAndCompanyId(
		...
		return serviceConfigPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ServiceConfig> getServiceConfigsByUuidAndCompanyId(
		...
		return serviceConfigPersistence.findByUuid_C(uuid, companyId, start,
	...
	public ServiceConfig getServiceConfigByUuidAndGroupId(String uuid,
		...
		return serviceConfigPersistence.findByUUID_G(uuid, groupId);
	}
	 ...
	 */
	public ServiceConfigLocalService getServiceConfigLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ServiceConfig",
	...
	public String getOSGiServiceIdentifier() {
		return ServiceConfigLocalService.class.getName();
	}
	...
	@BeanReference(type = ServiceConfigLocalService.class)
	protected ServiceConfigLocalService serviceConfigLocalService;
