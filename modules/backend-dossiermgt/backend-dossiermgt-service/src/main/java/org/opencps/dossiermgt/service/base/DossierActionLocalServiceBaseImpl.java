...
/**
 * Provides the base implementation for the dossier action local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.DossierActionLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class DossierActionLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DossierActionLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.DossierActionLocalServiceUtil} to access the dossier action local service.
	 */
	...
	public DossierAction addDossierAction(DossierAction dossierAction) {
		...
		return dossierActionPersistence.update(dossierAction);
	}
	...
	public DossierAction createDossierAction(long dossierActionId) {
		return dossierActionPersistence.create(dossierActionId);
	}
	...
	public DossierAction deleteDossierAction(long dossierActionId)
		...
		return dossierActionPersistence.remove(dossierActionId);
	}
	...
	public DossierAction deleteDossierAction(DossierAction dossierAction) {
		return dossierActionPersistence.remove(dossierAction);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DossierAction.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dossierActionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dossierActionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DossierAction fetchDossierAction(long dossierActionId) {
		return dossierActionPersistence.fetchByPrimaryKey(dossierActionId);
	}
	...
	public DossierAction fetchDossierActionByUuidAndGroupId(String uuid,
		long groupId) {
		return dossierActionPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DossierAction getDossierAction(long dossierActionId)
		throws PortalException {
		return dossierActionPersistence.findByPrimaryKey(dossierActionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dossierActionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DossierAction.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dossierActionId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dossierActionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DossierAction.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DossierAction>() {
				@Override
				public void performAction(DossierAction dossierAction)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DossierAction.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dossierActionLocalService.deleteDossierAction((DossierAction)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dossierActionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DossierAction> getDossierActionsByUuidAndCompanyId(
		...
		return dossierActionPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DossierAction> getDossierActionsByUuidAndCompanyId(
		...
		return dossierActionPersistence.findByUuid_C(uuid, companyId, start,
	...
	public DossierAction getDossierActionByUuidAndGroupId(String uuid,
		...
		return dossierActionPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DossierAction> getDossierActions(int start, int end) {
		return dossierActionPersistence.findAll(start, end);
	}
	...
	public int getDossierActionsCount() {
		return dossierActionPersistence.countAll();
	}
	 ...
	 */
	public DossierActionLocalService getDossierActionLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.DossierAction",
			dossierActionLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.DossierAction");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DossierActionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dossierActionPersistence.getDataSource();
	...
	@BeanReference(type = DossierActionLocalService.class)
	protected DossierActionLocalService dossierActionLocalService;
