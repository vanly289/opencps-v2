...
import org.opencps.dossiermgt.service.ProcessPluginLocalService;
...
/**
 * Provides the base implementation for the process plugin local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.dossiermgt.service.impl.ProcessPluginLocalServiceImpl}.
 * </p>
 *
 * @author huymq
 ...
 */
@ProviderType
public abstract class ProcessPluginLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ProcessPluginLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.dossiermgt.service.ProcessPluginLocalServiceUtil} to access the process plugin local service.
	 */
	...
	public ProcessPlugin addProcessPlugin(ProcessPlugin processPlugin) {
		...
		return processPluginPersistence.update(processPlugin);
	}
	...
	public ProcessPlugin createProcessPlugin(long processPluginId) {
		return processPluginPersistence.create(processPluginId);
	}
	...
	public ProcessPlugin deleteProcessPlugin(long processPluginId)
		...
		return processPluginPersistence.remove(processPluginId);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(ProcessPlugin.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return processPluginPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return processPluginPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public ProcessPlugin fetchProcessPlugin(long processPluginId) {
		return processPluginPersistence.fetchByPrimaryKey(processPluginId);
	}
	 ...
	 */
	@Override
	public ProcessPlugin fetchProcessPluginByUuidAndGroupId(String uuid,
		long groupId) {
		return processPluginPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public ProcessPlugin getProcessPlugin(long processPluginId)
		throws PortalException {
		return processPluginPersistence.findByPrimaryKey(processPluginId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(processPluginLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(ProcessPlugin.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("processPluginId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(processPluginLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(ProcessPlugin.class);
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<ProcessPlugin>() {
				@Override
				public void performAction(ProcessPlugin processPlugin)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(ProcessPlugin.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return processPluginLocalService.deleteProcessPlugin((ProcessPlugin)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return processPluginPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<ProcessPlugin> getProcessPluginsByUuidAndCompanyId(
		...
		return processPluginPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<ProcessPlugin> getProcessPluginsByUuidAndCompanyId(
		...
		return processPluginPersistence.findByUuid_C(uuid, companyId, start,
	 ...
	 */
	@Override
	public ProcessPlugin getProcessPluginByUuidAndGroupId(String uuid,
		long groupId) throws PortalException {
		return processPluginPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<ProcessPlugin> getProcessPlugins(int start, int end) {
		return processPluginPersistence.findAll(start, end);
	}
	...
	public int getProcessPluginsCount() {
		return processPluginPersistence.countAll();
	}
	 ...
	 */
	public ProcessPluginLocalService getProcessPluginLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.dossiermgt.model.ProcessPlugin",
			processPluginLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.dossiermgt.model.ProcessPlugin");
	}
	...
	public String getOSGiServiceIdentifier() {
		return ProcessPluginLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = processPluginPersistence.getDataSource();
	...
	@BeanReference(type = ProcessPluginLocalService.class)
	protected ProcessPluginLocalService processPluginLocalService;
