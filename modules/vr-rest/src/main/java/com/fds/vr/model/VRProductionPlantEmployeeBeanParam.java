...
@XmlType(name = "", propOrder = { "id", "mtcore", "productplantid", "sequenceno", "employeename",
		"employeecertificateno", "trainningat", "modifydate", "syncdate", "keyword", "start", "end", "order_asc",
		"order_desc" })
@XmlRootElement(name = "VRProductionPlantEmployeeBeanParam")
public class VRProductionPlantEmployeeBeanParam {
