...
@XmlType(name = "", propOrder = { "id", "mtcore", "copreportrepositoryid", "copreportno", "sequenceno", "employeename",
		"employeecertificateno", "trainningat", "modifydate", "syncdate", "keyword", "start", "end", "order_asc",
		"order_desc" })
@XmlRootElement(name = "VRCOPProductionPlantEmployeeBeanParam")
public class VRCOPProductionPlantEmployeeBeanParam {
	...
	@QueryParam(value = "employeecertificateno")
	protected String employeeCertificateNo;
	@QueryParam(value = "trainningat")
