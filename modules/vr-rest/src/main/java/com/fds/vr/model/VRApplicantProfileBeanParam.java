...
@XmlType(name = "", propOrder = { "id", "mtcore", "mappingma_cty", "mappingten_cty", "mappingdia_chi_cty",
		"mappingnote", "mappingstatus", "applicantcode", "applicantname", "applicantaddress", "applicantphone",
		"applicantemail", "applicantfax", "applicantrepresentative", "applicantrepresentativetitle",
		"applicantcontactname", "applicantcontactemail", "applicantcontactphone", "applicantnationality",
		"applicantregion", "applicantcity", "markupcorporation", "corporationid", "markupdesigner",
		"markupoverseasmanufacturer", "markupdomesticsmanufacturer", "markupimporter", "markupcomponentxcg",
		"markupcomponentxmy", "markupcomponentxcd", "markupcomponentxdd", "markupcomponentxcn", "markupcomponentxch",
		"markupxcg", "markupxmy", "markupxcd", "markupxdd", "markupxcn", "markupxch", "issuetypexcg", "issuetypexmy",
		"issuetypexcd", "issuetypexdd", "issuetypexcn", "issuetypexch", "issuetypedescription", "applicantceremonydate",
...
@XmlRootElement(name = "VRApplicantProfileBeanParam")
public class VRApplicantProfileBeanParam {
