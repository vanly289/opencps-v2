...
@XmlType(name = "", propOrder = { "id", "mtcore", "debitnoteid", "inputsheetid", "outputsheetid", "bookid",
		"certificateid", "certificatenumber", "certificatedate", "vehicleclass", "stamptype", "stampshortno",
		"serialstartno", "serialendno", "subtotalindocument", "subtotalquantities", "vehicleprice", "unitprice",
		"totalamount", "totalinuse", "totalnotused", "totallost", "totalcancelled", "totalreturned", "remark",
		"modifydate", "syncdate", "keyword", "start", "end", "order_asc", "order_desc" })
@XmlRootElement(name = "VRClearingStampbookBeanParam")
public class VRClearingStampbookBeanParam {
	...
	@QueryParam(value = "debitnoteid")
	protected Long debitNoteId;
