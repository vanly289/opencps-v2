...
public class VRProductionManagementImpl implements VRProductionManagement {
	...
	@Override
	public Response getProductionPlantEquipment(HttpServletRequest request, HttpHeaders header, Company company, Locale locale,
			User user, ServiceContext serviceContext,String productionPlantCode, String productClassificationCode ) {
		
		try {

			JSONArray result = VRProductionPlantEquipmentLocalServiceUtil.findByProductionPlanCode(productionPlantCode, productClassificationCode);
	...
	@Override
	public Response getProductionPlantProdEquipment(HttpServletRequest request, HttpHeaders header, Company company, Locale locale,
			User user, ServiceContext serviceContext,String productionPlantCode) {
		
		try {

			JSONArray result = VRProductionPlantProdEquipmentLocalServiceUtil.findByProductionPlanCode(productionPlantCode);
	...
	public Response getProductType(HttpServletRequest request, HttpHeaders header, Company company, Locale locale,
		...
		try {
			...
			JSONArray result = VRProductTypeLocalServiceUtil.findByProductionPlanCode(productionPlantCode, productClassificationCode);
	...
	@Override
	public Response getProductionClassification(HttpServletRequest request, HttpHeaders header, Company company, Locale locale,
			User user, ServiceContext serviceContext,String productionPlantCode) {
	...
	@Override
	public Response getProductionPlantEmployee(HttpServletRequest request, HttpHeaders header, Company company, Locale locale,
			User user, ServiceContext serviceContext,String productionPlantCode) {
