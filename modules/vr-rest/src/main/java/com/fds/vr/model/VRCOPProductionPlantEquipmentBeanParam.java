...
@XmlType(name = "", propOrder = { "id", "mtcore", "copreportrepositoryid", "copreportno", "sequenceno", "equipmentcode",
		"equipmentname", "equipmenttype", "trademark", "trademarkname", "commercialname", "modelcode", "designsymbolno",
		"productioncountrycode", "equipmentstatus", "expiredate", "notes", "modifydate", "syncdate", "keyword", "start",
		"end", "order_asc", "order_desc" })
@XmlRootElement(name = "VRCOPProductionPlantEquipmentBeanParam")
public class VRCOPProductionPlantEquipmentBeanParam {
