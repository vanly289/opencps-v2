...
@XmlType(name = "", propOrder = { "id", "mtcore", "corporationid", "corporationname", "inspectorid", "isleader",
		"keyword", "start", "end", "order_asc", "order_desc" })
@XmlRootElement(name = "VRCorporationViewBeanParam")
public class VRCorporationViewBeanParam {
