...
import org.opencps.api.controller.HotfixManagement;
...
public class HotfixManagementImpl implements HotfixManagement {
	...
	public Response updateDossier(HttpServletRequest request, HttpHeaders header, Company company, Locale locale,
		...
		try {
			...
			Dossier oldDossier = actions.getDossierDetail(groupId, id, StringPool.BLANK);
			
			oldDossier.setOnline(Boolean.valueOf(input.getOnline()));
			
			Dossier dossier = DossierLocalServiceUtil.updateDossier(oldDossier);
