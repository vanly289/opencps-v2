...
/**
 * Provides the local service interface for SyncQueue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author trungdk
 * @see SyncQueueLocalServiceUtil
...
public interface SyncQueueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SyncQueueLocalServiceUtil} to access the sync queue local service. Add custom service methods to {@link org.opencps.synchronization.service.impl.SyncQueueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public List<SyncQueue> findByF_className_Method(long groupId,
		java.lang.String className, java.lang.String method, int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SyncQueue> getSyncQueues(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SyncQueue> getSyncQueuesByUuidAndCompanyId(
	...
	*/
	...
	public SyncQueue addBusinessSyncQueue(long userId, long groupId,
		java.lang.String serverNo, java.lang.String className,
		java.lang.String jsonObject, int status, int retryCount, int priority,
	...
	public SyncQueue addSyncQueue(long userId, long groupId,
		java.lang.String serverNo, java.lang.String className,
		java.lang.String jsonObject, int status, int retryCount, int priority,
		java.lang.String method, ServiceContext serviceContext)
		throws NoSuchUserException, SystemException, UnauthenticationException,
	...
	*/
	...
	public SyncQueue addSyncQueue(SyncQueue syncQueue);
	...
	*/
	public SyncQueue createSyncQueue(long syncQueueId);
	...
	*/
	...
	public SyncQueue deleteSyncQueue(long syncQueueId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SyncQueue deleteSyncQueue(SyncQueue syncQueue);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SyncQueue fetchSyncQueue(long syncQueueId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SyncQueue fetchSyncQueueByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SyncQueue getSyncQueue(long syncQueueId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SyncQueue getSyncQueueByUuidAndGroupId(java.lang.String uuid,
		long groupId) throws PortalException;

	public SyncQueue updateSyncQueue(long userId, long groupId,
		long syncQueueId, java.lang.String serverNo,
		java.lang.String className, java.lang.String jsonObject, int status,
		int retryCount, int priority, java.lang.String method,
		ServiceContext serviceContext)
		throws NoSuchUserException, SystemException, UnauthenticationException,
			UnauthorizationException, NoSuchSyncQueueException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SyncQueue updateSyncQueue(SyncQueue syncQueue);
}