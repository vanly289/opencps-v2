...
public class SyncQueueLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.synchronization.model.SyncQueue addBusinessSyncQueue(
		...
		return getService()
				   .addBusinessSyncQueue(userId, groupId, serverNo, className,
	...
	*/
	...
	private static ServiceTracker<SyncQueueLocalService, SyncQueueLocalService> _serviceTracker =
		ServiceTrackerFactory.open(SyncQueueLocalService.class);
}