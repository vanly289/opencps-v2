...
public interface DictGroupTempLocalService extends BaseLocalService,
	...
	*/
	...
	public DictGroupTemp addDictGroupTemp(long userId, long groupId,
		...
		java.lang.String groupDescription, int status,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictGroupTemp fetchByF_DictGroupCode(java.lang.String groupCode,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictGroupTemp fetchDictGroupTempByUuidAndGroupId(
		java.lang.String uuid, long groupId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictGroupTemp getByGC_GI_DCI(java.lang.String groupCode,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictGroupTemp getDictGroupTempByUuidAndGroupId(
