...
public class DictItemGroupTempLocalServiceUtil {
	...
	*/
	...
	public static org.opencps.synchronization.model.DictItemGroupTemp addBusinessDictItemGroupTemp(
		...
		return getService()
				   .addBusinessDictItemGroupTemp(userId, groupId, dictGroupId,
	...
	*/
	...
	private static ServiceTracker<DictItemGroupTempLocalService, DictItemGroupTempLocalService> _serviceTracker =
		ServiceTrackerFactory.open(DictItemGroupTempLocalService.class);
}