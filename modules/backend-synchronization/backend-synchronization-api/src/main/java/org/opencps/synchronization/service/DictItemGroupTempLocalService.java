...
public interface DictItemGroupTempLocalService extends BaseLocalService,
	...
	*/
	...
	public DictItemGroupTemp addBusinessDictItemGroupTemp(long userId,
		long groupId, long dictGroupId, long dictItemId,
		java.lang.String groupCode, ServiceContext serviceContext)
	...
	*/
	...
	public DictItemGroupTemp addDictItemGroupTemp(long userId, long groupId,
		long dictGroupId, long dictItemId, java.lang.String groupCode,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictItemGroupTemp getDictItemGroupTempByUuidAndGroupId(
