...
public class SyncQueueLocalServiceWrapper implements SyncQueueLocalService,
	...
	*/
	...
	@Override
	public org.opencps.synchronization.model.SyncQueue addBusinessSyncQueue(
		...
		return _syncQueueLocalService.addBusinessSyncQueue(userId, groupId,
			serverNo, className, jsonObject, status, retryCount, priority,
	...
	*/
	...
	public org.opencps.synchronization.model.SyncQueue updateSyncQueue(
		long userId, long groupId, long syncQueueId, java.lang.String serverNo,
		java.lang.String className, java.lang.String jsonObject, int status,
		int retryCount, int priority, java.lang.String method,
		com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws com.liferay.portal.kernel.exception.NoSuchUserException,
