...
public interface DictItemTempLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DictItemTemp> getDictItemTempsByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictItemTemp fetchDictItemTempByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DictItemTemp getDictItemTempByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	...
	public void deleteDictItemTemp(long groupId, java.lang.String itemCode,
		ServiceContext serviceContext)
		throws DuplicateCategoryException, NoSuchUserException, PortalException,
			NotFoundException, UnauthenticationException,
			UnauthorizationException;
