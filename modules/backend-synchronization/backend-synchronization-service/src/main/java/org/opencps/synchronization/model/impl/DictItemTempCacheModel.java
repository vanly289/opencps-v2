...
public class DictItemTempCacheModel implements CacheModel<DictItemTemp>,
	...
	public DictItemTemp toEntityModel() {
		...
		if (uuid == null) {
			dictItemTempImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dictItemTempImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (itemCode == null) {
			dictItemTempImpl.setItemCode(StringPool.BLANK);
		}
		else {
		...
		if (itemName == null) {
			dictItemTempImpl.setItemName(StringPool.BLANK);
		}
		else {
		...
		if (itemNameEN == null) {
			dictItemTempImpl.setItemNameEN(StringPool.BLANK);
		}
		else {
		...
		if (itemDescription == null) {
			dictItemTempImpl.setItemDescription(StringPool.BLANK);
		}
		else {
		...
		if (sibling == null) {
			dictItemTempImpl.setSibling(StringPool.BLANK);
		}
		else {
		...
		if (treeIndex == null) {
			dictItemTempImpl.setTreeIndex(StringPool.BLANK);
		}
		else {
		...
		if (metaData == null) {
			dictItemTempImpl.setMetaData(StringPool.BLANK);
		}
		else {
