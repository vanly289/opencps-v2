...
public class DictItemGroupTempCacheModel implements CacheModel<DictItemGroupTemp>,
	...
	public DictItemGroupTemp toEntityModel() {
		...
		if (uuid == null) {
			dictItemGroupTempImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dictItemGroupTempImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (dictGroupName == null) {
			dictItemGroupTempImpl.setDictGroupName(StringPool.BLANK);
		}
		else {
