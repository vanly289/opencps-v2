...
public class SyncQueueCacheModel implements CacheModel<SyncQueue>,
	...
	public SyncQueue toEntityModel() {
		...
		if (uuid == null) {
			syncQueueImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			syncQueueImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (serverNo == null) {
			syncQueueImpl.setServerNo(StringPool.BLANK);
		}
		else {
		...
		if (className == null) {
			syncQueueImpl.setClassName(StringPool.BLANK);
		}
		else {
		...
		if (jsonObject == null) {
			syncQueueImpl.setJsonObject(StringPool.BLANK);
		}
		else {
		...
		if (method == null) {
			syncQueueImpl.setMethod(StringPool.BLANK);
		}
		else {
