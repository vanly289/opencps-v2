...
import org.opencps.synchronization.service.DictGroupTempLocalService;
...
/**
 * Provides the base implementation for the dict group temp local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link org.opencps.synchronization.service.impl.DictGroupTempLocalServiceImpl}.
 * </p>
 *
 * @author trungdk
 ...
 */
@ProviderType
public abstract class DictGroupTempLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DictGroupTempLocalService,
		IdentifiableOSGiService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link org.opencps.synchronization.service.DictGroupTempLocalServiceUtil} to access the dict group temp local service.
	 */
	...
	public DictGroupTemp addDictGroupTemp(DictGroupTemp dictGroupTemp) {
		...
		return dictGroupTempPersistence.update(dictGroupTemp);
	}
	...
	public DictGroupTemp createDictGroupTemp(long dictGroupId) {
		return dictGroupTempPersistence.create(dictGroupId);
	}
	...
	public DictGroupTemp deleteDictGroupTemp(long dictGroupId)
		...
		return dictGroupTempPersistence.remove(dictGroupId);
	}
	...
	public DictGroupTemp deleteDictGroupTemp(DictGroupTemp dictGroupTemp) {
		return dictGroupTempPersistence.remove(dictGroupTemp);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DictGroupTemp.class,
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dictGroupTempPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dictGroupTempPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public DictGroupTemp fetchDictGroupTemp(long dictGroupId) {
		return dictGroupTempPersistence.fetchByPrimaryKey(dictGroupId);
	}
	...
	public DictGroupTemp fetchDictGroupTempByUuidAndGroupId(String uuid,
		long groupId) {
		return dictGroupTempPersistence.fetchByUUID_G(uuid, groupId);
	}
	...
	public DictGroupTemp getDictGroupTemp(long dictGroupId)
		throws PortalException {
		return dictGroupTempPersistence.findByPrimaryKey(dictGroupId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dictGroupTempLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DictGroupTemp.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("dictGroupId");
	...
	public IndexableActionableDynamicQuery getIndexableActionableDynamicQuery() {
		...
		indexableActionableDynamicQuery.setBaseLocalService(dictGroupTempLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(DictGroupTemp.class);

		indexableActionableDynamicQuery.setPrimaryKeyPropertyName("dictGroupId");
	...
	public ExportActionableDynamicQuery getExportActionableDynamicQuery(
		...
		exportActionableDynamicQuery.setPerformActionMethod(new ActionableDynamicQuery.PerformActionMethod<DictGroupTemp>() {
				@Override
				public void performAction(DictGroupTemp dictGroupTemp)
					throws PortalException {
		...
		exportActionableDynamicQuery.setStagedModelType(new StagedModelType(
				PortalUtil.getClassNameId(DictGroupTemp.class.getName())));
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		throws PortalException {
		return dictGroupTempLocalService.deleteDictGroupTemp((DictGroupTemp)persistedModel);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException {
		return dictGroupTempPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DictGroupTemp> getDictGroupTempsByUuidAndCompanyId(
		...
		return dictGroupTempPersistence.findByUuid_C(uuid, companyId);
	}
	...
	public List<DictGroupTemp> getDictGroupTempsByUuidAndCompanyId(
		...
		return dictGroupTempPersistence.findByUuid_C(uuid, companyId, start,
	...
	public DictGroupTemp getDictGroupTempByUuidAndGroupId(String uuid,
		...
		return dictGroupTempPersistence.findByUUID_G(uuid, groupId);
	}
	...
	public List<DictGroupTemp> getDictGroupTemps(int start, int end) {
		return dictGroupTempPersistence.findAll(start, end);
	}
	...
	public int getDictGroupTempsCount() {
		return dictGroupTempPersistence.countAll();
	}
	 ...
	 */
	public DictGroupTempLocalService getDictGroupTempLocalService() {
	...
	public void afterPropertiesSet() {
		persistedModelLocalServiceRegistry.register("org.opencps.synchronization.model.DictGroupTemp",
			dictGroupTempLocalService);
	}

	public void destroy() {
		persistedModelLocalServiceRegistry.unregister(
			"org.opencps.synchronization.model.DictGroupTemp");
	}
	...
	public String getOSGiServiceIdentifier() {
		return DictGroupTempLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dictGroupTempPersistence.getDataSource();
	...
	@BeanReference(type = DictGroupTempLocalService.class)
	protected DictGroupTempLocalService dictGroupTempLocalService;
