...
public class DictGroupTempCacheModel implements CacheModel<DictGroupTemp>,
	...
	public DictGroupTemp toEntityModel() {
		...
		if (uuid == null) {
			dictGroupTempImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dictGroupTempImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (groupCode == null) {
			dictGroupTempImpl.setGroupCode(StringPool.BLANK);
		}
		else {
		...
		if (groupName == null) {
			dictGroupTempImpl.setGroupName(StringPool.BLANK);
		}
		else {
		...
		if (groupNameEN == null) {
			dictGroupTempImpl.setGroupNameEN(StringPool.BLANK);
		}
		else {
		...
		if (groupDescription == null) {
			dictGroupTempImpl.setGroupDescription(StringPool.BLANK);
		}
		else {
