...
public class DictCollectionTempCacheModel implements CacheModel<DictCollectionTemp>,
	...
	public DictCollectionTemp toEntityModel() {
		...
		if (uuid == null) {
			dictCollectionTempImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			dictCollectionTempImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (collectionCode == null) {
			dictCollectionTempImpl.setCollectionCode(StringPool.BLANK);
		}
		else {
		...
		if (collectionName == null) {
			dictCollectionTempImpl.setCollectionName(StringPool.BLANK);
		}
		else {
		...
		if (collectionNameEN == null) {
			dictCollectionTempImpl.setCollectionNameEN(StringPool.BLANK);
		}
		else {
		...
		if (description == null) {
			dictCollectionTempImpl.setDescription(StringPool.BLANK);
		}
		else {
		...
		if (dataForm == null) {
			dictCollectionTempImpl.setDataForm(StringPool.BLANK);
		}
		else {
