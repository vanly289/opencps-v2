...
<div class="row">
	<div class="col-xs-2 col-sm-2">
		...
		<span class="btn btn-active btn-block p-xxs" id="btnDeleteDictItems">Xoá mục</span> 
		...
		<div class="row M0 eq-height" >
			...
			<div class="col-xs-1 col-sm-1 align-middle" >
				...
				<div class="full-width text-center">
				    ...
				    <div class="item click" data="#:itemCode#">
				        <input type="checkbox" value="#:itemCode#" class="click" />
				    </div>
				</div>
			...
			<div class="col-xs-5 col-sm-5 align-middle" >
...
(function($) {
    ...
    $('#btnDeleteDictItems').click(function() {
					...
					confirmWindown.then(function(confirmed){
						...
						if(confirmed){
					    	$('.item.click input:checked').each(function() {
					    		var itemCode = $(this).val();
								$.ajax({
									url: _collectionSub_dictItem_BaseUrl_detail + "/" + itemCode,
									headers: {
										"groupId": ${groupId}
									},
									type: 'DELETE',
									success: function(result) {
										_collectionSub_dictItem_dataSource_detail.read();
									},
