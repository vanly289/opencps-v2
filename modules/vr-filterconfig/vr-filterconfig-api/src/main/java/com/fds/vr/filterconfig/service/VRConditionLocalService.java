...
/**
 * Provides the local service interface for VRCondition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author NhanHoang
 * @see VRConditionLocalServiceUtil
...
public interface VRConditionLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link VRConditionLocalServiceUtil} to access the vr condition local service. Add custom service methods to {@link com.fds.vr.filterconfig.service.impl.VRConditionLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public VRCondition getVRCondition(java.lang.String specificationCode)
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<VRCondition> getVRConditionByFilterModuleCode(
		java.lang.String filterModuleCode) throws SystemException;
