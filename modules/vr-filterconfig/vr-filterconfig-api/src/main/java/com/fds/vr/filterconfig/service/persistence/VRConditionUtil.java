...
/**
 * The persistence utility for the vr condition service. This utility wraps {@link com.fds.vr.filterconfig.service.persistence.impl.VRConditionPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class VRConditionUtil {
	 ...
	 */
	public static void clearCache(VRCondition vrCondition) {
		getPersistence().clearCache(vrCondition);
	}
	 ...
	 */
	public static List<VRCondition> findWithDynamicQuery(
	 ...
	 */
	public static VRCondition update(VRCondition vrCondition) {
		return getPersistence().update(vrCondition);
	}
	...
	public static VRCondition update(VRCondition vrCondition,
		...
		return getPersistence().update(vrCondition, serviceContext);
	}
	...
	*/
	public static VRCondition fetchBySPEC_CODE(
		java.lang.String specificationCode) {
		return getPersistence().fetchBySPEC_CODE(specificationCode);
	}
	...
	*/
	public static VRCondition fetchBySPEC_CODE(
		...
		return getPersistence()
				   .fetchBySPEC_CODE(specificationCode, retrieveFromCache);
	}
	...
	*/
	public static VRCondition removeBySPEC_CODE(
		java.lang.String specificationCode)
		throws com.fds.vr.filterconfig.exception.NoSuchVRConditionException {
		return getPersistence().removeBySPEC_CODE(specificationCode);
	}
	...
	*/
	public static int countBySPEC_CODE(java.lang.String specificationCode) {
		return getPersistence().countBySPEC_CODE(specificationCode);
	}
	...
	*/
	public static List<VRCondition> findByFILTER_MODULE_CODE(
		java.lang.String filterModuleCode) {
		return getPersistence().findByFILTER_MODULE_CODE(filterModuleCode);
	}
	...
	*/
	public static List<VRCondition> findByFILTER_MODULE_CODE(
		...
		return getPersistence()
				   .findByFILTER_MODULE_CODE(filterModuleCode, start, end);
	}
	...
	* @throws NoSuchVRConditionException if a matching vr condition could not be found
	*/
	public static VRCondition findByFILTER_MODULE_CODE_First(
		java.lang.String filterModuleCode,
		OrderByComparator<VRCondition> orderByComparator)
		throws com.fds.vr.filterconfig.exception.NoSuchVRConditionException {
		return getPersistence()
				   .findByFILTER_MODULE_CODE_First(filterModuleCode,
			orderByComparator);
	}
	...
	*/
	public static VRCondition fetchByFILTER_MODULE_CODE_First(
		java.lang.String filterModuleCode,
		OrderByComparator<VRCondition> orderByComparator) {
		return getPersistence()
				   .fetchByFILTER_MODULE_CODE_First(filterModuleCode,
			orderByComparator);
	}
	...
	* @throws NoSuchVRConditionException if a matching vr condition could not be found
	*/
	public static VRCondition findByFILTER_MODULE_CODE_Last(
		java.lang.String filterModuleCode,
		OrderByComparator<VRCondition> orderByComparator)
		throws com.fds.vr.filterconfig.exception.NoSuchVRConditionException {
		return getPersistence()
				   .findByFILTER_MODULE_CODE_Last(filterModuleCode,
			orderByComparator);
	}
	...
	*/
	public static VRCondition fetchByFILTER_MODULE_CODE_Last(
		java.lang.String filterModuleCode,
		OrderByComparator<VRCondition> orderByComparator) {
		return getPersistence()
				   .fetchByFILTER_MODULE_CODE_Last(filterModuleCode,
			orderByComparator);
	}
	...
	*/
	public static VRCondition[] findByFILTER_MODULE_CODE_PrevAndNext(long id,
		java.lang.String filterModuleCode,
		OrderByComparator<VRCondition> orderByComparator)
		throws com.fds.vr.filterconfig.exception.NoSuchVRConditionException {
		return getPersistence()
				   .findByFILTER_MODULE_CODE_PrevAndNext(id, filterModuleCode,
			orderByComparator);
	}
	...
	* @param filterModuleCode the filter module code
	*/
	public static void removeByFILTER_MODULE_CODE(
		java.lang.String filterModuleCode) {
		getPersistence().removeByFILTER_MODULE_CODE(filterModuleCode);
	}
	...
	* @return the number of matching vr conditions
	*/
	public static int countByFILTER_MODULE_CODE(
		java.lang.String filterModuleCode) {
		return getPersistence().countByFILTER_MODULE_CODE(filterModuleCode);
	}
	...
	*/
	public static void cacheResult(VRCondition vrCondition) {
		getPersistence().cacheResult(vrCondition);
	}
	...
	*/
	public static void cacheResult(List<VRCondition> vrConditions) {
		getPersistence().cacheResult(vrConditions);
	}
	...
	*/
	public static VRCondition create(long id) {
	...
	* @throws NoSuchVRConditionException if a vr condition with the primary key could not be found
	*/
	public static VRCondition remove(long id)
		throws com.fds.vr.filterconfig.exception.NoSuchVRConditionException {
		return getPersistence().remove(id);
	}

	public static VRCondition updateImpl(VRCondition vrCondition) {
		return getPersistence().updateImpl(vrCondition);
	}
	...
	* @throws NoSuchVRConditionException if a vr condition with the primary key could not be found
	*/
	public static VRCondition findByPrimaryKey(long id)
		throws com.fds.vr.filterconfig.exception.NoSuchVRConditionException {
	...
	*/
	public static VRCondition fetchByPrimaryKey(long id) {
		return getPersistence().fetchByPrimaryKey(id);
	}

	public static java.util.Map<java.io.Serializable, VRCondition> fetchByPrimaryKeys(
	...
	*/
	public static List<VRCondition> findAll() {
	...
	*/
	public static List<VRCondition> findAll(int start, int end) {
	...
	*/
	...
	public static VRConditionPersistence getPersistence() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<VRConditionPersistence, VRConditionPersistence> _serviceTracker =
		ServiceTrackerFactory.open(VRConditionPersistence.class);
}