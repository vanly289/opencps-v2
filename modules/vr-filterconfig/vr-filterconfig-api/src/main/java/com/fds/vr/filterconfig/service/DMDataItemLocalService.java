...
public interface DMDataItemLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DMDataItemLocalServiceUtil} to access the dm data item local service. Add custom service methods to {@link com.fds.vr.filterconfig.service.impl.DMDataItemLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public DMDataItem deleteDMDataItem(long id) throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DMDataItem fetchDMDataItem(long id);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DMDataItem getDMDataItem(long id) throws PortalException;
