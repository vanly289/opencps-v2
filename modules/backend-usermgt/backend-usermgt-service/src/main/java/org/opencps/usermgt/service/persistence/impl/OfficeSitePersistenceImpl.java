...
public class OfficeSitePersistenceImpl extends BasePersistenceImpl<OfficeSite>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((officeSite.getUuid() == null) ||
							!officeSite.getUuid().equals(uuid) ||
							(officeSite.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, officeSite);
					}
				}
			}
			catch (Exception e) {
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((officeSite.getGroupId() != groupId) ||
							(officeSite.getSiteGroupId() != siteGroupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_GROUPID_SITEGROUPID,
							finderArgs, officeSite);
					}
				}
	...
	protected OfficeSite removeImpl(OfficeSite officeSite) {
		officeSite = toUnwrappedModel(officeSite);
	...
	public OfficeSite updateImpl(OfficeSite officeSite) {
		...
		if (isNew || !OfficeSiteModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
	...
	protected OfficeSite toUnwrappedModel(OfficeSite officeSite) {
		if (officeSite instanceof OfficeSiteImpl) {
			return officeSite;
		}

		OfficeSiteImpl officeSiteImpl = new OfficeSiteImpl();

		officeSiteImpl.setNew(officeSite.isNew());
		officeSiteImpl.setPrimaryKey(officeSite.getPrimaryKey());

		officeSiteImpl.setUuid(officeSite.getUuid());
		officeSiteImpl.setOfficeSiteId(officeSite.getOfficeSiteId());
		officeSiteImpl.setCompanyId(officeSite.getCompanyId());
		officeSiteImpl.setGroupId(officeSite.getGroupId());
		officeSiteImpl.setUserId(officeSite.getUserId());
		officeSiteImpl.setUserName(officeSite.getUserName());
		officeSiteImpl.setCreateDate(officeSite.getCreateDate());
		officeSiteImpl.setModifiedDate(officeSite.getModifiedDate());
		officeSiteImpl.setName(officeSite.getName());
		officeSiteImpl.setEnName(officeSite.getEnName());
		officeSiteImpl.setGovAgencyCode(officeSite.getGovAgencyCode());
		officeSiteImpl.setAddress(officeSite.getAddress());
		officeSiteImpl.setTelNo(officeSite.getTelNo());
		officeSiteImpl.setFaxNo(officeSite.getFaxNo());
		officeSiteImpl.setEmail(officeSite.getEmail());
		officeSiteImpl.setWebsite(officeSite.getWebsite());
		officeSiteImpl.setLogoFileEntryId(officeSite.getLogoFileEntryId());
		officeSiteImpl.setSiteGroupId(officeSite.getSiteGroupId());
		officeSiteImpl.setAdminUserId(officeSite.getAdminUserId());
		officeSiteImpl.setPreferences(officeSite.getPreferences());
		officeSiteImpl.setCeremonyDate(officeSite.getCeremonyDate());
