...
public class EmployeePersistenceImpl extends BasePersistenceImpl<Employee>
	...
	protected Employee toUnwrappedModel(Employee employee) {
		...
		employeeImpl.setTitle(employee.getTitle());
		...
		employeeImpl.setMainJobPostId(employee.getMainJobPostId());
		employeeImpl.setPhotoFileEntryId(employee.getPhotoFileEntryId());
		employeeImpl.setRecruitDate(employee.getRecruitDate());
		employeeImpl.setLeaveDate(employee.getLeaveDate());
		employeeImpl.setFileCertId(employee.getFileCertId());
		employeeImpl.setFileSignId(employee.getFileSignId());
		employeeImpl.setFileCertPath(employee.getFileCertPath());
		employeeImpl.setFileSignPath(employee.getFileSignPath());
