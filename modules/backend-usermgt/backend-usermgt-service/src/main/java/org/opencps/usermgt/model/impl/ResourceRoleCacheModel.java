...
public class ResourceRoleCacheModel implements CacheModel<ResourceRole>,
	...
	public ResourceRole toEntityModel() {
		...
		if (uuid == null) {
			resourceRoleImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			resourceRoleImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (className == null) {
			resourceRoleImpl.setClassName(StringPool.BLANK);
		}
		else {
		...
		if (classPK == null) {
			resourceRoleImpl.setClassPK(StringPool.BLANK);
		}
		else {
