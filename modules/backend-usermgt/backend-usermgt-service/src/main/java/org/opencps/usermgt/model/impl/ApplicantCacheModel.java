...
public class ApplicantCacheModel implements CacheModel<Applicant>,
	...
	public Applicant toEntityModel() {
		...
		if (uuid == null) {
			applicantImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			applicantImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (applicantName == null) {
			applicantImpl.setApplicantName(StringPool.BLANK);
		}
		else {
		...
		if (applicantIdType == null) {
			applicantImpl.setApplicantIdType(StringPool.BLANK);
		}
		else {
		...
		if (applicantIdNo == null) {
			applicantImpl.setApplicantIdNo(StringPool.BLANK);
		}
		else {
		...
		if (address == null) {
			applicantImpl.setAddress(StringPool.BLANK);
		}
		else {
		...
		if (cityCode == null) {
			applicantImpl.setCityCode(StringPool.BLANK);
		}
		else {
		...
		if (cityName == null) {
			applicantImpl.setCityName(StringPool.BLANK);
		}
		else {
		...
		if (districtCode == null) {
			applicantImpl.setDistrictCode(StringPool.BLANK);
		}
		else {
		...
		if (districtName == null) {
			applicantImpl.setDistrictName(StringPool.BLANK);
		}
		else {
		...
		if (wardCode == null) {
			applicantImpl.setWardCode(StringPool.BLANK);
		}
		else {
		...
		if (wardName == null) {
			applicantImpl.setWardName(StringPool.BLANK);
		}
		else {
		...
		if (contactName == null) {
			applicantImpl.setContactName(StringPool.BLANK);
		}
		else {
		...
		if (contactTelNo == null) {
			applicantImpl.setContactTelNo(StringPool.BLANK);
		}
		else {
		...
		if (contactEmail == null) {
			applicantImpl.setContactEmail(StringPool.BLANK);
		}
		else {
		...
		if (activationCode == null) {
			applicantImpl.setActivationCode(StringPool.BLANK);
		}
		else {
		...
		if (profile == null) {
			applicantImpl.setProfile(StringPool.BLANK);
		}
		else {
		...
		if (tmpPass == null) {
			applicantImpl.setTmpPass(StringPool.BLANK);
		}
		else {
		...
		if (representativeEnterprise == null) {
			applicantImpl.setRepresentativeEnterprise(StringPool.BLANK);
		}
		else {
