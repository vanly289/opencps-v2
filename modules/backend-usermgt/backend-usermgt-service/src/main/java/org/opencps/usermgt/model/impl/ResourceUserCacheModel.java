...
public class ResourceUserCacheModel implements CacheModel<ResourceUser>,
	...
	public ResourceUser toEntityModel() {
		...
		if (uuid == null) {
			resourceUserImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			resourceUserImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (className == null) {
			resourceUserImpl.setClassName(StringPool.BLANK);
		}
		else {
		...
		if (classPK == null) {
			resourceUserImpl.setClassPK(StringPool.BLANK);
		}
		else {
		...
		if (fullname == null) {
			resourceUserImpl.setFullname(StringPool.BLANK);
		}
		else {
		...
		if (email == null) {
			resourceUserImpl.setEmail(StringPool.BLANK);
		}
		else {
