...
public class ApplicantPersistenceImpl extends BasePersistenceImpl<Applicant>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((applicant.getApplicantIdNo() == null) ||
							!applicant.getApplicantIdNo().equals(applicantIdNo)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_APLC_ID,
							finderArgs, applicant);
					}
				}
	...
	public Applicant fetchByF_CTT_ID(String contactTelNo,
		...
		if (result == null) {
			...
			else if (contactTelNo.equals(StringPool.BLANK)) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((applicant.getContactTelNo() == null) ||
							!applicant.getContactTelNo().equals(contactTelNo)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_CTT_ID,
							finderArgs, applicant);
					}
				}
	...
	public Applicant fetchByF_CTE_ID(String contactEmail,
		...
		if (result == null) {
			...
			else if (contactEmail.equals(StringPool.BLANK)) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((applicant.getContactEmail() == null) ||
							!applicant.getContactEmail().equals(contactEmail)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_CTE_ID,
							finderArgs, applicant);
					}
				}
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((applicant.getMappingUserId() != mappingUserId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_MAPPING_ID,
							finderArgs, applicant);
					}
				}
	...
	protected Applicant toUnwrappedModel(Applicant applicant) {
		...
		applicantImpl.setApplicantIdType(applicant.getApplicantIdType());
		applicantImpl.setApplicantIdNo(applicant.getApplicantIdNo());
		applicantImpl.setApplicantIdDate(applicant.getApplicantIdDate());
		applicantImpl.setAddress(applicant.getAddress());
		applicantImpl.setCityCode(applicant.getCityCode());
		applicantImpl.setCityName(applicant.getCityName());
		applicantImpl.setDistrictCode(applicant.getDistrictCode());
		applicantImpl.setDistrictName(applicant.getDistrictName());
		applicantImpl.setWardCode(applicant.getWardCode());
		applicantImpl.setWardName(applicant.getWardName());
		applicantImpl.setContactName(applicant.getContactName());
		applicantImpl.setContactTelNo(applicant.getContactTelNo());
		applicantImpl.setContactEmail(applicant.getContactEmail());
		applicantImpl.setMappingUserId(applicant.getMappingUserId());
		applicantImpl.setActivationCode(applicant.getActivationCode());
		applicantImpl.setLock_(applicant.isLock_());
		applicantImpl.setProfile(applicant.getProfile());
		applicantImpl.setTmpPass(applicant.getTmpPass());
		applicantImpl.setRepresentativeEnterprise(applicant.getRepresentativeEnterprise());
