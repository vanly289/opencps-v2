...
public class EmployeeJobPosPersistenceImpl extends BasePersistenceImpl<EmployeeJobPos>
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((employeeJobPos.getUuid() == null) ||
							!employeeJobPos.getUuid().equals(uuid) ||
							(employeeJobPos.getGroupId() != groupId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
							finderArgs, employeeJobPos);
					}
				}
			}
			catch (Exception e) {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_JP_ID = new FinderPath(EmployeeJobPosModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeJobPosModelImpl.FINDER_CACHE_ENABLED,
			EmployeeJobPosImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByJP_ID",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_ID = new FinderPath(EmployeeJobPosModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeJobPosModelImpl.FINDER_CACHE_ENABLED,
			EmployeeJobPosImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByJP_ID",
			new String[] { Long.class.getName() },
			EmployeeJobPosModelImpl.JOBPOSTID_COLUMN_BITMASK |
			EmployeeJobPosModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_JP_ID = new FinderPath(EmployeeJobPosModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeJobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByJP_ID",
			new String[] { Long.class.getName() });
	 ...
	 */
	@Override
	public List<EmployeeJobPos> findByJP_ID(long jobPostId) {
		return findByJP_ID(jobPostId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<EmployeeJobPos> findByJP_ID(long jobPostId, int start, int end) {
		return findByJP_ID(jobPostId, start, end, null);
	}
	...
	public List<EmployeeJobPos> findByJP_ID(long jobPostId, int start, int end,
		OrderByComparator<EmployeeJobPos> orderByComparator) {
		return findByJP_ID(jobPostId, start, end, orderByComparator, true);
	}
	...
	public List<EmployeeJobPos> findByJP_ID(long jobPostId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_ID;
			finderArgs = new Object[] { jobPostId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_JP_ID;
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (EmployeeJobPos employeeJobPos : list) {
					if ((jobPostId != employeeJobPos.getJobPostId())) {
						list = null;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_JP_ID_JOBPOSTID_2);
	 ...
	 */
	@Override
	public EmployeeJobPos findByJP_ID_First(long jobPostId,
		OrderByComparator<EmployeeJobPos> orderByComparator)
		throws NoSuchEmployeeJobPosException {
		EmployeeJobPos employeeJobPos = fetchByJP_ID_First(jobPostId,
				orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos fetchByJP_ID_First(long jobPostId,
		OrderByComparator<EmployeeJobPos> orderByComparator) {
		List<EmployeeJobPos> list = findByJP_ID(jobPostId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos findByJP_ID_Last(long jobPostId,
		OrderByComparator<EmployeeJobPos> orderByComparator)
		throws NoSuchEmployeeJobPosException {
		EmployeeJobPos employeeJobPos = fetchByJP_ID_Last(jobPostId,
				orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos fetchByJP_ID_Last(long jobPostId,
		OrderByComparator<EmployeeJobPos> orderByComparator) {
		int count = countByJP_ID(jobPostId);

		if (count == 0) {
			return null;
		}

		List<EmployeeJobPos> list = findByJP_ID(jobPostId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos[] findByJP_ID_PrevAndNext(long employeeJobPosId,
		...
		try {
			...
			array[0] = getByJP_ID_PrevAndNext(session, employeeJobPos,
					jobPostId, orderByComparator, true);

			array[1] = employeeJobPos;

			array[2] = getByJP_ID_PrevAndNext(session, employeeJobPos,
	...
	protected EmployeeJobPos getByJP_ID_PrevAndNext(Session session,
		EmployeeJobPos employeeJobPos, long jobPostId,
		OrderByComparator<EmployeeJobPos> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByJP_ID(long jobPostId) {
		for (EmployeeJobPos employeeJobPos : findByJP_ID(jobPostId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(employeeJobPos);
		}
	}
	 ...
	 */
	@Override
	public int countByJP_ID(long jobPostId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_JP_ID;
	...
	private static final String _FINDER_COLUMN_JP_ID_JOBPOSTID_2 = "employeeJobPos.jobPostId = ?";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_JP_WU_ID = new FinderPath(EmployeeJobPosModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeJobPosModelImpl.FINDER_CACHE_ENABLED,
			EmployeeJobPosImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByJP_WU_ID",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_WU_ID =
		new FinderPath(EmployeeJobPosModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeJobPosModelImpl.FINDER_CACHE_ENABLED,
			EmployeeJobPosImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByJP_WU_ID",
			new String[] { Long.class.getName(), Long.class.getName() },
			EmployeeJobPosModelImpl.JOBPOSTID_COLUMN_BITMASK |
			EmployeeJobPosModelImpl.WORKINGUNITID_COLUMN_BITMASK |
			EmployeeJobPosModelImpl.CREATEDATE_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_JP_WU_ID = new FinderPath(EmployeeJobPosModelImpl.ENTITY_CACHE_ENABLED,
			EmployeeJobPosModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByJP_WU_ID",
			new String[] { Long.class.getName(), Long.class.getName() });
	 ...
	 */
	@Override
	public List<EmployeeJobPos> findByJP_WU_ID(long jobPostId,
		long workingUnitId) {
		return findByJP_WU_ID(jobPostId, workingUnitId, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<EmployeeJobPos> findByJP_WU_ID(long jobPostId,
		...
		return findByJP_WU_ID(jobPostId, workingUnitId, start, end, null);
	}
	...
	public List<EmployeeJobPos> findByJP_WU_ID(long jobPostId,
		long workingUnitId, int start, int end,
		OrderByComparator<EmployeeJobPos> orderByComparator) {
		return findByJP_WU_ID(jobPostId, workingUnitId, start, end,
			orderByComparator, true);
	}
	...
	public List<EmployeeJobPos> findByJP_WU_ID(long jobPostId,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_WU_ID;
			finderArgs = new Object[] { jobPostId, workingUnitId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_JP_WU_ID;
			finderArgs = new Object[] {
					jobPostId, workingUnitId,
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_JP_WU_ID_JOBPOSTID_2);

			query.append(_FINDER_COLUMN_JP_WU_ID_WORKINGUNITID_2);
	 ...
	 */
	@Override
	public EmployeeJobPos findByJP_WU_ID_First(long jobPostId,
		long workingUnitId, OrderByComparator<EmployeeJobPos> orderByComparator)
		throws NoSuchEmployeeJobPosException {
		EmployeeJobPos employeeJobPos = fetchByJP_WU_ID_First(jobPostId,
	 ...
	 */
	@Override
	public EmployeeJobPos fetchByJP_WU_ID_First(long jobPostId,
		long workingUnitId, OrderByComparator<EmployeeJobPos> orderByComparator) {
		List<EmployeeJobPos> list = findByJP_WU_ID(jobPostId, workingUnitId, 0,
				1, orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos findByJP_WU_ID_Last(long jobPostId,
		long workingUnitId, OrderByComparator<EmployeeJobPos> orderByComparator)
		throws NoSuchEmployeeJobPosException {
		EmployeeJobPos employeeJobPos = fetchByJP_WU_ID_Last(jobPostId,
				workingUnitId, orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos fetchByJP_WU_ID_Last(long jobPostId,
		long workingUnitId, OrderByComparator<EmployeeJobPos> orderByComparator) {
		int count = countByJP_WU_ID(jobPostId, workingUnitId);

		if (count == 0) {
			return null;
		}

		List<EmployeeJobPos> list = findByJP_WU_ID(jobPostId, workingUnitId,
				count - 1, count, orderByComparator);
	 ...
	 */
	@Override
	public EmployeeJobPos[] findByJP_WU_ID_PrevAndNext(long employeeJobPosId,
		long jobPostId, long workingUnitId,
		OrderByComparator<EmployeeJobPos> orderByComparator)
		throws NoSuchEmployeeJobPosException {
		EmployeeJobPos employeeJobPos = findByPrimaryKey(employeeJobPosId);
		...
		try {
			...
			array[0] = getByJP_WU_ID_PrevAndNext(session, employeeJobPos,
					jobPostId, workingUnitId, orderByComparator, true);

			array[1] = employeeJobPos;

			array[2] = getByJP_WU_ID_PrevAndNext(session, employeeJobPos,
					jobPostId, workingUnitId, orderByComparator, false);
	...
	protected EmployeeJobPos getByJP_WU_ID_PrevAndNext(Session session,
		EmployeeJobPos employeeJobPos, long jobPostId, long workingUnitId,
		OrderByComparator<EmployeeJobPos> orderByComparator, boolean previous) {
		StringBundler query = null;
	 ...
	 */
	@Override
	public void removeByJP_WU_ID(long jobPostId, long workingUnitId) {
		for (EmployeeJobPos employeeJobPos : findByJP_WU_ID(jobPostId,
				workingUnitId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(employeeJobPos);
		}
	}
	 ...
	 */
	@Override
	public int countByJP_WU_ID(long jobPostId, long workingUnitId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_JP_WU_ID;

		Object[] finderArgs = new Object[] { jobPostId, workingUnitId };
	...
	private static final String _FINDER_COLUMN_JP_WU_ID_JOBPOSTID_2 = "employeeJobPos.jobPostId = ? AND ";
	private static final String _FINDER_COLUMN_JP_WU_ID_WORKINGUNITID_2 = "employeeJobPos.workingUnitId = ?";
		...
		if (result == null) {
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((employeeJobPos.getGroupId() != groupId) ||
							(employeeJobPos.getEmployeeId() != employeeId) ||
							(employeeJobPos.getJobPostId() != jobPostId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_EMPLOYEEID_JOBPOSTID,
							finderArgs, employeeJobPos);
					}
				}
			...
			try {
				...
				if (list.isEmpty()) {
					...
					if ((employeeJobPos.getGroupId() != groupId) ||
							(employeeJobPos.getEmployeeId() != employeeId) ||
							(employeeJobPos.getJobPostId() != jobPostId) ||
							(employeeJobPos.getWorkingUnitId() != workingUnitId)) {
						finderCache.putResult(FINDER_PATH_FETCH_BY_F_EMPLOYEEID_JOBPOSTID_WORKINGUNITID,
							finderArgs, employeeJobPos);
					}
				}
	...
	protected EmployeeJobPos removeImpl(EmployeeJobPos employeeJobPos) {
		employeeJobPos = toUnwrappedModel(employeeJobPos);
	...
	public EmployeeJobPos updateImpl(EmployeeJobPos employeeJobPos) {
		...
		if (isNew || !EmployeeJobPosModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
			...
			if ((employeeJobPosModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_ID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						employeeJobPosModelImpl.getOriginalJobPostId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_JP_ID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_ID,
					args);

				args = new Object[] { employeeJobPosModelImpl.getJobPostId() };
			...
			if ((employeeJobPosModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_WU_ID.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						employeeJobPosModelImpl.getOriginalJobPostId(),
						employeeJobPosModelImpl.getOriginalWorkingUnitId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_JP_WU_ID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_JP_WU_ID,
					args);
	...
	protected EmployeeJobPos toUnwrappedModel(EmployeeJobPos employeeJobPos) {
		if (employeeJobPos instanceof EmployeeJobPosImpl) {
			return employeeJobPos;
		}

		EmployeeJobPosImpl employeeJobPosImpl = new EmployeeJobPosImpl();

		employeeJobPosImpl.setNew(employeeJobPos.isNew());
		employeeJobPosImpl.setPrimaryKey(employeeJobPos.getPrimaryKey());

		employeeJobPosImpl.setUuid(employeeJobPos.getUuid());
		employeeJobPosImpl.setEmployeeJobPosId(employeeJobPos.getEmployeeJobPosId());
		employeeJobPosImpl.setCompanyId(employeeJobPos.getCompanyId());
		employeeJobPosImpl.setGroupId(employeeJobPos.getGroupId());
		employeeJobPosImpl.setUserId(employeeJobPos.getUserId());
		employeeJobPosImpl.setUserName(employeeJobPos.getUserName());
		employeeJobPosImpl.setCreateDate(employeeJobPos.getCreateDate());
		employeeJobPosImpl.setModifiedDate(employeeJobPos.getModifiedDate());
		employeeJobPosImpl.setEmployeeId(employeeJobPos.getEmployeeId());
		employeeJobPosImpl.setJobPostId(employeeJobPos.getJobPostId());
		employeeJobPosImpl.setWorkingUnitId(employeeJobPos.getWorkingUnitId());
