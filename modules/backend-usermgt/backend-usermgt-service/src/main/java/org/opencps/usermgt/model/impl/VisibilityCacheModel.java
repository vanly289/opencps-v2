...
public class VisibilityCacheModel implements CacheModel<Visibility>,
	...
	public Visibility toEntityModel() {
		...
		if (uuid == null) {
			visibilityImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			visibilityImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (className == null) {
			visibilityImpl.setClassName(StringPool.BLANK);
		}
		else {
		...
		if (classPK == null) {
			visibilityImpl.setClassPK(StringPool.BLANK);
		}
		else {
		...
		if (security == null) {
			visibilityImpl.setSecurity(StringPool.BLANK);
		}
		else {
