...
public class HmacAuthenPersistenceImpl extends BasePersistenceImpl<HmacAuthen>
	...
	protected HmacAuthen removeImpl(HmacAuthen hmacAuthen) {
		hmacAuthen = toUnwrappedModel(hmacAuthen);
	...
	protected HmacAuthen toUnwrappedModel(HmacAuthen hmacAuthen) {
		if (hmacAuthen instanceof HmacAuthenImpl) {
			return hmacAuthen;
		}

		HmacAuthenImpl hmacAuthenImpl = new HmacAuthenImpl();

		hmacAuthenImpl.setNew(hmacAuthen.isNew());
		hmacAuthenImpl.setPrimaryKey(hmacAuthen.getPrimaryKey());

		hmacAuthenImpl.setHmacAuthId(hmacAuthen.getHmacAuthId());
		hmacAuthenImpl.setGroupId(hmacAuthen.getGroupId());
		hmacAuthenImpl.setCompanyId(hmacAuthen.getCompanyId());
		hmacAuthenImpl.setUserId(hmacAuthen.getUserId());
		hmacAuthenImpl.setUserName(hmacAuthen.getUserName());
		hmacAuthenImpl.setCreateDate(hmacAuthen.getCreateDate());
		hmacAuthenImpl.setModifiedDate(hmacAuthen.getModifiedDate());
		hmacAuthenImpl.setSecret(hmacAuthen.getSecret());
		hmacAuthenImpl.setPermanent(hmacAuthen.isPermanent());
