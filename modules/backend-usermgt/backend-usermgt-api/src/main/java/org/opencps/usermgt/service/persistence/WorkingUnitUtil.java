...
public class WorkingUnitUtil {
	...
	* @return the number of matching working units
	*/
	public static int countByF_govAgencyCode(long groupId,
		java.lang.String govAgencyCode) {
	...
	*/
	public static WorkingUnit[] findByF_childs_unit_PrevAndNext(
		long workingUnitId, long groupId, java.lang.String treeIndex,
		OrderByComparator<WorkingUnit> orderByComparator)
		throws org.opencps.usermgt.exception.NoSuchWorkingUnitException {
		return getPersistence()
	...
	* @param treeIndex the tree index
	*/
	public static void removeByF_childs_unit(long groupId,
		java.lang.String treeIndex) {
	...
	* @return the number of matching working units
	*/
	public static int countByF_childs_unit(long groupId,
		java.lang.String treeIndex) {
