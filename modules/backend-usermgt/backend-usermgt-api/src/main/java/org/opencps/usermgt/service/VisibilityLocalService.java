...
public interface VisibilityLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Visibility> getVisibilitiesByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Visibility fetchVisibilityByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Visibility getVisibilityByUuidAndGroupId(java.lang.String uuid,
