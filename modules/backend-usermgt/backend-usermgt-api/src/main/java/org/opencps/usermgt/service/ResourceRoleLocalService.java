...
public interface ResourceRoleLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ResourceRole> getResourceRolesByUuidAndCompanyId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ResourceRole fetchResourceRoleByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ResourceRole getResourceRoleByUuidAndGroupId(java.lang.String uuid,
