...
/**
 * Provides the local service interface for JobPosWork. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoavu
 * @see JobPosWorkLocalServiceUtil
...
public interface JobPosWorkLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link JobPosWorkLocalServiceUtil} to access the job pos work local service. Add custom service methods to {@link org.opencps.usermgt.service.impl.JobPosWorkLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JobPosWork> getJobPosWorks(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JobPosWork> getJobPosWorksByUuidAndCompanyId(
	...
	*/
	...
	public JobPosWork addJobPosWork(long userId, long groupId, long jobPostId,
		java.lang.String checklistCat, ServiceContext serviceContext)
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public JobPosWork addJobPosWork(JobPosWork jobPosWork);
	...
	*/
	public JobPosWork createJobPosWork(long jobPosWorkId);
	...
	*/
	...
	public JobPosWork deleteJobPosWork(long jobPosWorkId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public JobPosWork deleteJobPosWork(JobPosWork jobPosWork);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobPosWork fetchJobPosWork(long jobPosWorkId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobPosWork fetchJobPosWorkByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobPosWork getJobPosWork(long jobPosWorkId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobPosWork getJobPosWorkByUuidAndGroupId(java.lang.String uuid,
		long groupId) throws PortalException;

	@Indexable(type = IndexableType.REINDEX)
	public JobPosWork updateJobPosWork(long userId, long jobPosWorkId,
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public JobPosWork updateJobPosWork(JobPosWork jobPosWork);
}