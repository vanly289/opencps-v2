...
public interface PreferencesLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Preferences> getPreferencesesByUuidAndCompanyId(
	...
	*/
	...
	public Preferences addPreferences(long userId, long groupId,
		java.lang.String preferencesData, ServiceContext serviceContext)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Preferences fetchPreferencesByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Preferences getPreferencesByUuidAndGroupId(java.lang.String uuid,
