...
public interface JobPosLocalService extends BaseLocalService,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<JobPos> getJobPosesByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
	...
	*/
	...
	public JobPos addJobPos(long userId, long groupId, java.lang.String title,
		java.lang.String description, int leader, ServiceContext serviceContext)
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobPos fetchJobPosByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public JobPos getJobPosByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;

	@Indexable(type = IndexableType.REINDEX)
	public JobPos updateJobPos(long userId, long jobPosId,
		java.lang.String title, java.lang.String description, int leader,
