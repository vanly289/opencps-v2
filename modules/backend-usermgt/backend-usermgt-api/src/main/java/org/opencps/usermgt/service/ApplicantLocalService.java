...
public interface ApplicantLocalService extends BaseLocalService,
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Applicant fetchByAppId(java.lang.String appId);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Applicant fetchByEmail(java.lang.String email);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Applicant fetchByMappingID(long mappingID);

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Applicant fetchByTelNo(java.lang.String telNo);
	...
	*/
	...
	public Applicant updateApplication(ServiceContext context, long groupId,
		long applicantId, java.lang.String applicantName,
		...
		java.lang.String contactEmail, java.lang.String profile,
		java.lang.String password) throws PortalException, SystemException;
}