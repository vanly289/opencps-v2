...
public interface WorkingUnitPersistence extends BasePersistence<WorkingUnit> {
	...
	* @throws NoSuchWorkingUnitException if a matching working unit could not be found
	*/
	public WorkingUnit findByF_govAgencyCode(long groupId,
		java.lang.String govAgencyCode) throws NoSuchWorkingUnitException;
	...
	* @return the number of matching working units
	*/
	public int countByF_govAgencyCode(long groupId,
		java.lang.String govAgencyCode);
	...
	* @throws NoSuchWorkingUnitException if a matching working unit could not be found
	*/
	public WorkingUnit findByF_childs_unit_Last(long groupId,
		java.lang.String treeIndex,
		com.liferay.portal.kernel.util.OrderByComparator<WorkingUnit> orderByComparator)
		throws NoSuchWorkingUnitException;
	...
	*/
	public WorkingUnit[] findByF_childs_unit_PrevAndNext(long workingUnitId,
		long groupId, java.lang.String treeIndex,
		com.liferay.portal.kernel.util.OrderByComparator<WorkingUnit> orderByComparator)
		throws NoSuchWorkingUnitException;
	...
	* @param treeIndex the tree index
	*/
	public void removeByF_childs_unit(long groupId, java.lang.String treeIndex);
	...
	* @return the number of matching working units
	*/
	public int countByF_childs_unit(long groupId, java.lang.String treeIndex);
